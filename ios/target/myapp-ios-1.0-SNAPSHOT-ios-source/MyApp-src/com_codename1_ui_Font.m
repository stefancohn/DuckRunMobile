...
JAVA_VOID com_codename1_ui_Font___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 205);
...
JAVA_VOID com_codename1_ui_Font___INIT_____java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3095, 205);
...
JAVA_VOID com_codename1_ui_Font___INIT_____int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3095, 205);
...
JAVA_OBJECT com_codename1_ui_Font_getBitmapFont___java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 3095, 3096);
...
JAVA_BOOLEAN com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 3095, 3098);
...
JAVA_BOOLEAN com_codename1_ui_Font_isCreationByStringSupported___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 3095, 3099);
...
JAVA_BOOLEAN com_codename1_ui_Font_isNativeFontSchemeSupported___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 3095, 1029);
...
JAVA_OBJECT com_codename1_ui_Font_createTrueTypeFont___java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 3095, 3100);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1381341801;
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1031))!=0) /* IFNE CustomJump */ goto label_L1381341801;
    __CN1_DEBUG_INFO(163);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3101));     SP -= 1;
...
JAVA_OBJECT com_codename1_ui_Font_createTrueTypeFont___java_lang_String_float_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 3095, 3100);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_Font_createTrueTypeFont___java_lang_String_java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(4, 6, 0, 3095, 3100);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L676692948;
...
label_L676692948:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1031))==0) /* IFEQ CustomJump */ goto label_L272220100;
    __CN1_DEBUG_INFO(224);
    if (virtual_com_codename1_impl_CodenameOneImplementation_isNativeFontSchemeSupported___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))!=0) /* IFNE CustomJump */ goto label_L2139431292;
    __CN1_DEBUG_INFO(225);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L272220100:
    __CN1_DEBUG_INFO(228);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2139431292;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[1].data.o, 47)>-1 /* ICONST_M1 */) /* IF_ICMPGT CustomJump */ goto label_L33389111;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[1].data.o, 92)>-1 /* ICONST_M1 */) /* IF_ICMPGT CustomJump */ goto label_L33389111;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3102))!=0) /* IFNE CustomJump */ goto label_L2139431292;
...
label_L33389111:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3103));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, locals[1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_toString___R_java_lang_String(threadStateData, SP[-1].data.o);
...
label_L2139431292:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L95552255;
...
JAVA_OBJECT com_codename1_ui_Font_derive___float_int_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 3095, 3104);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(276);
    if (get_field_com_codename1_ui_Font_fontUniqueId(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1487424018;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L242224826;
...
label_L1487424018:
    ...
    if (get_field_com_codename1_ui_Font_font(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1681318273;
...
label_L1681318273:
    ...
    if (get_field_com_codename1_ui_Font_ttf(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1904652802;
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3105));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3106));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_toString___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
...
label_L1904652802:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_Object_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, __cn1ThisObject);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3107));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_toString___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
...
JAVA_BOOLEAN com_codename1_ui_Font_isTTFNativeFont___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3095, 3108);
...
JAVA_OBJECT com_codename1_ui_Font_create___java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 3095, 3082);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(327);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1031))==0) /* IFEQ CustomJump */ goto label_L1801756410;
...
label_L1801756410:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1710180594;
...
JAVA_OBJECT com_codename1_ui_Font_createBitmapFont___java_lang_String_com_codename1_ui_Image_int_1ARRAY_int_1ARRAY_java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(4, 6, 0, 3095, 3110);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_Font_createBitmapFont___com_codename1_ui_Image_int_1ARRAY_int_1ARRAY_java_lang_String_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(6, 4, 0, 3095, 3110);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_Font_createSystemFont___int_int_int_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(5, 3, 0, 3095, 882);
...
JAVA_INT com_codename1_ui_Font_charsWidth___char_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 3095, 868);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_INT com_codename1_ui_Font_substringWidth___java_lang_String_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 3095, 3111);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_INT com_codename1_ui_Font_stringWidth___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3095, 873);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(434);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L906397479;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1918121287;
...
label_L1918121287:
    ...
    if (locals[1].data.o!=STRING_FROM_CONSTANT_POOL_OFFSET(1051)) /* IF_ACMPNE CustomJump */ goto label_L1032382137;
...
JAVA_INT com_codename1_ui_Font_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3095, 877);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_Font_getHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 879);
...
JAVA_OBJECT com_codename1_ui_Font_getDefaultFont___R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 3095, 881);
...
JAVA_VOID com_codename1_ui_Font_setDefaultFont___com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 3095, 3113);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(491);
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L582979874;
...
JAVA_INT com_codename1_ui_Font_getFace___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 978);
...
JAVA_INT com_codename1_ui_Font_getSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 995);
...
JAVA_INT com_codename1_ui_Font_getStyle___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 996);
...
JAVA_BOOLEAN com_codename1_ui_Font_isBitmapFontEnabled___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_Font(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 3095, 3117);
...
JAVA_OBJECT com_codename1_ui_Font_getNativeFont___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3095, 3118);
...
JAVA_BOOLEAN com_codename1_ui_Font_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 3095, 244);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(597);
    if (get_field_com_codename1_ui_Font_ttf(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L545392109;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L545392109;
    __CN1_DEBUG_INFO(598);
    if (get_field_com_codename1_ui_Font_font(locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1940906679;
    if (get_field_com_codename1_ui_Font_ttf(locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1940906679;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_Font_font(locals[1].data.o), get_field_com_codename1_ui_Font_font(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1940906679;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L157843285;
...
label_L545392109:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1459669467;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1459669467;
    __CN1_DEBUG_INFO(601);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(602);
    if (get_field_com_codename1_ui_Font_ttf(locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L1729954747;
    if (virtual_com_codename1_ui_Font_getFace___R_int(threadStateData, locals[2].data.o)!=virtual_com_codename1_ui_Font_getFace___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1729954747;
    if (virtual_com_codename1_ui_Font_getSize___R_int(threadStateData, locals[2].data.o)!=virtual_com_codename1_ui_Font_getSize___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1729954747;
    if (virtual_com_codename1_ui_Font_getStyle___R_int(threadStateData, locals[2].data.o)!=virtual_com_codename1_ui_Font_getStyle___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1729954747;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1806434229;
...
JAVA_INT com_codename1_ui_Font_getAscent___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3095, 3119);
...
JAVA_FLOAT com_codename1_ui_Font_getPixelSize___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3095, 3121);
...
JAVA_VOID com_codename1_ui_Font___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(3, 0, 0, 3095, 275);
    __CN1_DEBUG_INFO(69);
    PUSH_POINTER(__NEW_com_codename1_ui_Font(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
