...
JAVA_VOID com_codename1_media_AbstractMedia_2StateChangeListener_actionPerformed___com_codename1_media_AsyncMedia_MediaStateChangeEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_media_AsyncMedia_PauseRequest_isDone___R_boolean(threadStateData, get_field_com_codename1_media_AbstractMedia_2StateChangeListener_val_out(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L176312199;
    ...
    if (get_field_com_codename1_media_AbstractMedia_2StateChangeListener_onError(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1737077873;
