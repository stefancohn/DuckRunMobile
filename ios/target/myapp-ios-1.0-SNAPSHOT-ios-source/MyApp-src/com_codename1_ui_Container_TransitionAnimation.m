...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_destroyed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L149818403;
...
label_L149818403:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_started(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L716550087;
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1305002218;
...
label_L1305002218:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_next(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L239824711;
...
label_L239824711:
    ...
    if (/* CustomInvoke */com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1983706553;
...
label_L716550087:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_inProgress(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1911600942;
...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation_destroy__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_destroyed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L793808700;
...
label_L793808700:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L1053832786;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_layoutAnimationSpeed(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1257090913;
...
label_L389519344:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1010156357;
...
label_L1010156357:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_next(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L57151543;
...
label_L57151543:
    ...
    if (/* CustomInvoke */com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L609825180;
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject)));
    { JAVA_INT tmpResult = virtual_java_util_Vector_size___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L609825180;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L609825180;
    __CN1_DEBUG_INFO(4269);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L268086000;
...
label_L268086000:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_layoutAnimationSpeed(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L609825180;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_dontRevalidate(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L609825180;
    __CN1_DEBUG_INFO(4273);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L609825180;
