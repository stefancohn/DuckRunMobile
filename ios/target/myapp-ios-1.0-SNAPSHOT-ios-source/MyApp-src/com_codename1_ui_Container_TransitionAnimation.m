...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation___INIT_____com_codename1_ui_Container_com_codename1_ui_Component_com_codename1_ui_Component_com_codename1_ui_animations_Transition(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 7214, 205);
...
JAVA_BOOLEAN com_codename1_ui_Container_TransitionAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7214, 2795);
...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7214, 2796);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4220);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_destroyed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L716550087;
...
label_L716550087:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_started(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1305002218;
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L239824711;
...
label_L239824711:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_next(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1983706553;
...
label_L1983706553:
    ...
    if (/* CustomInvoke */com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1911600942;
...
label_L1305002218:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_inProgress(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2050291306;
...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7214, 934);
...
JAVA_VOID com_codename1_ui_Container_TransitionAnimation_destroy__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 7214, 7215);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4254);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_destroyed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1053832786;
...
label_L1053832786:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L1257090913;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_layoutAnimationSpeed(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L389519344;
...
label_L1010156357:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L57151543;
...
label_L57151543:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_next(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L609825180;
...
label_L609825180:
    ...
    if (/* CustomInvoke */com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L268086000;
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Container_access$1100___com_codename1_ui_Container_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Container_TransitionAnimation_thisContainer(__cn1ThisObject)));
    { JAVA_INT tmpResult = virtual_java_util_Vector_size___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L268086000;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L268086000;
    __CN1_DEBUG_INFO(4269);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_growSpeed(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L499609505;
...
label_L499609505:
    ...
    if (get_field_com_codename1_ui_Container_TransitionAnimation_layoutAnimationSpeed(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L268086000;
    if (get_field_com_codename1_ui_Container_TransitionAnimation_dontRevalidate(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L268086000;
    __CN1_DEBUG_INFO(4273);
    if (get_field_com_codename1_ui_Container_TransitionAnimation_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L268086000;
