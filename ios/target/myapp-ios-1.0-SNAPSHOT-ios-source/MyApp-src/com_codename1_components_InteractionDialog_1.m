...
JAVA_VOID com_codename1_components_InteractionDialog_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_components_InteractionDialog_1_val_p(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L845449668;
...
label_L845449668:
    ...
    if (get_field_com_codename1_components_InteractionDialog_1_val_onFinish(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1343642221;
