...
JAVA_VOID com_codename1_util_AsyncResource_AsyncCallback___INIT_____com_codename1_util_AsyncResource_com_codename1_util_SuccessCallback_com_codename1_util_EasyThread(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    BC_ALOAD(0);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1815772036;
    if (com_codename1_ui_CN_isEdt___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1815772036;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L306090132;
...
JAVA_VOID com_codename1_util_AsyncResource_AsyncCallback_onSucess___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_util_AsyncResource_AsyncCallback_edt(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L527148155;
    if (com_codename1_ui_CN_isEdt___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L527148155;
...
label_L527148155:
    ...
    if (get_field_com_codename1_util_AsyncResource_AsyncCallback_t(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L29063342;
    if (virtual_com_codename1_util_EasyThread_isThisIt___R_boolean(threadStateData, get_field_com_codename1_util_AsyncResource_AsyncCallback_t(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L29063342;
