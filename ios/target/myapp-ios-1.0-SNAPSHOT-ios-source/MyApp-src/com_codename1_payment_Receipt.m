...
JAVA_VOID com_codename1_payment_Receipt_setExternalizableRegistered___boolean(CODENAME_ONE_THREAD_STATE, JAVA_BOOLEAN __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_payment_Receipt(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 9126, 9127);
...
JAVA_VOID com_codename1_payment_Receipt___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 205);
...
JAVA_VOID com_codename1_payment_Receipt___INIT_____java_lang_String_java_util_Date_java_util_Date_java_util_Date_int_java_lang_String_java_lang_String_java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_OBJECT __cn1Arg6, JAVA_OBJECT __cn1Arg7, JAVA_OBJECT __cn1Arg8, JAVA_OBJECT __cn1Arg9) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 10, 0, 9126, 205);
...
JAVA_OBJECT com_codename1_payment_Receipt_getSku___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9123);
...
JAVA_VOID com_codename1_payment_Receipt_setSku___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9124);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_payment_Receipt_getExpiryDate___R_java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9104);
...
JAVA_VOID com_codename1_payment_Receipt_setExpiryDate___java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9128);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_payment_Receipt_getVersion___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 8197);
...
JAVA_VOID com_codename1_payment_Receipt_externalize___java_io_DataOutputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 9126, 8198);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    /* LDC: 'sku'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9129));
    ...
    BC_ALOAD(2);
    /* LDC: 'expiryDate'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9130));
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9131));
    ...
    BC_ALOAD(2);
    /* LDC: 'purchaseDate'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9132));
    ...
    BC_ALOAD(2);
    /* LDC: 'orderData'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9133));
    ...
    BC_ALOAD(2);
    /* LDC: 'transactionId'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9134));
    ...
    BC_ALOAD(2);
    /* LDC: 'quantity'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9135));
    ...
    BC_ALOAD(2);
    /* LDC: 'storeCode'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9136));
    ...
    BC_ALOAD(2);
    /* LDC: 'internalId'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9137));
...
JAVA_VOID com_codename1_payment_Receipt_internalize___int_java_io_DataInputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 9126, 8199);
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9129));
    PUSH_OBJ(tmpResult); }
    virtual_com_codename1_payment_Receipt_setSku___java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    __CN1_DEBUG_INFO(210);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9130));
    PUSH_OBJ(tmpResult); }
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9131));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_payment_Receipt_cancellationDate(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(212);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9132));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_payment_Receipt_purchaseDate(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(213);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9135));
    PUSH_OBJ(tmpResult); }
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9134));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_payment_Receipt_transactionId(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(215);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9133));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_payment_Receipt_orderData(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(216);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9136));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_payment_Receipt_storeCode(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(217);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_Map_get___java_lang_Object_R_java_lang_Object(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9137));
    PUSH_OBJ(tmpResult); }
...
JAVA_VOID com_codename1_payment_Receipt_registerExternalizable__(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_payment_Receipt(threadStateData);
    DEFINE_METHOD_STACK(2, 0, 0, 9126, 8450);
    __CN1_DEBUG_INFO(241);
    if (com_codename1_payment_Receipt_isExternalizableRegistered___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L247576438;
    __CN1_DEBUG_INFO(242);
    /* CustomInvoke */com_codename1_io_Util_register___java_lang_String_java_lang_Class(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(9138), (JAVA_OBJECT)&class__com_codename1_payment_Receipt); 
...
JAVA_OBJECT com_codename1_payment_Receipt_getCancellationDate___R_java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9140);
...
JAVA_OBJECT com_codename1_payment_Receipt_getPurchaseDate___R_java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9142);
...
JAVA_VOID com_codename1_payment_Receipt_setPurchaseDate___java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9143);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_payment_Receipt_getQuantity___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9144);
...
JAVA_OBJECT com_codename1_payment_Receipt_getTransactionId___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9146);
...
JAVA_VOID com_codename1_payment_Receipt_setTransactionId___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9147);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_payment_Receipt_getOrderData___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9148);
...
JAVA_VOID com_codename1_payment_Receipt_setOrderData___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9149);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_payment_Receipt_getStoreCode___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9117);
...
JAVA_VOID com_codename1_payment_Receipt_setStoreCode___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 9150);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_payment_Receipt_getInternalId___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9126, 9151);
...
JAVA_OBJECT com_codename1_payment_Receipt_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9126, 263);
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9153));
    PUSH_OBJ(tmpResult); }
    /* LDC: 'sku:'*/
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'cancellationDate:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9156));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'purchaseDate:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9157));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'orderData:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9158));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'quantity:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9159));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'transactionId:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9160));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'storeCode:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9161));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* LDC: 'internalId:'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9162));
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1303));     SP -= 1;
