#ifndef __COM_CODENAME1_PROPERTIES_NUMERICPROPERTY__
#define __COM_CODENAME1_PROPERTIES_NUMERICPROPERTY__

#include "cn1_globals.h"
#include "com_codename1_properties_Property.h"
extern struct clazz class__com_codename1_properties_NumericProperty;
extern void __INIT_VTABLE_com_codename1_properties_NumericProperty(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_com_codename1_properties_NumericProperty(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_com_codename1_properties_NumericProperty(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_com_codename1_properties_NumericProperty(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
...
JAVA_VOID com_codename1_properties_NumericProperty_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_codename1_properties_NumericProperty_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID com_codename1_properties_NumericProperty_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
#define get_static_com_codename1_properties_NumericProperty_onGlobalGetProperty(threadStateArgument) get_static_com_codename1_properties_PropertyBase_onGlobalGetProperty(threadStateArgument)
#define set_static_com_codename1_properties_NumericProperty_onGlobalGetProperty(threadStateArgument, valueArgument) set_static_com_codename1_properties_PropertyBase_onGlobalGetProperty(threadStateArgument, valueArgument)
#define get_static_com_codename1_properties_NumericProperty_onGlobalSetProperty(threadStateArgument) get_static_com_codename1_properties_PropertyBase_onGlobalSetProperty(threadStateArgument)
#define set_static_com_codename1_properties_NumericProperty_onGlobalSetProperty(threadStateArgument, valueArgument) set_static_com_codename1_properties_PropertyBase_onGlobalSetProperty(threadStateArgument, valueArgument)
JAVA_BOOLEAN get_field_com_codename1_properties_NumericProperty_nullable(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_codename1_properties_NumericProperty_parent(JAVA_OBJECT t);
...
struct obj__com_codename1_properties_NumericProperty {
    DEBUG_GC_VARIABLES
...
#endif //__COM_CODENAME1_PROPERTIES_NUMERICPROPERTY__
