...
JAVA_VOID com_codename1_ui_Container_5_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL14613660301;
    int tryBlockOffsetL14613660301;
    DEFINE_CATCH_BLOCK(catch_L14613660301, label_L406265225, restoreToL14613660301);
    __CN1_DEBUG_INFO(1352);
    if (get_field_com_codename1_ui_Container_5_alreadyRemoved(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1329572464, 0);

label_L146136603:
 tryBlockOffsetL14613660301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L14613660301);
    restoreToL14613660301 = threadStateData->threadObjectStackOffset;
