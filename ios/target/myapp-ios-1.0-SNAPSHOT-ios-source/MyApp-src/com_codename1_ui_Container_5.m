...
JAVA_VOID com_codename1_ui_Container_5_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL46151130201;
    int tryBlockOffsetL46151130201;
    DEFINE_CATCH_BLOCK(catch_L46151130201, label_L1329572464, restoreToL46151130201);
    __CN1_DEBUG_INFO(1352);
    if (get_field_com_codename1_ui_Container_5_alreadyRemoved(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1211297851, 0);

label_L461511302:
 tryBlockOffsetL46151130201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L46151130201);
    restoreToL46151130201 = threadStateData->threadObjectStackOffset;
