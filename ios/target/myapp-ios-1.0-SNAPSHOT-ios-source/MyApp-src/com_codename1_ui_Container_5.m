...
JAVA_VOID com_codename1_ui_Container_5___INIT_____com_codename1_ui_Container_com_codename1_ui_Component_com_codename1_ui_Container_QueuedRemoval(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 3437, 205);
...
JAVA_BOOLEAN com_codename1_ui_Container_5_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3437, 2806);
...
JAVA_VOID com_codename1_ui_Container_5_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3437, 2807);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL132036539601;
    int tryBlockOffsetL132036539601;
    DEFINE_CATCH_BLOCK(catch_L132036539601, label_L1261545224, restoreToL132036539601);
    __CN1_DEBUG_INFO(1352);
    if (get_field_com_codename1_ui_Container_5_alreadyRemoved(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L300111306, 0);

label_L1320365396:
 tryBlockOffsetL132036539601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L132036539601);
    restoreToL132036539601 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_Container_5_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3437, 301);
