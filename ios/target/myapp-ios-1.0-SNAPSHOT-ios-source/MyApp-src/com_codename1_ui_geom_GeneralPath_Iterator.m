...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_Iterator_typeIndex(__cn1ThisObject)<get_field_com_codename1_ui_geom_GeneralPath_typeSize(get_field_com_codename1_ui_geom_GeneralPath_Iterator_p(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L71599579;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_Iterator_currentSegment___double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL163560653501;
    int tryBlockOffsetL163560653501;
    DEFINE_CATCH_BLOCK(catch_L163560653501, label_L705801739, restoreToL163560653501);
    int restoreToL70580173902;
    int tryBlockOffsetL70580173902;
    DEFINE_CATCH_BLOCK(catch_L70580173902, label_L705801739, restoreToL70580173902);
...
label_L1635606535:
 tryBlockOffsetL163560653501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L163560653501);
    restoreToL163560653501 = threadStateData->threadObjectStackOffset;
...
label_L705801739:
 tryBlockOffsetL70580173902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L70580173902);
    restoreToL70580173902 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_Iterator_currentSegment___float_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1106755629;
...
label_L1106755629:
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_Iterator_transform(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1714507758;
