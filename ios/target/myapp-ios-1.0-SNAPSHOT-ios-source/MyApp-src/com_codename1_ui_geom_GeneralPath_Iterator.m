...
JAVA_INT com_codename1_ui_geom_GeneralPath_Iterator_currentSegment___double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL8091490201;
    int tryBlockOffsetL8091490201;
    DEFINE_CATCH_BLOCK(catch_L8091490201, label_L179437727, restoreToL8091490201);
...
label_L80914902:
 tryBlockOffsetL8091490201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L8091490201);
    restoreToL8091490201 = threadStateData->threadObjectStackOffset;
