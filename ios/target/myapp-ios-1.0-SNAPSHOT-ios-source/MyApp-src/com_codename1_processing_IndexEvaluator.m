...
JAVA_VOID com_codename1_processing_IndexEvaluator___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7642, 205);
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator__getByPositionLess___java_util_List_int_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 7642, 7643);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(90);
    if (ilocals_2_<=virtual_java_util_List_size___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPLE CustomJump */ goto label_L1159219582;
    __CN1_DEBUG_INFO(91);
...
label_L1159219582:
    __CN1_DEBUG_INFO(93);
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L1608524967;
    __CN1_DEBUG_INFO(94);
...
label_L571518740:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L2081126702;
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator__getByPositionGreater___java_util_List_int_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* rvalue */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 7642, 7644);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(123);
    if (ilocals_2_<virtual_java_util_List_size___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L325732352;
    __CN1_DEBUG_INFO(124);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L325732352:
    __CN1_DEBUG_INFO(126);
    if (ilocals_2_>0) /* IFGT CustomJump */ goto label_L349629923;
...
label_L1980588880:
    if (ilocals_4_>=virtual_java_util_List_size___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1427580388;
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator__getByLast___java_util_List_java_lang_String_R_com_codename1_processing_StructuredContent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 7642, 7645);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(160);
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5577));
    __CN1_DEBUG_INFO(161);
    if (ilocals_3_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1555478555;
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7646));
...
label_L1555478555:
    ...
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L706067443;
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator_evaluateSingle___java_util_List_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7642, 7626);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(176);
    if (/* CustomInvoke */virtual_com_codename1_processing_IndexEvaluator_isNumeric___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1187091280;
    ...
    if (ilocals_3_<0) /* IFLT CustomJump */ goto label_L1531670331;
    if (ilocals_3_<virtual_java_util_List_size___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L852779561;
...
label_L1187091280:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, get_static_com_codename1_processing_IndexEvaluator_FUNC_LAST(threadStateData))==0) /* IFEQ CustomJump */ goto label_L890867107;
    __CN1_DEBUG_INFO(183);
    if (virtual_java_util_List_size___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L2131280707;
...
label_L890867107:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, get_static_com_codename1_processing_IndexEvaluator_FUNC_LAST(threadStateData))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L2142914862;
...
label_L2142914862:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, get_static_com_codename1_processing_IndexEvaluator_FUNC_POSITION(threadStateData))==0) /* IFEQ CustomJump */ goto label_L1861138906;
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator_evaluateLeftLessRight___java_util_List_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7642, 7627);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_static_com_codename1_processing_IndexEvaluator_FUNC_POSITION(threadStateData), locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L392385841;
...
JAVA_OBJECT com_codename1_processing_IndexEvaluator_evaluateLeftGreaterRight___java_util_List_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7642, 7628);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_static_com_codename1_processing_IndexEvaluator_FUNC_POSITION(threadStateData), locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L776506949;
...
JAVA_VOID com_codename1_processing_IndexEvaluator___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 7642, 275);
    __CN1_DEBUG_INFO(63);
    set_static_com_codename1_processing_IndexEvaluator_FUNC_LAST(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(7647));
    __CN1_DEBUG_INFO(64);
    set_static_com_codename1_processing_IndexEvaluator_FUNC_POSITION(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(7648));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
