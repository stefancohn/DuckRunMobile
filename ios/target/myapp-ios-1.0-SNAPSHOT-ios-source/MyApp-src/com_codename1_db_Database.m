...
JAVA_VOID com_codename1_db_Database_validateDatabaseNameArgument___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(61);
    if (com_codename1_db_Database_isCustomPathSupported___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1309300230;
    __CN1_DEBUG_INFO(62);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L907681414;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1649))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1309300230;
...
JAVA_VOID com_codename1_db_Database_execute___java_lang_String_java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L43379081;
...
label_L765980478:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1290059927;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L720112035;
...
label_L720112035:
    ...
    if (CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_5_)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L127427798;
