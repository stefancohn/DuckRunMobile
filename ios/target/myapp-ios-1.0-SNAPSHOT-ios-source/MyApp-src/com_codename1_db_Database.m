...
JAVA_VOID com_codename1_db_Database___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8867, 205);
...
JAVA_BOOLEAN com_codename1_db_Database_isCustomPathSupported___R_boolean(CODENAME_ONE_THREAD_STATE) {
    ...
    DEFINE_METHOD_STACK(1, 0, 0, 8867, 8868);
    __CN1_DEBUG_INFO(57);
...
JAVA_VOID com_codename1_db_Database_validateDatabaseNameArgument___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_db_Database(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 8867, 8869);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(61);
    if (com_codename1_db_Database_isCustomPathSupported___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1859619422;
    __CN1_DEBUG_INFO(62);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1309300230;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1649))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1859619422;

label_L1309300230:
    __CN1_DEBUG_INFO(63);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8870));     SP -= 1;
...
JAVA_BOOLEAN com_codename1_db_Database_exists___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_db_Database(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 8867, 696);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(92);
...
JAVA_VOID com_codename1_db_Database_delete___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_db_Database(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 8867, 1006);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_db_Database_getDatabasePath___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_db_Database(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 8867, 738);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_db_Database_execute___java_lang_String_java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 8867, 532);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(193);
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L907681414;
...
label_L1194164020:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1346508543;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1290059927;
    __CN1_DEBUG_INFO(201);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8874));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1290059927:
    __CN1_DEBUG_INFO(203);
    if (CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_5_)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L720112035;
    __CN1_DEBUG_INFO(204);
    CN1_SET_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_5_, JAVA_NULL /* ACONST_NULL */);
    goto label_L127427798;
