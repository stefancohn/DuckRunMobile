...
JAVA_VOID com_codename1_ui_spinner_Picker_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_2_val_f(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L524876402;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L900973046;
...
label_L900973046:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1900___com_codename1_ui_spinner_Picker_R_byte_1ARRAY(threadStateData, get_field_com_codename1_ui_spinner_Picker_2_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1230875047;
