...
JAVA_VOID com_codename1_ui_spinner_Picker_2___INIT_____com_codename1_ui_spinner_Picker_com_codename1_ui_Form_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 10176, 205);
...
JAVA_VOID com_codename1_ui_spinner_Picker_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 10176, 207);
    ...
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_2_val_f(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L900973046;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1230875047;
...
label_L1230875047:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1900___com_codename1_ui_spinner_Picker_R_byte_1ARRAY(threadStateData, get_field_com_codename1_ui_spinner_Picker_2_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L737076200;
