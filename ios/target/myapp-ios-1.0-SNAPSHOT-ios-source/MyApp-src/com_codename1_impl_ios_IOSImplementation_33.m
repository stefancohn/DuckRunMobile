...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_33_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_impl_ios_IOSImplementation_access$6400___R_com_codename1_background_BackgroundFetch(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1612496268;
