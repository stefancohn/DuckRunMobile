...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderImage___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String_double_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1759500919;
    ...
    goto label_L1355676410;

label_L1759500919:
    __CN1_DEBUG_INFO(1194);
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L781527109;
...
label_L781527109:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L2032479363;
...
label_L2032479363:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1874812338;
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderImage___INIT_____com_codename1_ui_plaf_CSSBorder_com_codename1_ui_Image_double_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1352294549;
...
label_L1352294549:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L123458189;
...
label_L123458189:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L312233241;
...
label_L312233241:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L293669143;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderImage_image___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL47151359cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL47151359cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L47151359cn1_class_id_java_io_IOException1, label_L321358401, restoreToL47151359cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(1233);
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_image(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1244785938, 0);
...
label_L47151359:
 tryBlockOffsetL47151359cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L47151359cn1_class_id_java_io_IOException1);
    restoreToL47151359cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderImage_internal___R_com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_internal(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L984978888;
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1256);
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L593881656;
