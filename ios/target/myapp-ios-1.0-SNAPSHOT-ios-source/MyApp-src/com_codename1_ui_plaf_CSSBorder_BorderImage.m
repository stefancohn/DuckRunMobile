...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderImage___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String_double_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(12, 4, 0, 5767, 205);
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L123458189;
    ...
    goto label_L312233241;

label_L123458189:
    __CN1_DEBUG_INFO(1194);
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L293669143;
...
label_L293669143:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L321358401;
...
label_L321358401:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1244785938;
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderImage___INIT_____com_codename1_ui_plaf_CSSBorder_com_codename1_ui_Image_double_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L984978888;
    __CN1_DEBUG_INFO(1212);
    /* CustomInvoke */java_lang_System_arraycopy___java_lang_Object_int_java_lang_Object_int_int(threadStateData, locals[3].data.o, 0 /* ICONST_0 */, get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_slices(__cn1ThisObject), 0 /* ICONST_0 */, 4/* ICONST_4 */); 
    goto label_L593881656;

label_L984978888:
    __CN1_DEBUG_INFO(1213);
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L213850519;
...
label_L213850519:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1227041903;
...
label_L1227041903:
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1605299030;
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderImage_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(7, 4, 0, 5767, 2370);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderImage_image___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 5767, 5769);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1334011314cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1334011314cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1334011314cn1_class_id_java_io_IOException1, label_L1402400433, restoreToL1334011314cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(1233);
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_image(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L663824117, 0);
...
label_L1334011314:
 tryBlockOffsetL1334011314cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1334011314cn1_class_id_java_io_IOException1);
    restoreToL1334011314cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderImage_internal___R_com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(10, 1, 0, 5767, 5773);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1248);
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_internal(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2004952636;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderImage_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5767, 5630);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1256);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1608357825;
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1608357825;
