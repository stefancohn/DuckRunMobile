...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireDataChangeEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    int restoreToL182962258401;
    int tryBlockOffsetL182962258401;
    DEFINE_CATCH_BLOCK(catch_L182962258401, label_L1631143060, restoreToL182962258401);
...
label_L1829622584:
 tryBlockOffsetL182962258401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L182962258401);
    restoreToL182962258401 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireBindTargetChange___com_codename1_ui_Component_java_lang_String_java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    int restoreToL59865481701;
    int tryBlockOffsetL59865481701;
    DEFINE_CATCH_BLOCK(catch_L59865481701, label_L767794003, restoreToL59865481701);
...
label_L598654817:
 tryBlockOffsetL59865481701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L59865481701);
    restoreToL59865481701 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireStyleChangeEvent___java_lang_String_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL180418647701;
    int tryBlockOffsetL180418647701;
    DEFINE_CATCH_BLOCK(catch_L180418647701, label_L802814772, restoreToL180418647701);
...
label_L1804186477:
 tryBlockOffsetL180418647701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L180418647701);
    restoreToL180418647701 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireActionEvent___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL118490890401;
    int tryBlockOffsetL118490890401;
    DEFINE_CATCH_BLOCK(catch_L118490890401, label_L300526628, restoreToL118490890401);
...
label_L1184908904:
 tryBlockOffsetL118490890401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L118490890401);
    restoreToL118490890401 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireSelectionEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    int restoreToL104375231801;
    int tryBlockOffsetL104375231801;
    DEFINE_CATCH_BLOCK(catch_L104375231801, label_L1871838170, restoreToL104375231801);
...
label_L1043752318:
 tryBlockOffsetL104375231801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L104375231801);
    restoreToL104375231801 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireScrollEvent___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    int restoreToL167547443101;
    int tryBlockOffsetL167547443101;
    DEFINE_CATCH_BLOCK(catch_L167547443101, label_L1745904086, restoreToL167547443101);
...
label_L1675474431:
 tryBlockOffsetL167547443101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L167547443101);
    restoreToL167547443101 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireFocus___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL49960932901;
    int tryBlockOffsetL49960932901;
    DEFINE_CATCH_BLOCK(catch_L49960932901, label_L1662312252, restoreToL49960932901);
...
label_L499609329:
 tryBlockOffsetL49960932901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L49960932901);
    restoreToL49960932901 = threadStateData->threadObjectStackOffset;
