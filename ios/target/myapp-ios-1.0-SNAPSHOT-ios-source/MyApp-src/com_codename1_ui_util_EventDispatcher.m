...
JAVA_VOID com_codename1_ui_util_EventDispatcher_addListener___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L123045427;
    __CN1_DEBUG_INFO(134);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1448580731;
...
label_L1448580731:
    ...
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L123045427;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_removeListener___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1631143060;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireDataChangeEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    int restoreToL68109166401;
    int tryBlockOffsetL68109166401;
    DEFINE_CATCH_BLOCK(catch_L68109166401, label_L1468685544, restoreToL68109166401);
    int restoreToL146868554402;
    int tryBlockOffsetL146868554402;
    DEFINE_CATCH_BLOCK(catch_L146868554402, label_L1468685544, restoreToL146868554402);
    __CN1_DEBUG_INFO(180);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2084912180, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L382441865, 0);
...
label_L382441865:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1040015904, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1040015904, 0);
...
label_L681091664:
 tryBlockOffsetL68109166401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L68109166401);
    restoreToL68109166401 = threadStateData->threadObjectStackOffset;
...
label_L1843674049:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L940905579, 1);
...
label_L1052798573:
END_TRY(1);    JUMP_TO(label_L665448485, 0);

label_L1468685544:
 tryBlockOffsetL146868554402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L146868554402);
    restoreToL146868554402 = threadStateData->threadObjectStackOffset;
...
label_L665448485:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1905486482, 0);
...
label_L1905486482:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L767794003, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireBindTargetChange___com_codename1_ui_Component_java_lang_String_java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    int restoreToL199105040101;
    int tryBlockOffsetL199105040101;
    DEFINE_CATCH_BLOCK(catch_L199105040101, label_L1157856790, restoreToL199105040101);
    int restoreToL115785679002;
    int tryBlockOffsetL115785679002;
    DEFINE_CATCH_BLOCK(catch_L115785679002, label_L1157856790, restoreToL115785679002);
    __CN1_DEBUG_INFO(221);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L791563230, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1646410010, 0);
...
label_L1991050401:
 tryBlockOffsetL199105040101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L199105040101);
    restoreToL199105040101 = threadStateData->threadObjectStackOffset;
...
label_L220661927:
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1401564942, 1);
...
label_L1419987638:
END_TRY(1);    JUMP_TO(label_L1351275110, 0);

label_L1157856790:
 tryBlockOffsetL115785679002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L115785679002);
    restoreToL115785679002 = threadStateData->threadObjectStackOffset;
...
label_L1351275110:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L588503940, 0);
...
label_L588503940:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L347354124, 0);
...
label_L802814772:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L313249054;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireStyleChangeEvent___java_lang_String_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL191761086701;
    int tryBlockOffsetL191761086701;
    DEFINE_CATCH_BLOCK(catch_L191761086701, label_L362140338, restoreToL191761086701);
    int restoreToL36214033802;
    int tryBlockOffsetL36214033802;
    DEFINE_CATCH_BLOCK(catch_L36214033802, label_L362140338, restoreToL36214033802);
    __CN1_DEBUG_INFO(268);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L540315736, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1824225917, 0);
...
label_L1824225917:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L215694469, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L215694469, 0);
...
label_L1917610867:
 tryBlockOffsetL191761086701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L191761086701);
    restoreToL191761086701 = threadStateData->threadObjectStackOffset;
...
label_L869437194:
    if (ilocals_6_>=CN1_ARRAY_LENGTH(locals[4].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L929066990, 1);
...
label_L362140338:
 tryBlockOffsetL36214033802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L36214033802);
    restoreToL36214033802 = threadStateData->threadObjectStackOffset;
...
label_L76379039:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1374115999, 0);
...
label_L1374115999:
    ...
    if (get_static_com_codename1_ui_util_EventDispatcher_fireStyleEventsOnNonEDT(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1707889234, 0);
...
label_L767535474:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1119955774;
...
label_L1101970356:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1190608890;
...
label_L1515793520:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L184410212;
...
label_L300526628:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L623820846;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireActionEvent___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL184662801;
    int tryBlockOffsetL184662801;
    DEFINE_CATCH_BLOCK(catch_L184662801, label_L1962049725, restoreToL184662801);
    int restoreToL196204972502;
    int tryBlockOffsetL196204972502;
    DEFINE_CATCH_BLOCK(catch_L196204972502, label_L1962049725, restoreToL196204972502);
    __CN1_DEBUG_INFO(341);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1734023423, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L875010954, 0);
...
label_L875010954:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1752402342, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1752402342, 0);
...
label_L1846628:
 tryBlockOffsetL184662801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L184662801);
    restoreToL184662801 = threadStateData->threadObjectStackOffset;
...
label_L935818862:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L140778365, 1);
...
label_L876159048:
END_TRY(1);    JUMP_TO(label_L1068781783, 0);

label_L1962049725:
 tryBlockOffsetL196204972502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L196204972502);
    restoreToL196204972502 = threadStateData->threadObjectStackOffset;
...
label_L1068781783:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1266602046, 0);
...
label_L1266602046:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1871838170, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireSelectionEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    int restoreToL127473877201;
    int tryBlockOffsetL127473877201;
    DEFINE_CATCH_BLOCK(catch_L127473877201, label_L1916681239, restoreToL127473877201);
...
label_L1274738772:
 tryBlockOffsetL127473877201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L127473877201);
    restoreToL127473877201 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireScrollEvent___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    int restoreToL200388009801;
    int tryBlockOffsetL200388009801;
    DEFINE_CATCH_BLOCK(catch_L200388009801, label_L1406593369, restoreToL200388009801);
...
label_L1772358460:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L38914319, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L38914319, 0);
...
label_L2003880098:
 tryBlockOffsetL200388009801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L200388009801);
    restoreToL200388009801 = threadStateData->threadObjectStackOffset;
...
label_L768702707:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1713988669, 1);
...
label_L386869379:
END_TRY(1);    JUMP_TO(label_L1684368286, 0);
...
label_L1684368286:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1752223660, 0);
...
label_L1752223660:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1675999402, 0);
...
label_L1662312252:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L747833043;
    __CN1_DEBUG_INFO(458);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1114681666;
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L771359425;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireFocus___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL16768908401;
    int tryBlockOffsetL16768908401;
    DEFINE_CATCH_BLOCK(catch_L16768908401, label_L1468393491, restoreToL16768908401);
    int restoreToL146839349102;
    int tryBlockOffsetL146839349102;
    DEFINE_CATCH_BLOCK(catch_L146839349102, label_L1468393491, restoreToL146839349102);
    __CN1_DEBUG_INFO(470);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L280541440, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1831423452, 0);
...
label_L1831423452:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L671187578, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L671187578, 0);
    ...
    if (virtual_com_codename1_ui_Component_hasFocus___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1354510873, 0);
...
label_L167689084:
 tryBlockOffsetL16768908401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L16768908401);
    restoreToL16768908401 = threadStateData->threadObjectStackOffset;
...
label_L105860882:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L578362229, 1);
    __CN1_DEBUG_INFO(489);
    CN1_SET_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_6_, /* CustomInvoke */virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject), ilocals_6_));
    __CN1_DEBUG_INFO(488);
    BC_IINC(6, 1);
    JUMP_TO(label_L105860882, 1);
...
label_L624247155:
END_TRY(1);    JUMP_TO(label_L936544568, 0);

label_L1468393491:
 tryBlockOffsetL146839349102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L146839349102);
    restoreToL146839349102 = threadStateData->threadObjectStackOffset;
...
label_L936544568:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L2097992252, 0);
...
label_L2097992252:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1796154990, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireFocusSync___com_codename1_ui_events_FocusListener_1ARRAY_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_Component_hasFocus___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1211627902;
...
label_L1655072591:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1395740534;
...
label_L117701189:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1887965475;
...
JAVA_BOOLEAN com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1586519852;
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1586519852;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L266196910;
