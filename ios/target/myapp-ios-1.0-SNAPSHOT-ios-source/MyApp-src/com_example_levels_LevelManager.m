...
JAVA_VOID com_example_levels_LevelManager___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(2, 0, 0, 10287, 863);
    __CN1_DEBUG_INFO(16);
...
JAVA_VOID com_example_levels_LevelManager___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 10287, 205);
    ...
    __CN1_DEBUG_INFO(11);
    BC_ALOAD(0);
    /* CustomInvoke */PUSH_OBJ(com_example_util_LoadSave_getSpriteAtlas___java_lang_String_R_com_codename1_ui_Image(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(10288)));
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, get_static_com_example_levels_LevelManager_widthOfBlocks(threadStateData));
...
JAVA_VOID com_example_levels_LevelManager_importLevelSprite__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 3, 0, 10287, 10290);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(30);
    /* VarOp.assignFrom */ locals[1].data.o = /* CustomInvoke */com_example_util_LoadSave_getSpriteAtlas___java_lang_String_R_com_codename1_ui_Image(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(39));locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(31);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    goto label_L216376974;
...
label_L216376974:
    if (ilocals_2_<CN1_ARRAY_LENGTH(get_field_com_example_levels_LevelManager_levelSprite(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L164714495;
    __CN1_DEBUG_INFO(34);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
JAVA_VOID com_example_levels_LevelManager_importObstacleSequences__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(8, 3, 0, 10287, 10291);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(38);
    /* VarOp.assignFrom */ locals[1].data.o = /* CustomInvoke */com_example_util_LoadSave_getSpriteAtlas___java_lang_String_R_com_codename1_ui_Image(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(41));locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(39);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    goto label_L789982400;

label_L1576277927:
    __CN1_DEBUG_INFO(40);
    CN1_SET_ARRAY_ELEMENT_OBJECT(get_field_com_example_levels_LevelManager_obstacleSprites(__cn1ThisObject), ilocals_2_, /* CustomInvoke */virtual_com_codename1_ui_Image_subImage___int_int_int_int_boolean_R_com_codename1_ui_Image(threadStateData, locals[1].data.o, (ilocals_2_ * 50), 0 /* ICONST_0 */, 50, 30, 0 /* ICONST_0 */));
    __CN1_DEBUG_INFO(39);
    BC_IINC(2, 1);
...
label_L789982400:
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1576277927;
    __CN1_DEBUG_INFO(42);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    goto label_L2080643905;
...
label_L2080643905:
    if (ilocals_2_<CN1_ARRAY_LENGTH(get_field_com_example_levels_LevelManager_obstacleSprites(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L2137642385;
    __CN1_DEBUG_INFO(45);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
JAVA_VOID com_example_levels_LevelManager_transformMainLevel___int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 10287, 10292);
...
label_L481553464:
    ...
    SP++;
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1076966140;
    __CN1_DEBUG_INFO(51);
    BC_IINC(5, 1);
...
label_L1627883152:
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1908781622;
    __CN1_DEBUG_INFO(56);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
JAVA_OBJECT com_example_levels_LevelManager_getCurrentLevel___R_com_example_levels_Level(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10287, 10293);
...
JAVA_VOID com_example_levels_LevelManager_draw___com_codename1_ui_Graphics_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 10287, 5493);
...
label_L975001918:
    ...
    __CN1_DEBUG_INFO(69);
    if (ilocals_5_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1721045976;
    __CN1_DEBUG_INFO(72);
    ...
    SP++;
    PUSH_INT(29);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1721045976;
    __CN1_DEBUG_INFO(78);
...
label_L796553753:
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L975001918;
    __CN1_DEBUG_INFO(66);
    BC_IINC(3, 1);
...
label_L749443480:
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1250582716;
    __CN1_DEBUG_INFO(82);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
