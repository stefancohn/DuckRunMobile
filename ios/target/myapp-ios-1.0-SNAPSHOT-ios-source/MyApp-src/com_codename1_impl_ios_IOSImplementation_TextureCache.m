...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_TextureCache_get___com_codename1_ui_geom_Shape_com_codename1_ui_Stroke_R_com_codename1_impl_ios_IOSImplementation_TextureAlphaMaskProxy(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1537912396;
...
label_L205278236:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[9].data.o)!=0) /* IFNE CustomJump */ goto label_L1533972343;
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L1101451553;
    if (ilocals_17_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1101451553;
...
label_L1101451553:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1329897103;
        case 1: goto label_L1091736037;
        case 2: goto label_L1848163207;
        case 3: goto label_L435175610;
        case 4: goto label_L1923810797;
        default: goto label_L669200356;
    }
...
label_L669200356:
    ...
    goto label_L205278236;

label_L1533972343:
    __CN1_DEBUG_INFO(2402);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L399653041;
