...
JAVA_OBJECT com_codename1_io_Storage_fixFileName___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(69);
    if (get_field_com_codename1_io_Storage_normalizeNames(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1378841761;
    __CN1_DEBUG_INFO(70);
...
JAVA_VOID com_codename1_io_Storage_init___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(89);
    if (com_codename1_io_Util_getImplementation___R_com_codename1_impl_CodenameOneImplementation(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1500512598;
    __CN1_DEBUG_INFO(90);
...
label_L1500512598:
    __CN1_DEBUG_INFO(92);
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L510536150;
    __CN1_DEBUG_INFO(93);
...
JAVA_BOOLEAN com_codename1_io_Storage_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1935274924;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1526336282;
...
JAVA_OBJECT com_codename1_io_Storage_getInstance___R_com_codename1_io_Storage(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L64605090;
...
JAVA_OBJECT com_codename1_io_Storage_createInputStream___java_lang_String_R_java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_io_Storage_exists___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1813410454;
...
JAVA_BOOLEAN com_codename1_io_Storage_writeObject___java_lang_String_java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL724557539cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL724557539cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L724557539cn1_class_id_java_lang_Exception1, label_L1349400619, restoreToL724557539cn1_class_id_java_lang_Exception1);
...
label_L724557539:
 tryBlockOffsetL724557539cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L724557539cn1_class_id_java_lang_Exception1);
    restoreToL724557539cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
label_L1349400619:
    ...
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1514556391, 0);
...
JAVA_OBJECT com_codename1_io_Storage_readObject___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1858462212cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1858462212cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1858462212cn1_class_id_java_lang_Throwable1, label_L386863062, restoreToL1858462212cn1_class_id_java_lang_Throwable1);
    int restoreToL1767672626cn1_class_id_java_lang_Throwable2;
    int tryBlockOffsetL1767672626cn1_class_id_java_lang_Throwable2;
    DEFINE_CATCH_BLOCK(catch_L1767672626cn1_class_id_java_lang_Throwable2, label_L386863062, restoreToL1767672626cn1_class_id_java_lang_Throwable2);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1221741923, 0);
...
locals[3].type=CN1_TYPE_OBJECT;
label_L1858462212:
 tryBlockOffsetL1858462212cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1858462212cn1_class_id_java_lang_Throwable1);
    restoreToL1858462212cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(262);
    if (/* CustomInvoke */virtual_com_codename1_io_Storage_exists___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1767672626, 0);
...
label_L1767672626:
 tryBlockOffsetL1767672626cn1_class_id_java_lang_Throwable2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1767672626cn1_class_id_java_lang_Throwable2);
    restoreToL1767672626cn1_class_id_java_lang_Throwable2 = threadStateData->threadObjectStackOffset;
...
label_L386863062:
    ...
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L28175501, 0);
