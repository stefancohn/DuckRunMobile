...
JAVA_OBJECT com_codename1_ui_FontImage_getMaterialDesignFont___R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_FontImage_materialDesignFont(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1654999368;
    __CN1_DEBUG_INFO(11179);
    if (com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1615389290;
...
JAVA_INT com_codename1_ui_FontImage_rightSize___com_codename1_ui_plaf_Style_float_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1354314579;
...
JAVA_BOOLEAN com_codename1_ui_FontImage_setMaterialIcon___com_codename1_ui_Component_char_float_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_CHAR __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1143499107;
...
JAVA_VOID com_codename1_ui_FontImage_setIcon___com_codename1_ui_IconHolder_com_codename1_ui_Font_char_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_CHAR __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L728985582;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(11278);
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L843702904;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L843702904;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L843702904;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[6].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L900593187;
...
label_L1164934558:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1976788674;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1976788674;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1976788674;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[7].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L150208546;
...
label_L1379066865:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1821370276;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1821370276;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1821370276;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[8].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L33847681;
...
JAVA_OBJECT com_codename1_ui_FontImage_sizeFont___com_codename1_ui_Font_int_int_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1089280002;
...
label_L1089280002:
    ...
    if (ilocals_4_==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L600270822;
...
JAVA_VOID com_codename1_ui_FontImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L267061647;
    PUSH_INT(get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject));
    PUSH_INT(255);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L267061647;
...
label_L267061647:
    ...
    if (get_field_com_codename1_ui_FontImage_backgroundOpacity(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L434249609;
...
label_L434249609:
    ...
    if (ilocals_9_>0) /* IFGT CustomJump */ goto label_L837237183;
...
label_L837237183:
    ...
    PUSH_INT(255);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L688361522;
...
label_L688361522:
    ...
    if (get_field_com_codename1_ui_FontImage_rotated(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2121745388;
...
JAVA_VOID com_codename1_ui_FontImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    if (ilocals_5_!=get_field_com_codename1_ui_FontImage_width(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L2135089262;
    if (ilocals_6_!=get_field_com_codename1_ui_FontImage_height(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L2135089262;
...
label_L2135089262:
    ...
    if (get_field_com_codename1_ui_FontImage_backgroundOpacity(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1792113076;
...
label_L1792113076:
    ...
    if (ilocals_12_>0) /* IFGT CustomJump */ goto label_L788344609;
...
label_L788344609:
    ...
    if (get_field_com_codename1_ui_FontImage_rotated(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1506083063;
...
JAVA_BOOLEAN com_codename1_ui_FontImage_isAnimation___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L399683701;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_FontImage_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L822815599;
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1762260670;
...
JAVA_OBJECT com_codename1_ui_FontImage_rotate180Degrees___boolean_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    BC_ALOAD(2);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1942258276;
    PUSH_INT(get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject));
...
JAVA_OBJECT com_codename1_ui_FontImage_toEncodedImage___R_com_codename1_ui_EncodedImage(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1540277886;
    if (/* CustomInvoke */virtual_com_codename1_ui_util_ImageIO_isFormatSupported___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(105))==0) /* IFEQ CustomJump */ goto label_L1540277886;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1540277886;
...
JAVA_OBJECT com_codename1_ui_FontImage_toImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_Image_isAlphaMutableImageSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L766488161;
