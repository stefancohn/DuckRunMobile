...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_exp___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (ilocals_14_<1082535490) /* IF_IMPLT CustomJump */ goto label_L403583920;
    __CN1_DEBUG_INFO(233);
    if (ilocals_14_<2146435072) /* IF_IMPLT CustomJump */ goto label_L655089792;
    __CN1_DEBUG_INFO(234);
    /* VarOp.assignFrom */ ilocals_15_=((JAVA_INT)(llocals_18_ & 4294967295LL));
    __CN1_DEBUG_INFO(235);
    if (((ilocals_14_ & 1048575) | ilocals_15_)==0) /* IFEQ CustomJump */ goto label_L1966079203;
...
label_L1966079203:
    ...
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L2029215289;
    BC_DLOAD(0);
    goto label_L294215972;
...
label_L655089792:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, 709.782712893384)<=0) /* IFLE CustomJump */ goto label_L1778289781;
    __CN1_DEBUG_INFO(242);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1.0 / 0.0;

label_L1778289781:
    __CN1_DEBUG_INFO(244);
    if (CN1_CMP_EXPR(dlocals_0_, -745.1332191019411)>=0) /* IFGE CustomJump */ goto label_L403583920;
    __CN1_DEBUG_INFO(245);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* DCONST_0 */;

label_L403583920:
    __CN1_DEBUG_INFO(250);
    if (ilocals_14_<=1071001154) /* IF_ICMPLE CustomJump */ goto label_L1664920909;
    __CN1_DEBUG_INFO(251);
    if (ilocals_14_>=1072734898) /* IF_ICMPGE CustomJump */ goto label_L22820229;
...
label_L1535571147:
    ...
    goto label_L1183205098;

label_L1664920909:
    __CN1_DEBUG_INFO(262);
    if (ilocals_14_>=1043333120) /* IF_ICMPGE CustomJump */ goto label_L1183205098;
    __CN1_DEBUG_INFO(263);
    if (CN1_CMP_EXPR((1.0E300 + dlocals_0_), 1 /* DCONST_1 */)<=0) /* IFLE CustomJump */ goto label_L1183205098;
...
label_L1183205098:
    ...
    if (ilocals_12_!=0) /* IFNE CustomJump */ goto label_L1079430578;
...
label_L1079430578:
    ...
    SP++;
    PUSH_INT(-1021);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L541468704;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_pow___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    if ((ilocals_42_ | ilocals_44_)!=0) /* IFNE CustomJump */ goto label_L1641169735;
    __CN1_DEBUG_INFO(506);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* DCONST_1 */;

label_L1641169735:
    __CN1_DEBUG_INFO(510);
    if (ilocals_41_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L880771113;
    if (ilocals_41_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1064871405;
    if (ilocals_43_!=0) /* IFNE CustomJump */ goto label_L880771113;

label_L1064871405:
    if (ilocals_42_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L880771113;
    if (ilocals_42_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1661882384;
    if (ilocals_44_==0) /* IFEQ CustomJump */ goto label_L1661882384;
...
label_L1661882384:
    ...
    if (ilocals_39_>=0) /* IFGE CustomJump */ goto label_L280362829;
    __CN1_DEBUG_INFO(522);
    if (ilocals_42_<1128267776) /* IF_IMPLT CustomJump */ goto label_L1485003706;
...
label_L1485003706:
    ...
    if (ilocals_42_<1072693248) /* IF_IMPLT CustomJump */ goto label_L280362829;
    ...
    SP++;
    PUSH_INT(20);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L573495946;
    __CN1_DEBUG_INFO(527);
    /* VarOp.assignFrom */ ilocals_35_=BC_ISHR_EXPR(ilocals_44_, (52 - ilocals_36_));
    __CN1_DEBUG_INFO(528);
    if (BC_ISHL_EXPR(ilocals_35_, (52 - ilocals_36_))!=ilocals_44_) /* IF_ICMPNE CustomJump */ goto label_L280362829;
...
label_L573495946:
    ...
    if (ilocals_44_!=0) /* IFNE CustomJump */ goto label_L280362829;
    __CN1_DEBUG_INFO(532);
    /* VarOp.assignFrom */ ilocals_35_=BC_ISHR_EXPR(ilocals_42_, (20 - ilocals_36_));
    __CN1_DEBUG_INFO(533);
    if (BC_ISHL_EXPR(ilocals_35_, (20 - ilocals_36_))!=ilocals_42_) /* IF_ICMPNE CustomJump */ goto label_L280362829;
    __CN1_DEBUG_INFO(534);
    /* VarOp.assignFrom */ ilocals_37_=(2 /* ICONST_2 */ - (ilocals_35_ & 1 /* ICONST_1 */));

label_L280362829:
    __CN1_DEBUG_INFO(541);
    if (ilocals_44_!=0) /* IFNE CustomJump */ goto label_L858882063;
    __CN1_DEBUG_INFO(542);
    if (ilocals_42_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L205606579;
    __CN1_DEBUG_INFO(543);
    if (((ilocals_41_ - 1072693248) | ilocals_43_)!=0) /* IFNE CustomJump */ goto label_L1323141642;
...
label_L1323141642:
    ...
    if (ilocals_41_<1072693248) /* IF_IMPLT CustomJump */ goto label_L443806673;
    __CN1_DEBUG_INFO(546);
    if (ilocals_40_<0) /* IFLT CustomJump */ goto label_L628963688;
    BC_DLOAD(2);
    goto label_L600825762;
...
label_L205606579:
    ...
    if (ilocals_42_!=1072693248) /* IF_ICMPNE CustomJump */ goto label_L1223873821;
    __CN1_DEBUG_INFO(552);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L354230638;
...
label_L1223873821:
    ...
    if (ilocals_40_!=1073741824) /* IF_ICMPNE CustomJump */ goto label_L270071554;
...
label_L270071554:
    ...
    if (ilocals_40_!=1071644672) /* IF_ICMPNE CustomJump */ goto label_L858882063;
    __CN1_DEBUG_INFO(562);
    if (ilocals_39_<0) /* IFLT CustomJump */ goto label_L858882063;
...
label_L858882063:
    ...
    if (ilocals_43_!=0) /* IFNE CustomJump */ goto label_L1409342334;
    __CN1_DEBUG_INFO(571);
    if (ilocals_41_==2146435072) /* IF_ICMPEQ CustomJump */ goto label_L176469726;
    if (ilocals_41_==0) /* IFEQ CustomJump */ goto label_L176469726;
    if (ilocals_41_!=1072693248) /* IF_ICMPNE CustomJump */ goto label_L1409342334;
...
label_L1995366577:
    ...
    if (ilocals_39_>=0) /* IFGE CustomJump */ goto label_L555334025;
    __CN1_DEBUG_INFO(577);
    if (((ilocals_41_ - 1072693248) | ilocals_37_)!=0) /* IFNE CustomJump */ goto label_L1938841087;
...
label_L1938841087:
    ...
    if (ilocals_37_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L555334025;
...
label_L1409342334:
    ...
    if ((ilocals_38_ | ilocals_37_)!=0) /* IFNE CustomJump */ goto label_L1544369941;
...
label_L1544369941:
    ...
    if ((ilocals_38_ | (ilocals_37_ - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ goto label_L1567080269;
    __CN1_DEBUG_INFO(596);
    /* VarOp.assignFrom */     dlocals_24_ = -1.0;

label_L1567080269:
    __CN1_DEBUG_INFO(600);
    if (ilocals_42_<=1105199104) /* IF_ICMPLE CustomJump */ goto label_L836665497;
    __CN1_DEBUG_INFO(601);
    if (ilocals_42_<=1139802112) /* IF_ICMPLE CustomJump */ goto label_L1087393016;
    __CN1_DEBUG_INFO(602);
    if (ilocals_41_>1072693247) /* IF_ICMPGT CustomJump */ goto label_L1968209512;
    __CN1_DEBUG_INFO(603);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L355281496;
...
label_L1968209512:
    ...
    if (ilocals_41_<1072693248) /* IF_IMPLT CustomJump */ goto label_L1087393016;
    __CN1_DEBUG_INFO(606);
    if (ilocals_40_<=0) /* IFLE CustomJump */ goto label_L306678606;
    PUSH_DOUBLE(1.0 / 0.0); /* LDC */
...
label_L1087393016:
    ...
    if (ilocals_41_>=1072693247) /* IF_ICMPGE CustomJump */ goto label_L412192112;
    __CN1_DEBUG_INFO(611);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L1563899796;
    BC_DLOAD(24);
...
label_L412192112:
    ...
    if (ilocals_41_<=1072693248) /* IF_ICMPLE CustomJump */ goto label_L130052131;
    __CN1_DEBUG_INFO(614);
    if (ilocals_40_<=0) /* IFLE CustomJump */ goto label_L330205094;
    BC_DLOAD(24);
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    goto label_L2000783824;
...
label_L130052131:
    ...
    goto label_L583284045;

label_L836665497:
    __CN1_DEBUG_INFO(628);
    /* VarOp.assignFrom */     ilocals_38_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(630);
    if (ilocals_41_>=1048576) /* IF_ICMPGE CustomJump */ goto label_L645994590;
...
label_L645994590:
    ...
    if (ilocals_35_>235662) /* IF_ICMPGT CustomJump */ goto label_L1106589855;
...
label_L1106589855:
    ...
    if (ilocals_35_>=767610) /* IF_ICMPGE CustomJump */ goto label_L963383848;
...
label_L583284045:
    ...
    if (ilocals_35_<1083179008) /* IF_IMPLT CustomJump */ goto label_L385990323;
    __CN1_DEBUG_INFO(701);
    if (((ilocals_35_ - 1083179008) | ilocals_34_)==0) /* IFEQ CustomJump */ goto label_L2136493324;
...
label_L2136493324:
    ...
    if (CN1_CMP_EXPR((dlocals_14_ + 8.008566259537294E-17), (dlocals_4_ - dlocals_12_))<=0) /* IFLE CustomJump */ goto label_L1280939641;
...
label_L385990323:
    ...
    if ((ilocals_35_ & 2147483647)<1083231232) /* IF_IMPLT CustomJump */ goto label_L1280939641;
    __CN1_DEBUG_INFO(709);
    if (((ilocals_35_ - -1064252416) | ilocals_34_)==0) /* IFEQ CustomJump */ goto label_L368914568;
...
label_L368914568:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, (dlocals_4_ - dlocals_12_))>0) /* IFGT CustomJump */ goto label_L1280939641;
...
label_L1280939641:
    ...
    if (ilocals_34_<=1071644672) /* IF_ICMPLE CustomJump */ goto label_L252960930;
    ...
    if (ilocals_35_>=0) /* IFGE CustomJump */ goto label_L849280097;
...
label_L252960930:
    ...
    if (BC_ISHR_EXPR(ilocals_35_, 20)>0) /* IFGT CustomJump */ goto label_L854875669;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_acos___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (ilocals_19_<1072693248) /* IF_IMPLT CustomJump */ goto label_L1593290287;
    ...
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    if(POP_INT() != 0) /* IFNE */ goto label_L466562148;
    __CN1_DEBUG_INFO(788);
    if (ilocals_18_<=0) /* IFLE CustomJump */ goto label_L190569982;
...
label_L1593290287:
    ...
    if (ilocals_19_>=1071644672) /* IF_ICMPGE CustomJump */ goto label_L1340340719;
    __CN1_DEBUG_INFO(797);
    if (ilocals_19_>1012924416) /* IF_ICMPGT CustomJump */ goto label_L747024618;
...
label_L1340340719:
    ...
    if (ilocals_18_>=0) /* IFGE CustomJump */ goto label_L1313346834;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_atan___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (ilocals_10_<1141899264) /* IF_IMPLT CustomJump */ goto label_L343397606;
    __CN1_DEBUG_INFO(955);
    if (ilocals_10_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L817463247;
    if (ilocals_10_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L192487022;
    BC_DLOAD(0);
    ...
    SP--; SP[-1].data.l = SP[-1].data.l & (*SP).data.l; /* LAND */
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
    if(POP_INT() == 0) /* IFEQ */ goto label_L192487022;
...
label_L192487022:
    ...
    if (ilocals_11_<=0) /* IFLE CustomJump */ goto label_L1480280820;
...
label_L343397606:
    ...
    if (ilocals_10_>=1071382528) /* IF_ICMPGE CustomJump */ goto label_L1925281265;
    __CN1_DEBUG_INFO(966);
    if (ilocals_10_>=1042284544) /* IF_ICMPGE CustomJump */ goto label_L167590753;
    __CN1_DEBUG_INFO(967);
    if (CN1_CMP_EXPR((1.0E300 + dlocals_0_), 1 /* DCONST_1 */)<=0) /* IFLE CustomJump */ goto label_L167590753;
...
label_L1925281265:
    ...
    if (ilocals_10_>=1072889856) /* IF_ICMPGE CustomJump */ goto label_L1222267142;
    __CN1_DEBUG_INFO(975);
    if (ilocals_10_>=1072037888) /* IF_ICMPGE CustomJump */ goto label_L835574545;
...
label_L1222267142:
    ...
    if (ilocals_10_>=1073971200) /* IF_ICMPGE CustomJump */ goto label_L1359730810;
...
label_L1244978782:
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L1025587755;
...
label_L1025587755:
    ...
    if (ilocals_11_>=0) /* IFGE CustomJump */ goto label_L661200616;
    BC_DLOAD(8);
    SP[-1].data.d *= -1; /* DNEG */
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_atan2___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    if ((ilocals_10_ | BC_ISHR_EXPR((ilocals_12_ | (-(ilocals_12_))), 31))>2146435072) /* IF_ICMPGT CustomJump */ goto label_L2003075873;
    if ((ilocals_11_ | BC_ISHR_EXPR((ilocals_13_ | (-(ilocals_13_))), 31))<=2146435072) /* IF_ICMPLE CustomJump */ goto label_L1126178692;
...
label_L1126178692:
    ...
    if (((ilocals_8_ - 1072693248) | ilocals_12_)!=0) /* IFNE CustomJump */ goto label_L743556950;
...
label_L743556950:
    ...
    if ((ilocals_11_ | ilocals_13_)!=0) /* IFNE CustomJump */ goto label_L1324513263;
    ...
    switch((*SP).data.i) {
        ...
        case 1: goto label_L500992155;
        case 2: goto label_L1589864603;
        case 3: goto label_L2081058658;
...
label_L1324513263:
    ...
    if ((ilocals_10_ | ilocals_12_)!=0) /* IFNE CustomJump */ goto label_L563749379;
    __CN1_DEBUG_INFO(1071);
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L1492909819;
...
label_L563749379:
    ...
    if (ilocals_10_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L854056805;
    __CN1_DEBUG_INFO(1076);
    if (ilocals_11_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1109227776;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1167477662;
        case 1: goto label_L376067673;
        case 2: goto label_L452640518;
        case 3: goto label_L856031264;
        default: goto label_L1144743781;
    }
...
label_L1109227776:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L10955045;
        case 1: goto label_L1340777656;
        case 2: goto label_L1282320997;
        case 3: goto label_L1408367810;
        default: goto label_L854056805;
    }
...
label_L854056805:
    ...
    if (ilocals_11_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1780881816;
    __CN1_DEBUG_INFO(1102);
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L1895022336;
    PUSH_DOUBLE(-1.5707963267948966); /* LDC */
    goto label_L1232539385;
...
label_L1780881816:
    ...
    SP++;
    PUSH_INT(60);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L364702969;
    __CN1_DEBUG_INFO(1108);
    /* VarOp.assignFrom */     dlocals_4_ = 1.5707963267948966;
    goto label_L1326243087;

label_L364702969:
    __CN1_DEBUG_INFO(1109);
    if (ilocals_8_>=0) /* IFGE CustomJump */ goto label_L585785425;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(-60);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L585785425;
...
label_L1326243087:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1402712627;
        case 1: goto label_L565335965;
        case 2: goto label_L142545409;
        default: goto label_L2036732855;
    }
...
JAVA_DOUBLE com_codename1_util_MathUtil_scalb___double_int_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L2002922626;
    __CN1_DEBUG_INFO(1138);
    if ((ilocals_5_ | (ilocals_4_ & 2147483647))!=0) /* IFNE CustomJump */ goto label_L1155498828;
...
label_L1155498828:
    ...
    if (ilocals_2_>=-50000) /* IF_ICMPGE CustomJump */ goto label_L2002922626;
...
label_L2002922626:
    ...
    SP++;
    PUSH_INT(2047);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L885030604;
...
label_L885030604:
    ...
    SP++;
    PUSH_INT(2046);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2113026120;
...
label_L2113026120:
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L454167880;
...
label_L454167880:
    ...
    SP++;
    PUSH_INT(-54);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L594491525;
    __CN1_DEBUG_INFO(1161);
    if (ilocals_2_<=50000) /* IF_ICMPLE CustomJump */ goto label_L351147066;
