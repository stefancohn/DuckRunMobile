...
extern void __INIT_VTABLE_java_util_Vector_1(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_Vector_1(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_Vector_1(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_Vector_1(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_util_Vector_1(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT java_util_Vector_1_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_Vector_1_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_Vector_1_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_OBJECT java_util_Vector_1_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
struct obj__java_util_Vector_1 {
    ...
    void* __ownerThread;
    int __heapPosition;
    JAVA_INT java_util_Vector_1_pos;
    JAVA_OBJECT java_util_Vector_1_this_0;
};



#endif //__JAVA_UTIL_VECTOR_1__
