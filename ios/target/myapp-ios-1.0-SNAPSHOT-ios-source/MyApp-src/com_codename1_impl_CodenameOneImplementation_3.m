...
JAVA_VOID com_codename1_impl_CodenameOneImplementation_3_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL962085191cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL962085191cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L962085191cn1_class_id_java_lang_Throwable1, label_L1370224403, restoreToL962085191cn1_class_id_java_lang_Throwable1);

label_L962085191:
 tryBlockOffsetL962085191cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L962085191cn1_class_id_java_lang_Throwable1);
    restoreToL962085191cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
