...
JAVA_VOID com_codename1_impl_ios_IOSVirtualKeyboard_showKeyboard___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(54);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L489047267;
    __CN1_DEBUG_INFO(55);
    if (virtual_com_codename1_impl_ios_IOSVirtualKeyboard_isVirtualKeyboardShowing___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1335914322;
    __CN1_DEBUG_INFO(56);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L1335914322:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1613514326;
    __CN1_DEBUG_INFO(60);
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1613514326;
    if (virtual_com_codename1_ui_Component_isEditable___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1613514326;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1613514326;
    if (virtual_com_codename1_ui_Component_isVisible___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1613514326;
    if (virtual_com_codename1_ui_Component_isEditing___R_boolean(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L1613514326;
    __CN1_DEBUG_INFO(62);
...
label_L489047267:
    __CN1_DEBUG_INFO(66);
    if (virtual_com_codename1_impl_ios_IOSVirtualKeyboard_isVirtualKeyboardShowing___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1884422865;
    __CN1_DEBUG_INFO(67);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
