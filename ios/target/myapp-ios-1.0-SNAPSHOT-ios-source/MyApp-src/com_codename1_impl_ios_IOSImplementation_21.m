...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_21_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1495792782cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1495792782cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1495792782cn1_class_id_java_lang_InterruptedException1, label_L2017380745, restoreToL1495792782cn1_class_id_java_lang_InterruptedException1);
    int restoreToL149579278202;
    int tryBlockOffsetL149579278202;
    DEFINE_CATCH_BLOCK(catch_L149579278202, label_L501036152, restoreToL149579278202);
...
label_L1495792782:
 tryBlockOffsetL149579278202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L149579278202);
    restoreToL149579278202 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1495792782cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1495792782cn1_class_id_java_lang_InterruptedException1);
    restoreToL1495792782cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
