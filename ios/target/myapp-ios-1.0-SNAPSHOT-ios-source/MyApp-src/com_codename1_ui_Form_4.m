...
JAVA_BOOLEAN com_codename1_ui_Form_4_filter___com_codename1_ui_Component_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Component_getTabIndex___R_int(threadStateData, locals[1].data.o)<0) /* IFLT CustomJump */ goto label_L386478079;
    if (virtual_com_codename1_ui_Component_isVisible___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L386478079;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L386478079;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L386478079;
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_isHidden___boolean_R_boolean(threadStateData, locals[1].data.o, 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L386478079;
    PUSH_INT(1); /* ICONST_1 */
