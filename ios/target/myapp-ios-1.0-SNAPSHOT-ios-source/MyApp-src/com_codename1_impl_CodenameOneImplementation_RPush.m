...
JAVA_VOID com_codename1_impl_CodenameOneImplementation_RPush_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(llocals_1_, -1LL)<=0) /* IFLE CustomJump */ goto label_L687501326;
    if (com_codename1_impl_CodenameOneImplementation_access$100___R_com_codename1_push_PushCallback(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L687501326;
