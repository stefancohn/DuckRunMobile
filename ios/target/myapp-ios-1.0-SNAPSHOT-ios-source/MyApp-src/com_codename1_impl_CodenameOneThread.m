...
JAVA_BOOLEAN com_codename1_impl_CodenameOneThread_hasStackFrame___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_CodenameOneThread_stackPointer(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L948960194;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L173060252;
...
JAVA_OBJECT com_codename1_impl_CodenameOneThread_getStack___java_lang_Throwable_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1426317832cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1426317832cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1426317832cn1_class_id_java_io_IOException1, label_L567656864, restoreToL1426317832cn1_class_id_java_io_IOException1);
    int restoreToL519019247cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL519019247cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L519019247cn1_class_id_java_io_IOException2, label_L567656864, restoreToL519019247cn1_class_id_java_io_IOException2);

label_L1426317832:
 tryBlockOffsetL1426317832cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1426317832cn1_class_id_java_io_IOException1);
    restoreToL1426317832cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1306535359, 1);
...
label_L1401295795:
    ...
    if (locals[6].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L519019247, 0);
...
label_L519019247:
 tryBlockOffsetL519019247cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L519019247cn1_class_id_java_io_IOException2);
    restoreToL519019247cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
label_L416049054:
    if (ilocals_10_>=ilocals_8_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L288919635, 1);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[11].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1572442646, 1);
    __CN1_DEBUG_INFO(150);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = locals[11].data.o;
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1052842393, 1);
...
label_L167013780:
    if (ilocals_12_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1052842393, 1);
    __CN1_DEBUG_INFO(153);
    if (CN1_ARRAY_ELEMENT_INT(locals[4].data.o, ilocals_12_)!=(ilocals_10_ + 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1545327692, 1);
...
label_L743219449:
    if (ilocals_10_<0) /* IFLT CustomJump */ JUMP_TO(label_L779598031, 1);
...
JAVA_VOID com_codename1_impl_CodenameOneThread_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL20887754cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL20887754cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L20887754cn1_class_id_java_lang_Throwable1, label_L108982313, restoreToL20887754cn1_class_id_java_lang_Throwable1);

label_L20887754:
 tryBlockOffsetL20887754cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L20887754cn1_class_id_java_lang_Throwable1);
    restoreToL20887754cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_CodenameOneThread_handleException___java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1851255134;
