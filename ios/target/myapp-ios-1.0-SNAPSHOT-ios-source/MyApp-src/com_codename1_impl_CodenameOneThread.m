...
JAVA_OBJECT com_codename1_impl_CodenameOneThread_getStack___java_lang_Throwable_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL496875392cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL496875392cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L496875392cn1_class_id_java_io_IOException1, label_L562561015, restoreToL496875392cn1_class_id_java_io_IOException1);
...
label_L496875392:
 tryBlockOffsetL496875392cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L496875392cn1_class_id_java_io_IOException1);
    restoreToL496875392cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_CodenameOneThread_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1337277302cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1337277302cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1337277302cn1_class_id_java_lang_Throwable1, label_L779598031, restoreToL1337277302cn1_class_id_java_lang_Throwable1);

label_L1337277302:
 tryBlockOffsetL1337277302cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1337277302cn1_class_id_java_lang_Throwable1);
    restoreToL1337277302cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
