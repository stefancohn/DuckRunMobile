...
JAVA_VOID com_codename1_impl_CodenameOneThread___INIT_____java_lang_Runnable_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1952, 205);
...
JAVA_BOOLEAN com_codename1_impl_CodenameOneThread_hasStackFrame___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1952, 1953);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(55);
    if (get_field_com_codename1_impl_CodenameOneThread_stackPointer(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1306535359;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1401295795;
...
JAVA_OBJECT com_codename1_impl_CodenameOneThread_getStack___java_lang_Throwable_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 13, 0, 1952, 283);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1808932535cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1808932535cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1808932535cn1_class_id_java_io_IOException1, label_L1545327692, restoreToL1808932535cn1_class_id_java_io_IOException1);
    int restoreToL779598031cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL779598031cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L779598031cn1_class_id_java_io_IOException2, label_L1545327692, restoreToL779598031cn1_class_id_java_io_IOException2);

label_L1808932535:
 tryBlockOffsetL1808932535cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1808932535cn1_class_id_java_io_IOException1);
    restoreToL1808932535cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L167013780, 1);
...
label_L416049054:
    ...
    PUSH_OBJ(tmpResult); }
    /* LDC: '/methodData.dat'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(1960));
    ...
    if (locals[6].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L779598031, 0);
...
label_L779598031:
 tryBlockOffsetL779598031cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L779598031cn1_class_id_java_io_IOException2);
    restoreToL779598031cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
label_L1457226878:
    if (ilocals_10_>=ilocals_8_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L743219449, 1);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[11].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L108982313, 1);
    __CN1_DEBUG_INFO(150);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = locals[11].data.o;
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L2113243119, 1);
...
label_L659937029:
    if (ilocals_12_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2113243119, 1);
    __CN1_DEBUG_INFO(153);
    if (CN1_ARRAY_ELEMENT_INT(locals[4].data.o, ilocals_12_)!=(ilocals_10_ + 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1851255134, 1);
...
label_L1851255134:
    __CN1_DEBUG_INFO(152);
    BC_IINC(12, 1);
    JUMP_TO(label_L659937029, 1);

label_L2113243119:
    __CN1_DEBUG_INFO(147);
    BC_IINC(10, 1);
    JUMP_TO(label_L1457226878, 1);
...
label_L1443675930:
    if (ilocals_10_<0) /* IFLT CustomJump */ JUMP_TO(label_L121678773, 1);
    __CN1_DEBUG_INFO(160);
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1961)); 
    ...
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(303)); 
    __CN1_DEBUG_INFO(159);
    BC_IINC(10, -1);
    JUMP_TO(label_L1443675930, 1);
...
label_L1545327692:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1962));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_VOID com_codename1_impl_CodenameOneThread_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 1952, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1883375087cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1883375087cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1883375087cn1_class_id_java_lang_Throwable1, label_L1609086753, restoreToL1883375087cn1_class_id_java_lang_Throwable1);

label_L1883375087:
 tryBlockOffsetL1883375087cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1883375087cn1_class_id_java_lang_Throwable1);
    restoreToL1883375087cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_CodenameOneThread_handleException___java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_impl_CodenameOneThread(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 1952, 1963);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(184);
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1468343491;
...
JAVA_VOID com_codename1_impl_CodenameOneThread___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 1952, 275);
    __CN1_DEBUG_INFO(43);
