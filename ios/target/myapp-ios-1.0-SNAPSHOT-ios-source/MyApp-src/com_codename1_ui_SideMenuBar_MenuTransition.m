...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition_initTransition__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(79)) /* IF_ACMPNE CustomJump */ goto label_L1858779250;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1223399478;
    __CN1_DEBUG_INFO(1535);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1817281652;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L297031141;
...
label_L1223399478:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1828871453;
...
label_L1858779250:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(78)) /* IF_ACMPNE CustomJump */ goto label_L1948863514;
    __CN1_DEBUG_INFO(1563);
    BC_ALOAD(0);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L165850513;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1948863514:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2043702205;
    __CN1_DEBUG_INFO(1566);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1202168065;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1538593345;
...
label_L1954133542:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1960554990;
...
label_L2043702205:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1056889967;
...
label_L1579823168:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1170173753;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1170173753;
...
label_L1170173753:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(78)) /* IF_ACMPNE CustomJump */ goto label_L1816326817;
    __CN1_DEBUG_INFO(1605);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L396821493;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1816326817:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1636487850;
    __CN1_DEBUG_INFO(1608);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1636487850;
...
JAVA_BOOLEAN com_codename1_ui_SideMenuBar_MenuTransition_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_motion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L447144896;
    ...
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_MenuTransition_this_0(__cn1ThisObject));
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_MenuTransition_motion(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L892466122;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1214753695;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_getDisplayHeight___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1214753695;
    __CN1_DEBUG_INFO(1635);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1710422448;
...
label_L1214753695:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(79)) /* IF_ACMPNE CustomJump */ goto label_L1609038183;
    __CN1_DEBUG_INFO(1645);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1508130444;
    __CN1_DEBUG_INFO(1646);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L749362556;
...
label_L1609038183:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1187225933;
...
label_L1187225933:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L956061012;
    __CN1_DEBUG_INFO(1672);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1586289269;
    __CN1_DEBUG_INFO(1673);
    /* CustomInvoke */virtual_com_codename1_ui_Component_paintComponent___com_codename1_ui_Graphics_boolean(threadStateData, locals[3].data.o, locals[1].data.o, 1 /* ICONST_1 */); 
    __CN1_DEBUG_INFO(1674);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1057263702;
