...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L236590348;
...
label_L1445947009:
    if (ilocals_17_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L1383947848;
    ...
    if (ilocals_7_==ilocals_10_) /* IF_ICMPEQ CustomJump */ goto label_L1081819622;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L848419266;
...
label_L1081819622:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1828522217;
...
label_L1422562336:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1319406382;
...
label_L848419266:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1925645553;
...
label_L1925645553:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1996087296;
...
label_L1980895595:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L470092156;
...
label_L1383947848:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1869571492;
...
label_L1869571492:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_vAlignByRow(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L160479339;
    __CN1_DEBUG_INFO(216);
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1038753484;
...
label_L67795316:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L274492574;
...
label_L1038753484:
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L160479339;
...
label_L384766304:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1705294294;
    ...
    __CN1_DEBUG_INFO(243);
    BC_IINC(6, 1);
    goto label_L384766304;

label_L1705294294:
    __CN1_DEBUG_INFO(248);
    if (ilocals_5_<=0) /* IFLE CustomJump */ goto label_L1106840336;
    if ((ilocals_4_ - ilocals_3_)<=0) /* IFLE CustomJump */ goto label_L1106840336;
    ...
    if (ilocals_6_<=0) /* IFLE CustomJump */ goto label_L1733902203;
...
label_L1859997666:
    if (ilocals_10_>=(ilocals_4_ - 1 /* ICONST_1 */)) /* IF_ICMPGE CustomJump */ goto label_L661868623;
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L1232675280;
...
label_L661868623:
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L1402047326;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_moveComponents___com_codename1_ui_Container_int_int_int_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6, JAVA_INT __cn1Arg7, JAVA_INT __cn1Arg8) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L460107127;
        case 4: goto label_L533353383;
        default: goto label_L1088348283;
    }

label_L533353383:
    __CN1_DEBUG_INFO(287);
    if (virtual_com_codename1_ui_Container_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L568564610;
    __CN1_DEBUG_INFO(288);
    /* VarOp.assignFrom */ ilocals_2_=((-(ilocals_4_)) / 2 /* ICONST_2 */);
    goto label_L1088348283;
...
label_L460107127:
    ...
    if (virtual_com_codename1_ui_Container_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1603964380;
...
label_L74974017:
    if (ilocals_11_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L310426339;
    ...
    SP++;
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L627727856;
...
label_L627727856:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L409529684;
        case 3: goto label_L320305128;
        case 4: goto label_L72847563;
        case 5: goto label_L1940248684;
        default: goto label_L320305128;
    }

label_L409529684:
    __CN1_DEBUG_INFO(316);
    if (get_field_com_codename1_ui_layouts_FlowLayout_vAlignByRow(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L754485505;
...
JAVA_OBJECT com_codename1_ui_layouts_FlowLayout_getPreferredSize___com_codename1_ui_Container_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1016138445;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1630192523;
...
label_L2032613967:
    if (ilocals_9_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L166919726;
    ...
    if (ilocals_2_<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L1305777754;
    if (ilocals_5_<=(ilocals_2_ - ilocals_8_)) /* IF_ICMPLE CustomJump */ goto label_L1305777754;
    if (ilocals_9_<=0) /* IFLE CustomJump */ goto label_L1305777754;
...
JAVA_BOOLEAN com_codename1_ui_layouts_FlowLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1311152251;
    if (get_field_com_codename1_ui_layouts_FlowLayout_orientation(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_orientation(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1311152251;
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1311152251;
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1311152251;
    PUSH_INT(1); /* ICONST_1 */
