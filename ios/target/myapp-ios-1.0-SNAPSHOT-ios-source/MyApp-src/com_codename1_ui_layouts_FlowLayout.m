...
JAVA_VOID com_codename1_ui_layouts_FlowLayout___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 6044, 205);
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 6044, 205);
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout___INIT_____int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 6044, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout___INIT_____int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 6044, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(9, 23, 0, 6044, 3370);
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1925645553;
...
label_L1705294294:
    if (ilocals_17_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L1996087296;
    ...
    if (ilocals_7_==ilocals_10_) /* IF_ICMPEQ CustomJump */ goto label_L1980895595;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L470092156;
...
label_L1980895595:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1445947009;
...
label_L1869571492:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L160479339;
...
label_L470092156:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1038753484;
...
label_L1038753484:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L274492574;
...
label_L67795316:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L148232830;
...
label_L1996087296:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L384766304;
...
label_L384766304:
    ...
    if (get_field_com_codename1_ui_layouts_FlowLayout_vAlignByRow(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1106840336;
    __CN1_DEBUG_INFO(216);
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1733902203;
...
label_L1232675280:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L661868623;
...
label_L661868623:
    ...
    goto label_L1106840336;

label_L1733902203:
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1106840336;
...
label_L1087439460:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L1106840336;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_fillRow___com_codename1_ui_Container_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_9_ = 0; /* v9 */
    volatile JAVA_INT ilocals_10_ = 0; /* v10 */
    DEFINE_INSTANCE_METHOD_STACK(4, 12, 0, 6044, 6045);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
label_L1402047326:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1859997666;
    ...
    __CN1_DEBUG_INFO(243);
    BC_IINC(6, 1);
    goto label_L1402047326;

label_L1859997666:
    __CN1_DEBUG_INFO(248);
    if (ilocals_5_<=0) /* IFLE CustomJump */ goto label_L1399215965;
    if ((ilocals_4_ - ilocals_3_)<=0) /* IFLE CustomJump */ goto label_L1399215965;
    ...
    if (ilocals_6_<=0) /* IFLE CustomJump */ goto label_L460107127;
...
label_L1603964380:
    if (ilocals_10_>=(ilocals_4_ - 1 /* ICONST_1 */)) /* IF_ICMPGE CustomJump */ goto label_L533353383;
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L1088348283;
...
label_L533353383:
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L310426339;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_moveComponents___com_codename1_ui_Container_int_int_int_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6, JAVA_INT __cn1Arg7, JAVA_INT __cn1Arg8) {
    ...
    volatile JAVA_INT ilocals_14_ = 0; /* v14 */
    volatile JAVA_INT ilocals_15_ = 0; /* v15 */
    DEFINE_INSTANCE_METHOD_STACK(7, 16, 0, 6044, 6046);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L409529684;
        case 4: goto label_L320305128;
        default: goto label_L72847563;
    }

label_L320305128:
    __CN1_DEBUG_INFO(287);
    if (virtual_com_codename1_ui_Container_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1940248684;
...
label_L409529684:
    ...
    if (virtual_com_codename1_ui_Container_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L754485505;
...
label_L1354439711:
    if (ilocals_11_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L74974017;
    ...
    SP++;
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1016138445;
...
label_L1016138445:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1630192523;
        case 3: goto label_L166919726;
        case 4: goto label_L1305777754;
        case 5: goto label_L2032613967;
        default: goto label_L166919726;
    }

label_L1630192523:
    __CN1_DEBUG_INFO(316);
    if (get_field_com_codename1_ui_layouts_FlowLayout_vAlignByRow(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1311152251;
...
JAVA_OBJECT com_codename1_ui_layouts_FlowLayout_getPreferredSize___com_codename1_ui_Container_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2038535743;
...
label_L332464215:
    if (ilocals_9_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L52313140;
    ...
    if (ilocals_2_<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L189629356;
    if (ilocals_5_<=(ilocals_2_ - ilocals_8_)) /* IF_ICMPLE CustomJump */ goto label_L189629356;
    if (ilocals_9_<=0) /* IFLE CustomJump */ goto label_L189629356;
...
JAVA_OBJECT com_codename1_ui_layouts_FlowLayout_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6044, 263);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(385);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return STRING_FROM_CONSTANT_POOL_OFFSET(6047);
}
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_setFillRows___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6044, 6049);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_layouts_FlowLayout_setAlign___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* orientation */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6044, 6021);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_layouts_FlowLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6044, 244);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(468);
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1720994940;
    if (get_field_com_codename1_ui_layouts_FlowLayout_orientation(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_orientation(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1720994940;
    if (get_field_com_codename1_ui_layouts_FlowLayout_valign(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_valign(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1720994940;
    if (get_field_com_codename1_ui_layouts_FlowLayout_fillRows(locals[1].data.o)!=get_field_com_codename1_ui_layouts_FlowLayout_fillRows(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1720994940;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L345584390;
...
JAVA_OBJECT com_codename1_ui_layouts_FlowLayout_encloseIn___com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_FlowLayout(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 6044, 3321);
...
JAVA_OBJECT com_codename1_ui_layouts_FlowLayout_encloseRightMiddle___com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_FlowLayout(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 6044, 6060);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
