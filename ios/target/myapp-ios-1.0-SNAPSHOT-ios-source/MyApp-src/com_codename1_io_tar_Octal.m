...
JAVA_VOID com_codename1_io_tar_Octal___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8974, 205);
...
JAVA_LONG com_codename1_io_tar_Octal_parseOctal___byte_1ARRAY_int_int_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_io_tar_Octal(threadStateData);
    DEFINE_METHOD_STACK(4, 8, 0, 8974, 8975);
...
label_L1244601059:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1373719734;
    __CN1_DEBUG_INFO(49);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[0].data.o, ilocals_7_)!=0) /* IFNE CustomJump */ goto label_L1901405112;
    __CN1_DEBUG_INFO(50);
    goto label_L1373719734;
...
label_L1901405112:
    ...
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1327733366;
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_7_; 
    SP++;
    ...
    PUSH_INT(48);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L448990180;

label_L1327733366:
    __CN1_DEBUG_INFO(53);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1100771574;
    __CN1_DEBUG_INFO(54);
