...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_ensureConnection__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_CATCH_BLOCK(catch_L1129057570cn1_class_id_java_lang_InterruptedException1, label_L999221400, restoreToL1129057570cn1_class_id_java_lang_InterruptedException1);
    int restoreToL900425684cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL900425684cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L900425684cn1_class_id_java_io_IOException2, label_L8197402, restoreToL900425684cn1_class_id_java_io_IOException2);
    int restoreToL2123448049cn1_class_id_java_lang_InterruptedException3;
    int tryBlockOffsetL2123448049cn1_class_id_java_lang_InterruptedException3;
    DEFINE_CATCH_BLOCK(catch_L2123448049cn1_class_id_java_lang_InterruptedException3, label_L692838068, restoreToL2123448049cn1_class_id_java_lang_InterruptedException3);
    int restoreToL54311916604;
    int tryBlockOffsetL54311916604;
    DEFINE_CATCH_BLOCK(catch_L54311916604, label_L1392570698, restoreToL54311916604);
...
label_L543119166:
 tryBlockOffsetL54311916604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L54311916604);
    restoreToL54311916604 = threadStateData->threadObjectStackOffset;
...
label_L900425684:
 tryBlockOffsetL900425684cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L900425684cn1_class_id_java_io_IOException2);
    restoreToL900425684cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
label_L2123448049:
 tryBlockOffsetL2123448049cn1_class_id_java_lang_InterruptedException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L2123448049cn1_class_id_java_lang_InterruptedException3);
    restoreToL2123448049cn1_class_id_java_lang_InterruptedException3 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection___INIT_____long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    int restoreToL80689010001;
    int tryBlockOffsetL80689010001;
    DEFINE_CATCH_BLOCK(catch_L80689010001, label_L1164394344, restoreToL80689010001);
...
label_L806890100:
 tryBlockOffsetL80689010001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L80689010001);
    restoreToL80689010001 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_streamComplete__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL40135708201;
    int tryBlockOffsetL40135708201;
    DEFINE_CATCH_BLOCK(catch_L40135708201, label_L1776486598, restoreToL40135708201);
...
label_L401357082:
 tryBlockOffsetL40135708201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L40135708201);
    restoreToL40135708201 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NetworkConnection_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL457107443cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL457107443cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L457107443cn1_class_id_java_lang_InterruptedException1, label_L1719547057, restoreToL457107443cn1_class_id_java_lang_InterruptedException1);
    int restoreToL14589979302;
    int tryBlockOffsetL14589979302;
    DEFINE_CATCH_BLOCK(catch_L14589979302, label_L476973576, restoreToL14589979302);
...
label_L145899793:
 tryBlockOffsetL14589979302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L14589979302);
    restoreToL14589979302 = threadStateData->threadObjectStackOffset;
...
label_L457107443:
 tryBlockOffsetL457107443cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L457107443cn1_class_id_java_lang_InterruptedException1);
    restoreToL457107443cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL38420985701;
    int tryBlockOffsetL38420985701;
    DEFINE_CATCH_BLOCK(catch_L38420985701, label_L936380963, restoreToL38420985701);
    ...
    int restoreToL190260387104;
    int tryBlockOffsetL190260387104;
    DEFINE_CATCH_BLOCK(catch_L190260387104, label_L1128158063, restoreToL190260387104);
...
label_L384209857:
 tryBlockOffsetL38420985701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L38420985701);
    restoreToL38420985701 = threadStateData->threadObjectStackOffset;
...
label_L1902603871:
 tryBlockOffsetL190260387104 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L190260387104);
    restoreToL190260387104 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NetworkConnection_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    int restoreToL1662346822cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1662346822cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1662346822cn1_class_id_java_lang_InterruptedException1, label_L1649498695, restoreToL1662346822cn1_class_id_java_lang_InterruptedException1);
    int restoreToL42846871602;
    int tryBlockOffsetL42846871602;
    DEFINE_CATCH_BLOCK(catch_L42846871602, label_L1012552887, restoreToL42846871602);
...
label_L428468716:
 tryBlockOffsetL42846871602 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L42846871602);
    restoreToL42846871602 = threadStateData->threadObjectStackOffset;
...
label_L1662346822:
 tryBlockOffsetL1662346822cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1662346822cn1_class_id_java_lang_InterruptedException1);
    restoreToL1662346822cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NetworkConnection_getSSLCertificates___java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL129452163cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL129452163cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L129452163cn1_class_id_java_lang_Exception1, label_L1492219097, restoreToL129452163cn1_class_id_java_lang_Exception1);
...
label_L129452163:
 tryBlockOffsetL129452163cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L129452163cn1_class_id_java_lang_Exception1);
    restoreToL129452163cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
