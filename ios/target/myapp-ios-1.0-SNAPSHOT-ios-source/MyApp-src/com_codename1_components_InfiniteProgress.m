...
JAVA_VOID com_codename1_components_InfiniteProgress_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L477373723;
...
label_L477373723:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L447362054;
...
JAVA_VOID com_codename1_components_InfiniteProgress_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2031996327;
...
JAVA_BOOLEAN com_codename1_components_InfiniteProgress_animate___boolean_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L902387079;
    __CN1_DEBUG_INFO(231);
    if (virtual_com_codename1_components_InfiniteProgress_isVisible___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L136897240;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L902387079;
...
label_L902387079:
    ...
    if (com_codename1_ui_Component_animate___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1139404255;
    if ((get_field_com_codename1_components_InfiniteProgress_tick(__cn1ThisObject) % get_field_com_codename1_components_InfiniteProgress_tickCount(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1418621168;

label_L1139404255:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L722756235;
...
label_L722756235:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1684372243;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialDesignMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1752098133;
...
label_L1752098133:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1337983320;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1195913745;
...
JAVA_VOID com_codename1_components_InfiniteProgress_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L392260615;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L392260615;
...
label_L392260615:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialDesignMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1491363186;
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1589251269;
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L100350254;
...
label_L1589251269:
    ...
    BC_ALOAD(0);
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L434535618;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1649563001;
...
label_L100350254:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1820373458;
...
label_L1491363186:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L440708502;
...
label_L440708502:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1791871546;
    __CN1_DEBUG_INFO(346);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Image_rotate___int_R_com_codename1_ui_Image(threadStateData, get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject), ilocals_2_);locals[4].type=CN1_TYPE_OBJECT;    goto label_L53143696;
...
label_L1791871546:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L53143696;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2363))==0) /* IFEQ CustomJump */ goto label_L2058120467;
