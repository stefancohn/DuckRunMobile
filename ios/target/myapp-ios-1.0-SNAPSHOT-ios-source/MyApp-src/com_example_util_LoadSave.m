...
JAVA_VOID com_example_util_LoadSave___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10270, 205);
...
JAVA_OBJECT com_example_util_LoadSave_getSpriteAtlas___java_lang_String_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_example_util_LoadSave(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 10270, 10271);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL12053765001;
    int tryBlockOffsetL12053765001;
    DEFINE_CATCH_BLOCK(catch_L12053765001, label_L1119242936, restoreToL12053765001);
    int restoreToL101972770402;
    int tryBlockOffsetL101972770402;
    DEFINE_CATCH_BLOCK(catch_L101972770402, label_L2123914473, restoreToL101972770402);
    int restoreToL1099185032cn1_class_id_java_io_IOException3;
    int tryBlockOffsetL1099185032cn1_class_id_java_io_IOException3;
    DEFINE_CATCH_BLOCK(catch_L1099185032cn1_class_id_java_io_IOException3, label_L708443754, restoreToL1099185032cn1_class_id_java_io_IOException3);
    __CN1_DEBUG_INFO(19);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[1].type=CN1_TYPE_OBJECT;
label_L1099185032:
 tryBlockOffsetL1099185032cn1_class_id_java_io_IOException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1099185032cn1_class_id_java_io_IOException3);
    restoreToL1099185032cn1_class_id_java_io_IOException3 = threadStateData->threadObjectStackOffset;
...
label_L1019727704:
 tryBlockOffsetL101972770402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L101972770402);
    restoreToL101972770402 = threadStateData->threadObjectStackOffset;
...
label_L120537650:
 tryBlockOffsetL12053765001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L12053765001);
    restoreToL12053765001 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(22);
    ...
    JUMP_TO(label_L1091234211, 0);

label_L1119242936:
    BC_ASTORE(2);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L832145584, 2);
    virtual_java_io_InputStream_close__(threadStateData, locals[4].data.o); 
...
label_L2123914473:
END_TRY(1);    BC_ASTORE(3);
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L224060798, 1);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[3].data.o;
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1752535057, 1);

label_L224060798:
    if (locals[2].data.o==locals[3].data.o) /* IF_ACMPEQ CustomJump */ JUMP_TO(label_L1752535057, 1);
    BC_ALOAD(2);
    BC_ALOAD(3);
    SP--; /* POP */
    SP--; /* POP */
...
END_TRY(1);    BC_ASTORE(2);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_StringBuilder___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10272));     SP -= 1;
...
JAVA_OBJECT com_example_util_LoadSave_getLevelDataRed___java_lang_String_R_int_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_example_util_LoadSave(threadStateData);
    DEFINE_METHOD_STACK(3, 9, 0, 10270, 10273);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(32);
    ...
    goto label_L2116299597;

label_L1111379131:
    __CN1_DEBUG_INFO(37);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    goto label_L50720817;
...
label_L488600086:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1496220730;
    __CN1_DEBUG_INFO(43);
...
label_L50720817:
    if (ilocals_5_<virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L488600086;
    __CN1_DEBUG_INFO(36);
    BC_IINC(4, 1);

label_L2116299597:
    if (ilocals_4_<virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L1111379131;
    __CN1_DEBUG_INFO(48);
...
JAVA_OBJECT com_example_util_LoadSave_getLevelDataRedImg___com_codename1_ui_Image_R_int_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    __STATIC_INITIALIZER_com_example_util_LoadSave(threadStateData);
    DEFINE_METHOD_STACK(3, 8, 0, 10270, 10274);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(52);
...
label_L355885103:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L635288507;
    __CN1_DEBUG_INFO(62);
...
label_L1135935001:
    if (ilocals_4_<virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, locals[0].data.o)) /* IF_IMPLT CustomJump */ goto label_L355885103;
    __CN1_DEBUG_INFO(55);
    BC_IINC(3, 1);

label_L1846982837:
    if (ilocals_3_<virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, locals[0].data.o)) /* IF_IMPLT CustomJump */ goto label_L1321115948;
    __CN1_DEBUG_INFO(67);
...
JAVA_OBJECT com_example_util_LoadSave_getLevelDataBlue___java_lang_String_R_int_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_8_ = 0; /* v8 */
    __STATIC_INITIALIZER_com_example_util_LoadSave(threadStateData);
    DEFINE_METHOD_STACK(3, 9, 0, 10270, 10275);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(72);
    ...
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 
    goto label_L706665172;

label_L1950136544:
    __CN1_DEBUG_INFO(78);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    goto label_L1649847375;
...
label_L593447952:
    ...
    __CN1_DEBUG_INFO(82);
    if (ilocals_7_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1153933106;
    PUSH_INT(0); /* ICONST_0 */
...
label_L1649847375:
    if (ilocals_5_<virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L593447952;
    __CN1_DEBUG_INFO(77);
    BC_IINC(4, 1);

label_L706665172:
    if (ilocals_4_<virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L1950136544;
    __CN1_DEBUG_INFO(86);
