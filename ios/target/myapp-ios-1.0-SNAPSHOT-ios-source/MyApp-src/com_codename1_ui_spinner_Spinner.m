...
JAVA_OBJECT com_codename1_ui_spinner_Spinner_createDate___long_long_long_char_int_R_com_codename1_ui_spinner_Spinner(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_LONG __cn1Arg2, JAVA_LONG __cn1Arg3, JAVA_CHAR __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    SP++;
    PUSH_INT(12);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L834075412;
    if (ilocals_7_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1055787253;
...
JAVA_VOID com_codename1_ui_spinner_Spinner___INIT_____com_codename1_ui_list_ListModel_com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_spinner_Spinner_ios7Mode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L717151165;
...
label_L717151165:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L743893925;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    BC_ALOAD(0);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1647441786;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1974690755:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L63178138;
...
label_L1856218387:
    ...
    if (get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1261661384;
    __CN1_DEBUG_INFO(289);
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData))<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L628142870;
...
label_L1261661384:
    ...
    if (get_field_com_codename1_ui_spinner_Spinner_ios7Mode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1975727624;
...
label_L625361236:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(threadStateData, locals[9].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L93241065;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ goto label_L320605039;
...
label_L809976993:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L407976995;
    ...
    if (locals[5].data.o==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L216197799;
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L560383114;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[5].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L560383114;
...
JAVA_OBJECT com_codename1_ui_spinner_Spinner_getValue___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_SpinnerDateModel);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1933073727;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    int restoreToL2143419697cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL2143419697cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L2143419697cn1_class_id_java_lang_IllegalArgumentException1, label_L1746150957, restoreToL2143419697cn1_class_id_java_lang_IllegalArgumentException1);
    int restoreToL1145677323cn1_class_id_java_lang_IllegalArgumentException2;
    int tryBlockOffsetL1145677323cn1_class_id_java_lang_IllegalArgumentException2;
    DEFINE_CATCH_BLOCK(catch_L1145677323cn1_class_id_java_lang_IllegalArgumentException2, label_L1746150957, restoreToL1145677323cn1_class_id_java_lang_IllegalArgumentException2);
    int restoreToL1314740929cn1_class_id_java_lang_IllegalArgumentException3;
    int tryBlockOffsetL1314740929cn1_class_id_java_lang_IllegalArgumentException3;
    DEFINE_CATCH_BLOCK(catch_L1314740929cn1_class_id_java_lang_IllegalArgumentException3, label_L1746150957, restoreToL1314740929cn1_class_id_java_lang_IllegalArgumentException3);
    int restoreToL2113133067cn1_class_id_java_lang_IllegalArgumentException4;
    int tryBlockOffsetL2113133067cn1_class_id_java_lang_IllegalArgumentException4;
    DEFINE_CATCH_BLOCK(catch_L2113133067cn1_class_id_java_lang_IllegalArgumentException4, label_L1746150957, restoreToL2113133067cn1_class_id_java_lang_IllegalArgumentException4);
    int restoreToL1826091905cn1_class_id_java_lang_IllegalArgumentException5;
    int tryBlockOffsetL1826091905cn1_class_id_java_lang_IllegalArgumentException5;
    DEFINE_CATCH_BLOCK(catch_L1826091905cn1_class_id_java_lang_IllegalArgumentException5, label_L1746150957, restoreToL1826091905cn1_class_id_java_lang_IllegalArgumentException5);
    int restoreToL1342061890cn1_class_id_java_lang_IllegalArgumentException6;
    int tryBlockOffsetL1342061890cn1_class_id_java_lang_IllegalArgumentException6;
    DEFINE_CATCH_BLOCK(catch_L1342061890cn1_class_id_java_lang_IllegalArgumentException6, label_L1746150957, restoreToL1342061890cn1_class_id_java_lang_IllegalArgumentException6);
    int restoreToL228972001cn1_class_id_java_lang_IllegalArgumentException7;
    int tryBlockOffsetL228972001cn1_class_id_java_lang_IllegalArgumentException7;
    DEFINE_CATCH_BLOCK(catch_L228972001cn1_class_id_java_lang_IllegalArgumentException7, label_L1746150957, restoreToL228972001cn1_class_id_java_lang_IllegalArgumentException7);
    int restoreToL1358150250cn1_class_id_java_lang_IllegalArgumentException8;
    int tryBlockOffsetL1358150250cn1_class_id_java_lang_IllegalArgumentException8;
    DEFINE_CATCH_BLOCK(catch_L1358150250cn1_class_id_java_lang_IllegalArgumentException8, label_L1746150957, restoreToL1358150250cn1_class_id_java_lang_IllegalArgumentException8);
    int restoreToL45733040cn1_class_id_java_lang_IllegalArgumentException9;
    int tryBlockOffsetL45733040cn1_class_id_java_lang_IllegalArgumentException9;
    DEFINE_CATCH_BLOCK(catch_L45733040cn1_class_id_java_lang_IllegalArgumentException9, label_L1746150957, restoreToL45733040cn1_class_id_java_lang_IllegalArgumentException9);
    int restoreToL736431034cn1_class_id_java_lang_IllegalArgumentException10;
    int tryBlockOffsetL736431034cn1_class_id_java_lang_IllegalArgumentException10;
    DEFINE_CATCH_BLOCK(catch_L736431034cn1_class_id_java_lang_IllegalArgumentException10, label_L1746150957, restoreToL736431034cn1_class_id_java_lang_IllegalArgumentException10);
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ JUMP_TO(label_L2143419697, 0);
    __CN1_DEBUG_INFO(370);
    /* CustomInvoke */com_codename1_ui_List_keyReleased___int(threadStateData, __cn1ThisObject, ilocals_1_); 
    JUMP_TO(label_L1974062116, 0);

label_L2143419697:
 tryBlockOffsetL2143419697cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L2143419697cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL2143419697cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1145677323, 0);
...
label_L1145677323:
 tryBlockOffsetL1145677323cn1_class_id_java_lang_IllegalArgumentException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1145677323cn1_class_id_java_lang_IllegalArgumentException2);
    restoreToL1145677323cn1_class_id_java_lang_IllegalArgumentException2 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(380);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_spinner_Spinner_getRenderer___R_com_codename1_ui_list_ListCellRenderer(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_DateTimeRenderer);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L228972001, 0);
    __CN1_DEBUG_INFO(382);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_spinner_Spinner_getModel___R_com_codename1_ui_list_ListModel(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_SpinnerNumberModel);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2105379089, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1175368310, 1);
        case 2: JUMP_TO(label_L1342061890, 0);
        case 3: JUMP_TO(label_L1826091905, 0);
        case 4: JUMP_TO(label_L2113133067, 0);
        default: JUMP_TO(label_L1342061890, 0);
    }
...
label_L1175368310:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1314740929, 0);
    __CN1_DEBUG_INFO(393);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_7_; 
    SP++;
    PUSH_INT(24);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1342061890, 0);
...
label_L1314740929:
 tryBlockOffsetL1314740929cn1_class_id_java_lang_IllegalArgumentException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1314740929cn1_class_id_java_lang_IllegalArgumentException3);
    restoreToL1314740929cn1_class_id_java_lang_IllegalArgumentException3 = threadStateData->threadObjectStackOffset;
...
label_L2113133067:
 tryBlockOffsetL2113133067cn1_class_id_java_lang_IllegalArgumentException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L2113133067cn1_class_id_java_lang_IllegalArgumentException4);
    restoreToL2113133067cn1_class_id_java_lang_IllegalArgumentException4 = threadStateData->threadObjectStackOffset;
...
label_L1826091905:
 tryBlockOffsetL1826091905cn1_class_id_java_lang_IllegalArgumentException5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1826091905cn1_class_id_java_lang_IllegalArgumentException5);
    restoreToL1826091905cn1_class_id_java_lang_IllegalArgumentException5 = threadStateData->threadObjectStackOffset;
...
label_L1342061890:
 tryBlockOffsetL1342061890cn1_class_id_java_lang_IllegalArgumentException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1342061890cn1_class_id_java_lang_IllegalArgumentException6);
    restoreToL1342061890cn1_class_id_java_lang_IllegalArgumentException6 = threadStateData->threadObjectStackOffset;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1886878309, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L594531345, 1);
        case 2: JUMP_TO(label_L1886878309, 1);
        case 3: JUMP_TO(label_L1076847093, 1);
        case 4: JUMP_TO(label_L1686151267, 1);
        default: JUMP_TO(label_L1886878309, 1);
    }
...
label_L1686151267:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L795822788, 1);
...
label_L2105379089:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1239821079, 1);
        case 2: JUMP_TO(label_L679741936, 1);
        case 3: JUMP_TO(label_L2103992142, 1);
        case 4: JUMP_TO(label_L1642771051, 1);
        default: JUMP_TO(label_L679741936, 1);
    }
...
label_L679741936:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1920846948, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L776105426, 1);
        case 2: JUMP_TO(label_L1920846948, 1);
        case 3: JUMP_TO(label_L437255067, 1);
        case 4: JUMP_TO(label_L1740687627, 1);
        default: JUMP_TO(label_L1920846948, 1);
    }
...
label_L228972001:
 tryBlockOffsetL228972001cn1_class_id_java_lang_IllegalArgumentException7 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L228972001cn1_class_id_java_lang_IllegalArgumentException7);
    restoreToL228972001cn1_class_id_java_lang_IllegalArgumentException7 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_ui_spinner_SpinnerNumberModel_realValues(locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L139762783, 1);
    ...
    BC_DCMPL();
    if(POP_INT() > 0) /* IFGT */ JUMP_TO(label_L893734010, 1);
    BC_DLOAD(5);
    BC_ALOAD(0);
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1358150250, 0);
...
label_L1358150250:
 tryBlockOffsetL1358150250cn1_class_id_java_lang_IllegalArgumentException8 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1358150250cn1_class_id_java_lang_IllegalArgumentException8);
    restoreToL1358150250cn1_class_id_java_lang_IllegalArgumentException8 = threadStateData->threadObjectStackOffset;
...
label_L139762783:
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() > 0) /* IFGT */ JUMP_TO(label_L494956006, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    SP[-1].data.d = SP[-1].data.i; /* I2D */;
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L45733040, 0);
...
label_L45733040:
 tryBlockOffsetL45733040cn1_class_id_java_lang_IllegalArgumentException9 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L45733040cn1_class_id_java_lang_IllegalArgumentException9);
    restoreToL45733040cn1_class_id_java_lang_IllegalArgumentException9 = threadStateData->threadObjectStackOffset;
...
label_L890547325:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1330912871, 1);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[6].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L736431034, 0);
...
label_L736431034:
 tryBlockOffsetL736431034cn1_class_id_java_lang_IllegalArgumentException10 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L736431034cn1_class_id_java_lang_IllegalArgumentException10);
    restoreToL736431034cn1_class_id_java_lang_IllegalArgumentException10 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(504);
    BC_IINC(5, 1);
    JUMP_TO(label_L890547325, 1);
...
JAVA_VOID com_codename1_ui_spinner_Spinner_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2042950203;
...
label_L2042950203:
    ...
    BC_LCMP();
    if(POP_INT() < 0) /* IFLT */ goto label_L369916994;
    if (virtual_com_codename1_ui_TextField_isPendingCommit___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Spinner_quickType(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L355933666;
...
label_L369916994:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1532711878;
        case 3: goto label_L784386691;
        default: goto label_L53807796;
    }
...
JAVA_BOOLEAN com_codename1_ui_spinner_Spinner_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_spinner_Spinner_lastKeyInteraction(__cn1ThisObject), -1LL)==0) /* IFEQ CustomJump */ goto label_L105302830;
    ...
    PUSH_LONG(get_field_com_codename1_ui_spinner_Spinner_lastKeyInteraction(__cn1ThisObject));
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L779787703;
    if (virtual_com_codename1_ui_TextField_isPendingCommit___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Spinner_quickType(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L779787703;
...
JAVA_BOOLEAN com_codename1_ui_spinner_Spinner_shouldRenderSelection___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_spinner_Spinner_isIgnoreFocusComponentWhenUnfocused___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L87118438;
