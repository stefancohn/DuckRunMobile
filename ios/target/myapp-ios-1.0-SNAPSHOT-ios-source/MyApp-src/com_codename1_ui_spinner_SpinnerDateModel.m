...
JAVA_VOID com_codename1_ui_spinner_SpinnerDateModel_setValue___java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(60);
    if (ilocals_2_==virtual_com_codename1_ui_spinner_SpinnerDateModel_getSelectedIndex___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L788316339;
    __CN1_DEBUG_INFO(61);
