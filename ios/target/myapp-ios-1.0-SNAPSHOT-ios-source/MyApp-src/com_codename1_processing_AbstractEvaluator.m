...
JAVA_OBJECT com_codename1_processing_AbstractEvaluator__evaluate___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1369352990;
...
JAVA_OBJECT com_codename1_processing_AbstractEvaluator__evaluate___java_lang_Object_int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 37: goto label_L1251935072;
        case 60: goto label_L1863497271;
        case 61: goto label_L250219336;
        case 62: goto label_L1609272986;
        default: goto label_L1834816004;
    }
...
label_L604991790:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1723212594;
    __CN1_DEBUG_INFO(281);
    if (/* CustomInvoke */java_lang_Character_isDigit___char_R_boolean(threadStateData, /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[1].data.o, ilocals_3_))!=0) /* IFNE CustomJump */ goto label_L404923931;
...
label_L1679470965:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1048435582;
    ...
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1761988656;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(34);
...
JAVA_OBJECT com_codename1_processing_AbstractEvaluator_explode___java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6438))==0) /* IFEQ CustomJump */ goto label_L1002650329;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3650))==0) /* IFEQ CustomJump */ goto label_L1002650329;
...
label_L754346482:
    if (ilocals_4_>=virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1798680820;
...
label_L1282401410:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L2039850377;
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(5);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1723067056;
...
label_L2039850377:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[3].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L2075983878;
...
label_L1539048255:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1706518410;
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(6);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1989797386;
...
label_L1989797386:
    ...
    goto label_L1539048255;

label_L1706518410:
    __CN1_DEBUG_INFO(401);
    if (virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1934240791;
...
label_L344954076:
    ...
    /* VarOp.assignFrom */ locals[5].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, locals[1].data.o);locals[5].type=CN1_TYPE_OBJECT;
label_L1554058510:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L789698697;
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(6);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L219771880;
...
label_L789698697:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L878725938;
...
label_L1398063054:
    ...
    /* VarOp.assignFrom */ locals[5].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, locals[1].data.o);locals[5].type=CN1_TYPE_OBJECT;
label_L69338216:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L122225111;
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(6);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L826733527;
...
label_L122225111:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1920885229;
...
JAVA_OBJECT com_codename1_processing_AbstractEvaluator_evaluateLeftContainsRight___java_util_List_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_util_Vector);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1039565260;
    __CN1_DEBUG_INFO(532);
    PUSH_POINTER(__NEW_java_util_Vector(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_Vector___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(4);
    goto label_L1000871406;
...
label_L1000871406:
    ...
    /* VarOp.assignFrom */ locals[5].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, locals[1].data.o);locals[5].type=CN1_TYPE_OBJECT;
label_L666642000:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L800933815;
    ...
    BC_ALOAD(6);
    BC_INSTANCEOF(cn1_class_id_com_codename1_processing_StructuredContent);
    if(POP_INT() == 0) /* IFEQ */ goto label_L785197732;
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(6);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L785197732;
    __CN1_DEBUG_INFO(541);
    /* CustomInvoke */virtual_java_util_List_add___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, locals[6].data.o); 

label_L785197732:
    __CN1_DEBUG_INFO(544);
    goto label_L666642000;

label_L800933815:
    __CN1_DEBUG_INFO(545);
    if (virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1547714604;
