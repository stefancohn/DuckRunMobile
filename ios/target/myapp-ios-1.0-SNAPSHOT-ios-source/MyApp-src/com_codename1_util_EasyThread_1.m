...
JAVA_VOID com_codename1_util_EasyThread_1___INIT_____com_codename1_util_EasyThread(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7276, 205);
...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 7276, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL27778868801;
    int tryBlockOffsetL27778868801;
    DEFINE_CATCH_BLOCK(catch_L27778868801, label_L1649565139, restoreToL27778868801);
    int restoreToL164956513902;
    int tryBlockOffsetL164956513902;
    DEFINE_CATCH_BLOCK(catch_L164956513902, label_L1649565139, restoreToL164956513902);
    int restoreToL1239639900cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL1239639900cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L1239639900cn1_class_id_java_lang_Throwable3, label_L1454226183, restoreToL1239639900cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L1091819947:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2078726843, 0);

label_L1239639900:
 tryBlockOffsetL1239639900cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1239639900cn1_class_id_java_lang_Throwable3);
    restoreToL1239639900cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L277788688:
 tryBlockOffsetL27778868801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L27778868801);
    restoreToL27778868801 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1761370986, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L405804899, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L2135828131:
END_TRY(1);    JUMP_TO(label_L1845548855, 1);

label_L1649565139:
 tryBlockOffsetL164956513902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L164956513902);
    restoreToL164956513902 = threadStateData->threadObjectStackOffset;
...
label_L1845548855:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1701580462, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2105513583, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1701580462, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1091819947, 0);
