...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL188747756101;
    int tryBlockOffsetL188747756101;
    DEFINE_CATCH_BLOCK(catch_L188747756101, label_L1701580462, restoreToL188747756101);
    int restoreToL170158046202;
    int tryBlockOffsetL170158046202;
    DEFINE_CATCH_BLOCK(catch_L170158046202, label_L1701580462, restoreToL170158046202);
    int restoreToL171290935cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL171290935cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L171290935cn1_class_id_java_lang_Throwable3, label_L2105513583, restoreToL171290935cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L1231373644:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L700586699, 0);

label_L171290935:
 tryBlockOffsetL171290935cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L171290935cn1_class_id_java_lang_Throwable3);
    restoreToL171290935cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L1887477561:
 tryBlockOffsetL188747756101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L188747756101);
    restoreToL188747756101 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1091819947, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1150264921, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L1989745462:
END_TRY(1);    JUMP_TO(label_L2087699064, 1);

label_L1701580462:
 tryBlockOffsetL170158046202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L170158046202);
    restoreToL170158046202 = threadStateData->threadObjectStackOffset;
...
label_L2087699064:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L602837727, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L443172245, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L602837727, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1231373644, 0);
