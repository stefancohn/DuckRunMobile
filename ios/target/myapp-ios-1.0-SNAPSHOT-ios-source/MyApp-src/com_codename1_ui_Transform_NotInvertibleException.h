#ifndef __COM_CODENAME1_UI_TRANSFORM_NOTINVERTIBLEEXCEPTION__
#define __COM_CODENAME1_UI_TRANSFORM_NOTINVERTIBLEEXCEPTION__

#include "cn1_globals.h"
#include "java_lang_Exception.h"
extern struct clazz class__com_codename1_ui_Transform_NotInvertibleException;
extern void __INIT_VTABLE_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_com_codename1_ui_Transform_NotInvertibleException(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT com_codename1_ui_Transform_NotInvertibleException_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_codename1_ui_Transform_NotInvertibleException_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_codename1_ui_Transform_NotInvertibleException_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID com_codename1_ui_Transform_NotInvertibleException_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
struct obj__com_codename1_ui_Transform_NotInvertibleException {
    DEBUG_GC_VARIABLES
...
#endif //__COM_CODENAME1_UI_TRANSFORM_NOTINVERTIBLEEXCEPTION__
