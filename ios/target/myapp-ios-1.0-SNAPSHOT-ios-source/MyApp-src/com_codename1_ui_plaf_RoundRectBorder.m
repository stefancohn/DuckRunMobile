...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_paintBorderBackground___com_codename1_ui_Graphics_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL64907665401;
    int tryBlockOffsetL64907665401;
    DEFINE_CATCH_BLOCK(catch_L64907665401, label_L93981118, restoreToL64907665401);
...
label_L649076654:
 tryBlockOffsetL64907665401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L64907665401);
    restoreToL64907665401 = threadStateData->threadObjectStackOffset;
