#ifndef __COM_EXAMPLE_UTIL_COLLISIONS__
#define __COM_EXAMPLE_UTIL_COLLISIONS__

#include "cn1_globals.h"
#include "java_lang_Object.h"
extern struct clazz class__com_example_util_Collisions;
extern void __INIT_VTABLE_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_com_example_util_Collisions(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT com_example_util_Collisions_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_example_util_Collisions_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_example_util_Collisions_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_OBJECT com_example_util_Collisions_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID com_example_util_Collisions_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);

JAVA_OBJECT com_example_util_Collisions_clone___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);


struct obj__com_example_util_Collisions {
    DEBUG_GC_VARIABLES
...
#endif //__COM_EXAMPLE_UTIL_COLLISIONS__
