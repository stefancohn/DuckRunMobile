...
JAVA_VOID com_codename1_io_FileSystemStorage_deleteRetry___java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    int restoreToL594855230cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL594855230cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L594855230cn1_class_id_java_lang_Throwable1, label_L616302301, restoreToL594855230cn1_class_id_java_lang_Throwable1);
    __CN1_DEBUG_INFO(167);
    java_lang_System_gc__(threadStateData); 

label_L594855230:
 tryBlockOffsetL594855230cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L594855230cn1_class_id_java_lang_Throwable1);
    restoreToL594855230cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
label_L651177414:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L618120037, 0);
    __CN1_DEBUG_INFO(173);
    if (ilocals_2_<=0) /* IFLE CustomJump */ JUMP_TO(label_L618120037, 0);
