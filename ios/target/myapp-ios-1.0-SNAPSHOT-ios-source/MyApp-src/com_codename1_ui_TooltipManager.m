...
JAVA_VOID com_codename1_ui_TooltipManager_clearTooltip__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_TooltipManager_currentTooltip(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1640868131;
    __CN1_DEBUG_INFO(77);
...
label_L1640868131:
    __CN1_DEBUG_INFO(80);
    if (get_field_com_codename1_ui_TooltipManager_pendingTooltip(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1190941229;
    __CN1_DEBUG_INFO(81);
...
JAVA_VOID com_codename1_ui_TooltipManager_prepareTooltip___java_lang_String_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __CN1_DEBUG_INFO(96);
    if (get_field_com_codename1_ui_TooltipManager_currentComponent(__cn1ThisObject)!=locals[2].data.o) /* IF_ACMPNE CustomJump */ goto label_L1113783787;
    __CN1_DEBUG_INFO(97);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L1113783787:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1594500664;
