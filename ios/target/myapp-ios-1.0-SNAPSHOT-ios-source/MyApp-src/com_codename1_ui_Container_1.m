...
JAVA_VOID com_codename1_ui_Container_1___INIT_____com_codename1_ui_Container_com_codename1_ui_layouts_Layout_java_lang_Object_com_codename1_ui_Container_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3415, 205);
...
JAVA_VOID com_codename1_ui_Container_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3415, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(303);
    if (get_field_com_codename1_ui_Container_1_val_parentLayout(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1177427556;
...
label_L1177427556:
    ...
    if (get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1773117761;
...
label_L1389810291:
    if (ilocals_2_>=virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1240730624;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[3].data.o, get_field_com_codename1_ui_Container_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1681730990;
    __CN1_DEBUG_INFO(314);
    /* VarOp.assignFrom */     ilocals_1_ = ilocals_2_;
    __CN1_DEBUG_INFO(315);
    goto label_L1240730624;

label_L1681730990:
    __CN1_DEBUG_INFO(311);
    BC_IINC(2, 1);
    goto label_L1389810291;

label_L1240730624:
    __CN1_DEBUG_INFO(319);
    if (ilocals_1_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1181205697;
    __CN1_DEBUG_INFO(320);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3416));     SP -= 1;
