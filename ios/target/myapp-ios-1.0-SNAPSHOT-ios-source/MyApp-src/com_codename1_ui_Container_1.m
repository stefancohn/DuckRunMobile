...
JAVA_VOID com_codename1_ui_Container_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Container_1_val_parentLayout(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1078905349;
...
label_L1078905349:
    ...
    if (get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1488526679;
...
label_L555864569:
    if (ilocals_2_>=virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1638472859;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[3].data.o, get_field_com_codename1_ui_Container_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L386478079;
...
label_L386478079:
    __CN1_DEBUG_INFO(311);
    BC_IINC(2, 1);
    goto label_L555864569;

label_L1638472859:
    __CN1_DEBUG_INFO(319);
    if (ilocals_1_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L836903727;
