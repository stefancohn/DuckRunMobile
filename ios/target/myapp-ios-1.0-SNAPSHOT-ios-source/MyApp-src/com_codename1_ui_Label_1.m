...
JAVA_VOID com_codename1_ui_Label_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(59);
    if (virtual_com_codename1_ui_Label_isInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Label_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L766488161;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L766488161;
    __CN1_DEBUG_INFO(60);
