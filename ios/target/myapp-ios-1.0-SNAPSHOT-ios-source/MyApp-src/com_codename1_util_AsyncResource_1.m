...
JAVA_VOID com_codename1_util_AsyncResource_1_update___java_util_Observable_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL90933764701;
    int tryBlockOffsetL90933764701;
    DEFINE_CATCH_BLOCK(catch_L90933764701, label_L696759961, restoreToL90933764701);
    int restoreToL69675996102;
    int tryBlockOffsetL69675996102;
    DEFINE_CATCH_BLOCK(catch_L69675996102, label_L696759961, restoreToL69675996102);
    __CN1_DEBUG_INFO(140);
    if (virtual_com_codename1_util_AsyncResource_isDone___R_boolean(threadStateData, get_field_com_codename1_util_AsyncResource_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L758558161, 0);
...
label_L909337647:
 tryBlockOffsetL90933764701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L90933764701);
    restoreToL90933764701 = threadStateData->threadObjectStackOffset;
...
label_L1582319135:
END_TRY(1);    JUMP_TO(label_L758558161, 0);

label_L696759961:
 tryBlockOffsetL69675996102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L69675996102);
    restoreToL69675996102 = threadStateData->threadObjectStackOffset;
