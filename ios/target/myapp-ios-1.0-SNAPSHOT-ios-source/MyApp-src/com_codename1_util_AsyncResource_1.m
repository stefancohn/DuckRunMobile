...
JAVA_VOID com_codename1_util_AsyncResource_1_update___java_util_Observable_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL158278977101;
    int tryBlockOffsetL158278977101;
    DEFINE_CATCH_BLOCK(catch_L158278977101, label_L1402120747, restoreToL158278977101);
    ...
    if (virtual_com_codename1_util_AsyncResource_isDone___R_boolean(threadStateData, get_field_com_codename1_util_AsyncResource_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L391056646, 0);
...
label_L1582789771:
 tryBlockOffsetL158278977101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L158278977101);
    restoreToL158278977101 = threadStateData->threadObjectStackOffset;
