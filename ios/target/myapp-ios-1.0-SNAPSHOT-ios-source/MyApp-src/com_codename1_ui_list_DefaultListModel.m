...
JAVA_OBJECT com_codename1_ui_list_DefaultListModel_createList___java_lang_Object_1ARRAY_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(93);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1137350304;
    __CN1_DEBUG_INFO(94);
    PUSH_INT(0); /* ICONST_0 */
    SP--;
...
label_L1413679210:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L2087233084;
    __CN1_DEBUG_INFO(99);
...
JAVA_OBJECT com_codename1_ui_list_DefaultListModel_getItemAt___int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_1_>=virtual_com_codename1_ui_list_DefaultListModel_getSize___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1463856502;
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1463856502;
...
JAVA_INT com_codename1_ui_list_DefaultListModel_getSelectedIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_ARRAY_LENGTH(locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L2043169223;
...
JAVA_VOID com_codename1_ui_list_DefaultListModel_removeItem___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_1_>=virtual_com_codename1_ui_list_DefaultListModel_getSize___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1744645655;
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1744645655;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1705173326;
...
label_L1274584381:
    ...
    if (virtual_com_codename1_ui_list_DefaultListModel_getSize___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1587485260;
...
JAVA_VOID com_codename1_ui_list_DefaultListModel_setSelectedIndex___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_list_DefaultListModel_isMultiSelectionMode___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1165725635;
...
label_L1165725635:
    ...
    if (ilocals_1_!=get_field_com_codename1_ui_list_DefaultListModel_selectedIndex(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L298487665;
    if (get_field_com_codename1_ui_list_DefaultListModel_firstSetSelectedIndex(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L933346995;
...
JAVA_VOID com_codename1_ui_list_DefaultListModel_setSelectedIndices___int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_list_DefaultListModel_isMultiSelectionMode___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1034296050;
    __CN1_DEBUG_INFO(287);
    if (get_field_com_codename1_ui_list_DefaultListModel_selectedIndices(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2018683696;
...
label_L2018683696:
    ...
    if (virtual_java_util_Set_size___R_int(threadStateData, get_field_com_codename1_ui_list_DefaultListModel_selectedIndices(__cn1ThisObject))!=CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1098338771;
    if (/* CustomInvoke */virtual_java_util_Set_containsAll___java_util_Collection_R_boolean(threadStateData, get_field_com_codename1_ui_list_DefaultListModel_selectedIndices(__cn1ThisObject), locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L96423419;
...
label_L1696962359:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L147043892;
...
label_L505920393:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L96423419;
    ...
    goto label_L505920393;

label_L96423419:
    __CN1_DEBUG_INFO(306);
    goto label_L1627979043;

label_L1034296050:
    __CN1_DEBUG_INFO(307);
    if (CN1_ARRAY_LENGTH(locals[1].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1953465632;
...
label_L1953465632:
    ...
    if (CN1_ARRAY_LENGTH(locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1027221685;
...
JAVA_OBJECT com_codename1_ui_list_DefaultListModel_getSelectedIndices___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_list_DefaultListModel_isMultiSelectionMode___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L327193443;
    __CN1_DEBUG_INFO(369);
    if (get_field_com_codename1_ui_list_DefaultListModel_selectedIndices(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1447901504;
...
label_L1383055428:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1487734150;
