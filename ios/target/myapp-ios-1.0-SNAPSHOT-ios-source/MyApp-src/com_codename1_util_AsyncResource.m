...
JAVA_OBJECT com_codename1_util_AsyncResource_get___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL880917572cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL880917572cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L880917572cn1_class_id_java_lang_InterruptedException1, label_L168354843, restoreToL880917572cn1_class_id_java_lang_InterruptedException1);

label_L880917572:
 tryBlockOffsetL880917572cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L880917572cn1_class_id_java_lang_InterruptedException1);
    restoreToL880917572cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_util_AsyncResource_get___int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    int restoreToL202848592301;
    int tryBlockOffsetL202848592301;
    DEFINE_CATCH_BLOCK(catch_L202848592301, label_L235460721, restoreToL202848592301);
    int restoreToL23546072102;
    int tryBlockOffsetL23546072102;
    DEFINE_CATCH_BLOCK(catch_L23546072102, label_L235460721, restoreToL23546072102);
    __CN1_DEBUG_INFO(130);
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1320909739, 0);
    PUSH_LONG(java_lang_System_currentTimeMillis___R_long(threadStateData));
    JUMP_TO(label_L864312893, 0);
...
label_L864312893:
    ...
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2120309866, 0);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2120309866, 0);
...
label_L2120309866:
    ...
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L912443527, 0);
...
label_L1719999141:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(locals[4].data.o, 0 /* ICONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L588356547, 0);
    __CN1_DEBUG_INFO(150);
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L854936618, 0);
    PUSH_LONG(java_lang_System_currentTimeMillis___R_long(threadStateData));
    BC_LLOAD(2);
    ...
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L854936618, 0);
...
label_L854936618:
    ...
    if (com_codename1_ui_CN_isEdt___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1174651922, 0);
...
label_L2028485923:
 tryBlockOffsetL202848592301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L202848592301);
    restoreToL202848592301 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(165);
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1231374901, 1);
...
label_L1760922197:
END_TRY(1);    JUMP_TO(label_L152217156, 0);

label_L235460721:
 tryBlockOffsetL23546072102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L23546072102);
    restoreToL23546072102 = threadStateData->threadObjectStackOffset;
...
label_L588356547:
    ...
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1200408049, 0);
...
JAVA_OBJECT com_codename1_util_AsyncResource_get___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_util_AsyncResource_value(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L105531193;
...
JAVA_OBJECT com_codename1_util_AsyncResource_ready___com_codename1_util_SuccessCallback_com_codename1_util_EasyThread_R_com_codename1_util_AsyncResource(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL99655422601;
    int tryBlockOffsetL99655422601;
    DEFINE_CATCH_BLOCK(catch_L99655422601, label_L58397208, restoreToL99655422601);
    int restoreToL5839720802;
    int tryBlockOffsetL5839720802;
    DEFINE_CATCH_BLOCK(catch_L5839720802, label_L58397208, restoreToL5839720802);
...
label_L996554226:
 tryBlockOffsetL99655422601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L99655422601);
    restoreToL99655422601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(346);
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1465712321, 1);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1465712321, 1);
    ...
    BC_ASTORE(3);
    JUMP_TO(label_L839289583, 1);

label_L1465712321:
    __CN1_DEBUG_INFO(349);
    if (get_field_com_codename1_util_AsyncResource_successCallback(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L9089585, 1);
...
label_L956244325:
END_TRY(1);    JUMP_TO(label_L1530563562, 0);

label_L58397208:
 tryBlockOffsetL5839720802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L5839720802);
    restoreToL5839720802 = threadStateData->threadObjectStackOffset;
...
label_L1530563562:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1805704378, 0);
...
JAVA_OBJECT com_codename1_util_AsyncResource_except___com_codename1_util_SuccessCallback_com_codename1_util_EasyThread_R_com_codename1_util_AsyncResource(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_CATCH_BLOCK(catch_L90796166301, label_L1836544723, restoreToL90796166301);
    int restoreToL183654472302;
    int tryBlockOffsetL183654472302;
    DEFINE_CATCH_BLOCK(catch_L183654472302, label_L1836544723, restoreToL183654472302);
...
label_L907961663:
 tryBlockOffsetL90796166301 = threadStateData->tryBlockOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L943279734, 1);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L943279734, 1);
    __CN1_DEBUG_INFO(395);
    PUSH_POINTER(__NEW_com_codename1_util_AsyncResource_AsyncCallback(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_util_AsyncResource_AsyncCallback___INIT_____com_codename1_util_AsyncResource_com_codename1_util_SuccessCallback_com_codename1_util_EasyThread(threadStateData, SP[-1].data.o, __cn1ThisObject, locals[1].data.o, locals[2].data.o);     SP -= 1;
    BC_ASTORE(3);
    JUMP_TO(label_L936634176, 1);

label_L943279734:
    __CN1_DEBUG_INFO(397);
    if (get_field_com_codename1_util_AsyncResource_errorCallback(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1526441996, 1);
...
label_L1836544723:
 tryBlockOffsetL183654472302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L183654472302);
    restoreToL183654472302 = threadStateData->threadObjectStackOffset;
...
label_L206350442:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2121538923, 0);
...
JAVA_VOID com_codename1_util_AsyncResource_complete___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL48260629401;
    int tryBlockOffsetL48260629401;
    DEFINE_CATCH_BLOCK(catch_L48260629401, label_L1446321154, restoreToL48260629401);
    int restoreToL144632115402;
    int tryBlockOffsetL144632115402;
    DEFINE_CATCH_BLOCK(catch_L144632115402, label_L1446321154, restoreToL144632115402);
...
label_L482606294:
 tryBlockOffsetL48260629401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L48260629401);
    restoreToL48260629401 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_successCallback(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1359574272, 1);
...
label_L647138859:
END_TRY(1);    JUMP_TO(label_L946833587, 0);

label_L1446321154:
 tryBlockOffsetL144632115402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L144632115402);
    restoreToL144632115402 = threadStateData->threadObjectStackOffset;
...
label_L946833587:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1714312592, 0);
...
JAVA_VOID com_codename1_util_AsyncResource_error___java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL204822721301;
    int tryBlockOffsetL204822721301;
    DEFINE_CATCH_BLOCK(catch_L204822721301, label_L411406427, restoreToL204822721301);
...
label_L2048227213:
 tryBlockOffsetL204822721301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L204822721301);
    restoreToL204822721301 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_errorCallback(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L37639998, 1);
...
label_L1254967247:
END_TRY(1);    JUMP_TO(label_L1179680218, 0);
...
label_L1179680218:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1380332117, 0);
