...
JAVA_OBJECT com_codename1_ui_Image_getScaleCache___R_java_util_HashMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Image_scaleCache(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1372817363;
    __CN1_DEBUG_INFO(82);
...
label_L1372817363:
    ...
    BC_ASTORE(1);
    __CN1_DEBUG_INFO(87);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L594586746;
    __CN1_DEBUG_INFO(88);
    PUSH_POINTER(__NEW_java_util_HashMap(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_HashMap___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
...
label_L132461369:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L558913557;
...
JAVA_OBJECT com_codename1_ui_Image_applyMask___java_lang_Object_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_4_!=virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L728746911;
    if (ilocals_5_==virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L1977508673;
...
label_L1760622380:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1947666055;
...
JAVA_OBJECT com_codename1_ui_Image_applyMaskAutoScale___java_lang_Object_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1006006164cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1006006164cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1006006164cn1_class_id_java_lang_Throwable1, label_L1033304734, restoreToL1006006164cn1_class_id_java_lang_Throwable1);
    int restoreToL2008762581cn1_class_id_java_lang_Throwable2;
    int tryBlockOffsetL2008762581cn1_class_id_java_lang_Throwable2;
    DEFINE_CATCH_BLOCK(catch_L2008762581cn1_class_id_java_lang_Throwable2, label_L1033304734, restoreToL2008762581cn1_class_id_java_lang_Throwable2);

label_L1006006164:
 tryBlockOffsetL1006006164cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1006006164cn1_class_id_java_lang_Throwable1);
    restoreToL1006006164cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
    ...
    if (ilocals_2_!=virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L995381766, 1);
    if (ilocals_3_==virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L2008762581, 0);
...
label_L2008762581:
 tryBlockOffsetL2008762581cn1_class_id_java_lang_Throwable2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L2008762581cn1_class_id_java_lang_Throwable2);
    restoreToL2008762581cn1_class_id_java_lang_Throwable2 = threadStateData->threadObjectStackOffset;
...
label_L643328884:
    if (ilocals_5_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L404588697;
    __CN1_DEBUG_INFO(355);
    /* VarOp.assignFrom */     ilocals_6_ = 0 /* ICONST_0 */; 

label_L193492784:
    if (ilocals_6_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L315998990;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(378);
    if (virtual_com_codename1_impl_CodenameOneImplementation_isRotationDrawingSupported___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1391818342;
    __CN1_DEBUG_INFO(379);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(90);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1845760645;
    __CN1_DEBUG_INFO(380);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(381);
    if (get_field_com_codename1_ui_Image_transform(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L645777794;
    __CN1_DEBUG_INFO(382);
    /* VarOp.assignFrom */ ilocals_3_=((get_field_com_codename1_ui_Image_transform(__cn1ThisObject) + ilocals_1_) % 360);
    goto label_L1134237170;
...
label_L1134237170:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L983834017;
...
label_L1845760645:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1962586186;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(420);
    if (virtual_com_codename1_impl_CodenameOneImplementation_isNativeIndexed___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1015236238;
...
label_L472262461:
    if (ilocals_7_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L657252457;
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1031780408;
...
label_L387201851:
    if (ilocals_8_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L976725249;
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L2052601222;
    __CN1_DEBUG_INFO(474);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L975629453;
...
label_L646757254:
    if (ilocals_8_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L269257589;
    __CN1_DEBUG_INFO(508);
    if ((CN1_ARRAY_ELEMENT_INT(locals[6].data.o, ilocals_8_) & -16777216)==0) /* IFEQ CustomJump */ goto label_L734230775;
    ...
    if (ilocals_2_!=(16777215 & CN1_ARRAY_ELEMENT_INT(locals[6].data.o, ilocals_8_))) /* IF_ICMPNE CustomJump */ goto label_L734230775;
...
JAVA_OBJECT com_codename1_ui_Image_createImage___java_lang_String_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL1476648176cn1_class_id_java_lang_OutOfMemoryError1;
    int tryBlockOffsetL1476648176cn1_class_id_java_lang_OutOfMemoryError1;
    DEFINE_CATCH_BLOCK(catch_L1476648176cn1_class_id_java_lang_OutOfMemoryError1, label_L284660111, restoreToL1476648176cn1_class_id_java_lang_OutOfMemoryError1);

label_L1476648176:
 tryBlockOffsetL1476648176cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_OutOfMemoryError, catch_L1476648176cn1_class_id_java_lang_OutOfMemoryError1);
    restoreToL1476648176cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_Image_createImage___java_io_InputStream_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL332596708cn1_class_id_java_lang_OutOfMemoryError1;
    int tryBlockOffsetL332596708cn1_class_id_java_lang_OutOfMemoryError1;
    DEFINE_CATCH_BLOCK(catch_L332596708cn1_class_id_java_lang_OutOfMemoryError1, label_L1691678663, restoreToL332596708cn1_class_id_java_lang_OutOfMemoryError1);

label_L332596708:
 tryBlockOffsetL332596708cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_OutOfMemoryError, catch_L332596708cn1_class_id_java_lang_OutOfMemoryError1);
    restoreToL332596708cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_Image_createImage___int_1ARRAY_int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    int restoreToL813142559cn1_class_id_java_lang_OutOfMemoryError1;
    int tryBlockOffsetL813142559cn1_class_id_java_lang_OutOfMemoryError1;
    DEFINE_CATCH_BLOCK(catch_L813142559cn1_class_id_java_lang_OutOfMemoryError1, label_L1423978346, restoreToL813142559cn1_class_id_java_lang_OutOfMemoryError1);

label_L813142559:
 tryBlockOffsetL813142559cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_OutOfMemoryError, catch_L813142559cn1_class_id_java_lang_OutOfMemoryError1);
    restoreToL813142559cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_Image_createImage___int_int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_CATCH_BLOCK(catch_L215063818cn1_class_id_java_lang_OutOfMemoryError1, label_L401862395, restoreToL215063818cn1_class_id_java_lang_OutOfMemoryError1);
...
JAVA_OBJECT com_codename1_ui_Image_createImage___byte_1ARRAY_int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    ilocals_1_ = __cn1Arg2;
    ilocals_2_ = __cn1Arg3;
    int restoreToL540827518cn1_class_id_java_lang_OutOfMemoryError1;
    int tryBlockOffsetL540827518cn1_class_id_java_lang_OutOfMemoryError1;
    DEFINE_CATCH_BLOCK(catch_L540827518cn1_class_id_java_lang_OutOfMemoryError1, label_L1000631907, restoreToL540827518cn1_class_id_java_lang_OutOfMemoryError1);

label_L540827518:
 tryBlockOffsetL540827518cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_OutOfMemoryError, catch_L540827518cn1_class_id_java_lang_OutOfMemoryError1);
    restoreToL540827518cn1_class_id_java_lang_OutOfMemoryError1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2022562847, 1);
...
JAVA_INT com_codename1_ui_Image_getHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Image_transform(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1023423954;
    __CN1_DEBUG_INFO(709);
    PUSH_INT(get_field_com_codename1_ui_Image_transform(__cn1ThisObject));
    PUSH_INT(90);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L737897289;
    PUSH_INT(get_field_com_codename1_ui_Image_transform(__cn1ThisObject));
    PUSH_INT(270);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1023423954;
...
JAVA_OBJECT com_codename1_ui_Image_getRGBCached___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L523528914;
...
JAVA_OBJECT com_codename1_ui_Image_getRGBCache___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Image_rgbCache(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1184974266;
...
JAVA_OBJECT com_codename1_ui_Image_scaledSmallerRatio___int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(flocals_3_, flocals_4_)>=0) /* IFGE CustomJump */ goto label_L2058569241;
...
JAVA_OBJECT com_codename1_ui_Image_scaledImpl___int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    int restoreToL1493132386cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1493132386cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1493132386cn1_class_id_java_io_IOException1, label_L909918801, restoreToL1493132386cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(952);
    if (ilocals_1_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2063355321, 0);
...
label_L2063355321:
    ...
    if (ilocals_2_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L438263665, 0);
...
label_L438263665:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L104367332, 0);
...
label_L104367332:
    ...
    if (get_field_com_codename1_ui_Image_svgData(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1380085944, 0);

label_L1493132386:
 tryBlockOffsetL1493132386cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1493132386cn1_class_id_java_io_IOException1);
    restoreToL1493132386cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_Image_scaleArray___int_int_int_int_int_1ARRAY_int_1ARRAY_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_OBJECT __cn1Arg6) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(65536); /* LDC */
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L951629504;
    if (get_field_com_codename1_ui_Image_opaqueTested(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L951629504;
    PUSH_INT(1); /* ICONST_1 */
...
label_L530528285:
    if (ilocals_13_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L389703464;
...
label_L1929218620:
    if (ilocals_15_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L438493423;
    ...
    if (ilocals_17_<0) /* IFLT CustomJump */ goto label_L1733381085;
    if (ilocals_17_>=CN1_ARRAY_LENGTH(locals[6].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1733381085;
    if (ilocals_16_>=CN1_ARRAY_LENGTH(locals[5].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1733381085;
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ goto label_L999427036;
    if (ilocals_12_==0) /* IFEQ CustomJump */ goto label_L999427036;
    if ((CN1_ARRAY_ELEMENT_INT(locals[5].data.o, ilocals_16_) & -16777216)!=-16777216) /* IF_ICMPNE CustomJump */ goto label_L999427036;
    PUSH_INT(1); /* ICONST_1 */
...
label_L389703464:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ goto label_L880282841;
...
JAVA_BOOLEAN com_codename1_ui_Image_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Image_imageTime(__cn1ThisObject), -1LL)!=0) /* IFNE CustomJump */ goto label_L1648278215;
...
JAVA_BOOLEAN com_codename1_ui_Image_isOpaque___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Image_opaqueTested(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2089578710;
...
JAVA_VOID com_codename1_ui_Image_dispose__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Image_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L448131210;
...
JAVA_BOOLEAN com_codename1_ui_Image_requiresDrawImage___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Image_getImage___R_java_lang_Object(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1860118977;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_Image_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Image_listeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1723177853;
...
JAVA_VOID com_codename1_ui_Image_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Image_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1395725953;
