...
JAVA_OBJECT com_codename1_payment_Purchase_getReceipts___R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1101606543cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1101606543cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1101606543cn1_class_id_java_lang_Exception1, label_L499105172, restoreToL1101606543cn1_class_id_java_lang_Exception1);
    int restoreToL61135714102;
    int tryBlockOffsetL61135714102;
    DEFINE_CATCH_BLOCK(catch_L61135714102, label_L247576438, restoreToL61135714102);
...
label_L611357141:
 tryBlockOffsetL61135714102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L61135714102);
    restoreToL61135714102 = threadStateData->threadObjectStackOffset;
...
label_L1101606543:
 tryBlockOffsetL1101606543cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1101606543cn1_class_id_java_lang_Exception1);
    restoreToL1101606543cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_payment_Purchase_getReceiptsRefreshTime___R_java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL13468002501;
    int tryBlockOffsetL13468002501;
    DEFINE_CATCH_BLOCK(catch_L13468002501, label_L1913740360, restoreToL13468002501);
...
label_L134680025:
 tryBlockOffsetL13468002501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L13468002501);
    restoreToL13468002501 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_payment_Purchase_setReceipts___java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L95069768801, label_L2006005439, restoreToL95069768801);
...
JAVA_VOID com_codename1_payment_Purchase_setReceiptsRefreshTime___java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L107593272801, label_L1403255947, restoreToL107593272801);
...
JAVA_OBJECT com_codename1_payment_Purchase_getPendingPurchases___R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL197253335001;
    int tryBlockOffsetL197253335001;
    DEFINE_CATCH_BLOCK(catch_L197253335001, label_L341778327, restoreToL197253335001);
...
JAVA_VOID com_codename1_payment_Purchase_addPendingPurchase___com_codename1_payment_Receipt(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L195982228001, label_L424848797, restoreToL195982228001);
...
JAVA_OBJECT com_codename1_payment_Purchase_removePendingPurchase___java_lang_String_R_com_codename1_payment_Receipt(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL93645093601;
    int tryBlockOffsetL93645093601;
    DEFINE_CATCH_BLOCK(catch_L93645093601, label_L495471129, restoreToL93645093601);
...
label_L936450936:
 tryBlockOffsetL93645093601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L93645093601);
    restoreToL93645093601 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_payment_Purchase_fireSynchronizeReceiptsCallbacks___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    int restoreToL94751475201;
    int tryBlockOffsetL94751475201;
    DEFINE_CATCH_BLOCK(catch_L94751475201, label_L1710905079, restoreToL94751475201);
...
label_L947514752:
 tryBlockOffsetL94751475201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L94751475201);
    restoreToL94751475201 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_payment_Purchase_synchronizeReceipts___long_com_codename1_util_SuccessCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[3].data.o = __cn1Arg2;
    locals[3].type = CN1_TYPE_OBJECT;
    int restoreToL27268273001;
    int tryBlockOffsetL27268273001;
    DEFINE_CATCH_BLOCK(catch_L27268273001, label_L627747774, restoreToL27268273001);
    ...
    int restoreToL402470304;
    int tryBlockOffsetL402470304;
    DEFINE_CATCH_BLOCK(catch_L402470304, label_L1803161368, restoreToL402470304);
...
label_L272682730:
 tryBlockOffsetL27268273001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L27268273001);
    restoreToL27268273001 = threadStateData->threadObjectStackOffset;
...
label_L4024703:
 tryBlockOffsetL402470304 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L402470304);
    restoreToL402470304 = threadStateData->threadObjectStackOffset;
