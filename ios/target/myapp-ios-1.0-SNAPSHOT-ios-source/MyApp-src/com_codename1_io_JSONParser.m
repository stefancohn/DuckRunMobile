...
JAVA_VOID com_codename1_io_JSONParser___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7499, 205);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isUseLongsInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7499, 7501);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7499, 7507);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isUseBooleanInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7499, 7509);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_io_JSONParser(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7499, 7512);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_io_JSONParser(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7499, 7513);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(220);
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_JSONParser);
    if(POP_INT() == 0) /* IFEQ */ goto label_L135832852;
...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_io_JSONParser(threadStateData);
    DEFINE_METHOD_STACK(3, 23, 0, 7499, 443);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL433516222cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL433516222cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L433516222cn1_class_id_java_lang_NumberFormatException1, label_L1879362884, restoreToL433516222cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL2096102294cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL2096102294cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L2096102294cn1_class_id_java_lang_NumberFormatException2, label_L1230904017, restoreToL2096102294cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL993576454cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL993576454cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L993576454cn1_class_id_java_lang_NumberFormatException3, label_L1299436497, restoreToL993576454cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL699302992cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL699302992cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L699302992cn1_class_id_java_lang_NumberFormatException4, label_L978798, restoreToL699302992cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL152834486cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL152834486cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L152834486cn1_class_id_java_lang_Exception5, label_L1454795974, restoreToL152834486cn1_class_id_java_lang_Exception5);
    int restoreToL1010419513cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL1010419513cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L1010419513cn1_class_id_java_lang_Exception6, label_L1454795974, restoreToL1010419513cn1_class_id_java_lang_Exception6);
    ...
    /* VarOp.assignFrom */ locals[8].type=CN1_TYPE_INVALID;    locals[8].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(289);
...
label_L152834486:
 tryBlockOffsetL152834486cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L152834486cn1_class_id_java_lang_Exception5);
    restoreToL152834486cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1862757459, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1010419513, 0);
...
label_L1010419513:
 tryBlockOffsetL1010419513cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1010419513cn1_class_id_java_lang_Exception6);
    restoreToL1010419513cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1262168655, 1);
    __CN1_DEBUG_INFO(284);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(285);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L781103026, 1);
...
label_L781103026:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L2050964420, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L147663797, 1);
        case 92: JUMP_TO(label_L439751089, 1);
        default: JUMP_TO(label_L1100926586, 1);
    }
...
label_L147663797:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1115434134, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L596453359, 1);
...
label_L439751089:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1053225969, 1);
...
label_L433516222:
 tryBlockOffsetL433516222cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L433516222cn1_class_id_java_lang_NumberFormatException1);
    restoreToL433516222cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L1879362884:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7514));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L1053225969:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L1048421579, 1);
        case 114: JUMP_TO(label_L934117774, 1);
        case 116: JUMP_TO(label_L1093079840, 1);
        default: JUMP_TO(label_L1468374572, 1);
    }
...
label_L2050964420:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1772106148, 1);
        case 10: JUMP_TO(label_L1772106148, 1);
        case 11: JUMP_TO(label_L975733206, 1);
        case 12: JUMP_TO(label_L975733206, 1);
        case 13: JUMP_TO(label_L1772106148, 1);
        case 14: JUMP_TO(label_L975733206, 1);
        case 15: JUMP_TO(label_L975733206, 1);
        case 16: JUMP_TO(label_L975733206, 1);
        case 17: JUMP_TO(label_L975733206, 1);
        case 18: JUMP_TO(label_L975733206, 1);
        case 19: JUMP_TO(label_L975733206, 1);
        case 20: JUMP_TO(label_L975733206, 1);
        case 21: JUMP_TO(label_L975733206, 1);
        case 22: JUMP_TO(label_L975733206, 1);
        case 23: JUMP_TO(label_L975733206, 1);
        case 24: JUMP_TO(label_L975733206, 1);
        case 25: JUMP_TO(label_L975733206, 1);
        case 26: JUMP_TO(label_L975733206, 1);
        case 27: JUMP_TO(label_L975733206, 1);
        case 28: JUMP_TO(label_L975733206, 1);
        case 29: JUMP_TO(label_L975733206, 1);
        case 30: JUMP_TO(label_L975733206, 1);
        case 31: JUMP_TO(label_L975733206, 1);
        case 32: JUMP_TO(label_L1772106148, 1);
        case 33: JUMP_TO(label_L975733206, 1);
        case 34: JUMP_TO(label_L853175535, 1);
        case 35: JUMP_TO(label_L975733206, 1);
        case 36: JUMP_TO(label_L975733206, 1);
        case 37: JUMP_TO(label_L975733206, 1);
        case 38: JUMP_TO(label_L975733206, 1);
        case 39: JUMP_TO(label_L975733206, 1);
        case 40: JUMP_TO(label_L975733206, 1);
        case 41: JUMP_TO(label_L975733206, 1);
        case 42: JUMP_TO(label_L975733206, 1);
        case 43: JUMP_TO(label_L975733206, 1);
        case 44: JUMP_TO(label_L1268635527, 1);
        case 45: JUMP_TO(label_L893765907, 1);
        case 46: JUMP_TO(label_L893765907, 1);
        case 47: JUMP_TO(label_L975733206, 1);
        case 48: JUMP_TO(label_L893765907, 1);
        case 49: JUMP_TO(label_L893765907, 1);
        case 50: JUMP_TO(label_L893765907, 1);
        case 51: JUMP_TO(label_L893765907, 1);
        case 52: JUMP_TO(label_L893765907, 1);
        case 53: JUMP_TO(label_L893765907, 1);
        case 54: JUMP_TO(label_L893765907, 1);
        case 55: JUMP_TO(label_L893765907, 1);
        case 56: JUMP_TO(label_L893765907, 1);
        case 57: JUMP_TO(label_L893765907, 1);
        case 58: JUMP_TO(label_L1268635527, 1);
        case 59: JUMP_TO(label_L975733206, 1);
        case 60: JUMP_TO(label_L975733206, 1);
        case 61: JUMP_TO(label_L975733206, 1);
        case 62: JUMP_TO(label_L975733206, 1);
        case 63: JUMP_TO(label_L975733206, 1);
        case 64: JUMP_TO(label_L975733206, 1);
        case 65: JUMP_TO(label_L975733206, 1);
        case 66: JUMP_TO(label_L975733206, 1);
        case 67: JUMP_TO(label_L975733206, 1);
        case 68: JUMP_TO(label_L975733206, 1);
        case 69: JUMP_TO(label_L893765907, 1);
        case 70: JUMP_TO(label_L975733206, 1);
        case 71: JUMP_TO(label_L975733206, 1);
        case 72: JUMP_TO(label_L975733206, 1);
        case 73: JUMP_TO(label_L975733206, 1);
        case 74: JUMP_TO(label_L975733206, 1);
        case 75: JUMP_TO(label_L975733206, 1);
        case 76: JUMP_TO(label_L975733206, 1);
        case 77: JUMP_TO(label_L975733206, 1);
        case 78: JUMP_TO(label_L975733206, 1);
        case 79: JUMP_TO(label_L975733206, 1);
        case 80: JUMP_TO(label_L975733206, 1);
        case 81: JUMP_TO(label_L975733206, 1);
        case 82: JUMP_TO(label_L975733206, 1);
        case 83: JUMP_TO(label_L975733206, 1);
        case 84: JUMP_TO(label_L975733206, 1);
        case 85: JUMP_TO(label_L975733206, 1);
        case 86: JUMP_TO(label_L975733206, 1);
        case 87: JUMP_TO(label_L975733206, 1);
        case 88: JUMP_TO(label_L975733206, 1);
        case 89: JUMP_TO(label_L975733206, 1);
        case 90: JUMP_TO(label_L975733206, 1);
        case 91: JUMP_TO(label_L1560339214, 1);
        case 92: JUMP_TO(label_L975733206, 1);
        case 93: JUMP_TO(label_L1021071701, 1);
        case 94: JUMP_TO(label_L975733206, 1);
        case 95: JUMP_TO(label_L975733206, 1);
        case 96: JUMP_TO(label_L975733206, 1);
        case 97: JUMP_TO(label_L975733206, 1);
        case 98: JUMP_TO(label_L975733206, 1);
        case 99: JUMP_TO(label_L975733206, 1);
        case 100: JUMP_TO(label_L893765907, 1);
        case 101: JUMP_TO(label_L893765907, 1);
        case 102: JUMP_TO(label_L425232550, 1);
        case 103: JUMP_TO(label_L975733206, 1);
        case 104: JUMP_TO(label_L975733206, 1);
        case 105: JUMP_TO(label_L975733206, 1);
        case 106: JUMP_TO(label_L975733206, 1);
        case 107: JUMP_TO(label_L975733206, 1);
        case 108: JUMP_TO(label_L893765907, 1);
        case 109: JUMP_TO(label_L975733206, 1);
        case 110: JUMP_TO(label_L47110095, 1);
        case 111: JUMP_TO(label_L975733206, 1);
        case 112: JUMP_TO(label_L975733206, 1);
        case 113: JUMP_TO(label_L975733206, 1);
        case 114: JUMP_TO(label_L975733206, 1);
        case 115: JUMP_TO(label_L975733206, 1);
        case 116: JUMP_TO(label_L1477200907, 1);
        case 117: JUMP_TO(label_L975733206, 1);
        case 118: JUMP_TO(label_L975733206, 1);
        case 119: JUMP_TO(label_L975733206, 1);
        case 120: JUMP_TO(label_L893765907, 1);
        case 121: JUMP_TO(label_L975733206, 1);
        case 122: JUMP_TO(label_L975733206, 1);
        case 123: JUMP_TO(label_L100984998, 1);
        case 124: JUMP_TO(label_L975733206, 1);
        case 125: JUMP_TO(label_L1539591544, 1);
        default: JUMP_TO(label_L975733206, 1);
    }
...
label_L47110095:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L152834486, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L152834486, 0);
...
label_L792758624:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7515));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7516));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7517));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L1477200907:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L353825943, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L880176971, 1);
...
label_L353825943:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7518));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, ilocals_4_);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7516));
...
label_L425232550:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1711329405, 1);
...
label_L1711329405:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1141912166, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1134231960, 1);
    ...
    JUMP_TO(label_L204319504, 1);

label_L1134231960:
    __CN1_DEBUG_INFO(389);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_stringToken___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(267)); 

label_L204319504:
    __CN1_DEBUG_INFO(391);
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L152834486, 0);
    __CN1_DEBUG_INFO(392);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_keyValue___java_lang_String_java_lang_String(threadStateData, locals[1].data.o, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(267)); 
...
label_L1141912166:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7519));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, ilocals_4_);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7516));
...
label_L100984998:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1817055696, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L688426301, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7520);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1817055696, 1);
...
label_L1539591544:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L847568453, 1);

label_L2096102294:
 tryBlockOffsetL2096102294cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L2096102294cn1_class_id_java_lang_NumberFormatException2);
    restoreToL2096102294cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1401980462, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1338826013, 2);
...
label_L583057596:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L916608087, 1);
...
label_L1021071701:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1641289051, 1);

label_L993576454:
 tryBlockOffsetL993576454cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L993576454cn1_class_id_java_lang_NumberFormatException3);
    restoreToL993576454cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1213794377, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1815672030, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L1218188770, 2);
...
label_L1218188770:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L153337703, 1);
...
label_L1268635527:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L154723658, 1);

label_L699302992:
 tryBlockOffsetL699302992cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L699302992cn1_class_id_java_lang_NumberFormatException4);
    restoreToL699302992cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L571309751, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L169237521, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L517608115, 2);
...
label_L517608115:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1342613143, 1);
...
label_L1454795974:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7521));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, ilocals_4_);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7516));
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7499, 443);
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1878553091;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7499, 7523);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(594);
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L179258229;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L179258229;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_OBJECT com_codename1_io_JSONParser_getStackHash___R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7499, 7524);
...
JAVA_OBJECT com_codename1_io_JSONParser_getStackVec___R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7499, 7525);
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7499, 7526);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(610);
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1135030031;
...
label_L1135030031:
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L531068784;
...
label_L1660136848:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L416692630;
...
JAVA_VOID com_codename1_io_JSONParser_endBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7499, 7527);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7499, 7530);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(685);
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1246962289;
    __CN1_DEBUG_INFO(686);
    PUSH_POINTER(__NEW_java_util_ArrayList(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ArrayList___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(2);
    goto label_L900958598;
...
label_L900958598:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L469765167;
    __CN1_DEBUG_INFO(693);
    /* CustomInvoke */virtual_java_util_List_add___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject), get_field_com_codename1_io_JSONParser_state(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(694);
    set_field_com_codename1_io_JSONParser_currentKey(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(7520), __cn1ThisObject);
...
JAVA_VOID com_codename1_io_JSONParser_endArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7499, 7531);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7499, 7532);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(716);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1455386398;
    __CN1_DEBUG_INFO(717);
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1254252690;
    __CN1_DEBUG_INFO(718);
    set_field_com_codename1_io_JSONParser_currentKey(threadStateData, locals[1].data.o, __cn1ThisObject);
    goto label_L814630491;

label_L1254252690:
    __CN1_DEBUG_INFO(720);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L115857872;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L722305421;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 7499, 7533);
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 7499, 7534);
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7499, 7535);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(758);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L685399117;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isAlive___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7499, 538);
