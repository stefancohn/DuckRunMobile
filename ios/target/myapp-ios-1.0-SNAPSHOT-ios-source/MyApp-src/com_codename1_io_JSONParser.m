...
JAVA_BOOLEAN com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1862757459;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_JSONParser);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1010419513;
...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL1854064967cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL1854064967cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L1854064967cn1_class_id_java_lang_NumberFormatException1, label_L1262168655, restoreToL1854064967cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL1427069962cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL1427069962cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L1427069962cn1_class_id_java_lang_NumberFormatException2, label_L781103026, restoreToL1427069962cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL1921677196cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL1921677196cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L1921677196cn1_class_id_java_lang_NumberFormatException3, label_L2050964420, restoreToL1921677196cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL980788522cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL980788522cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L980788522cn1_class_id_java_lang_NumberFormatException4, label_L147663797, restoreToL980788522cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL975733206cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL975733206cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L975733206cn1_class_id_java_lang_Exception5, label_L439751089, restoreToL975733206cn1_class_id_java_lang_Exception5);
    int restoreToL1115434134cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL1115434134cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L1115434134cn1_class_id_java_lang_Exception6, label_L439751089, restoreToL1115434134cn1_class_id_java_lang_Exception6);
...
label_L975733206:
 tryBlockOffsetL975733206cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L975733206cn1_class_id_java_lang_Exception5);
    restoreToL975733206cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1100926586, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1115434134, 0);
...
label_L1115434134:
 tryBlockOffsetL1115434134cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1115434134cn1_class_id_java_lang_Exception6);
    restoreToL1115434134cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
...
label_L152834486:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1053225969, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L503144483, 1);
        case 92: JUMP_TO(label_L1468374572, 1);
        default: JUMP_TO(label_L1048421579, 1);
    }
...
label_L503144483:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L934117774, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1093079840, 1);
...
label_L1468374572:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1772106148, 1);
...
label_L1854064967:
 tryBlockOffsetL1854064967cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1854064967cn1_class_id_java_lang_NumberFormatException1);
    restoreToL1854064967cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L1772106148:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L893765907, 1);
        case 114: JUMP_TO(label_L1560339214, 1);
        case 116: JUMP_TO(label_L1021071701, 1);
        default: JUMP_TO(label_L1268635527, 1);
    }
...
label_L1053225969:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L47110095, 1);
        case 10: JUMP_TO(label_L47110095, 1);
        case 11: JUMP_TO(label_L425232550, 1);
        case 12: JUMP_TO(label_L425232550, 1);
        case 13: JUMP_TO(label_L47110095, 1);
        case 14: JUMP_TO(label_L425232550, 1);
        case 15: JUMP_TO(label_L425232550, 1);
        case 16: JUMP_TO(label_L425232550, 1);
        case 17: JUMP_TO(label_L425232550, 1);
        case 18: JUMP_TO(label_L425232550, 1);
        case 19: JUMP_TO(label_L425232550, 1);
        case 20: JUMP_TO(label_L425232550, 1);
        case 21: JUMP_TO(label_L425232550, 1);
        case 22: JUMP_TO(label_L425232550, 1);
        case 23: JUMP_TO(label_L425232550, 1);
        case 24: JUMP_TO(label_L425232550, 1);
        case 25: JUMP_TO(label_L425232550, 1);
        case 26: JUMP_TO(label_L425232550, 1);
        case 27: JUMP_TO(label_L425232550, 1);
        case 28: JUMP_TO(label_L425232550, 1);
        case 29: JUMP_TO(label_L425232550, 1);
        case 30: JUMP_TO(label_L425232550, 1);
        case 31: JUMP_TO(label_L425232550, 1);
        case 32: JUMP_TO(label_L47110095, 1);
        case 33: JUMP_TO(label_L425232550, 1);
        case 34: JUMP_TO(label_L1477200907, 1);
        case 35: JUMP_TO(label_L425232550, 1);
        case 36: JUMP_TO(label_L425232550, 1);
        case 37: JUMP_TO(label_L425232550, 1);
        case 38: JUMP_TO(label_L425232550, 1);
        case 39: JUMP_TO(label_L425232550, 1);
        case 40: JUMP_TO(label_L425232550, 1);
        case 41: JUMP_TO(label_L425232550, 1);
        case 42: JUMP_TO(label_L425232550, 1);
        case 43: JUMP_TO(label_L425232550, 1);
        case 44: JUMP_TO(label_L100984998, 1);
        case 45: JUMP_TO(label_L1539591544, 1);
        case 46: JUMP_TO(label_L1539591544, 1);
        case 47: JUMP_TO(label_L425232550, 1);
        case 48: JUMP_TO(label_L1539591544, 1);
        case 49: JUMP_TO(label_L1539591544, 1);
        case 50: JUMP_TO(label_L1539591544, 1);
        case 51: JUMP_TO(label_L1539591544, 1);
        case 52: JUMP_TO(label_L1539591544, 1);
        case 53: JUMP_TO(label_L1539591544, 1);
        case 54: JUMP_TO(label_L1539591544, 1);
        case 55: JUMP_TO(label_L1539591544, 1);
        case 56: JUMP_TO(label_L1539591544, 1);
        case 57: JUMP_TO(label_L1539591544, 1);
        case 58: JUMP_TO(label_L100984998, 1);
        case 59: JUMP_TO(label_L425232550, 1);
        case 60: JUMP_TO(label_L425232550, 1);
        case 61: JUMP_TO(label_L425232550, 1);
        case 62: JUMP_TO(label_L425232550, 1);
        case 63: JUMP_TO(label_L425232550, 1);
        case 64: JUMP_TO(label_L425232550, 1);
        case 65: JUMP_TO(label_L425232550, 1);
        case 66: JUMP_TO(label_L425232550, 1);
        case 67: JUMP_TO(label_L425232550, 1);
        case 68: JUMP_TO(label_L425232550, 1);
        case 69: JUMP_TO(label_L1539591544, 1);
        case 70: JUMP_TO(label_L425232550, 1);
        case 71: JUMP_TO(label_L425232550, 1);
        case 72: JUMP_TO(label_L425232550, 1);
        case 73: JUMP_TO(label_L425232550, 1);
        case 74: JUMP_TO(label_L425232550, 1);
        case 75: JUMP_TO(label_L425232550, 1);
        case 76: JUMP_TO(label_L425232550, 1);
        case 77: JUMP_TO(label_L425232550, 1);
        case 78: JUMP_TO(label_L425232550, 1);
        case 79: JUMP_TO(label_L425232550, 1);
        case 80: JUMP_TO(label_L425232550, 1);
        case 81: JUMP_TO(label_L425232550, 1);
        case 82: JUMP_TO(label_L425232550, 1);
        case 83: JUMP_TO(label_L425232550, 1);
        case 84: JUMP_TO(label_L425232550, 1);
        case 85: JUMP_TO(label_L425232550, 1);
        case 86: JUMP_TO(label_L425232550, 1);
        case 87: JUMP_TO(label_L425232550, 1);
        case 88: JUMP_TO(label_L425232550, 1);
        case 89: JUMP_TO(label_L425232550, 1);
        case 90: JUMP_TO(label_L425232550, 1);
        case 91: JUMP_TO(label_L792758624, 1);
        case 92: JUMP_TO(label_L425232550, 1);
        case 93: JUMP_TO(label_L353825943, 1);
        case 94: JUMP_TO(label_L425232550, 1);
        case 95: JUMP_TO(label_L425232550, 1);
        case 96: JUMP_TO(label_L425232550, 1);
        case 97: JUMP_TO(label_L425232550, 1);
        case 98: JUMP_TO(label_L425232550, 1);
        case 99: JUMP_TO(label_L425232550, 1);
        case 100: JUMP_TO(label_L1539591544, 1);
        case 101: JUMP_TO(label_L1539591544, 1);
        case 102: JUMP_TO(label_L880176971, 1);
        case 103: JUMP_TO(label_L425232550, 1);
        case 104: JUMP_TO(label_L425232550, 1);
        case 105: JUMP_TO(label_L425232550, 1);
        case 106: JUMP_TO(label_L425232550, 1);
        case 107: JUMP_TO(label_L425232550, 1);
        case 108: JUMP_TO(label_L1539591544, 1);
        case 109: JUMP_TO(label_L425232550, 1);
        case 110: JUMP_TO(label_L1293962032, 1);
        case 111: JUMP_TO(label_L425232550, 1);
        case 112: JUMP_TO(label_L425232550, 1);
        case 113: JUMP_TO(label_L425232550, 1);
        case 114: JUMP_TO(label_L425232550, 1);
        case 115: JUMP_TO(label_L425232550, 1);
        case 116: JUMP_TO(label_L1711329405, 1);
        case 117: JUMP_TO(label_L425232550, 1);
        case 118: JUMP_TO(label_L425232550, 1);
        case 119: JUMP_TO(label_L425232550, 1);
        case 120: JUMP_TO(label_L1539591544, 1);
        case 121: JUMP_TO(label_L425232550, 1);
        case 122: JUMP_TO(label_L425232550, 1);
        case 123: JUMP_TO(label_L1141912166, 1);
        case 124: JUMP_TO(label_L425232550, 1);
        case 125: JUMP_TO(label_L1134231960, 1);
        default: JUMP_TO(label_L425232550, 1);
    }
...
label_L1293962032:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L204319504, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L975733206, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L975733206, 0);
...
label_L1711329405:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1817055696, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L688426301, 1);
...
label_L880176971:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1401980462, 1);
...
label_L1401980462:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1338826013, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L583057596, 1);
...
label_L1141912166:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1641289051, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1213794377, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7520);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1641289051, 1);
...
label_L1134231960:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1815672030, 1);

label_L1427069962:
 tryBlockOffsetL1427069962cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1427069962cn1_class_id_java_lang_NumberFormatException2);
    restoreToL1427069962cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1218188770, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L153337703, 2);
...
label_L353825943:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L169237521, 1);

label_L1921677196:
 tryBlockOffsetL1921677196cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1921677196cn1_class_id_java_lang_NumberFormatException3);
    restoreToL1921677196cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L517608115, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1342613143, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L423072486, 2);
...
label_L100984998:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1878553091, 1);

label_L980788522:
 tryBlockOffsetL980788522cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L980788522cn1_class_id_java_lang_NumberFormatException4);
    restoreToL980788522cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L179258229, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L791302244, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L1135030031, 2);
...
label_L1135030031:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1877161234, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L416692630;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1852560443;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1852560443;
    PUSH_INT(1); /* ICONST_1 */
...
label_L900958598:
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L746244504;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L814630491;
    __CN1_DEBUG_INFO(686);
    PUSH_POINTER(__NEW_java_util_ArrayList(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ArrayList___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(2);
    goto label_L115857872;
...
label_L115857872:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L722305421;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1329271270;
...
label_L1329271270:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2089976729;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L466396438;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L216998824;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L508294491;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L366381648;
