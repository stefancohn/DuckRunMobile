...
extern void __INIT_VTABLE_java_util_StringTokenizer(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_StringTokenizer(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_StringTokenizer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_StringTokenizer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_util_StringTokenizer(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT java_util_StringTokenizer_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_StringTokenizer_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_StringTokenizer_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_OBJECT java_util_StringTokenizer_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_util_StringTokenizer_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);

JAVA_OBJECT java_util_StringTokenizer_clone___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
#define virtual_java_util_StringTokenizer_countTokens___R_int java_util_StringTokenizer_countTokens___R_int
#define virtual_java_util_StringTokenizer_hasMoreTokens___R_boolean java_util_StringTokenizer_hasMoreTokens___R_boolean
#define virtual_java_util_StringTokenizer_nextToken___R_java_lang_String java_util_StringTokenizer_nextToken___R_java_lang_String
JAVA_OBJECT get_field_java_util_StringTokenizer_string(JAVA_OBJECT t);
void set_field_java_util_StringTokenizer_string(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T);
JAVA_OBJECT get_field_java_util_StringTokenizer_delimiters(JAVA_OBJECT t);
void set_field_java_util_StringTokenizer_delimiters(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T);
JAVA_BOOLEAN get_field_java_util_StringTokenizer_returnDelimiters(JAVA_OBJECT t);
...
struct obj__java_util_StringTokenizer {
    ...
    void* __ownerThread;
    int __heapPosition;
    JAVA_OBJECT java_util_StringTokenizer_string;
    JAVA_OBJECT java_util_StringTokenizer_delimiters;
    JAVA_BOOLEAN java_util_StringTokenizer_returnDelimiters;
    JAVA_INT java_util_StringTokenizer_position;
};
