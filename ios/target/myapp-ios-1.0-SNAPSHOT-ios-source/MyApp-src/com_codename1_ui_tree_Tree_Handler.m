...
JAVA_VOID com_codename1_ui_tree_Tree_Handler_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_tree_Tree_Handler_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L366180667;
...
label_L366180667:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L90050962;
...
label_L90050962:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L303300540;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(212))==0) /* IFEQ CustomJump */ goto label_L303300540;
