...
label_L141213117:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L57964663;
...
label_L671546968:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1122059861;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(100);
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L135370989;
...
JAVA_OBJECT com_codename1_properties_PropertyIndex_getProps___R_java_util_HashMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L654239297;
...
JAVA_VOID com_codename1_properties_PropertyIndex_putMetaDataOfClass___java_lang_String_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L855329415;
...
JAVA_OBJECT com_codename1_properties_PropertyIndex_toString___boolean_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L657530009;
...
label_L1341485339:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1990998736;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L510388720;
    __CN1_DEBUG_INFO(218);
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___char_R_java_lang_StringBuilder(threadStateData, locals[2].data.o, 10); 

label_L510388720:
    __CN1_DEBUG_INFO(220);
    goto label_L1341485339;
...
label_L914880182:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1620015528;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2011342291;
    ...
    goto label_L914880182;

label_L2011342291:
    __CN1_DEBUG_INFO(242);
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_java_util_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1377711316;
...
JAVA_BOOLEAN com_codename1_properties_PropertyIndex_setSimpleObject___com_codename1_properties_PropertyBase_java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1237796102;
...
label_L1237796102:
    ...
    if (virtual_com_codename1_properties_PropertyBase_getGenericType___R_java_lang_Class(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L736734672;
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L575855709;
...
label_L1846902600:
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L938070417;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_properties_PropertyBase_getGenericType___R_java_lang_Class(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    /* LDC: 'com_codename1_ui_EncodedImage'*/
    PUSH_POINTER((JAVA_OBJECT)&class__com_codename1_ui_EncodedImage);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L87702732;

label_L938070417:
    __CN1_DEBUG_INFO(287);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Image);
    if(POP_INT() == 0) /* IFEQ */ goto label_L667585114;
...
label_L667585114:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L469528144;
...
label_L87702732:
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1333063103;
...
JAVA_VOID com_codename1_properties_PropertyIndex_populateFromMap___java_util_Map_java_lang_Class(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL840163101cn1_class_id_java_lang_InstantiationException1;
    int tryBlockOffsetL840163101cn1_class_id_java_lang_InstantiationException1;
    DEFINE_CATCH_BLOCK(catch_L840163101cn1_class_id_java_lang_InstantiationException1, label_L1008674385, restoreToL840163101cn1_class_id_java_lang_InstantiationException1);
    int restoreToL840163101cn1_class_id_java_lang_IllegalAccessException2;
    int tryBlockOffsetL840163101cn1_class_id_java_lang_IllegalAccessException2;
    DEFINE_CATCH_BLOCK(catch_L840163101cn1_class_id_java_lang_IllegalAccessException2, label_L1558825448, restoreToL840163101cn1_class_id_java_lang_IllegalAccessException2);

label_L840163101:
 tryBlockOffsetL840163101cn1_class_id_java_lang_IllegalAccessException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L840163101cn1_class_id_java_lang_IllegalAccessException2);
    restoreToL840163101cn1_class_id_java_lang_IllegalAccessException2 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL840163101cn1_class_id_java_lang_InstantiationException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L840163101cn1_class_id_java_lang_InstantiationException1);
    restoreToL840163101cn1_class_id_java_lang_InstantiationException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(312);
    /* VarOp.assignFrom */ locals[3].data.o = virtual_com_codename1_properties_PropertyIndex_iterator___R_java_util_Iterator(threadStateData, __cn1ThisObject);locals[3].type=CN1_TYPE_OBJECT;
label_L151400576:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L614441675, 1);
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1282325234, 2);
...
label_L1282325234:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L464658113, 2);
    __CN1_DEBUG_INFO(320);
    BC_ALOAD(6);
    BC_INSTANCEOF(cn1_class_id_java_util_List);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1113747078, 2);
    __CN1_DEBUG_INFO(321);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_properties_CollectionProperty);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L151400576, 2);
    __CN1_DEBUG_INFO(322);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2078471442, 2);
    __CN1_DEBUG_INFO(323);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1129859294, 2);
...
label_L69062608:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1217860194, 2);
    ...
    BC_ALOAD(8);
    BC_INSTANCEOF(cn1_class_id_java_util_Map);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L433079208, 2);
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1979088869, 2);
    BC_ALOAD(2);
    JUMP_TO(label_L1953089341, 2);
...
label_L433079208:
    ...
    BC_ALOAD(8);
    BC_INSTANCEOF(cn1_class_id_java_util_List);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L533398008, 2);
...
locals[7].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(345);
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1501846707, 2);
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1676552337, 2);
    BC_ALOAD(7);
    PUSH_INT(0); /* ICONST_0 */
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ JUMP_TO(label_L157747315, 2);
...
label_L658947139:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[9].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L905879757, 2);
...
label_L1113747078:
    ...
    BC_ALOAD(6);
    BC_INSTANCEOF(cn1_class_id_java_util_Map);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L382934088, 2);
...
label_L790438788:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L948050650, 2);
    ...
    if (locals[10].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L716442925, 2);
...
label_L716442925:
    ...
    if (locals[11].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L604726639, 2);
    /* LDC: 'com_codename1_properties_PropertyBusinessObject'*/
    PUSH_POINTER((JAVA_OBJECT)&class__com_codename1_properties_PropertyBusinessObject);
    BC_ALOAD(11);
...
label_L625647461:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[13].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L230035651, 2);
...
label_L604726639:
    ...
    BC_ALOAD(9);
    BC_INSTANCEOF(cn1_class_id_java_util_Map);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1354894101, 2);
...
label_L470758061:
    ...
    if (virtual_com_codename1_properties_PropertyBase_getGenericType___R_java_lang_Class(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1514681259, 2);
    ...
    BC_ALOAD(7);
    BC_INSTANCEOF(cn1_class_id_com_codename1_properties_PropertyBusinessObject);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L445776212, 2);
...
label_L1514681259:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L151400576, 2);
...
label_L382934088:
    ...
    if (/* CustomInvoke */virtual_com_codename1_properties_PropertyIndex_setSimpleObject___com_codename1_properties_PropertyBase_java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[4].data.o, locals[6].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L243731145, 2);
...
label_L1279509373:
    ...
    if (/* CustomInvoke */virtual_com_codename1_properties_PropertyBase_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[4].data.o, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2057588642;
...
label_L2057588642:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1640580768;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(484);
    if (virtual_com_codename1_properties_Property_get___R_java_lang_Object(threadStateData, locals[6].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L687185923;
    __CN1_DEBUG_INFO(485);
    if (virtual_com_codename1_properties_Property_getGenericType___R_java_lang_Class(threadStateData, locals[6].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L52563963;
    /* LDC: 'com_codename1_properties_PropertyBusinessObject'*/
    PUSH_POINTER((JAVA_OBJECT)&class__com_codename1_properties_PropertyBusinessObject);
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(790);
    if (get_field_com_codename1_properties_PropertyIndex_parent(__cn1ThisObject)!=get_field_com_codename1_properties_PropertyIndex_parent(locals[2].data.o)) /* IF_ACMPNE CustomJump */ goto label_L281091638;
...
label_L281091638:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L497365138;
    __CN1_DEBUG_INFO(794);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L497365138:
    __CN1_DEBUG_INFO(796);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_properties_PropertyIndex_properties(__cn1ThisObject))!=CN1_ARRAY_LENGTH(get_field_com_codename1_properties_PropertyIndex_properties(locals[2].data.o))) /* IF_ICMPNE CustomJump */ goto label_L131243974;
    __CN1_DEBUG_INFO(797);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L467752021:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_properties_PropertyIndex_properties(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L284576707;
    __CN1_DEBUG_INFO(798);
    if (/* CustomInvoke */virtual_com_codename1_properties_PropertyBase_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_properties_PropertyIndex_properties(__cn1ThisObject), ilocals_3_), CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_properties_PropertyIndex_properties(locals[2].data.o), ilocals_3_))!=0) /* IFNE CustomJump */ goto label_L63556276;
...
label_L131243974:
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_properties_PropertyBusinessObject);
    if(POP_INT() == 0) /* IFEQ */ goto label_L804574747;
...
label_L1367173304:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_properties_PropertyIndex_properties(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L234760309;
    ...
    BC_INSTANCEOF(cn1_class_id_com_codename1_properties_Property);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1076875028;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1076875028;
