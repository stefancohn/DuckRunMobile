...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_ui_Toolbar_isOnTopSideMenu___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1681730990;
    if (com_codename1_ui_Toolbar_isGlobalToolbar___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1389810291;
    ...
    PUSH_INT(8);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1681730990;
...
label_L1681730990:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_CommandWrapper_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1181205697;
...
label_L1181205697:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L798639105;
