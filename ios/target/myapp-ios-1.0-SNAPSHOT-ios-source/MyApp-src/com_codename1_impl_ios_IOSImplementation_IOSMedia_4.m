...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL26468562601;
    int tryBlockOffsetL26468562601;
    DEFINE_CATCH_BLOCK(catch_L26468562601, label_L13692003, restoreToL26468562601);
    int restoreToL1369200302;
    int tryBlockOffsetL1369200302;
    DEFINE_CATCH_BLOCK(catch_L1369200302, label_L13692003, restoreToL1369200302);
    __CN1_DEBUG_INFO(3680);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_IOSMedia_access$2100___com_codename1_impl_ios_IOSImplementation_IOSMedia_R_java_util_List(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_4_this_1(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L94748968, 0);
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L94748968, 0);
...
label_L264685626:
 tryBlockOffsetL26468562601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L26468562601);
    restoreToL26468562601 = threadStateData->threadObjectStackOffset;
...
label_L130111210:
END_TRY(1);    JUMP_TO(label_L1944815218, 0);

label_L13692003:
 tryBlockOffsetL1369200302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L1369200302);
    restoreToL1369200302 = threadStateData->threadObjectStackOffset;
...
label_L1497558532:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L94748968, 0);
