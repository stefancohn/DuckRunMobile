...
JAVA_OBJECT com_codename1_io_Preferences_get___R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(82);
    if (get_static_com_codename1_io_Preferences_p(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1938005794;
    __CN1_DEBUG_INFO(83);
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L353562601;
    __CN1_DEBUG_INFO(84);
    PUSH_OBJ(com_codename1_io_Storage_getInstance___R_com_codename1_io_Storage(threadStateData));
...
JAVA_VOID com_codename1_io_Preferences_set___java_lang_String_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2093474881;
...
JAVA_VOID com_codename1_io_Preferences_set___java_lang_String_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1715635474;
...
JAVA_OBJECT com_codename1_io_Preferences_get___java_lang_String_java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2051550010;
...
JAVA_LONG com_codename1_io_Preferences_get___java_lang_String_long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_LONG __cn1Arg2) {
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L5092445;
...
JAVA_BOOLEAN com_codename1_io_Preferences_get___java_lang_String_boolean_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1034327311;
...
JAVA_VOID com_codename1_io_Preferences_fireChange___java_lang_String_java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[1].data.o==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1114131846;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1168134992;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L1114131846;

label_L1168134992:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L2104139102;
...
label_L2104139102:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1961718033;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1961718033;
...
label_L1953044087:
    if (ilocals_5_<0) /* IFLT CustomJump */ goto label_L1961718033;
