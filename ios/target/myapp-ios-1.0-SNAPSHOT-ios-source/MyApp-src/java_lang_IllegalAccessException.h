...
extern void __INIT_VTABLE_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_java_lang_IllegalAccessException(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT java_lang_IllegalAccessException_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_lang_IllegalAccessException_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_lang_IllegalAccessException_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_lang_IllegalAccessException_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
struct obj__java_lang_IllegalAccessException {
    DEBUG_GC_VARIABLES
