...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(786);
    if (locals[3].data.o==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L745642964;
...
label_L1403664574:
    ...
    if (get_field_com_codename1_ui_Display_EdtException_parent(locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L933293116;
    __CN1_DEBUG_INFO(793);
    if (/* CustomInvoke */virtual_java_util_HashSet_contains___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, get_field_com_codename1_ui_Display_EdtException_parent(locals[3].data.o))==0) /* IFEQ CustomJump */ goto label_L1110103522;
...
locals[3].type=CN1_TYPE_OBJECT;    goto label_L1403664574;
