...
JAVA_VOID com_example_util_SaveScores___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10315, 205);
...
JAVA_VOID com_example_util_SaveScores_saveScore__(CODENAME_ONE_THREAD_STATE) {
    ...
    __STATIC_INITIALIZER_com_example_util_SaveScores(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 10315, 10316);
    __CN1_DEBUG_INFO(12);
...
JAVA_OBJECT com_example_util_SaveScores_isTop5___int_R_java_lang_Boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_example_util_SaveScores(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 10315, 10317);
...
label_L854653864:
    if (ilocals_1_<virtual_java_util_ArrayList_size___R_int(threadStateData, get_static_com_example_util_SaveScores_highscores(threadStateData))) /* IF_IMPLT CustomJump */ goto label_L703555670;
    __CN1_DEBUG_INFO(33);
...
JAVA_OBJECT com_example_util_SaveScores_readScores___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    __STATIC_INITIALIZER_com_example_util_SaveScores(threadStateData);
    DEFINE_METHOD_STACK(3, 4, 0, 10315, 10318);
    __CN1_DEBUG_INFO(37);
...
label_L1068445309:
    __CN1_DEBUG_INFO(41);
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L73698537;
    __CN1_DEBUG_INFO(48);
    if (virtual_java_lang_String_isEmpty___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L179808568;
    __CN1_DEBUG_INFO(49);
    BC_ALOAD(0);
...
JAVA_VOID com_example_util_SaveScores_cleanScores__(CODENAME_ONE_THREAD_STATE) {
    volatile JAVA_INT ilocals_0_ = 0; /* v0 */
    __STATIC_INITIALIZER_com_example_util_SaveScores(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 10315, 10319);
    __CN1_DEBUG_INFO(56);
    PUSH_POINTER(get_static_com_example_util_SaveScores_highscores(threadStateData));
...
label_L1632789609:
    if (ilocals_0_>4/* ICONST_4 */) /* IF_ICMPGT CustomJump */ goto label_L659059448;
...
JAVA_VOID com_example_util_SaveScores_saveScores__(CODENAME_ONE_THREAD_STATE) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    __STATIC_INITIALIZER_com_example_util_SaveScores(threadStateData);
    DEFINE_METHOD_STACK(3, 3, 0, 10315, 10320);
    __CN1_DEBUG_INFO(65);
    PUSH_POINTER(get_static_com_example_util_SaveScores_highscores(threadStateData));
    PUSH_OBJ(java_util_Collections_reverseOrder___R_java_util_Comparator(threadStateData));
    java_util_Collections_sort___java_util_List_java_util_Comparator(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    __CN1_DEBUG_INFO(66);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_static_com_example_util_SaveScores_highscores(threadStateData))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L124494140;
    __CN1_DEBUG_INFO(67);
...
label_L124494140:
    ...
    BC_ASTORE(0);
    __CN1_DEBUG_INFO(72);
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_ArrayList_iterator___R_java_util_Iterator(threadStateData, get_static_com_example_util_SaveScores_highscores(threadStateData));locals[2].type=CN1_TYPE_OBJECT;    goto label_L246826139;
...
label_L2083854344:
    ...
    BC_ISTORE(1);
    __CN1_DEBUG_INFO(73);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, locals[0].data.o, ilocals_1_);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(536));     SP -= 1;

label_L246826139:
    __CN1_DEBUG_INFO(72);
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L2083854344;
    __CN1_DEBUG_INFO(75);
    PUSH_OBJ(com_codename1_io_Storage_getInstance___R_com_codename1_io_Storage(threadStateData));
    /* LDC: 'highscores'*/
