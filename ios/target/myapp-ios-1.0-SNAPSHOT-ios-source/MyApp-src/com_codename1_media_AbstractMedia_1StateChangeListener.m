...
JAVA_VOID com_codename1_media_AbstractMedia_1StateChangeListener_actionPerformed___com_codename1_media_AsyncMedia_MediaStateChangeEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_media_AsyncMedia_PlayRequest_isDone___R_boolean(threadStateData, get_field_com_codename1_media_AbstractMedia_1StateChangeListener_val_out(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1039430632;
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1039430632;
    ...
    if (get_field_com_codename1_media_AbstractMedia_1StateChangeListener_onError(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1304495746;
