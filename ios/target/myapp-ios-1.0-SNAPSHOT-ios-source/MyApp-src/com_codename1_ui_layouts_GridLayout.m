...
JAVA_VOID com_codename1_ui_layouts_GridLayout___INIT_____int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __CN1_DEBUG_INFO(95);
    if (ilocals_1_<1 /* ICONST_1 */) /* IF_IMPLT CustomJump */ goto label_L471031651;
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L104615190;
...
JAVA_VOID com_codename1_ui_layouts_GridLayout___INIT_____int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (ilocals_1_<1 /* ICONST_1 */) /* IF_IMPLT CustomJump */ goto label_L700262294;
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L390827278;
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_isLandscapeMode___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_layouts_GridLayout_landscapeRows(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L287649987;
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L287649987;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_autoSizeCols___com_codename1_ui_Container_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    if (virtual_com_codename1_ui_layouts_GridLayout_isAutoFit___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L894735295;
...
label_L1177018330:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2126273510;
    ...
    __CN1_DEBUG_INFO(169);
    BC_IINC(6, 1);
    goto label_L1177018330;

label_L2126273510:
    __CN1_DEBUG_INFO(174);
    if (ilocals_2_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L523461097;
...
label_L1790250268:
    ...
    if ((ilocals_4_ % get_field_com_codename1_ui_layouts_GridLayout_landscapeColumns(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L894735295;
    if (ilocals_4_<=get_field_com_codename1_ui_layouts_GridLayout_landscapeColumns(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L894735295;
...
label_L250331355:
    ...
    if (ilocals_5_>0) /* IFGT CustomJump */ goto label_L1846347146;
...
label_L1051786632:
    ...
    if ((ilocals_4_ % get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L894735295;
    if (ilocals_4_<=get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L894735295;
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L182203204;
...
label_L1212351214:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ goto label_L1315209017;
...
label_L1315209017:
    ...
    if (ilocals_5_<=(ilocals_7_ * ilocals_8_)) /* IF_ICMPLE CustomJump */ goto label_L2004981696;
    ...
    if ((ilocals_5_ % ilocals_8_)!=0) /* IFNE CustomJump */ goto label_L472702055;
    PUSH_INT(0); /* ICONST_0 */
...
label_L457596841:
    if (ilocals_17_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1511814681;
    ...
    if (get_field_com_codename1_ui_layouts_GridLayout_hideZeroSized(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L547964633;
    __CN1_DEBUG_INFO(249);
    if (virtual_com_codename1_ui_Component_isHidden___R_boolean(threadStateData, locals[18].data.o)==0) /* IFEQ CustomJump */ goto label_L547964633;
...
label_L1966657510:
    ...
    if (((ilocals_16_ + 1 /* ICONST_1 */) % ilocals_8_)!=0) /* IFNE CustomJump */ goto label_L525193238;
    __CN1_DEBUG_INFO(262);
    BC_IINC(15, 1);
    __CN1_DEBUG_INFO(265);
    if (get_field_com_codename1_ui_layouts_GridLayout_fillLastRow(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L525193238;
    if (ilocals_15_!=(ilocals_7_ - 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ goto label_L525193238;
    __CN1_DEBUG_INFO(266);
    /* VarOp.assignFrom */ ilocals_12_=(ilocals_5_ % ilocals_8_);
    __CN1_DEBUG_INFO(267);
    if (ilocals_12_!=0) /* IFNE CustomJump */ goto label_L963585828;
...
label_L1502502072:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L682812632;
...
label_L682812632:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L429393578;
...
label_L806005031:
    ...
    if (ilocals_7_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L262217690;
    __CN1_DEBUG_INFO(303);
    /* VarOp.assignFrom */ ilocals_2_=(ilocals_2_ * ilocals_7_);

label_L262217690:
    __CN1_DEBUG_INFO(306);
    if (ilocals_6_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L618785034;
    __CN1_DEBUG_INFO(307);
    if (ilocals_4_<=(ilocals_6_ * ilocals_7_)) /* IF_ICMPLE CustomJump */ goto label_L2106922602;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    if ((ilocals_4_ % ilocals_7_)!=0) /* IFNE CustomJump */ goto label_L414440302;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L535517293;
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L879319843;
    if (virtual_com_codename1_ui_layouts_GridLayout_getRows___R_int(threadStateData, locals[1].data.o)!=virtual_com_codename1_ui_layouts_GridLayout_getRows___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L879319843;
    BC_ALOAD(1);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L879319843;
    if (get_field_com_codename1_ui_layouts_GridLayout_autoFit(locals[1].data.o)!=get_field_com_codename1_ui_layouts_GridLayout_autoFit(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L879319843;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1629105538;
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_obscuresPotential___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, locals[1].data.o)==(get_field_com_codename1_ui_layouts_GridLayout_portraitRows(__cn1ThisObject) * get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L1735717476;
    if (get_field_com_codename1_ui_layouts_GridLayout_autoFit(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L580515543;
