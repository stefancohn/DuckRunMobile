...
JAVA_VOID com_codename1_ui_layouts_GridLayout___INIT_____int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 6093, 205);
    ...
    __CN1_DEBUG_INFO(95);
    if (ilocals_1_<1 /* ICONST_1 */) /* IF_IMPLT CustomJump */ goto label_L1177018330;
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L523461097;

label_L1177018330:
    __CN1_DEBUG_INFO(96);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6094));     SP -= 1;
...
JAVA_VOID com_codename1_ui_layouts_GridLayout___INIT_____int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 6093, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    if (ilocals_1_<1 /* ICONST_1 */) /* IF_IMPLT CustomJump */ goto label_L250331355;
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L303352203;
...
JAVA_VOID com_codename1_ui_layouts_GridLayout___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 6093, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT com_codename1_ui_layouts_GridLayout_autoFit___R_com_codename1_ui_layouts_GridLayout(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_GridLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 6093, 6095);
...
JAVA_OBJECT com_codename1_ui_layouts_GridLayout_encloseIn___com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_GridLayout(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 6093, 3321);
...
JAVA_OBJECT com_codename1_ui_layouts_GridLayout_encloseIn___int_com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_layouts_GridLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 6093, 3321);
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_isLandscapeMode___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 6093, 6096);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(162);
    if (get_field_com_codename1_ui_layouts_GridLayout_landscapeRows(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1790250268;
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L1790250268;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_autoSizeCols___com_codename1_ui_Container_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 6093, 6097);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(166);
    if (virtual_com_codename1_ui_layouts_GridLayout_isAutoFit___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1051786632;
...
label_L1212351214:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L182203204;
    ...
    __CN1_DEBUG_INFO(169);
    BC_IINC(6, 1);
    goto label_L1212351214;

label_L182203204:
    __CN1_DEBUG_INFO(174);
    if (ilocals_2_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1315209017;
...
label_L1315209017:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L2004981696;
    __CN1_DEBUG_INFO(179);
    if (ilocals_5_>0) /* IFGT CustomJump */ goto label_L472702055;
...
label_L1277753726:
    ...
    if ((ilocals_4_ % get_field_com_codename1_ui_layouts_GridLayout_landscapeColumns(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1051786632;
    if (ilocals_4_<=get_field_com_codename1_ui_layouts_GridLayout_landscapeColumns(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1051786632;
...
label_L1511814681:
    ...
    if ((ilocals_4_ % get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1051786632;
    if (ilocals_4_<=get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1051786632;
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 22, 0, 6093, 3370);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L547964633;
...
label_L725727419:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ goto label_L1286460628;
...
label_L1286460628:
    ...
    if (ilocals_5_<=(ilocals_7_ * ilocals_8_)) /* IF_ICMPLE CustomJump */ goto label_L1966657510;
    ...
    if ((ilocals_5_ % ilocals_8_)!=0) /* IFNE CustomJump */ goto label_L525193238;
    PUSH_INT(0); /* ICONST_0 */
...
label_L414440302:
    if (ilocals_17_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L682812632;
    ...
    if (get_field_com_codename1_ui_layouts_GridLayout_hideZeroSized(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1502502072;
    __CN1_DEBUG_INFO(249);
    if (virtual_com_codename1_ui_Component_isHidden___R_boolean(threadStateData, locals[18].data.o)==0) /* IFEQ CustomJump */ goto label_L1502502072;
...
label_L1502502072:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ goto label_L806005031;
...
label_L262217690:
    ...
    if (((ilocals_16_ + 1 /* ICONST_1 */) % ilocals_8_)!=0) /* IFNE CustomJump */ goto label_L618785034;
    __CN1_DEBUG_INFO(262);
    BC_IINC(15, 1);
    __CN1_DEBUG_INFO(265);
    if (get_field_com_codename1_ui_layouts_GridLayout_fillLastRow(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L618785034;
    if (ilocals_15_!=(ilocals_7_ - 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ goto label_L618785034;
    __CN1_DEBUG_INFO(266);
    /* VarOp.assignFrom */ ilocals_12_=(ilocals_5_ % ilocals_8_);
    __CN1_DEBUG_INFO(267);
    if (ilocals_12_!=0) /* IFNE CustomJump */ goto label_L2106922602;
...
JAVA_OBJECT com_codename1_ui_layouts_GridLayout_getPreferredSize___com_codename1_ui_Container_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 6093, 2452);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L879319843:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L535517293;
...
label_L535517293:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1629105538;
...
label_L1735717476:
    ...
    if (ilocals_7_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L580515543;
    __CN1_DEBUG_INFO(303);
    /* VarOp.assignFrom */ ilocals_2_=(ilocals_2_ * ilocals_7_);

label_L580515543:
    __CN1_DEBUG_INFO(306);
    if (ilocals_6_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1557594596;
    __CN1_DEBUG_INFO(307);
    if (ilocals_4_<=(ilocals_6_ * ilocals_7_)) /* IF_ICMPLE CustomJump */ goto label_L1821462977;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    if ((ilocals_4_ % ilocals_7_)!=0) /* IFNE CustomJump */ goto label_L741767653;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1106513402;
...
JAVA_INT com_codename1_ui_layouts_GridLayout_getColumns___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6093, 4133);
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6093, 244);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(344);
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L625540097;
    if (virtual_com_codename1_ui_layouts_GridLayout_getRows___R_int(threadStateData, locals[1].data.o)!=virtual_com_codename1_ui_layouts_GridLayout_getRows___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L625540097;
    BC_ALOAD(1);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L625540097;
    if (get_field_com_codename1_ui_layouts_GridLayout_autoFit(locals[1].data.o)!=get_field_com_codename1_ui_layouts_GridLayout_autoFit(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L625540097;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_setFillLastRow___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6093, 6100);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_isAutoFit___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6093, 6101);
...
JAVA_VOID com_codename1_ui_layouts_GridLayout_setAutoFit___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6093, 6102);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_layouts_GridLayout_obscuresPotential___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 6093, 3425);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(388);
    if (virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, locals[1].data.o)==(get_field_com_codename1_ui_layouts_GridLayout_portraitRows(__cn1ThisObject) * get_field_com_codename1_ui_layouts_GridLayout_portraitColumns(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L1557602018;
    if (get_field_com_codename1_ui_layouts_GridLayout_autoFit(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1034769247;
