...
JAVA_VOID com_codename1_ui_Toolbar_16_scrollChanged___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    int restoreToL80884712601;
    int tryBlockOffsetL80884712601;
    DEFINE_CATCH_BLOCK(catch_L80884712601, label_L201421173, restoreToL80884712601);
    int restoreToL206278023802;
    int tryBlockOffsetL206278023802;
    DEFINE_CATCH_BLOCK(catch_L206278023802, label_L201421173, restoreToL206278023802);
    int restoreToL20142117303;
    int tryBlockOffsetL20142117303;
    DEFINE_CATCH_BLOCK(catch_L20142117303, label_L201421173, restoreToL20142117303);
    __CN1_DEBUG_INFO(2360);
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$500___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1436347886, 0);
    if (virtual_com_codename1_ui_Container_isTensileMotionInProgress___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_val_contentPane(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L406265225, 0);
...
label_L808847126:
 tryBlockOffsetL80884712601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L80884712601);
    restoreToL80884712601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(2367);
    /* VarOp.assignFrom */ ilocals_5_=(ilocals_2_ - ilocals_4_);
    __CN1_DEBUG_INFO(2368);
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1329572464, 1);
...
label_L1329572464:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ JUMP_TO(label_L1211297851, 1);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, ilocals_6_)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2062780238, 0);
...
label_L2062780238:
 tryBlockOffsetL206278023802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L206278023802);
    restoreToL206278023802 = threadStateData->threadObjectStackOffset;
    ...
    if (ilocals_6_==virtual_com_codename1_ui_Toolbar_getY___R_int(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1518868172, 1);
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$800___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1750490055, 1);
...
END_TRY(1);    __CN1_DEBUG_INFO(2395);
    ...
    JUMP_TO(label_L934993374, 0);

label_L201421173:
 tryBlockOffsetL20142117303 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L20142117303);
    restoreToL20142117303 = threadStateData->threadObjectStackOffset;
