...
JAVA_OBJECT com_codename1_processing_Result_fromContent___com_codename1_processing_StructuredContent_boolean_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_processing_Result(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 7577, 7578);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    __CN1_DEBUG_INFO(121);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1629827491;
    __CN1_DEBUG_INFO(122);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7579));     SP -= 1;
...
JAVA_OBJECT com_codename1_processing_Result_fromContent___com_codename1_processing_StructuredContent_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_processing_Result(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 7577, 7578);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_processing_Result___INIT_____com_codename1_processing_StructuredContent_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7577, 205);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L981716924;
    __CN1_DEBUG_INFO(152);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7580));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L981716924:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1805632967;
    if (virtual_com_codename1_processing_StructuredContent_getParent___R_com_codename1_processing_StructuredContent(threadStateData, get_field_com_codename1_processing_Result_root(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1805632967;
...
JAVA_OBJECT com_codename1_processing_Result_fromContent___java_lang_String_java_lang_String_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_processing_Result(threadStateData);
    DEFINE_METHOD_STACK(6, 3, 0, 7577, 7578);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1340744662cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1340744662cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1340744662cn1_class_id_java_io_IOException1, label_L600865491, restoreToL1340744662cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(175);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1798373155, 0);
...
label_L1798373155:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1340744662, 0);
    __CN1_DEBUG_INFO(179);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7581));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1340744662:
 tryBlockOffsetL1340744662cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1340744662cn1_class_id_java_io_IOException1);
    restoreToL1340744662cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_processing_Result_fromContent___java_io_Reader_java_lang_String_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_processing_Result(threadStateData);
    DEFINE_METHOD_STACK(4, 3, 0, 7577, 7578);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(259);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L527252097;
...
label_L527252097:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1679592356;
...
label_L1679592356:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(150), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1382446710;
    ...
    BC_ASTORE(2);
    goto label_L1968544985;

label_L1382446710:
    __CN1_DEBUG_INFO(268);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(149), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L60426688;
...
JAVA_INT com_codename1_processing_Result_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7577, 885);
...
JAVA_BOOLEAN com_codename1_processing_Result_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7577, 880);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_processing_Result_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7577, 899);
...
JAVA_INT com_codename1_processing_Result_getAsInteger___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7577, 7584);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L694762269;
    __CN1_DEBUG_INFO(403);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L694762269:
    __CN1_DEBUG_INFO(405);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[2].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L975328564;
...
JAVA_OBJECT com_codename1_processing_Result_getAsString___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7577, 7585);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1411531045;
...
JAVA_OBJECT com_codename1_processing_Result__internalGet___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7577, 7586);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L267039662;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L580904875;
...
JAVA_OBJECT com_codename1_processing_Result_getAsStringArray___java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 7577, 7588);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1266713639;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L377458755;
...
label_L523699314:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1735523369;
...
JAVA_OBJECT com_codename1_processing_Result__internalGetAsArray___java_lang_String_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 7577, 7594);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1714613017;
...
label_L1714613017:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L70104063;
...
label_L70104063:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1519757998;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1519757998;
...
label_L1519757998:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5210))==0) /* IFEQ CustomJump */ goto label_L85583486;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1946337255;
...
label_L85583486:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(93);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L492394707;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L492394707;
...
JAVA_OBJECT com_codename1_processing_Result_apply___com_codename1_processing_StructuredContent_java_util_List_int_R_com_codename1_processing_StructuredContent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 20, 0, 7577, 7595);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1785610508;
...
label_L1785610508:
    ...
    if (ilocals_3_<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L537813033;
...
label_L1519656884:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1091702344;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[7].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L375019897;
    BC_ALOAD(7);
    PUSH_INT(0); /* ICONST_0 */
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L375019897;
    __CN1_DEBUG_INFO(948);
    goto label_L245632159;

label_L375019897:
    __CN1_DEBUG_INFO(950);
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[7].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1568156234;
    __CN1_DEBUG_INFO(951);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[7].data.o, get_static_com_codename1_processing_Result_SELECT_GLOB(threadStateData))==0) /* IFEQ CustomJump */ goto label_L214507491;
...
label_L214507491:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[7].data.o, get_static_com_codename1_processing_Result_SELECT_PARENT(threadStateData))==0) /* IFEQ CustomJump */ goto label_L1568156234;
...
label_L1568156234:
    ...
    if ((ilocals_6_ + 1 /* ICONST_1 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1209802386;
...
label_L1209802386:
    ...
    SP--;
    switch((*SP).data.i) {
        case 47: goto label_L1727144954;
        case 91: goto label_L2059697940;
        default: goto label_L245632159;
    }

label_L1727144954:
    __CN1_DEBUG_INFO(967);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1052131752;
    __CN1_DEBUG_INFO(968);
    /* VarOp.assignFrom */ locals[10].data.o = /* CustomInvoke */virtual_com_codename1_processing_StructuredContent_getDescendants___java_lang_String_R_java_util_List(threadStateData, locals[1].data.o, locals[7].data.o);locals[10].type=CN1_TYPE_OBJECT;    goto label_L385228898;
...
label_L385228898:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[10].data.o)<=0) /* IFLE CustomJump */ goto label_L1642867893;
...
label_L2059697940:
    ...
    if ((ilocals_6_ + 2 /* ICONST_2 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L948552515;
...
label_L948552515:
    ...
    if ((ilocals_6_ + 3 /* ICONST_3 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L884899579;
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7597));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L884899579:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[13].data.o)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L325889342;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[13].data.o, 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    PUSH_INT(93);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L325889342;
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7598));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L325889342:
    ...
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L333820514;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[14].data.o)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L333820514;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[14].data.o, 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    PUSH_INT(47);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L333820514;
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7599));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, locals[13].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_toString___R_java_lang_String(threadStateData, SP[-1].data.o);
...
label_L333820514:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1694558342;
    __CN1_DEBUG_INFO(1010);
    /* VarOp.assignFrom */ locals[14].data.o = /* CustomInvoke */virtual_com_codename1_processing_StructuredContent_getDescendants___java_lang_String_R_java_util_List(threadStateData, locals[1].data.o, locals[7].data.o);locals[14].type=CN1_TYPE_OBJECT;    goto label_L571349883;
...
label_L571349883:
    ...
    BC_ALOAD(15);
    BC_INSTANCEOF(cn1_class_id_com_codename1_processing_StructuredContent);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1425889113;
...
label_L1425889113:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L245632159;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[15].data.o)<=0) /* IFLE CustomJump */ goto label_L245632159;
...
label_L143853598:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[17].data.o)==0) /* IFEQ CustomJump */ goto label_L1781893382;
...
JAVA_VOID com_codename1_processing_Result___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 7577, 863);
    __CN1_DEBUG_INFO(103);
    set_static_com_codename1_processing_Result_SELECT_GLOB(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(16));
    __CN1_DEBUG_INFO(104);
    set_static_com_codename1_processing_Result_SELECT_PARENT(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(3649));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
