...
JAVA_VOID com_codename1_io_NetworkManager_1___INIT_____com_codename1_io_NetworkManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3232, 205);
...
JAVA_VOID com_codename1_io_NetworkManager_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 3232, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1954592717cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1954592717cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1954592717cn1_class_id_java_lang_InterruptedException1, label_L1204785709, restoreToL1954592717cn1_class_id_java_lang_InterruptedException1);
    int restoreToL611017319cn1_class_id_java_lang_InterruptedException2;
    int tryBlockOffsetL611017319cn1_class_id_java_lang_InterruptedException2;
    DEFINE_CATCH_BLOCK(catch_L611017319cn1_class_id_java_lang_InterruptedException2, label_L1801753119, restoreToL611017319cn1_class_id_java_lang_InterruptedException2);

label_L99722180:
    __CN1_DEBUG_INFO(528);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1134388380, 0);

label_L1954592717:
 tryBlockOffsetL1954592717cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1954592717cn1_class_id_java_lang_InterruptedException1);
    restoreToL1954592717cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1850169748:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1436741771, 0);
...
label_L1977202492:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L446264394, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L839404033, 0);
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeout___R_int(threadStateData, locals[4].data.o)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1725382189, 0);
...
label_L1725382189:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L839404033, 0);
...
label_L611017319:
 tryBlockOffsetL611017319cn1_class_id_java_lang_InterruptedException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L611017319cn1_class_id_java_lang_InterruptedException2);
    restoreToL611017319cn1_class_id_java_lang_InterruptedException2 = threadStateData->threadObjectStackOffset;
...
label_L607370452:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(4);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L839404033, 0);
    __CN1_DEBUG_INFO(559);
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L839404033, 0);
    __CN1_DEBUG_INFO(561);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L839404033, 0);
...
label_L839404033:
    __CN1_DEBUG_INFO(540);
    BC_IINC(3, 1);
    JUMP_TO(label_L1977202492, 0);

label_L446264394:
    __CN1_DEBUG_INFO(570);
    JUMP_TO(label_L99722180, 0);
