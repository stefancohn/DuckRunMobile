...
JAVA_VOID com_codename1_ui_Display_DebugRunnable___INIT_____com_codename1_ui_Display_java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Display_DebugRunnable_parentContext(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1764622989;
...
label_L1764622989:
    ...
    if (virtual_com_codename1_ui_Display_isEnableAsyncStackTraces___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1714007305;
    ...
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1048332309;
...
JAVA_VOID com_codename1_ui_Display_DebugRunnable_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL491591201cn1_class_id_java_lang_RuntimeException1;
    int tryBlockOffsetL491591201cn1_class_id_java_lang_RuntimeException1;
    DEFINE_CATCH_BLOCK(catch_L491591201cn1_class_id_java_lang_RuntimeException1, label_L668929853, restoreToL491591201cn1_class_id_java_lang_RuntimeException1);
...
label_L491591201:
 tryBlockOffsetL491591201cn1_class_id_java_lang_RuntimeException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L491591201cn1_class_id_java_lang_RuntimeException1);
    restoreToL491591201cn1_class_id_java_lang_RuntimeException1 = threadStateData->threadObjectStackOffset;
