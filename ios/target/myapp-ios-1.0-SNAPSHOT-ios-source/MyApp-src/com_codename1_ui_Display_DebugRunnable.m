...
JAVA_VOID com_codename1_ui_Display_DebugRunnable___INIT_____com_codename1_ui_Display_java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 9207, 205);
    ...
    if (get_field_com_codename1_ui_Display_DebugRunnable_parentContext(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1713453581;
...
label_L1713453581:
    ...
    if (virtual_com_codename1_ui_Display_isEnableAsyncStackTraces___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L178575564;
    ...
    if (get_field_com_codename1_ui_Display_DebugRunnable_parentContext(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1018742990;
    __CN1_DEBUG_INFO(831);
    PUSH_INT(get_field_com_codename1_ui_Display_DebugRunnable_depth(__cn1ThisObject));
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L534643569;
...
JAVA_VOID com_codename1_ui_Display_DebugRunnable_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9207, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1871319536cn1_class_id_java_lang_RuntimeException1;
    int tryBlockOffsetL1871319536cn1_class_id_java_lang_RuntimeException1;
    DEFINE_CATCH_BLOCK(catch_L1871319536cn1_class_id_java_lang_RuntimeException1, label_L1891673045, restoreToL1871319536cn1_class_id_java_lang_RuntimeException1);
    __CN1_DEBUG_INFO(846);
    if (get_field_com_codename1_ui_Display_DebugRunnable_exceptionWrapper(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1552836537, 0);

label_L1871319536:
 tryBlockOffsetL1871319536cn1_class_id_java_lang_RuntimeException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L1871319536cn1_class_id_java_lang_RuntimeException1);
    restoreToL1871319536cn1_class_id_java_lang_RuntimeException1 = threadStateData->threadObjectStackOffset;
