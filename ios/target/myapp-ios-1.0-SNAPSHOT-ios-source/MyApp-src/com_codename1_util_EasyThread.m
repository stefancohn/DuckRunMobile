...
JAVA_VOID com_codename1_util_EasyThread_run___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L97862555101, label_L121548383, restoreToL97862555101);
...
JAVA_VOID com_codename1_util_EasyThread_kill__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL22729060001;
    int tryBlockOffsetL22729060001;
    DEFINE_CATCH_BLOCK(catch_L22729060001, label_L1436082162, restoreToL22729060001);
...
label_L227290600:
 tryBlockOffsetL22729060001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L22729060001);
    restoreToL22729060001 = threadStateData->threadObjectStackOffset;
