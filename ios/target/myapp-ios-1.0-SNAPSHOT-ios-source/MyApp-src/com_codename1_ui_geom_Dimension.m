...
JAVA_BOOLEAN com_codename1_ui_geom_Dimension_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L705801739;
    if (get_field_com_codename1_ui_geom_Dimension_width(locals[1].data.o)!=get_field_com_codename1_ui_geom_Dimension_width(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L705801739;
    if (get_field_com_codename1_ui_geom_Dimension_height(locals[1].data.o)!=get_field_com_codename1_ui_geom_Dimension_height(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L705801739;
    PUSH_INT(1); /* ICONST_1 */
