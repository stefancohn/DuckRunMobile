...
JAVA_VOID com_codename1_ui_Container_3_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL143843920201;
    int tryBlockOffsetL143843920201;
    DEFINE_CATCH_BLOCK(catch_L143843920201, label_L479160976, restoreToL143843920201);
    __CN1_DEBUG_INFO(951);
    if (get_field_com_codename1_ui_Container_3_alreadyAdded(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L810593327, 0);

label_L1438439202:
 tryBlockOffsetL143843920201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L143843920201);
    restoreToL143843920201 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_ui_Container_3_val_constraint(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L643552582, 1);
