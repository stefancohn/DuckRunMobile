...
JAVA_VOID com_codename1_ui_Container_3_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL61884436901;
    int tryBlockOffsetL61884436901;
    DEFINE_CATCH_BLOCK(catch_L61884436901, label_L525551643, restoreToL61884436901);
...
label_L618844369:
 tryBlockOffsetL61884436901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L61884436901);
    restoreToL61884436901 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_ui_Container_3_val_constraint(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L669501311, 1);
