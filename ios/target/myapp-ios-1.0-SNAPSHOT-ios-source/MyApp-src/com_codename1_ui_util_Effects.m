...
JAVA_OBJECT com_codename1_ui_util_Effects_verticalPerspective___com_codename1_ui_Image_float_float_float_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    if (CN1_CMP_EXPR(flocals_2_, flocals_1_)>=0) /* IFGE CustomJump */ goto label_L954742840;
...
label_L964895360:
    ...
    if (ilocals_7_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1231469233;
    __CN1_DEBUG_INFO(157);
    /* VarOp.assignFrom */     ilocals_11_ = 0 /* ICONST_0 */; 

label_L1520921298:
    if (ilocals_11_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L2131723476;
...
label_L652803980:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L115297013;
...
label_L622625093:
    if (ilocals_11_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L1494051958;
...
label_L1150063356:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L628694336;
