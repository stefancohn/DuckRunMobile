...
JAVA_VOID com_codename1_util_CallbackDispatcher_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_util_CallbackDispatcher_success(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1250685404;
    __CN1_DEBUG_INFO(53);
...
label_L1250685404:
    __CN1_DEBUG_INFO(54);
    if (get_field_com_codename1_util_CallbackDispatcher_failure(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1638556416;
    __CN1_DEBUG_INFO(55);
...
JAVA_VOID com_codename1_util_CallbackDispatcher_dispatchError___com_codename1_util_FailureCallback_java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1783594007;
    __CN1_DEBUG_INFO(87);
    BC_ALOAD(0);
    BC_ALOAD(0);
    BC_ALOAD(1);
