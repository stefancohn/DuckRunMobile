#ifndef __JAVA_IO_NSLOGOUTPUTSTREAM__
#define __JAVA_IO_NSLOGOUTPUTSTREAM__

#include "cn1_globals.h"
#include "java_io_OutputStream.h"
extern struct clazz class__java_io_NSLogOutputStream;
extern void __INIT_VTABLE_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_java_io_NSLogOutputStream(CODENAME_ONE_THREAD_STATE);
...
JAVA_VOID java_io_NSLogOutputStream_write___byte_1ARRAY_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3);
...
JAVA_INT java_io_NSLogOutputStream_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_io_NSLogOutputStream_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_io_NSLogOutputStream_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_OBJECT java_io_NSLogOutputStream_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_io_NSLogOutputStream_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
struct obj__java_io_NSLogOutputStream {
    DEBUG_GC_VARIABLES
...
#endif //__JAVA_IO_NSLOGOUTPUTSTREAM__
