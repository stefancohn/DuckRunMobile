...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_8___INIT_____com_codename1_impl_ios_IOSImplementation_com_codename1_ui_Component_com_codename1_ui_plaf_Style_boolean_com_codename1_ui_plaf_Style_com_codename1_impl_ios_IOSImplementation_NativeFont_int_int_java_lang_String_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_OBJECT __cn1Arg6, JAVA_INT __cn1Arg7, JAVA_INT __cn1Arg8, JAVA_OBJECT __cn1Arg9, JAVA_BOOLEAN __cn1Arg10) {
    DEFINE_INSTANCE_METHOD_STACK(2, 11, 0, 9632, 205);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_8_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL145711011101;
    int tryBlockOffsetL145711011101;
    DEFINE_CATCH_BLOCK(catch_L145711011101, label_L1555793073, restoreToL145711011101);
    int restoreToL155579307302;
    int tryBlockOffsetL155579307302;
    DEFINE_CATCH_BLOCK(catch_L155579307302, label_L1555793073, restoreToL155579307302);
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(899);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L46627301, 0);
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9633), 1 /* ICONST_1 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L46627301, 0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject)));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_TextArea_getHint___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ JUMP_TO(label_L46627301, 0);
...
label_L46627301:
    ...
    if (virtual_com_codename1_impl_ios_IOSImplementation_isAsyncEditMode___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1787083818, 0);
...
label_L1457110111:
 tryBlockOffsetL145711011101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L145711011101);
    restoreToL145711011101 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(910);
    ...
    JUMP_TO(label_L1367594377, 0);

label_L1555793073:
 tryBlockOffsetL155579307302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L155579307302);
    restoreToL155579307302 = threadStateData->threadObjectStackOffset;
...
label_L1787083818:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_val_cmp(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(9634))!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1360878852, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1747721875, 0);
...
label_L1747721875:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L654740048, 0);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getProperty___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9634), STRING_FROM_CONSTANT_POOL_OFFSET(266));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L654740048, 0);
    __CN1_DEBUG_INFO(916);
    /* VarOp.assignFrom */     ilocals_11_ = 0 /* ICONST_0 */; 

label_L654740048:
    __CN1_DEBUG_INFO(918);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1759915172, 0);
    ...
    /* LDC: 'blockCopyPaste'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(710));
