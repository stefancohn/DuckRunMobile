...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_8_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL57141993101;
    int tryBlockOffsetL57141993101;
    DEFINE_CATCH_BLOCK(catch_L57141993101, label_L1395173825, restoreToL57141993101);
    int restoreToL139517382502;
    int tryBlockOffsetL139517382502;
    DEFINE_CATCH_BLOCK(catch_L139517382502, label_L1395173825, restoreToL139517382502);
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(899);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1534655921, 0);
...
label_L1534655921:
    ...
    if (virtual_com_codename1_impl_ios_IOSImplementation_isAsyncEditMode___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1220524164, 0);
...
label_L571419931:
 tryBlockOffsetL57141993101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L57141993101);
    restoreToL57141993101 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(910);
    ...
    JUMP_TO(label_L291847739, 0);

label_L1395173825:
 tryBlockOffsetL139517382502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L139517382502);
    restoreToL139517382502 = threadStateData->threadObjectStackOffset;
...
label_L1220524164:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_val_cmp(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(9644))!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L118881143, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L463215441, 0);
...
label_L463215441:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L777190206, 0);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L777190206, 0);
    __CN1_DEBUG_INFO(916);
    /* VarOp.assignFrom */     ilocals_11_ = 0 /* ICONST_0 */; 

label_L777190206:
    __CN1_DEBUG_INFO(918);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L385784873, 0);
