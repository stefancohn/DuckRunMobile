...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_updateAnimationState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL50974588701;
    int tryBlockOffsetL50974588701;
    DEFINE_CATCH_BLOCK(catch_L50974588701, label_L232226317, restoreToL50974588701);
    int restoreToL23222631702;
    int tryBlockOffsetL23222631702;
    DEFINE_CATCH_BLOCK(catch_L23222631702, label_L232226317, restoreToL23222631702);
    __CN1_DEBUG_INFO(100);
    virtual_com_codename1_ui_animations_ComponentAnimation_updateState__(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(101);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L2040329005, 0);
    __CN1_DEBUG_INFO(102);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_completed(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L857396971, 0);
    __CN1_DEBUG_INFO(103);
    set_field_com_codename1_ui_animations_ComponentAnimation_completed(threadStateData, 1 /* ICONST_1 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(104);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_notifyLock(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1825991051, 0);
...
label_L509745887:
 tryBlockOffsetL50974588701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L50974588701);
    restoreToL50974588701 = threadStateData->threadObjectStackOffset;
...
label_L172395496:
END_TRY(1);    JUMP_TO(label_L1825991051, 0);

label_L232226317:
 tryBlockOffsetL23222631702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L23222631702);
    restoreToL23222631702 = threadStateData->threadObjectStackOffset;
...
label_L1825991051:
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_onCompletion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1523012874, 0);
...
label_L1523012874:
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_post(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L857396971, 0);
...
label_L555019034:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1155317988, 0);
    ...
    JUMP_TO(label_L555019034, 0);

label_L1155317988:
    JUMP_TO(label_L857396971, 0);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_setNotifyLock___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_notifyLock(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2119255170;
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_setOnCompletion___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_onCompletion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L509489479;
