...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_updateAnimationState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL143827425201;
    int tryBlockOffsetL143827425201;
    DEFINE_CATCH_BLOCK(catch_L143827425201, label_L1820750521, restoreToL143827425201);
...
label_L1438274252:
 tryBlockOffsetL143827425201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L143827425201);
    restoreToL143827425201 = threadStateData->threadObjectStackOffset;
