...
label_L1036938712:
    ...
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L430976509;
...
label_L981231499:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_Calendar_MonthView_components(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1777519364;
    ...
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L327170708;
...
label_L1160326849:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L189215452;
...
JAVA_VOID com_codename1_ui_Calendar_MonthView_setCurrentDay___long_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (/* CustomInvoke */com_codename1_ui_Calendar_access$1000___com_codename1_ui_Calendar_R_com_codename1_ui_ComboBox(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L683327178;
...
label_L683327178:
    ...
    if (/* CustomInvoke */com_codename1_ui_Calendar_access$300___com_codename1_ui_Calendar_R_com_codename1_ui_Label(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L450476243;
...
label_L450476243:
    ...
    if (ilocals_9_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L378196591;
    if (ilocals_10_!=ilocals_6_) /* IF_ICMPNE CustomJump */ goto label_L378196591;
    if (ilocals_11_!=ilocals_7_) /* IF_ICMPNE CustomJump */ goto label_L378196591;
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1335082762;
...
label_L378196591:
    ...
    PUSH_LONG(-1LL); /* LDC */
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L841090268;
...
label_L841090268:
    ...
    if (ilocals_15_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1701461355;

label_L2005537360:
    __CN1_DEBUG_INFO(1061);
    if (ilocals_15_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L632521219;
...
label_L1437396121:
    ...
    if (ilocals_17_>(ilocals_16_ - ilocals_18_)) /* IF_ICMPGT CustomJump */ goto label_L1701461355;
...
label_L1075593808:
    ...
    if (ilocals_18_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_Calendar_MonthView_components(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1629032994;
    if (((ilocals_18_ - ilocals_17_) + 1 /* ICONST_1 */)>ilocals_16_) /* IF_ICMPGT CustomJump */ goto label_L1629032994;
    ...
    /* CustomInvoke */PUSH_LONG(com_codename1_ui_Calendar_access$1100___com_codename1_ui_Calendar_R_long(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject)));
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L1484994456;
...
label_L622396011:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ goto label_L1296450832;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1692915352;
...
label_L1692915352:
    ...
    goto label_L622396011;

label_L1296450832:
    __CN1_DEBUG_INFO(1096);
    if (/* CustomInvoke */com_codename1_ui_Calendar_access$1400___com_codename1_ui_Calendar_R_boolean(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1066270324;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1066270324;
...
label_L445976541:
    ...
    if (ilocals_18_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_Calendar_MonthView_components(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1335082762;
...
label_L91273747:
    ...
    if (/* CustomInvoke */virtual_java_util_Calendar_get___int_R_int(threadStateData, locals[3].data.o, 2 /* ICONST_2 */)==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L668754554;
...
JAVA_VOID com_codename1_ui_Calendar_MonthView_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1713204150;
...
label_L1713204150:
    ...
    if (/* CustomInvoke */com_codename1_ui_Calendar_access$2100___com_codename1_ui_Calendar_R_boolean(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1933554786;
    __CN1_DEBUG_INFO(1254);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L149052735:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_Calendar_MonthView_components(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1933554786;
...
label_L1648231985:
    ...
    if (locals[2].data.o==CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_Calendar_MonthView_components(__cn1ThisObject), ilocals_3_)) /* IF_ACMPEQ CustomJump */ goto label_L898655932;
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L945683299;

label_L898655932:
    __CN1_DEBUG_INFO(1261);
    if (/* CustomInvoke */com_codename1_ui_Calendar_access$1400___com_codename1_ui_Calendar_R_boolean(threadStateData, get_field_com_codename1_ui_Calendar_MonthView_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L911201454;
...
label_L573819584:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L221402392;
...
label_L911201454:
    ...
    if (get_field_com_codename1_ui_Calendar_MonthView_selected(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2021540695;
...
label_L1070319462:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L2021540695;
...
label_L1744523301:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L42783426;
