...
extern void __INIT_VTABLE_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_java_util_Collections_EmptyList(CODENAME_ONE_THREAD_STATE);
...
JAVA_VOID java_util_Collections_EmptyList_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_Collections_EmptyList_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_util_Collections_EmptyList_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
extern JAVA_LONG get_static_java_util_Collections_EmptyList_serialVersionUID();
JAVA_INT get_field_java_util_Collections_EmptyList_modCount(JAVA_OBJECT t);
void set_field_java_util_Collections_EmptyList_modCount(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Val, JAVA_OBJECT __cn1T);


struct obj__java_util_Collections_EmptyList {
    DEBUG_GC_VARIABLES
...
#endif //__JAVA_UTIL_COLLECTIONS_EMPTYLIST__
