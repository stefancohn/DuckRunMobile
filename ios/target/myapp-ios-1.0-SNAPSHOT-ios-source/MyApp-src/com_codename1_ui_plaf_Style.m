...
JAVA_VOID com_codename1_ui_plaf_Style___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 205);
...
JAVA_VOID com_codename1_ui_plaf_Style_markAsRendererStyle__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3443);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_createProxyStyle___com_codename1_ui_plaf_Style_1ARRAY_R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_plaf_Style(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 3442, 3444);
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(6, 2, 0, 3442, 205);
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2087831689;
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 5, 0, 3442, 205);
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    ...
    volatile JAVA_INT ilocals_1_ = 0; /* fgColor */
    volatile JAVA_INT ilocals_2_ = 0; /* bgColor */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3442, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    locals[3].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte_com_codename1_ui_Image_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_BYTE __cn1Arg6) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* bgColor */
    DEFINE_INSTANCE_METHOD_STACK(2, 7, 0, 3442, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    locals[3].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_merge___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 3442, 3445);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 1 /* LCONST_1 */), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1288230669;
...
label_L1288230669:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 262144LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1549377783;
...
label_L1549377783:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 2LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L269693101;
...
label_L269693101:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 32LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1649706918;
...
label_L1649706918:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 2048LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1747862622;
...
label_L1747862622:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 4096LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2044792756;
...
label_L2044792756:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 8192LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1895751293;
...
label_L1895751293:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 16LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L911281779;
...
label_L911281779:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 128LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L742891603;
...
label_L742891603:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 32768LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1563068096;
...
label_L1563068096:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 256LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1537324590;
...
label_L1537324590:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 512LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1706891711;
...
label_L1706891711:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 1024LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1953069155;
...
label_L1953069155:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 64LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2105339048;
...
label_L2105339048:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 16384LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L733623791;
...
label_L733623791:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 65536LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L650621382;
...
label_L650621382:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 524288LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L424832797;
...
label_L424832797:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 131072LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L64080179;
...
JAVA_INT com_codename1_ui_plaf_Style_getElevation___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3446);
...
JAVA_INT com_codename1_ui_plaf_Style_getIconGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3447);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(763);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_Style_iconGap(__cn1ThisObject), 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L2042532331;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isSurface___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3323);
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isModified___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3449);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(794);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1651267227;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_plaf_Style_getBgColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3450);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBgImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3451);
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBackgroundType___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3452);
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBackgroundAlignment___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3453);
...
JAVA_INT com_codename1_ui_plaf_Style_getBackgroundGradientStartColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3454);
...
JAVA_INT com_codename1_ui_plaf_Style_getBackgroundGradientEndColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3455);
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1759889326;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3456);
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1757252775;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3457);
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L1732538491;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeSize___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3458);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(895);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1260955583;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=4/* ICONST_4 */) /* IF_ICMPLE CustomJump */ goto label_L1260955583;
...
JAVA_INT com_codename1_ui_plaf_Style_getFgColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3459);
...
JAVA_INT com_codename1_ui_plaf_Style_getFgAlpha___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3460);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getFont___R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3461);
...
JAVA_VOID com_codename1_ui_plaf_Style_setElevation___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3462);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(937);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L221692355;
...
label_L221692355:
    ...
    if (get_field_com_codename1_ui_plaf_Style_elevation(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1131577797;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L2020702385;
...
JAVA_VOID com_codename1_ui_plaf_Style_setElevation___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* elevation */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3462);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float_byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BYTE __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3442, 3463);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(972);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L614785733;
...
label_L1894861020:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L668637515;
...
label_L614785733:
    ...
    if (ilocals_2_!=get_field_com_codename1_ui_plaf_Style_iconGapUnit(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L53871235;
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L490218;
...
label_L53871235:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1944370016;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3442, 3463);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3463);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGapUnit___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3464);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1029);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L162114152;
...
label_L22249027:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L976782276;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L162114152:
    ...
    if (ilocals_1_==get_field_com_codename1_ui_plaf_Style_iconGapUnit(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L1463478962;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L319086807;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGapUnit___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3464);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setSurface___boolean_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 2414);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1843161040:
    ...
    if (get_field_com_codename1_ui_plaf_Style_surface(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1128198660;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1305669460;
...
JAVA_VOID com_codename1_ui_plaf_Style_setSurface___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* surface */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 2414);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3465);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3044);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setAlignment___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3044);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1123);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L127252077;
...
label_L17203574:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L899476243;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L127252077:
    ...
    if (get_field_com_codename1_ui_plaf_Style_align(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1542747725;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1903728000;
...
JAVA_INT com_codename1_ui_plaf_Style_getAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3466);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgImage___com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 2901);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundType___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundAlignment___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3468);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientStartColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3469);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientEndColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3470);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeX___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3471);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeY___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3472);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeSize___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3473);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* fgColor */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3474);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgAlpha___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3475);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFont___com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3476);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_plaf_Style_getTextDecoration___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3488);
...
JAVA_VOID com_codename1_ui_plaf_Style_setTextDecoration___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3489);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setTextDecoration___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3489);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1701378456:
    ...
    if (get_field_com_codename1_ui_plaf_Style_textDecoration(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L355977028;
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBgTransparency___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3490);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1476);
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1343365138;
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)>2 /* ICONST_2 */) /* IF_ICMPGT CustomJump */ goto label_L1343365138;
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1343365138;
    if (virtual_com_codename1_ui_Image_isAnimation___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1452493025;
    if (virtual_com_codename1_ui_Image_isOpaque___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1343365138;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3491);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_plaf_Style_getOpacity___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3442, 3492);
...
JAVA_VOID com_codename1_ui_plaf_Style_setOpacity___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3493);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setOpacity___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3493);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1519);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2109061264;
...
label_L19410584:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1081836597;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L2109061264:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1303427612;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L496105986;
...
label_L1303427612:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3494));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L496105986:
    ...
    if (get_field_com_codename1_ui_plaf_Style_opacity(__cn1ThisObject)==((ilocals_1_ << 24) >> 24)) /* IF_ICMPEQ CustomJump */ goto label_L22515625;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1095446005;
...
JAVA_VOID com_codename1_ui_plaf_Style_stripMarginAndPadding__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 2427);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 3442, 3495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 3442, 3495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L640113478:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L456172878;
...
label_L165875610:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1050406642;
    if (CN1_CMP_EXPR(flocals_3_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1050406642;
    if (CN1_CMP_EXPR(flocals_4_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1050406642;
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L789948772;

label_L1050406642:
    __CN1_DEBUG_INFO(1589);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3496));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L789948772:
    __CN1_DEBUG_INFO(1591);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)!=0) /* IFNE CustomJump */ goto label_L823223069;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 2 /* ICONST_2 */), flocals_2_)!=0) /* IFNE CustomJump */ goto label_L823223069;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 1 /* ICONST_1 */), flocals_3_)!=0) /* IFNE CustomJump */ goto label_L823223069;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 3 /* ICONST_3 */), flocals_4_)==0) /* IFEQ CustomJump */ goto label_L762376978;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3442, 3495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* left */
    volatile JAVA_INT ilocals_4_ = 0; /* right */
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 3442, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    volatile JAVA_FLOAT flocals_1_ = 0; /* top */
    volatile JAVA_FLOAT flocals_2_ = 0; /* bottom */
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 3442, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    flocals_3_ = __cn1Arg3;
    flocals_4_ = __cn1Arg4;
    __CN1_DEBUG_INFO(1646);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1283290160;
...
label_L1947349264:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1319217746;
    /* VarOp.assignFrom */ locals[8].type=CN1_TYPE_INVALID;locals[8].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[5].data.o, ilocals_7_);
...
label_L1283290160:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1590736099;
    if (CN1_CMP_EXPR(flocals_3_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1590736099;
    if (CN1_CMP_EXPR(flocals_4_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L1590736099;
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L2041288701;

label_L1590736099:
    __CN1_DEBUG_INFO(1653);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3498));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L2041288701:
    __CN1_DEBUG_INFO(1655);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)!=0) /* IFNE CustomJump */ goto label_L983253408;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 2 /* ICONST_2 */), flocals_2_)!=0) /* IFNE CustomJump */ goto label_L983253408;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 1 /* ICONST_1 */), flocals_3_)!=0) /* IFNE CustomJump */ goto label_L983253408;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 3 /* ICONST_3 */), flocals_4_)==0) /* IFEQ CustomJump */ goto label_L1608805714;
...
JAVA_VOID com_codename1_ui_plaf_Style_cacheMargins___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3499);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1678);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L71871969;
...
label_L1099892020:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L570017514;
...
label_L71871969:
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1040023210;
    if (get_field_com_codename1_ui_plaf_Style_cached_margin(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2090593105;
...
JAVA_VOID com_codename1_ui_plaf_Style_restoreCachedMargins__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 3442, 3500);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1698);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L322612414;
...
label_L2096860824:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L715504968;
...
label_L322612414:
    ...
    if (get_field_com_codename1_ui_plaf_Style_cached_margin(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1595487029;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* orientation */
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3442, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingValue___boolean_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3442, 3502);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1755);
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L686904524;
    if (ilocals_2_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L808485741;
...
label_L686904524:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3503));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L808485741:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1794607688;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1859227008;
        case 3: goto label_L1277490082;
        default: goto label_L1794607688;
    }
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingLeft___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3442, 3504);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1779);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L2017147552;
...
JAVA_VOID com_codename1_ui_plaf_Style_initPaddingUnits__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 3505);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1786);
    if (get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L784882213;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitLeft___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3506);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitRight___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3507);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitTop___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3508);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitBottom___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3509);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingRight___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3442, 3510);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1842);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1276604401;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingTop___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3511);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingTop___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3512);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingTop___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3512);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1874);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L667237426;
...
label_L1795135446:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L109767760;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L667237426:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L492832159;
...
label_L492832159:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L323653293;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingBottom___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingBottom___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1909);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1114835192;
...
label_L1232461217:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1411675719;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1114835192:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L235740612;
...
label_L235740612:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 2 /* ICONST_2 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1415835701;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingLeft___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3514);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingLeft___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3514);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1944);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L587346608;
...
label_L586722754:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1157462948;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L587346608:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1775305712;
...
label_L1775305712:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 1 /* ICONST_1 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1534340040;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingRight___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3515);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingRight___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3515);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L1915040171:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L319450809;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1962629977:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L150306380;
...
label_L150306380:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 3 /* ICONST_3 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L653974936;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginTop___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3516);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginTop___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3516);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L512934838:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1035394386;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1715802200:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1861536737;
    __CN1_DEBUG_INFO(2018);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3517));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1861536737:
    __CN1_DEBUG_INFO(2020);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L545116599;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginBottom___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3518);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginBottom___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3518);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L1808679232:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L598551831;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L732611751:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L636536295;
...
label_L636536295:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 2 /* ICONST_2 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1484960258;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginLeft___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3519);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginLeft___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3442, 3519);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L673992096:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L189820624;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L302905744:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1710483461;
...
label_L1710483461:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 1 /* ICONST_1 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L416242770;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingBottom___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3521);
...
JAVA_INT com_codename1_ui_plaf_Style_getHorizontalMargins___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 3522);
...
JAVA_INT com_codename1_ui_plaf_Style_getVerticalMargins___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 3523);
...
JAVA_INT com_codename1_ui_plaf_Style_getHorizontalPadding___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 3524);
...
JAVA_INT com_codename1_ui_plaf_Style_getVerticalPadding___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3442, 3525);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginRightNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3526);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginLeftNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3527);
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingRightNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3528);
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingLeftNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3529);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginRight___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3442, 3530);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginLeft___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3442, 3531);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginTop___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3532);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginBottom___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3442, 3533);
...
JAVA_INT com_codename1_ui_plaf_Style_getPadding___boolean_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3442, 3534);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_INT com_codename1_ui_plaf_Style_convertUnit___byte_1ARRAY_float_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 3442, 3535);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(2249);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1300016164;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1083650811;
        case 2: goto label_L121463477;
        case 3: goto label_L1587143371;
        case 4: goto label_L1991010480;
        case 5: goto label_L257268852;
        case 6: goto label_L1670479841;
        case 7: goto label_L1913607906;
        default: goto label_L1735608827;
    }
...
label_L1083650811:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1147588445;
    if (ilocals_3_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L744541767;
...
JAVA_INT com_codename1_ui_plaf_Style_getPadding___int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* orientation */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3534);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3465);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2344);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1907982059;
...
label_L476234749:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L662109583;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1907982059:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgColor(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1934418561;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1236833317;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgImage___com_codename1_ui_Image_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 2901);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2367);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1496482328;
...
label_L1200187371:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1397088232;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1496482328:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1243470467;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L133346202;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundType___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2393);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2050328083;
...
label_L1382159617:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1980698753;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L2050328083:
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1075708596;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L374145466;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundAlignment___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3468);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2421);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L415793386;
...
label_L1794893473:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1522549999;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L415793386:
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundAlignment(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L340097685;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1213626151;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBackgroundGradient___R_java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 2, 0, 3442, 3538);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2444);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L283747838;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradient___java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3539);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientStartColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3469);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2466);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L630359980;
...
label_L1638429542:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L448581721;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L630359980:
    ...
    (*SP).data.i = ilocals_1_; 
    SP++;
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1010040056;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L229483317;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientEndColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3470);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2489);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1903137985;
...
label_L1879644274:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1409215177;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1903137985:
    ...
    (*SP).data.i = ilocals_1_; 
    SP++;
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L274577741;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L496627227;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeX___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeX */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3471);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2513);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L957736899;
...
label_L2081289387:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L23568923;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L957736899:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L775300103;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L948692477;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeY___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeY */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3472);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2536);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L71364493;
...
label_L150135782:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L402389762;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L71364493:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L1865505544;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1821310436;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeSize___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeSize */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3473);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2560);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L619002012;
...
label_L1587279684:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L991363637;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L619002012:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L1172390062;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1221439830;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3474);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1263015120:
    ...
    if (get_field_com_codename1_ui_plaf_Style_fgColor(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L539058198;
    __CN1_DEBUG_INFO(2590);
    set_field_com_codename1_ui_plaf_Style_fgColor(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(2591);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L725884502;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgAlpha___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3475);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2606);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L645435839;
...
label_L286947699:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L974168055;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L645435839:
    ...
    if (get_field_com_codename1_ui_plaf_Style_fgAlpha(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L438793128;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L2024860730;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFont___com_codename1_ui_Font_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3476);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
...
label_L627677863:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L82973602;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1180773372:
    ...
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1514631948;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L355900787;

label_L1514631948:
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L30270324;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L30270324;
...
label_L355900787:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1746468168;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgTransparency___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3491);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L153500756:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1765745171;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1363376124;

label_L1765745171:
    __CN1_DEBUG_INFO(2662);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3540));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1363376124:
    __CN1_DEBUG_INFO(2664);
    if (get_field_com_codename1_ui_plaf_Style_transparency(__cn1ThisObject)==((ilocals_1_ << 24) >> 24)) /* IF_ICMPEQ CustomJump */ goto label_L776919575;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3442, 3495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3442, 3495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
label_L2040477002:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L567921924;
    /* VarOp.assignFrom */ locals[7].type=CN1_TYPE_INVALID;locals[7].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_6_);
...
label_L1810873106:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L54254849;
    if (ilocals_1_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L362463583;
...
label_L362463583:
    ...
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L2059702021;
...
label_L2059702021:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), ilocals_1_), flocals_2_)==0) /* IFEQ CustomJump */ goto label_L2062667890;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L671078904;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3442, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    volatile JAVA_FLOAT flocals_2_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3442, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
label_L1313359405:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L986604358;
    /* VarOp.assignFrom */ locals[7].type=CN1_TYPE_INVALID;locals[7].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_6_);
...
label_L1680630881:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L388064773;
    if (ilocals_1_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L279513068;
...
label_L279513068:
    ...
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1505006316;
...
label_L1505006316:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), ilocals_1_), flocals_2_)==0) /* IFEQ CustomJump */ goto label_L1438764761;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1238145834;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isSuppressChangeEvents___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3541);
...
JAVA_VOID com_codename1_ui_plaf_Style_setSuppressChangeEvents___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3442, 3542);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_firePropertyChanged___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3543);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L293757848;
    if (get_field_com_codename1_ui_plaf_Style_suppressChangeEvents(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1818009782;
...
JAVA_VOID com_codename1_ui_plaf_Style_addStyleListener___com_codename1_ui_events_StyleListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3442, 3544);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L412416671:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L445170933;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L934288610:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L289710123;
...
JAVA_VOID com_codename1_ui_plaf_Style_removeStyleListener___com_codename1_ui_events_StyleListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3442, 3545);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2813);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L648346093;
...
label_L1160278903:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L2052533920;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L648346093:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1901712897;
...
JAVA_VOID com_codename1_ui_plaf_Style_removeListeners__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 3442, 3546);
...
label_L904351240:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L869413070;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
label_L1890792022:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L171011947;
...
JAVA_VOID com_codename1_ui_plaf_Style_resetModifiedFlag__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 3442, 3547);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBorder___com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3442, 3548);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBorder___com_codename1_ui_plaf_Border_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3442, 3548);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2860);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1677319673;
...
label_L1310147631:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1091552520;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1677319673:
    ...
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1331441841;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1659321014;

label_L1331441841:
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1568638055;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1568638055;
...
label_L1659321014:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L700286427;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 2543);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBgPainter___R_com_codename1_ui_Painter(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3549);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgPainter___com_codename1_ui_Painter(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3442, 3550);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2902);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L130740709;
...
label_L2111746687:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1545816352;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getPaddingUnit___R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3551);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnit___byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 3442, 3552);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1746790527;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1746790527;
...
label_L645190902:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L783402517;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L940077890:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1570578713;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1570578713;
...
label_L1570578713:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2061865206;
...
label_L2061865206:
    ...
    if (get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2058762296;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getMarginUnit___R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3442, 3553);
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginUnit___byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 3442, 3554);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L923565253;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L923565253;
...
label_L704948997:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1639463154;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1318538142:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1589370464;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1589370464;
    ...
    POP_MANY(2);
    goto label_L168127270;

label_L1589370464:
    __CN1_DEBUG_INFO(2981);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L710589756;
...
label_L710589756:
    ...
    if (get_field_com_codename1_ui_plaf_Style_marginUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L621373425;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 3442, 244);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(3044);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L79488555;
...
label_L79488555:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L2079332573;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(3051);
    if (get_field_com_codename1_ui_plaf_Style_fgColor(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_fgColor(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L363384509;
    __CN1_DEBUG_INFO(3052);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L363384509:
    __CN1_DEBUG_INFO(3054);
    if (get_field_com_codename1_ui_plaf_Style_fgAlpha(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_fgAlpha(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1064052579;
    __CN1_DEBUG_INFO(3055);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1064052579:
    __CN1_DEBUG_INFO(3057);
    if (get_field_com_codename1_ui_plaf_Style_bgColor(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_bgColor(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1552024347;
    __CN1_DEBUG_INFO(3058);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1552024347:
    __CN1_DEBUG_INFO(3060);
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_font(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L659545766;
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1958814164;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject));
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L659545766;
...
label_L659545766:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_bgImage(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L709379856;
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1713247129;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L709379856;
...
label_L709379856:
    ...
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_padding(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L1073564434;
    __CN1_DEBUG_INFO(3069);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1073564434:
    __CN1_DEBUG_INFO(3071);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_margin(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L1112474296;
    __CN1_DEBUG_INFO(3072);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1112474296:
    __CN1_DEBUG_INFO(3074);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_paddingUnit(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L718781734;
    __CN1_DEBUG_INFO(3075);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L718781734:
    __CN1_DEBUG_INFO(3077);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_marginUnit(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_marginUnit(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L1019474238;
    __CN1_DEBUG_INFO(3078);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1019474238:
    __CN1_DEBUG_INFO(3080);
    if (get_field_com_codename1_ui_plaf_Style_transparency(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_transparency(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1773373551;
    __CN1_DEBUG_INFO(3081);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1773373551:
    __CN1_DEBUG_INFO(3083);
    if (get_field_com_codename1_ui_plaf_Style_opacity(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_opacity(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1406340387;
    __CN1_DEBUG_INFO(3084);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1406340387:
    __CN1_DEBUG_INFO(3086);
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_backgroundType(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1157276914;
    __CN1_DEBUG_INFO(3087);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1157276914:
    __CN1_DEBUG_INFO(3089);
    if (get_field_com_codename1_ui_plaf_Style_backgroundAlignment(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_backgroundAlignment(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1737750354;
    __CN1_DEBUG_INFO(3090);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1737750354:
    __CN1_DEBUG_INFO(3092);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_backgroundGradient(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L303491903;
    __CN1_DEBUG_INFO(3094);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L303491903:
    __CN1_DEBUG_INFO(3096);
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_border(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L1508333131;
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1210819761;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject));
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1508333131;
...
label_L1508333131:
    ...
    if (get_field_com_codename1_ui_plaf_Style_align(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_align(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L813364097;
    __CN1_DEBUG_INFO(3101);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L813364097:
    __CN1_DEBUG_INFO(3103);
    if (get_field_com_codename1_ui_plaf_Style_textDecoration(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_textDecoration(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L353417634;
    __CN1_DEBUG_INFO(3104);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L353417634:
    __CN1_DEBUG_INFO(3106);
    if (get_field_com_codename1_ui_plaf_Style_elevation(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_elevation(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1990651973;
    __CN1_DEBUG_INFO(3107);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1990651973:
    __CN1_DEBUG_INFO(3109);
    if (get_field_com_codename1_ui_plaf_Style_surface(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_surface(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1664998412;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_equals___float_1ARRAY_float_1ARRAY_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    __STATIC_INITIALIZER_com_codename1_ui_plaf_Style(threadStateData);
    DEFINE_METHOD_STACK(3, 4, 0, 3442, 244);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(3116);
    if (locals[0].data.o!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L79486225;
    __CN1_DEBUG_INFO(3117);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L79486225:
    __CN1_DEBUG_INFO(3120);
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L342997389;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1427396510;
...
label_L1427396510:
    ...
    if (CN1_ARRAY_LENGTH(locals[1].data.o)==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L1489251468;
...
label_L1418286721:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L988952272;
    __CN1_DEBUG_INFO(3130);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[0].data.o, ilocals_3_), CN1_ARRAY_ELEMENT_FLOAT(locals[1].data.o, ilocals_3_))==0) /* IFEQ CustomJump */ goto label_L592858578;
