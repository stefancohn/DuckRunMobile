...
JAVA_OBJECT STATIC_FIELD_com_example_myapp_Game_audioPlayer = 0;
JAVA_OBJECT get_static_com_example_myapp_Game_audioPlayer(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_example_myapp_Game(threadStateData);
     return STATIC_FIELD_com_example_myapp_Game_audioPlayer;
}

void set_static_com_example_myapp_Game_audioPlayer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1StaticVal) {
    __STATIC_INITIALIZER_com_example_myapp_Game(threadStateData);
    STATIC_FIELD_com_example_myapp_Game_audioPlayer = __cn1StaticVal;
}

JAVA_OBJECT STATIC_FIELD_com_example_myapp_Game_audioOn = 0;
JAVA_OBJECT get_static_com_example_myapp_Game_audioOn(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_example_myapp_Game(threadStateData);
     return STATIC_FIELD_com_example_myapp_Game_audioOn;
}

void set_static_com_example_myapp_Game_audioOn(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1StaticVal) {
    __STATIC_INITIALIZER_com_example_myapp_Game(threadStateData);
    STATIC_FIELD_com_example_myapp_Game_audioOn = __cn1StaticVal;
}
...
JAVA_OBJECT com_example_myapp_Game_getGame___R_com_example_myapp_Game(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(39);
    if (get_static_com_example_myapp_Game_game(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1605988985;
    __CN1_DEBUG_INFO(40);
...
JAVA_VOID com_example_myapp_Game_changeState___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1134202713;
        case 1: goto label_L1636178473;
        case 2: goto label_L822232612;
        default: goto label_L633131207;
    }
...
label_L822232612:
    ...
    SP++;
    PUSH_INT(54);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L852190062;
    __CN1_DEBUG_INFO(89);
...
label_L61137731:
    ...
    if (get_field_com_example_myapp_Game_GameThread(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1674403916;
    ...
    if (CN1_CMP_EXPR(dlocals_7_, 1 /* DCONST_1 */)<0) /* IFLT CustomJump */ goto label_L1088239991;
...
label_L1088239991:
    ...
    if (CN1_CMP_EXPR(dlocals_5_, 1 /* DCONST_1 */)<0) /* IFLT CustomJump */ goto label_L61137731;
