...
JAVA_VOID com_codename1_ui_geom_GeneralPath_ShapeUtil___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3731, 205);
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersection___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 3731, 3595);
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersection___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_com_codename1_ui_geom_GeneralPath_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(10, 29, 0, 3731, 3595);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    int restoreToL152269141401;
    int tryBlockOffsetL152269141401;
    DEFINE_CATCH_BLOCK(catch_L152269141401, label_L1585238239, restoreToL152269141401);
    int restoreToL189906453502;
    int tryBlockOffsetL189906453502;
    DEFINE_CATCH_BLOCK(catch_L189906453502, label_L1585238239, restoreToL189906453502);
    int restoreToL158523823903;
    int tryBlockOffsetL158523823903;
    DEFINE_CATCH_BLOCK(catch_L158523823903, label_L1585238239, restoreToL158523823903);
    __CN1_DEBUG_INFO(1840);
    if (virtual_com_codename1_ui_geom_Rectangle_getWidth___R_int(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L151020702, 0);
    if (virtual_com_codename1_ui_geom_Rectangle_getHeight___R_int(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L146316090, 0);
...
label_L1522691414:
 tryBlockOffsetL152269141401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L152269141401);
    restoreToL152269141401 = threadStateData->threadObjectStackOffset;
...
label_L484258212:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L86411583, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L1038375788, 1);
        case 1: JUMP_TO(label_L1038375788, 1);
        case 2: JUMP_TO(label_L936045786, 1);
        case 3: JUMP_TO(label_L936045786, 1);
        case 4: JUMP_TO(label_L2078785618, 1);
        default: JUMP_TO(label_L1253691744, 1);
    }
...
label_L936045786:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L894780981, 1);
...
label_L894780981:
    ...
    if (ilocals_25_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1895167389, 1);
...
label_L1950554162:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1872928774, 1);
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1884890921, 1);
...
label_L1884890921:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L803175842, 1);
    { JAVA_DOUBLE tmpResult = virtual_com_codename1_ui_geom_Rectangle2D_getX___R_double(threadStateData, locals[27].data.o);
    PUSH_DOUBLE(tmpResult); }
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1135702755, 1);
...
label_L3162216:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1423314849, 1);
    { JAVA_DOUBLE tmpResult = virtual_com_codename1_ui_geom_Rectangle2D_getY___R_double(threadStateData, locals[27].data.o);
    PUSH_DOUBLE(tmpResult); }
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L481839538, 1);
...
label_L481839538:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle2D_contains___double_double_R_boolean(threadStateData, locals[3].data.o, /* CustomInvoke */virtual_com_codename1_ui_geom_Geometry_BezierCurve_x___double_R_double(threadStateData, locals[22].data.o, 0.5), /* CustomInvoke */virtual_com_codename1_ui_geom_Geometry_BezierCurve_y___double_R_double(threadStateData, locals[22].data.o, 0.5))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1877123942, 1);
...
label_L1842580978:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1471615414, 1);
...
label_L766796213:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L887814593, 1);
...
label_L1551484396:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L1539273803, 1);
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1434984256, 1);
...
label_L1434984256:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L613100385, 1);
...
label_L613100385:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L79044247, 1);
...
label_L79044247:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L298939230, 1);
...
label_L298939230:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L822619898, 1);
...
label_L822619898:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3734));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3736));     SP -= 1;
...
label_L1038375788:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_8_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1285933977, 1);
    __CN1_DEBUG_INFO(1976);
    CN1_SET_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */, flocals_8_);
    JUMP_TO(label_L2018719292, 1);

label_L1285933977:
    __CN1_DEBUG_INFO(1977);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_9_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2018719292, 1);
    __CN1_DEBUG_INFO(1978);
    CN1_SET_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */, flocals_9_);

label_L2018719292:
    __CN1_DEBUG_INFO(1980);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_10_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1652748779, 1);
    __CN1_DEBUG_INFO(1981);
    CN1_SET_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */, flocals_10_);
    JUMP_TO(label_L302869695, 1);

label_L1652748779:
    __CN1_DEBUG_INFO(1982);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_11_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L302869695, 1);
    __CN1_DEBUG_INFO(1983);
    CN1_SET_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */, flocals_11_);

label_L302869695:
    __CN1_DEBUG_INFO(1986);
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1880527972, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_12_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L286637708, 1);
...
label_L286637708:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1693260012, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L503117914, 1);
...
label_L503117914:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1494084149, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_13_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1699794502, 1);
...
label_L1699794502:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1777766520, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_15_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L330472244, 1);
...
label_L330472244:
    ...
    if (ilocals_25_!=0) /* IFNE CustomJump */ JUMP_TO(label_L626562869, 1);
    ...
    JUMP_TO(label_L1184452390, 1);

label_L626562869:
    __CN1_DEBUG_INFO(2006);
    if (CN1_CMP_EXPR(flocals_16_, CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L464614109, 1);
    if (CN1_CMP_EXPR(flocals_17_, CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1184452390, 1);
...
label_L86411583:
    ...
    if (CN1_CMP_EXPR((flocals_14_ - flocals_12_), 1 /* FCONST_1 */)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2111700021, 1);
    if (CN1_CMP_EXPR((flocals_15_ - flocals_13_), 1 /* FCONST_1 */)>0) /* IFGT CustomJump */ JUMP_TO(label_L1899064535, 0);
...
label_L1899064535:
 tryBlockOffsetL189906453502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L189906453502);
    restoreToL189906453502 = threadStateData->threadObjectStackOffset;
...
label_L1585238239:
 tryBlockOffsetL158523823903 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L158523823903);
    restoreToL158523823903 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_segmentShape___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 3731, 3738);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_segmentShape___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_com_codename1_ui_geom_GeneralPath_R_com_codename1_ui_geom_GeneralPath(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    volatile JAVA_FLOAT flocals_17_ = 0; /* v17 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(10, 23, 0, 3731, 3738);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg3;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL133050097201;
    int tryBlockOffsetL133050097201;
    DEFINE_CATCH_BLOCK(catch_L133050097201, label_L1627840438, restoreToL133050097201);
    int restoreToL162784043802;
    int tryBlockOffsetL162784043802;
    DEFINE_CATCH_BLOCK(catch_L162784043802, label_L1627840438, restoreToL162784043802);
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2056);
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L337875491, 0);
...
label_L1330500972:
 tryBlockOffsetL133050097201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L133050097201);
    restoreToL133050097201 = threadStateData->threadObjectStackOffset;
...
label_L1237024911:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[8].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L109967558, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L2082499348, 1);
        case 1: JUMP_TO(label_L730656841, 1);
        case 2: JUMP_TO(label_L590794129, 1);
        case 3: JUMP_TO(label_L1251232505, 1);
        case 4: JUMP_TO(label_L898883700, 1);
        default: JUMP_TO(label_L2043756599, 1);
    }
...
label_L2082499348:
    ...
    JUMP_TO(label_L1813922009, 1);

label_L590794129:
    __CN1_DEBUG_INFO(2091);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L78973985, 1);
...
label_L78973985:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L772791427, 1);
...
label_L1867686441:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1126853225, 1);
...
label_L1251232505:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1072267396, 1);
...
label_L1072267396:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L99827309, 1);
...
label_L354051480:
    ...
    /* VarOp.assignFrom */ locals[19].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, locals[4].data.o);locals[19].type=CN1_TYPE_OBJECT;
label_L473800232:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1873010424, 1);
...
label_L730656841:
    ...
    BC_FCMPL();
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L10603412, 1);
...
label_L1188120765:
    if (ilocals_21_>=ilocals_20_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L10603412, 1);
...
label_L898883700:
    ...
    PUSH_FLOAT(1); /* FCONST_1 */
    BC_FCMPL();
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L938744449, 1);
...
label_L1204297353:
    if (ilocals_21_>=ilocals_20_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L938744449, 1);
...
label_L2043756599:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3739));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L1627840438:
 tryBlockOffsetL162784043802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L162784043802);
    restoreToL162784043802 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectLineWithRectAsHash___float_float_float_float_com_codename1_ui_geom_Rectangle_float_1ARRAY_R_float_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_OBJECT __cn1Arg6) {
    ...
    volatile JAVA_FLOAT flocals_17_ = 0; /* v17 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 22, 0, 3731, 3740);
    ...
    int restoreToL214441681201;
    int tryBlockOffsetL214441681201;
    DEFINE_CATCH_BLOCK(catch_L214441681201, label_L90418597, restoreToL214441681201);
    int restoreToL9041859702;
    int tryBlockOffsetL9041859702;
    DEFINE_CATCH_BLOCK(catch_L9041859702, label_L90418597, restoreToL9041859702);
...
label_L2144416812:
 tryBlockOffsetL214441681201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L214441681201);
    restoreToL214441681201 = threadStateData->threadObjectStackOffset;
    ...
    if (CN1_CMP_EXPR(flocals_11_, 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L307531674, 1);
    __CN1_DEBUG_INFO(2224);
    if (CN1_CMP_EXPR(flocals_8_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L359659279, 1);
    if (CN1_CMP_EXPR(flocals_8_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L359659279, 1);
...
label_L359659279:
    ...
    if (CN1_CMP_EXPR(flocals_10_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L12952277, 1);
    if (CN1_CMP_EXPR(flocals_10_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L12952277, 1);
...
label_L12952277:
    ...
    if (CN1_CMP_EXPR(flocals_1_, flocals_3_)>0) /* IFGT CustomJump */ JUMP_TO(label_L408107501, 1);
    __CN1_DEBUG_INFO(2237);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1148194923:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L776817954, 1);
...
label_L307531674:
    ...
    if (CN1_CMP_EXPR(flocals_12_, 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L745764314, 1);
    __CN1_DEBUG_INFO(2255);
    if (CN1_CMP_EXPR(flocals_7_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1757731703, 1);
    if (CN1_CMP_EXPR(flocals_7_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1757731703, 1);
...
label_L1757731703:
    ...
    if (CN1_CMP_EXPR(flocals_9_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2002534484, 1);
    if (CN1_CMP_EXPR(flocals_9_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L2002534484, 1);
...
label_L2002534484:
    ...
    if (CN1_CMP_EXPR(flocals_0_, flocals_2_)>0) /* IFGT CustomJump */ JUMP_TO(label_L129165617, 1);
    __CN1_DEBUG_INFO(2267);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L2122967975:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L811106744, 1);
...
label_L745764314:
    ...
    if (CN1_CMP_EXPR(flocals_7_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2066337258, 1);
    if (CN1_CMP_EXPR(flocals_7_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L2066337258, 1);
...
label_L2066337258:
    ...
    if (CN1_CMP_EXPR(flocals_9_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L252237430, 1);
    if (CN1_CMP_EXPR(flocals_9_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L252237430, 1);
...
label_L252237430:
    ...
    if (CN1_CMP_EXPR(flocals_8_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1055772899, 1);
    if (CN1_CMP_EXPR(flocals_8_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1055772899, 1);
...
label_L1055772899:
    ...
    if (CN1_CMP_EXPR(flocals_10_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1199606198, 1);
    if (CN1_CMP_EXPR(flocals_10_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1199606198, 1);
...
label_L1199606198:
    ...
    if (CN1_CMP_EXPR(flocals_0_, flocals_2_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1928550961, 1);
    __CN1_DEBUG_INFO(2310);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1799040052:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L989956479, 1);
...
label_L90418597:
 tryBlockOffsetL9041859702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L9041859702);
    restoreToL9041859702 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_solveQuad___double_1ARRAY_double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(8, 11, 0, 3731, 3741);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (CN1_CMP_EXPR(dlocals_2_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1082073129;
    __CN1_DEBUG_INFO(2363);
    if (CN1_CMP_EXPR(dlocals_4_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1996620584;
...
label_L1082073129:
    ...
    if (CN1_CMP_EXPR(dlocals_9_, 0 /* DCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1131932964;
...
label_L1131932964:
    ...
    if (CN1_CMP_EXPR(dlocals_9_, 0 /* DCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1173015408;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_solveCubic___double_1ARRAY_double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_DOUBLE dlocals_23_ = 0; /* v23 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(8, 27, 0, 3731, 3742);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (CN1_CMP_EXPR(dlocals_2_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2050024203;
...
label_L2050024203:
    ...
    if (CN1_CMP_EXPR(dlocals_17_, dlocals_15_)>=0) /* IFGE CustomJump */ goto label_L499950630;
...
label_L499950630:
    ...
    if (CN1_CMP_EXPR(dlocals_13_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1913425792;
    __CN1_DEBUG_INFO(2419);
    /* VarOp.assignFrom */ dlocals_21_=(-(dlocals_21_));

label_L1913425792:
    __CN1_DEBUG_INFO(2422);
    if (CN1_CMP_EXPR(-1.0E-10, dlocals_21_)>=0) /* IFGE CustomJump */ goto label_L257495665;
    if (CN1_CMP_EXPR(dlocals_21_, 1.0E-10)>=0) /* IFGE CustomJump */ goto label_L257495665;
...
label_L257495665:
    ...
    if (CN1_CMP_EXPR(-1.0E-10, dlocals_25_)>=0) /* IFGE CustomJump */ goto label_L242113956;
    if (CN1_CMP_EXPR(dlocals_25_, 1.0E-10)>=0) /* IFGE CustomJump */ goto label_L242113956;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_fixRoots___double_1ARRAY_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 3731, 3743);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
label_L1504033633:
    if (ilocals_3_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L2009885224;
    __CN1_DEBUG_INFO(2448);
    /* VarOp.assignFrom */ ilocals_4_=(ilocals_3_ + 1 /* ICONST_1 */);

label_L1322359657:
    if (ilocals_4_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L187931144;
    __CN1_DEBUG_INFO(2449);
    if (/* CustomInvoke */com_codename1_ui_geom_GeneralPath_ShapeUtil_isZero___double_R_boolean(threadStateData, (CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_3_) - CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_4_)))==0) /* IFEQ CustomJump */ goto label_L492135521;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossLine___double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 12, 0, 3731, 3744);
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1868933720;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)<0) /* IFLT CustomJump */ goto label_L1956602275;

label_L1868933720:
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L920102538;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>0) /* IFGT CustomJump */ goto label_L1956602275;

label_L920102538:
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L1121811842;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)>0) /* IFGT CustomJump */ goto label_L1956602275;

label_L1121811842:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L2636011;
...
label_L2636011:
    ...
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L263574324;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L263574324;
    goto label_L73254846;

label_L263574324:
    __CN1_DEBUG_INFO(2685);
    if (CN1_CMP_EXPR((((dlocals_6_ - dlocals_2_) * (dlocals_8_ - dlocals_0_)) / (dlocals_4_ - dlocals_0_)), (dlocals_10_ - dlocals_2_))>0) /* IFGT CustomJump */ goto label_L73254846;
    __CN1_DEBUG_INFO(2687);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L73254846:
    __CN1_DEBUG_INFO(2692);
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)!=0) /* IFNE CustomJump */ goto label_L759536602;
    __CN1_DEBUG_INFO(2693);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1827344889;
    PUSH_INT(0); /* ICONST_0 */
...
label_L759536602:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L669781254;
    __CN1_DEBUG_INFO(2698);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L645323114;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L304504964;
...
label_L669781254:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1839613624;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossQuad___double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(14, 23, 0, 3731, 3745);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    dlocals_4_ = __cn1Arg3;
    dlocals_6_ = __cn1Arg4;
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L977847192;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)<0) /* IFLT CustomJump */ goto label_L457942549;

label_L977847192:
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L1141354562;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1141354562;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>0) /* IFGT CustomJump */ goto label_L457942549;

label_L1141354562:
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L1106675375;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L1106675375;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)>0) /* IFGT CustomJump */ goto label_L457942549;

label_L1106675375:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1038014730;
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L1038014730;
...
label_L1038014730:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L2078518186;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L2078518186;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L2078518186;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L2078518186;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L2078518186;
    __CN1_DEBUG_INFO(2721);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L44007732;
    __CN1_DEBUG_INFO(2722);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L2007608374;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L2007608374;
    PUSH_INT(1); /* ICONST_1 */
...
label_L44007732:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    PUSH_INT(-1); /* ICONST_M1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossCubic___double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10) {
    ...
    volatile JAVA_DOUBLE dlocals_23_ = 0; /* v23 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(18, 27, 0, 3731, 3746);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    dlocals_4_ = __cn1Arg3;
    dlocals_6_ = __cn1Arg4;
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L515244925;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L515244925;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)<0) /* IFLT CustomJump */ goto label_L53851094;

label_L515244925:
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L979166392;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L979166392;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<=0) /* IFLE CustomJump */ goto label_L979166392;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>0) /* IFGT CustomJump */ goto label_L53851094;

label_L979166392:
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L948208151;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L948208151;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L948208151;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)>0) /* IFGT CustomJump */ goto label_L53851094;

label_L948208151:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L369611665;
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L369611665;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)!=0) /* IFNE CustomJump */ goto label_L369611665;
...
label_L369611665:
    ...
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L948070788;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L948070788;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L948070788;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)>=0) /* IFGE CustomJump */ goto label_L948070788;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L948070788;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)==0) /* IFEQ CustomJump */ goto label_L948070788;
    __CN1_DEBUG_INFO(2753);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1696998152;
    __CN1_DEBUG_INFO(2754);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L2033090945;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L2033090945;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1696998152:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L2054738816;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L2054738816;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L772968868;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossPath___com_codename1_ui_geom_PathIterator_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3) {
    ...
    volatile JAVA_DOUBLE dlocals_8_ = 0; /* v8 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(21, 15, 0, 3731, 3747);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
label_L1562533966:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L599601006;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L417917785;
        case 1: goto label_L607178519;
        case 2: goto label_L513144196;
        case 3: goto label_L1419345767;
        case 4: goto label_L200598670;
        default: goto label_L698272400;
    }

label_L417917785:
    __CN1_DEBUG_INFO(2780);
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)!=0) /* IFNE CustomJump */ goto label_L412496882;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L124454336;
...
label_L200598670:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L731332919;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)==0) /* IFEQ CustomJump */ goto label_L698272400;
...
label_L698272400:
    ...
    if (CN1_CMP_EXPR(dlocals_1_, dlocals_10_)!=0) /* IFNE CustomJump */ goto label_L1946338463;
    if (CN1_CMP_EXPR(dlocals_3_, dlocals_12_)!=0) /* IFNE CustomJump */ goto label_L1946338463;
...
label_L1946338463:
    ...
    goto label_L1562533966;

label_L599601006:
    __CN1_DEBUG_INFO(2810);
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L37235503;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossShape___com_codename1_ui_geom_Shape_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3) {
    ...
    volatile JAVA_DOUBLE dlocals_3_ = 0; /* y */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 5, 0, 3731, 3748);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    dlocals_1_ = __cn1Arg2;
    dlocals_3_ = __cn1Arg3;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L322391206;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isZero___double_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 3731, 3749);
    dlocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2831);
    if (CN1_CMP_EXPR(-1.0E-5, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1903379555;
    if (CN1_CMP_EXPR(dlocals_0_, 1.0E-5)>=0) /* IFGE CustomJump */ goto label_L1903379555;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_ShapeUtil_sortBound___double_1ARRAY_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_DOUBLE dlocals_4_ = 0; /* v4 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 6, 0, 3731, 3750);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
...
label_L443021492:
    if (ilocals_2_>=(ilocals_1_ - 4/* ICONST_4 */)) /* IF_ICMPGE CustomJump */ goto label_L2092912524;
...
label_L1793511544:
    if (ilocals_4_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1438936769;
    __CN1_DEBUG_INFO(2841);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_3_), CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_4_))<=0) /* IFLE CustomJump */ goto label_L1056925766;
...
label_L1056925766:
    __CN1_DEBUG_INFO(2840);
    BC_IINC(4, 4);
    goto label_L1793511544;

label_L1438936769:
    __CN1_DEBUG_INFO(2845);
    if (ilocals_3_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L1822634375;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossBound___double_1ARRAY_int_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 11, 0, 3731, 3751);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1595870950;
...
label_L1151421920:
    if (ilocals_8_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L52850797;
    __CN1_DEBUG_INFO(2876);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_8_), dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1996248711;
...
label_L1996248711:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_8_), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1949625875;
...
label_L52850797:
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L1358787485;
    __CN1_DEBUG_INFO(2889);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1358787485:
    __CN1_DEBUG_INFO(2892);
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1578964260;
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, 2 /* ICONST_2 */), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L218770562;
    PUSH_INT(1); /* ICONST_1 */
...
label_L76032922:
    if (ilocals_9_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1578964260;
    __CN1_DEBUG_INFO(2897);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_9_), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L2018528489;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1314050802:
    ...
    if (ilocals_8_==ilocals_10_) /* IF_ICMPEQ CustomJump */ goto label_L308316550;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, (ilocals_9_ + 1 /* ICONST_1 */)), CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, (ilocals_9_ - 3 /* ICONST_3 */)))==0) /* IFEQ CustomJump */ goto label_L308316550;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectLine___double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 26, 0, 3731, 3752);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    dlocals_4_ = __cn1Arg3;
    dlocals_6_ = __cn1Arg4;
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L2126842086;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<0) /* IFLT CustomJump */ goto label_L651726990;

label_L2126842086:
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L820117866;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>0) /* IFGT CustomJump */ goto label_L651726990;

label_L820117866:
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L1978869783;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L1978869783;
...
label_L1978869783:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L598183031;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L598183031;
    goto label_L1092170861;

label_L598183031:
    __CN1_DEBUG_INFO(2925);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1641059445;
...
label_L1641059445:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L219130824;
    __CN1_DEBUG_INFO(2932);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L315902506;
    BC_DLOAD(8);
...
label_L442940993:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L2138104388;
    BC_DLOAD(4);
...
label_L219130824:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L274725976;
    BC_DLOAD(8);
...
label_L1749372629:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1831711067;
    BC_DLOAD(0);
...
label_L1063573827:
    ...
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L457727115;
    if (CN1_CMP_EXPR(dlocals_24_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L457727115;
    __CN1_DEBUG_INFO(2944);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L457727115:
    __CN1_DEBUG_INFO(2948);
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L1505331921;
    if (CN1_CMP_EXPR(dlocals_24_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L1505331921;
    goto label_L1092170861;
...
label_L1092170861:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1495162836;
    __CN1_DEBUG_INFO(2956);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1495162836:
    __CN1_DEBUG_INFO(2960);
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)!=0) /* IFNE CustomJump */ goto label_L2076014264;
    __CN1_DEBUG_INFO(2961);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L575197504;
    PUSH_INT(0); /* ICONST_0 */
...
label_L2076014264:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L477700359;
    __CN1_DEBUG_INFO(2966);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L216112262;
    PUSH_INT(1); /* ICONST_1 */
...
label_L477700359:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1318395825;
    __CN1_DEBUG_INFO(2970);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L456228477;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L456228477;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1318395825:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1339273738;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1339273738;
    PUSH_INT(-1); /* ICONST_M1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectQuad___double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10) {
    ...
    volatile JAVA_DOUBLE dlocals_23_ = 0; /* v23 */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(14, 40, 0, 3731, 3753);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    dlocals_4_ = __cn1Arg3;
    dlocals_6_ = __cn1Arg4;
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L965674262;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L965674262;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<0) /* IFLT CustomJump */ goto label_L78109530;

label_L965674262:
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L1454795302;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1454795302;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>0) /* IFGT CustomJump */ goto label_L78109530;

label_L1454795302:
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L361656258;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L361656258;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L361656258;
...
label_L361656258:
    ...
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1416134608;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1416134608;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L1416134608;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L1416134608;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L1416134608;
    __CN1_DEBUG_INFO(2991);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1856963340;
    __CN1_DEBUG_INFO(2992);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L187540389;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L187540389;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1840987517;
...
label_L1856963340:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L2050640357;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L2050640357;
    PUSH_INT(-1); /* ICONST_M1 */
...
label_L1416134608:
    ...
    if (ilocals_31_!=0) /* IFNE CustomJump */ goto label_L181220448;
    if (ilocals_32_!=0) /* IFNE CustomJump */ goto label_L181220448;
...
label_L181220448:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1051304081;
...
label_L1051304081:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L385131456;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L385131456;
...
label_L385131456:
    ...
    SP++;
    PUSH_INT(254);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L642340409;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectCubic___double_double_double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10, JAVA_DOUBLE __cn1Arg11, JAVA_DOUBLE __cn1Arg12) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(18, 44, 0, 3731, 3754);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    dlocals_4_ = __cn1Arg3;
    dlocals_6_ = __cn1Arg4;
    ...
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1170475172;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1170475172;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1170475172;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_12_)<0) /* IFLT CustomJump */ goto label_L916100517;

label_L1170475172:
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L88332821;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L88332821;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<=0) /* IFLE CustomJump */ goto label_L88332821;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>0) /* IFGT CustomJump */ goto label_L916100517;

label_L88332821:
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L1775746074;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L1775746074;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L1775746074;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L1775746074;
...
label_L1775746074:
    ...
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_14_)>=0) /* IFGE CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)==0) /* IFEQ CustomJump */ goto label_L213063852;
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L1978560393;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1978560393;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1852212002:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L896475319;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L896475319;
    PUSH_INT(-1); /* ICONST_M1 */
...
label_L213063852:
    ...
    if (ilocals_35_!=0) /* IFNE CustomJump */ goto label_L1776186092;
    if (ilocals_36_!=0) /* IFNE CustomJump */ goto label_L1776186092;
...
label_L1776186092:
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L566860479;
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_20_)>=0) /* IFGE CustomJump */ goto label_L566860479;
...
label_L566860479:
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1836018857;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_20_)>=0) /* IFGE CustomJump */ goto label_L1836018857;
...
label_L1836018857:
    ...
    SP++;
    PUSH_INT(254);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1414097965;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isInsideNonZero___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 3731, 3757);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(3194);
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L1567135053;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isInsideEvenOdd___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_0_ = 0; /* cross */
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 3731, 3758);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(3201);
    if ((ilocals_0_ & 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L65830581;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_access$400___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_com_codename1_ui_geom_GeneralPath_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    __STATIC_INITIALIZER_com_codename1_ui_geom_GeneralPath_ShapeUtil(threadStateData);
    DEFINE_METHOD_STACK(3, 3, 0, 3731, 525);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
