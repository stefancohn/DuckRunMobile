...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersection___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_com_codename1_ui_geom_GeneralPath_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    int restoreToL137603546001;
    int tryBlockOffsetL137603546001;
    DEFINE_CATCH_BLOCK(catch_L137603546001, label_L1824877362, restoreToL137603546001);
    int restoreToL177776652002;
    int tryBlockOffsetL177776652002;
    DEFINE_CATCH_BLOCK(catch_L177776652002, label_L1824877362, restoreToL177776652002);
    int restoreToL182487736203;
    int tryBlockOffsetL182487736203;
    DEFINE_CATCH_BLOCK(catch_L182487736203, label_L1824877362, restoreToL182487736203);
    __CN1_DEBUG_INFO(1840);
    if (virtual_com_codename1_ui_geom_Rectangle_getWidth___R_int(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1140727816, 0);
    if (virtual_com_codename1_ui_geom_Rectangle_getHeight___R_int(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1428942383, 0);
...
label_L1376035460:
 tryBlockOffsetL137603546001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L137603546001);
    restoreToL137603546001 = threadStateData->threadObjectStackOffset;
...
label_L1494084149:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1783905801, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L755979402, 1);
        case 1: JUMP_TO(label_L755979402, 1);
        case 2: JUMP_TO(label_L532930371, 1);
        case 3: JUMP_TO(label_L532930371, 1);
        case 4: JUMP_TO(label_L353566722, 1);
        default: JUMP_TO(label_L1585238239, 1);
    }
...
label_L353566722:
    ...
    JUMP_TO(label_L151020702, 1);

label_L532930371:
    __CN1_DEBUG_INFO(1880);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L146316090, 1);
...
label_L146316090:
    ...
    if (ilocals_25_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L86411583, 1);
...
label_L1038375788:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L2078785618, 1);
...
label_L2078785618:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1436146784, 1);
...
label_L1436146784:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1895167389, 1);
...
label_L1895167389:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1950554162, 1);
    { JAVA_DOUBLE tmpResult = virtual_com_codename1_ui_geom_Rectangle2D_getY___R_double(threadStateData, locals[27].data.o);
    PUSH_DOUBLE(tmpResult); }
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1872928774, 1);
...
label_L1872928774:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle2D_contains___double_double_R_boolean(threadStateData, locals[3].data.o, /* CustomInvoke */virtual_com_codename1_ui_geom_Geometry_BezierCurve_x___double_R_double(threadStateData, locals[22].data.o, 0.5), /* CustomInvoke */virtual_com_codename1_ui_geom_Geometry_BezierCurve_y___double_R_double(threadStateData, locals[22].data.o, 0.5))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1884890921, 1);
...
label_L1884890921:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L803175842, 1);
...
label_L803175842:
    ...
    SP[-1].data.d = SP[-1].data.f; /* F2D */
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L963205123, 1);
...
label_L1423314849:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L1877123942, 1);
...
label_L766796213:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1551484396, 1);
...
label_L1551484396:
    ...
    BC_DLOAD(23);
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L887814593, 1);
...
label_L755979402:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_8_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1539273803, 1);
...
label_L1539273803:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_9_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1434984256, 1);
    __CN1_DEBUG_INFO(1978);
    CN1_SET_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */, flocals_9_);

label_L1434984256:
    __CN1_DEBUG_INFO(1980);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_10_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1196222136, 1);
...
label_L1196222136:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_11_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L613100385, 1);
...
label_L613100385:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_12_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L298939230, 1);
...
label_L298939230:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */), flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1285933977, 1);
...
label_L1285933977:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_13_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1652748779, 1);
...
label_L1652748779:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L302869695, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */), flocals_15_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1880527972, 1);
...
label_L1880527972:
    ...
    if (ilocals_25_!=0) /* IFNE CustomJump */ JUMP_TO(label_L286637708, 1);
...
label_L286637708:
    ...
    if (CN1_CMP_EXPR(flocals_16_, CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 0 /* ICONST_0 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L503117914, 1);
    if (CN1_CMP_EXPR(flocals_17_, CN1_ARRAY_ELEMENT_FLOAT(locals[6].data.o, 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1693260012, 1);
...
label_L151020702:
    ...
    JUMP_TO(label_L1494084149, 1);

label_L1783905801:
    __CN1_DEBUG_INFO(2023);
    if (CN1_CMP_EXPR((flocals_14_ - flocals_12_), 1 /* FCONST_1 */)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1699794502, 1);
    if (CN1_CMP_EXPR((flocals_15_ - flocals_13_), 1 /* FCONST_1 */)>0) /* IFGT CustomJump */ JUMP_TO(label_L1777766520, 0);
...
label_L1777766520:
 tryBlockOffsetL177776652002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L177776652002);
    restoreToL177776652002 = threadStateData->threadObjectStackOffset;
...
label_L1824877362:
 tryBlockOffsetL182487736203 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L182487736203);
    restoreToL182487736203 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_segmentShape___com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Shape_com_codename1_ui_geom_GeneralPath_R_com_codename1_ui_geom_GeneralPath(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    locals[2].data.o = __cn1Arg3;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL164033448201;
    int tryBlockOffsetL164033448201;
    DEFINE_CATCH_BLOCK(catch_L164033448201, label_L330472244, restoreToL164033448201);
    int restoreToL33047224402;
    int tryBlockOffsetL33047224402;
    DEFINE_CATCH_BLOCK(catch_L33047224402, label_L330472244, restoreToL33047224402);
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2056);
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L626562869, 0);
...
label_L1640334482:
 tryBlockOffsetL164033448201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L164033448201);
    restoreToL164033448201 = threadStateData->threadObjectStackOffset;
...
label_L354051480:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[8].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1184452390, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L464614109, 1);
        case 1: JUMP_TO(label_L484258212, 1);
        case 2: JUMP_TO(label_L2111700021, 1);
        case 3: JUMP_TO(label_L1899064535, 1);
        case 4: JUMP_TO(label_L1627840438, 1);
        default: JUMP_TO(label_L337875491, 1);
    }
...
label_L464614109:
    ...
    JUMP_TO(label_L109967558, 1);

label_L2111700021:
    __CN1_DEBUG_INFO(2091);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2082499348, 1);
...
label_L2082499348:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L730656841, 1);
...
label_L898883700:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1251232505, 1);
...
label_L1899064535:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2043756599, 1);
...
label_L2043756599:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1813922009, 1);
...
label_L78973985:
    ...
    /* VarOp.assignFrom */ locals[19].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, locals[4].data.o);locals[19].type=CN1_TYPE_OBJECT;
label_L1571615117:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L772791427, 1);
...
label_L99827309:
    if (ilocals_21_>=ilocals_20_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1072267396, 1);
    __CN1_DEBUG_INFO(2177);
    /* CustomInvoke */virtual_com_codename1_ui_geom_GeneralPath_lineTo___float_float(threadStateData, locals[2].data.o, CN1_ARRAY_ELEMENT_FLOAT(locals[13].data.o, ilocals_21_), CN1_ARRAY_ELEMENT_FLOAT(locals[13].data.o, (ilocals_21_ + 1 /* ICONST_1 */))); 
    __CN1_DEBUG_INFO(2176);
    BC_IINC(21, 2);
    JUMP_TO(label_L99827309, 1);
...
label_L330472244:
 tryBlockOffsetL33047224402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L33047224402);
    restoreToL33047224402 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectLineWithRectAsHash___float_float_float_float_com_codename1_ui_geom_Rectangle_float_1ARRAY_R_float_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_OBJECT __cn1Arg6) {
    ...
    int restoreToL198165889501;
    int tryBlockOffsetL198165889501;
    DEFINE_CATCH_BLOCK(catch_L198165889501, label_L1873010424, restoreToL198165889501);
    int restoreToL187301042402;
    int tryBlockOffsetL187301042402;
    DEFINE_CATCH_BLOCK(catch_L187301042402, label_L1873010424, restoreToL187301042402);
...
label_L1981658895:
 tryBlockOffsetL198165889501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L198165889501);
    restoreToL198165889501 = threadStateData->threadObjectStackOffset;
    ...
    if (CN1_CMP_EXPR(flocals_11_, 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L473800232, 1);
    __CN1_DEBUG_INFO(2224);
    if (CN1_CMP_EXPR(flocals_8_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L10603412, 1);
    if (CN1_CMP_EXPR(flocals_8_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L10603412, 1);
...
label_L10603412:
    ...
    if (CN1_CMP_EXPR(flocals_10_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1188120765, 1);
    if (CN1_CMP_EXPR(flocals_10_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1188120765, 1);
...
label_L1188120765:
    ...
    if (CN1_CMP_EXPR(flocals_1_, flocals_3_)>0) /* IFGT CustomJump */ JUMP_TO(label_L938744449, 1);
    __CN1_DEBUG_INFO(2237);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1237024911:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1204297353, 1);
...
label_L1204297353:
    ...
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); /* FASTORE */
    FLOAT_ARRAY_LOOKUP((JAVA_ARRAY)SP[-3].data.o, SP[-2].data.i) = SP[-1].data.f; SP -= 3;
    JUMP_TO(label_L307531674, 1);

label_L473800232:
    __CN1_DEBUG_INFO(2254);
    if (CN1_CMP_EXPR(flocals_12_, 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L359659279, 1);
    __CN1_DEBUG_INFO(2255);
    if (CN1_CMP_EXPR(flocals_7_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L12952277, 1);
    if (CN1_CMP_EXPR(flocals_7_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L12952277, 1);
...
label_L12952277:
    ...
    if (CN1_CMP_EXPR(flocals_9_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L408107501, 1);
    if (CN1_CMP_EXPR(flocals_9_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L408107501, 1);
...
label_L408107501:
    ...
    if (CN1_CMP_EXPR(flocals_0_, flocals_2_)>0) /* IFGT CustomJump */ JUMP_TO(label_L776817954, 1);
    __CN1_DEBUG_INFO(2267);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1762578746:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1148194923, 1);
...
label_L359659279:
    ...
    if (CN1_CMP_EXPR(flocals_7_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L745764314, 1);
    if (CN1_CMP_EXPR(flocals_7_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L745764314, 1);
...
label_L745764314:
    ...
    if (CN1_CMP_EXPR(flocals_9_, flocals_16_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1757731703, 1);
    if (CN1_CMP_EXPR(flocals_9_, flocals_17_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1757731703, 1);
...
label_L1757731703:
    ...
    if (CN1_CMP_EXPR(flocals_8_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2002534484, 1);
    if (CN1_CMP_EXPR(flocals_8_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L2002534484, 1);
...
label_L2002534484:
    ...
    if (CN1_CMP_EXPR(flocals_10_, flocals_14_)<=0) /* IFLE CustomJump */ JUMP_TO(label_L129165617, 1);
    if (CN1_CMP_EXPR(flocals_10_, flocals_15_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L129165617, 1);
...
label_L129165617:
    ...
    if (CN1_CMP_EXPR(flocals_0_, flocals_2_)>=0) /* IFGE CustomJump */ JUMP_TO(label_L811106744, 1);
    __CN1_DEBUG_INFO(2310);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1807899330:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2122967975, 1);
...
label_L1873010424:
 tryBlockOffsetL187301042402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L187301042402);
    restoreToL187301042402 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_solveQuad___double_1ARRAY_double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(dlocals_2_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L252237430;
    __CN1_DEBUG_INFO(2363);
    if (CN1_CMP_EXPR(dlocals_4_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1055772899;
...
label_L1928550961:
    ...
    if (CN1_CMP_EXPR(dlocals_9_, 0 /* DCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1199606198;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_solveCubic___double_1ARRAY_double_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(dlocals_2_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L989956479;
...
label_L989956479:
    ...
    if (CN1_CMP_EXPR(dlocals_17_, dlocals_15_)>=0) /* IFGE CustomJump */ goto label_L1799040052;
...
label_L1799040052:
    ...
    if (CN1_CMP_EXPR(dlocals_13_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1082073129;
    __CN1_DEBUG_INFO(2419);
    /* VarOp.assignFrom */ dlocals_21_=(-(dlocals_21_));

label_L1082073129:
    __CN1_DEBUG_INFO(2422);
    if (CN1_CMP_EXPR(-1.0E-10, dlocals_21_)>=0) /* IFGE CustomJump */ goto label_L1996620584;
    if (CN1_CMP_EXPR(dlocals_21_, 1.0E-10)>=0) /* IFGE CustomJump */ goto label_L1996620584;
...
label_L1996620584:
    ...
    if (CN1_CMP_EXPR(-1.0E-10, dlocals_25_)>=0) /* IFGE CustomJump */ goto label_L683005404;
    if (CN1_CMP_EXPR(dlocals_25_, 1.0E-10)>=0) /* IFGE CustomJump */ goto label_L683005404;
...
label_L1913425792:
    if (ilocals_3_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1173015408;
    __CN1_DEBUG_INFO(2448);
    /* VarOp.assignFrom */ ilocals_4_=(ilocals_3_ + 1 /* ICONST_1 */);

label_L242113956:
    if (ilocals_4_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1131932964;
    __CN1_DEBUG_INFO(2449);
    if (/* CustomInvoke */com_codename1_ui_geom_GeneralPath_ShapeUtil_isZero___double_R_boolean(threadStateData, (CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_3_) - CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_4_)))==0) /* IFEQ CustomJump */ goto label_L2050024203;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossLine___double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6) {
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L257495665;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)<0) /* IFLT CustomJump */ goto label_L2009885224;

label_L257495665:
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L187931144;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>0) /* IFGT CustomJump */ goto label_L2009885224;

label_L187931144:
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L492135521;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)>0) /* IFGT CustomJump */ goto label_L2009885224;

label_L492135521:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1515730720;
...
label_L1515730720:
    ...
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1322359657;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1322359657;
    goto label_L1504033633;

label_L1322359657:
    __CN1_DEBUG_INFO(2685);
    if (CN1_CMP_EXPR((((dlocals_6_ - dlocals_2_) * (dlocals_8_ - dlocals_0_)) / (dlocals_4_ - dlocals_0_)), (dlocals_10_ - dlocals_2_))>0) /* IFGT CustomJump */ goto label_L1504033633;
    __CN1_DEBUG_INFO(2687);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1504033633:
    __CN1_DEBUG_INFO(2692);
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)!=0) /* IFNE CustomJump */ goto label_L1868933720;
    __CN1_DEBUG_INFO(2693);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1956602275;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L920102538;
...
label_L1868933720:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1121811842;
...
label_L1121811842:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L73254846;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossQuad___double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8) {
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1827344889;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1827344889;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)<0) /* IFLT CustomJump */ goto label_L1298547491;

label_L1827344889:
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L669781254;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L669781254;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>0) /* IFGT CustomJump */ goto label_L1298547491;

label_L669781254:
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L645323114;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L645323114;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)>0) /* IFGT CustomJump */ goto label_L1298547491;

label_L645323114:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L304504964;
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L304504964;
...
label_L304504964:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1839613624;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1839613624;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L1839613624;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L1839613624;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L1839613624;
    __CN1_DEBUG_INFO(2721);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L711320119;
    __CN1_DEBUG_INFO(2722);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L977847192;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L977847192;
    PUSH_INT(1); /* ICONST_1 */
...
label_L711320119:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1141354562;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1141354562;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L1106675375;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossCubic___double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10) {
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1038014730;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1038014730;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1038014730;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)<0) /* IFLT CustomJump */ goto label_L2078518186;

label_L1038014730:
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L44007732;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L44007732;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<=0) /* IFLE CustomJump */ goto label_L44007732;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>0) /* IFGT CustomJump */ goto label_L2078518186;

label_L44007732:
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L2007608374;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L2007608374;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L2007608374;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)>0) /* IFGT CustomJump */ goto label_L2078518186;

label_L2007608374:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1014250816;
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L1014250816;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)!=0) /* IFNE CustomJump */ goto label_L1014250816;
...
label_L1014250816:
    ...
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)>=0) /* IFGE CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L1521250207;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)==0) /* IFEQ CustomJump */ goto label_L1521250207;
    __CN1_DEBUG_INFO(2753);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L608486367;
    __CN1_DEBUG_INFO(2754);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L515244925;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L515244925;
    PUSH_INT(1); /* ICONST_1 */
...
label_L608486367:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L979166392;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L979166392;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L948208151;
...
label_L1419345767:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L369611665;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L948070788;
        case 1: goto label_L1696998152;
        case 2: goto label_L2033090945;
        case 3: goto label_L1360879214;
        case 4: goto label_L2054738816;
        default: goto label_L772968868;
    }

label_L948070788:
    __CN1_DEBUG_INFO(2780);
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)!=0) /* IFNE CustomJump */ goto label_L599601006;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L417917785;
...
label_L2054738816:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)!=0) /* IFNE CustomJump */ goto label_L607178519;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)==0) /* IFEQ CustomJump */ goto label_L772968868;
...
label_L772968868:
    ...
    if (CN1_CMP_EXPR(dlocals_1_, dlocals_10_)!=0) /* IFNE CustomJump */ goto label_L513144196;
    if (CN1_CMP_EXPR(dlocals_3_, dlocals_12_)!=0) /* IFNE CustomJump */ goto label_L513144196;
    __CN1_DEBUG_INFO(2804);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(2805);
    /* VarOp.assignFrom */     dlocals_12_ = dlocals_8_;
    __CN1_DEBUG_INFO(2806);
    goto label_L369611665;
...
label_L369611665:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L200598670;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossShape___com_codename1_ui_geom_Shape_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L698272400;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isZero___double_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (CN1_CMP_EXPR(-1.0E-5, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L412496882;
    if (CN1_CMP_EXPR(dlocals_0_, 1.0E-5)>=0) /* IFGE CustomJump */ goto label_L412496882;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1903379555:
    if (ilocals_2_>=(ilocals_1_ - 4/* ICONST_4 */)) /* IF_ICMPGE CustomJump */ goto label_L731332919;
...
label_L37235503:
    if (ilocals_4_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1946338463;
    __CN1_DEBUG_INFO(2841);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_3_), CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_4_))<=0) /* IFLE CustomJump */ goto label_L1562533966;
...
label_L1946338463:
    ...
    if (ilocals_3_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L322391206;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_crossBound___double_1ARRAY_int_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4) {
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1058892307;
...
label_L1822634375:
    if (ilocals_8_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L2092912524;
    __CN1_DEBUG_INFO(2876);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_8_), dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1438936769;
...
label_L1438936769:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_8_), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1793511544;
...
label_L2092912524:
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L443021492;
    __CN1_DEBUG_INFO(2889);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L443021492:
    __CN1_DEBUG_INFO(2892);
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1595870950;
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, 2 /* ICONST_2 */), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L52850797;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1358787485:
    if (ilocals_9_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1595870950;
    __CN1_DEBUG_INFO(2897);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, ilocals_9_), dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1409004212;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1949625875:
    ...
    if (ilocals_8_==ilocals_10_) /* IF_ICMPEQ CustomJump */ goto label_L1151421920;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, (ilocals_9_ + 1 /* ICONST_1 */)), CN1_ARRAY_ELEMENT_DOUBLE(locals[0].data.o, (ilocals_9_ - 3 /* ICONST_3 */)))==0) /* IFEQ CustomJump */ goto label_L1151421920;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectLine___double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8) {
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1578964260;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<0) /* IFLT CustomJump */ goto label_L218770562;

label_L1578964260:
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L1124773518;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>0) /* IFGT CustomJump */ goto label_L218770562;

label_L1124773518:
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L2018528489;
    if (CN1_CMP_EXPR(dlocals_10_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L2018528489;
...
label_L2018528489:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1314050802;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1314050802;
    goto label_L308316550;

label_L1314050802:
    __CN1_DEBUG_INFO(2925);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L76032922;
...
label_L76032922:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L2126842086;
    __CN1_DEBUG_INFO(2932);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L651726990;
    BC_DLOAD(8);
...
label_L820117866:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1978869783;
    BC_DLOAD(4);
...
label_L2126842086:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1641059445;
    BC_DLOAD(8);
...
label_L219130824:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L315902506;
    BC_DLOAD(0);
...
label_L1092170861:
    ...
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L2138104388;
    if (CN1_CMP_EXPR(dlocals_24_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L2138104388;
    __CN1_DEBUG_INFO(2944);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L2138104388:
    __CN1_DEBUG_INFO(2948);
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L265373577;
    if (CN1_CMP_EXPR(dlocals_24_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L265373577;
    goto label_L308316550;
...
label_L308316550:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1063573827;
    __CN1_DEBUG_INFO(2956);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1063573827:
    __CN1_DEBUG_INFO(2960);
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)!=0) /* IFNE CustomJump */ goto label_L274725976;
    __CN1_DEBUG_INFO(2961);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1749372629;
    PUSH_INT(0); /* ICONST_0 */
...
label_L274725976:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)!=0) /* IFNE CustomJump */ goto label_L1956303740;
...
label_L1956303740:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1495162836;
    __CN1_DEBUG_INFO(2970);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L2076014264;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L2076014264;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1495162836:
    ...
    if (CN1_CMP_EXPR(dlocals_4_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L934426842;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L934426842;
    PUSH_INT(-1); /* ICONST_M1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectQuad___double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10) {
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L216112262;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L216112262;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<0) /* IFLT CustomJump */ goto label_L1749524107;

label_L216112262:
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L1318395825;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1318395825;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>0) /* IFGT CustomJump */ goto label_L1749524107;

label_L1318395825:
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L456228477;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L456228477;
    if (CN1_CMP_EXPR(dlocals_14_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L456228477;
...
label_L456228477:
    ...
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L464831537;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L464831537;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L464831537;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L464831537;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)==0) /* IFEQ CustomJump */ goto label_L464831537;
    __CN1_DEBUG_INFO(2991);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1339273738;
    __CN1_DEBUG_INFO(2992);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L693982422;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L693982422;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1339273738:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L78109530;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L78109530;
    PUSH_INT(-1); /* ICONST_M1 */
...
label_L464831537:
    ...
    if (ilocals_31_!=0) /* IFNE CustomJump */ goto label_L361656258;
    if (ilocals_32_!=0) /* IFNE CustomJump */ goto label_L361656258;
...
label_L361656258:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L1416134608;
...
label_L1416134608:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1856963340;
    if (CN1_CMP_EXPR(dlocals_8_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L1856963340;
...
label_L1856963340:
    ...
    SP++;
    PUSH_INT(254);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L187540389;
...
JAVA_INT com_codename1_ui_geom_GeneralPath_ShapeUtil_intersectCubic___double_double_double_double_double_double_double_double_double_double_double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4, JAVA_DOUBLE __cn1Arg5, JAVA_DOUBLE __cn1Arg6, JAVA_DOUBLE __cn1Arg7, JAVA_DOUBLE __cn1Arg8, JAVA_DOUBLE __cn1Arg9, JAVA_DOUBLE __cn1Arg10, JAVA_DOUBLE __cn1Arg11, JAVA_DOUBLE __cn1Arg12) {
    ...
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L1840987517;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_4_)>=0) /* IFGE CustomJump */ goto label_L1840987517;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_8_)>=0) /* IFGE CustomJump */ goto label_L1840987517;
    if (CN1_CMP_EXPR(dlocals_20_, dlocals_12_)<0) /* IFLT CustomJump */ goto label_L2050640357;

label_L1840987517:
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)<=0) /* IFLE CustomJump */ goto label_L1813742285;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_4_)<=0) /* IFLE CustomJump */ goto label_L1813742285;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_8_)<=0) /* IFLE CustomJump */ goto label_L1813742285;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>0) /* IFGT CustomJump */ goto label_L2050640357;

label_L1813742285:
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L181220448;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_6_)<=0) /* IFLE CustomJump */ goto label_L181220448;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_10_)<=0) /* IFLE CustomJump */ goto label_L181220448;
    if (CN1_CMP_EXPR(dlocals_18_, dlocals_14_)<=0) /* IFLE CustomJump */ goto label_L181220448;
...
label_L181220448:
    ...
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L1051304081;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_6_)>=0) /* IFGE CustomJump */ goto label_L1051304081;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_10_)>=0) /* IFGE CustomJump */ goto label_L1051304081;
    if (CN1_CMP_EXPR(dlocals_22_, dlocals_14_)>=0) /* IFGE CustomJump */ goto label_L1051304081;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L1051304081;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)==0) /* IFEQ CustomJump */ goto label_L1051304081;
    __CN1_DEBUG_INFO(3062);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L385131456;
    __CN1_DEBUG_INFO(3063);
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L642340409;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L642340409;
    PUSH_INT(1); /* ICONST_1 */
...
label_L385131456:
    ...
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_16_)>=0) /* IFGE CustomJump */ goto label_L916100517;
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L916100517;
    PUSH_INT(-1); /* ICONST_M1 */
...
label_L1051304081:
    ...
    if (ilocals_35_!=0) /* IFNE CustomJump */ goto label_L1775746074;
    if (ilocals_36_!=0) /* IFNE CustomJump */ goto label_L1775746074;
...
label_L1775746074:
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_0_)>=0) /* IFGE CustomJump */ goto label_L213063852;
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_20_)>=0) /* IFGE CustomJump */ goto label_L213063852;
...
label_L213063852:
    ...
    if (CN1_CMP_EXPR(dlocals_16_, dlocals_12_)>=0) /* IFGE CustomJump */ goto label_L1852212002;
    if (CN1_CMP_EXPR(dlocals_12_, dlocals_20_)>=0) /* IFGE CustomJump */ goto label_L1852212002;
...
label_L1852212002:
    ...
    SP++;
    PUSH_INT(254);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1978560393;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isInsideNonZero___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L289214325;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_ShapeUtil_isInsideEvenOdd___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    if ((ilocals_0_ & 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L2000630624;
    PUSH_INT(1); /* ICONST_1 */
