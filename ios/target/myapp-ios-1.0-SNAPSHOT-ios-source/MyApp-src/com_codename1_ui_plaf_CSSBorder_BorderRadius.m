...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderRadius___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 5764, 205);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))<=0) /* IFLE CustomJump */ goto label_L1474310983;
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L786116491;
...
label_L786116491:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L568239889;
...
label_L568239889:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L2004013670;
...
label_L2004013670:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L10624116;
...
label_L10624116:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5770));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1933513621:
    __CN1_DEBUG_INFO(689);
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L193598542;
...
label_L193598542:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1043907698;
...
label_L1043907698:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L787033725;
...
label_L787033725:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1973053322;
...
label_L1474310983:
    ...
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */com_codename1_io_Util_split___java_lang_String_java_lang_String_R_java_lang_String_1ARRAY(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(617));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(715);
    BC_ALOAD(3);
    { /* ARRAYLENGTH */
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L347645777;
        case 2: goto label_L1933965693;
        case 3: goto label_L1430611624;
        case 4: goto label_L1711410537;
        default: goto label_L928099543;
    }
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_BorderRadius_hasNonZeroRadius___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5764, 5773);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(765);
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1803756881;
    if (virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L353201839;

label_L1803756881:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1662140450;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L353201839;

label_L1662140450:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1495232387;
...
label_L1495232387:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L725901404;
...
label_L725901404:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1430395789;
...
label_L1430395789:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L614482519;
...
label_L614482519:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L107041335;
...
label_L107041335:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L246383655;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject));
    __CN1_DEBUG_INFO(772);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L246383655;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5774);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(776);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1835022815;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5775);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(783);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1629241006;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5776);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(790);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L333447190;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5777);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(797);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2067578478;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5778);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(804);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L394190359;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5779);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(811);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L387410712;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5780);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(818);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L82065756;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5764, 5781);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(825);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L448084064;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderRadius_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5764, 5620);
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderRadius_access$200___com_codename1_ui_plaf_CSSBorder_BorderRadius_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_plaf_CSSBorder_BorderRadius(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 5764, 803);
