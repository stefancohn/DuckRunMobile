...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderRadius___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))<=0) /* IFLE CustomJump */ goto label_L1933513621;
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L568239889;
...
label_L568239889:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L10624116;
...
label_L10624116:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L193598542;
...
label_L193598542:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1605950465;
...
label_L2004013670:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1043907698;
    ...
    POP_MANY(2);
    goto label_L787033725;

label_L1043907698:
    __CN1_DEBUG_INFO(694);
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1973053322;
...
label_L1973053322:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L1826350572;
...
label_L1826350572:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L347645777;
...
label_L1933513621:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1430611624;
        case 2: goto label_L1711410537;
        case 3: goto label_L928099543;
        case 4: goto label_L1803756881;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_BorderRadius_hasNonZeroRadius___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1662140450;
    if (virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1495232387;

label_L1662140450:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L725901404;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1495232387;

label_L725901404:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1430395789;
...
label_L1430395789:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L614482519;
...
label_L614482519:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L107041335;
...
label_L107041335:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L246383655;
...
label_L246383655:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1274308620;
...
label_L1274308620:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1835022815;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject));
    __CN1_DEBUG_INFO(772);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1835022815;
