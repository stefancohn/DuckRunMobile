...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL32010651001;
    int tryBlockOffsetL32010651001;
    DEFINE_CATCH_BLOCK(catch_L32010651001, label_L703627308, restoreToL32010651001);
    __CN1_DEBUG_INFO(625);
    if (get_field_com_codename1_impl_ios_IOSImplementation_4_val_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L979420182, 0);
    __CN1_DEBUG_INFO(626);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L979420182, 0);
...
label_L320106510:
 tryBlockOffsetL32010651001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L32010651001);
    restoreToL32010651001 = threadStateData->threadObjectStackOffset;
