...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL144276537501;
    int tryBlockOffsetL144276537501;
    DEFINE_CATCH_BLOCK(catch_L144276537501, label_L1511004956, restoreToL144276537501);
...
label_L1442765375:
 tryBlockOffsetL144276537501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L144276537501);
    restoreToL144276537501 = threadStateData->threadObjectStackOffset;
