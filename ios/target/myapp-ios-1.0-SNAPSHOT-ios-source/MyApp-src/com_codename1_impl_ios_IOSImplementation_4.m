...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL126752795101;
    int tryBlockOffsetL126752795101;
    DEFINE_CATCH_BLOCK(catch_L126752795101, label_L1511004956, restoreToL126752795101);
...
label_L1267527951:
 tryBlockOffsetL126752795101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L126752795101);
    restoreToL126752795101 = threadStateData->threadObjectStackOffset;
