...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4___INIT_____com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9622, 205);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 9622, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL167903205101;
    int tryBlockOffsetL167903205101;
    DEFINE_CATCH_BLOCK(catch_L167903205101, label_L244297136, restoreToL167903205101);
    __CN1_DEBUG_INFO(625);
    if (get_field_com_codename1_impl_ios_IOSImplementation_4_val_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1835316563, 0);
    __CN1_DEBUG_INFO(626);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1835316563, 0);
...
label_L1679032051:
 tryBlockOffsetL167903205101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L167903205101);
    restoreToL167903205101 = threadStateData->threadObjectStackOffset;
