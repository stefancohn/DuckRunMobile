...
extern void __INIT_VTABLE_java_util_TreeMap_AbstractSubMapIterator(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_TreeMap_AbstractSubMapIterator(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_TreeMap_AbstractSubMapIterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_TreeMap_AbstractSubMapIterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
...
JAVA_INT java_util_TreeMap_AbstractSubMapIterator_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_TreeMap_AbstractSubMapIterator_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_TreeMap_AbstractSubMapIterator_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_OBJECT java_util_TreeMap_AbstractSubMapIterator_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_util_TreeMap_AbstractSubMapIterator_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
JAVA_OBJECT get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(JAVA_OBJECT t);
...
JAVA_INT get_field_java_util_TreeMap_AbstractSubMapIterator_expectedModCount(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_java_util_TreeMap_AbstractSubMapIterator_node(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_java_util_TreeMap_AbstractSubMapIterator_boundaryPair(JAVA_OBJECT t);
...
JAVA_INT get_field_java_util_TreeMap_AbstractSubMapIterator_offset(JAVA_OBJECT t);
...
JAVA_INT get_field_java_util_TreeMap_AbstractSubMapIterator_lastOffset(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_java_util_TreeMap_AbstractSubMapIterator_getToEnd(JAVA_OBJECT t);
...
struct obj__java_util_TreeMap_AbstractSubMapIterator {
    DEBUG_GC_VARIABLES
...
#endif //__JAVA_UTIL_TREEMAP_ABSTRACTSUBMAPITERATOR__
