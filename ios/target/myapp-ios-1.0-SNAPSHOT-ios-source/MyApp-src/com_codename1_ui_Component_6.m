...
JAVA_VOID com_codename1_ui_Component_6_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_ui_Component_access$1000___com_codename1_ui_Component_R_boolean(threadStateData, get_field_com_codename1_ui_Component_6_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L806588571;
