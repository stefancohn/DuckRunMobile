...
JAVA_VOID com_codename1_impl_ios_ZoozPurchase_2___INIT_____com_codename1_impl_ios_ZoozPurchase_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 9742, 205);
...
JAVA_VOID com_codename1_impl_ios_ZoozPurchase_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 9742, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(171);
    if (/* CustomInvoke */com_codename1_impl_ios_ZoozPurchase_access$200___com_codename1_impl_ios_ZoozPurchase_R_com_codename1_payment_PurchaseCallback(threadStateData, get_field_com_codename1_impl_ios_ZoozPurchase_2_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L689448569;
    __CN1_DEBUG_INFO(172);
    if (com_codename1_impl_ios_ZoozPurchase_access$300___R_java_lang_String(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1472036907;
