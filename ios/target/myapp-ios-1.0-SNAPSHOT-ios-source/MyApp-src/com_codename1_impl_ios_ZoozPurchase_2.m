...
JAVA_VOID com_codename1_impl_ios_ZoozPurchase_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_impl_ios_ZoozPurchase_access$200___com_codename1_impl_ios_ZoozPurchase_R_com_codename1_payment_PurchaseCallback(threadStateData, get_field_com_codename1_impl_ios_ZoozPurchase_2_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1123166613;
    __CN1_DEBUG_INFO(172);
    if (com_codename1_impl_ios_ZoozPurchase_access$300___R_java_lang_String(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1765690649;
