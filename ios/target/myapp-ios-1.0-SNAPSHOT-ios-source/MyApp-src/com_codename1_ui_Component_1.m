...
JAVA_VOID com_codename1_ui_Component_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL154421736701;
    int tryBlockOffsetL154421736701;
    DEFINE_CATCH_BLOCK(catch_L154421736701, label_L691540605, restoreToL154421736701);
    int restoreToL69154060502;
    int tryBlockOffsetL69154060502;
    DEFINE_CATCH_BLOCK(catch_L69154060502, label_L691540605, restoreToL69154060502);
    int restoreToL7063990603;
    int tryBlockOffsetL7063990603;
    DEFINE_CATCH_BLOCK(catch_L7063990603, label_L310014578, restoreToL7063990603);
    int restoreToL31001457804;
    int tryBlockOffsetL31001457804;
    DEFINE_CATCH_BLOCK(catch_L31001457804, label_L310014578, restoreToL31001457804);
...
label_L70639906:
 tryBlockOffsetL7063990603 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L7063990603);
    restoreToL7063990603 = threadStateData->threadObjectStackOffset;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2527);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L267533031, 1);
        case 2: JUMP_TO(label_L1111173986, 1);
        case 3: JUMP_TO(label_L729375394, 1);
        case 4: JUMP_TO(label_L1792109661, 1);
        case 5: JUMP_TO(label_L1961510626, 1);
        case 6: JUMP_TO(label_L1871778598, 1);
        case 7: JUMP_TO(label_L1961510626, 1);
        case 8: JUMP_TO(label_L253558788, 1);
        case 9: JUMP_TO(label_L1850680894, 1);
        case 10: JUMP_TO(label_L1961510626, 1);
        case 11: JUMP_TO(label_L1961510626, 1);
        case 12: JUMP_TO(label_L1219797059, 1);
        case 13: JUMP_TO(label_L1961510626, 1);
        case 14: JUMP_TO(label_L1961510626, 1);
        case 15: JUMP_TO(label_L1961510626, 1);
        case 16: JUMP_TO(label_L794526288, 1);
        case 17: JUMP_TO(label_L1961510626, 1);
        case 18: JUMP_TO(label_L1961510626, 1);
        case 19: JUMP_TO(label_L1961510626, 1);
        case 20: JUMP_TO(label_L1961510626, 1);
        case 21: JUMP_TO(label_L1961510626, 1);
        case 22: JUMP_TO(label_L1961510626, 1);
        case 23: JUMP_TO(label_L1961510626, 1);
        case 24: JUMP_TO(label_L1210165919, 1);
        default: JUMP_TO(label_L1961510626, 1);
    }
...
label_L1544217367:
 tryBlockOffsetL154421736701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L154421736701);
    restoreToL154421736701 = threadStateData->threadObjectStackOffset;
...
label_L1346143281:
END_TRY(1);    JUMP_TO(label_L1598561139, 1);

label_L691540605:
 tryBlockOffsetL69154060502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L69154060502);
    restoreToL69154060502 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(2621);
    ...
    JUMP_TO(label_L840109665, 0);

label_L310014578:
 tryBlockOffsetL31001457804 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L31001457804);
    restoreToL31001457804 = threadStateData->threadObjectStackOffset;
