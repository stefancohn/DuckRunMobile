...
JAVA_VOID com_codename1_ui_Component_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL27433581401;
    int tryBlockOffsetL27433581401;
    DEFINE_CATCH_BLOCK(catch_L27433581401, label_L253558788, restoreToL27433581401);
    int restoreToL25355878802;
    int tryBlockOffsetL25355878802;
    DEFINE_CATCH_BLOCK(catch_L25355878802, label_L253558788, restoreToL25355878802);
    int restoreToL104038489503;
    int tryBlockOffsetL104038489503;
    DEFINE_CATCH_BLOCK(catch_L104038489503, label_L1850680894, restoreToL104038489503);
    int restoreToL185068089404;
    int tryBlockOffsetL185068089404;
    DEFINE_CATCH_BLOCK(catch_L185068089404, label_L1850680894, restoreToL185068089404);
...
label_L1040384895:
 tryBlockOffsetL104038489503 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L104038489503);
    restoreToL104038489503 = threadStateData->threadObjectStackOffset;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2527);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1219797059, 1);
        case 2: JUMP_TO(label_L794526288, 1);
        case 3: JUMP_TO(label_L1210165919, 1);
        case 4: JUMP_TO(label_L1598561139, 1);
        case 5: JUMP_TO(label_L840109665, 1);
        case 6: JUMP_TO(label_L1093223281, 1);
        case 7: JUMP_TO(label_L840109665, 1);
        case 8: JUMP_TO(label_L77163673, 1);
        case 9: JUMP_TO(label_L462777594, 1);
        case 10: JUMP_TO(label_L840109665, 1);
        case 11: JUMP_TO(label_L840109665, 1);
        case 12: JUMP_TO(label_L828312047, 1);
        case 13: JUMP_TO(label_L840109665, 1);
        case 14: JUMP_TO(label_L840109665, 1);
        case 15: JUMP_TO(label_L840109665, 1);
        case 16: JUMP_TO(label_L979822206, 1);
        case 17: JUMP_TO(label_L840109665, 1);
        case 18: JUMP_TO(label_L840109665, 1);
        case 19: JUMP_TO(label_L840109665, 1);
        case 20: JUMP_TO(label_L840109665, 1);
        case 21: JUMP_TO(label_L840109665, 1);
        case 22: JUMP_TO(label_L840109665, 1);
        case 23: JUMP_TO(label_L840109665, 1);
        case 24: JUMP_TO(label_L1976870927, 1);
        default: JUMP_TO(label_L840109665, 1);
    }
...
label_L274335814:
 tryBlockOffsetL27433581401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L27433581401);
    restoreToL27433581401 = threadStateData->threadObjectStackOffset;
...
label_L997020761:
END_TRY(1);    JUMP_TO(label_L1167522035, 1);

label_L253558788:
 tryBlockOffsetL25355878802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L25355878802);
    restoreToL25355878802 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(2621);
    ...
    JUMP_TO(label_L214929887, 0);

label_L1850680894:
 tryBlockOffsetL185068089404 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L185068089404);
    restoreToL185068089404 = threadStateData->threadObjectStackOffset;
