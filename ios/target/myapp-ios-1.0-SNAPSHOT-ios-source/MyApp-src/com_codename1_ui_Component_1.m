...
JAVA_VOID com_codename1_ui_Component_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL15353917201;
    int tryBlockOffsetL15353917201;
    DEFINE_CATCH_BLOCK(catch_L15353917201, label_L1449360639, restoreToL15353917201);
    ...
    int restoreToL164940543703;
    int tryBlockOffsetL164940543703;
    DEFINE_CATCH_BLOCK(catch_L164940543703, label_L691540605, restoreToL164940543703);
...
label_L1649405437:
 tryBlockOffsetL164940543703 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L164940543703);
    restoreToL164940543703 = threadStateData->threadObjectStackOffset;
...
label_L153539172:
 tryBlockOffsetL15353917201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L15353917201);
    restoreToL15353917201 = threadStateData->threadObjectStackOffset;
