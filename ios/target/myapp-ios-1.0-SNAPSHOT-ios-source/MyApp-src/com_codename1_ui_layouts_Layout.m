...
JAVA_BOOLEAN com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1752820099;
    { JAVA_OBJECT tmpResult = virtual_java_lang_Object_getClass___R_java_lang_Class(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_java_lang_Object_getClass___R_java_lang_Class(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1752820099;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_layouts_Layout_updateTabIndices___com_codename1_ui_Container_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_layouts_Layout_overridesTabIndices___com_codename1_ui_Container_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1171489125;
...
label_L326190931:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L32764980;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(194);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L643899512;
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L1421622223;
...
label_L222122132:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L643899512;
