...
label_L1403191795:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1300359226;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(977);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L2096690266;
        default: goto label_L1657760388;
    }
...
label_L2096690266:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L541957855;
...
label_L541957855:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1797959612;
        default: goto label_L1355533479;
    }
...
label_L96388064:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1229526896;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1009);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L995613604;
        default: goto label_L905418397;
    }
...
label_L995613604:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L872736196;
