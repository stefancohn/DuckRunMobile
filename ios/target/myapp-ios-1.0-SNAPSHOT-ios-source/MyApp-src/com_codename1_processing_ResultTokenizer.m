...
JAVA_VOID com_codename1_processing_ResultTokenizer___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7730, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(62);
    java_lang_Object___INIT____(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L384537519;
    __CN1_DEBUG_INFO(64);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7731));     SP -= 1;
...
JAVA_OBJECT com_codename1_processing_ResultTokenizer_tokenize___java_util_Map_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 7730, 6782);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(74);
...
label_L1111811191:
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(223), locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L1078290151;
    __CN1_DEBUG_INFO(78);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1054374766;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[3].data.o, 58);
    PUSH_INT(tmpResult); }
    BC_DUP(); /* DUP */
    BC_ISTORE(4);
    PUSH_INT(-1); /* ICONST_M1 */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1054374766;
    __CN1_DEBUG_INFO(79);
    BC_ALOAD(1);
    ...
    BC_ASTORE(5);
    __CN1_DEBUG_INFO(80);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1054374766;
    __CN1_DEBUG_INFO(81);
...
label_L1054374766:
    ...
    __CN1_DEBUG_INFO(77);
    /* VarOp.assignFrom */ locals[3].data.o = com_codename1_processing_ResultTokenizer_next___R_java_lang_String(threadStateData, __cn1ThisObject);locals[3].type=CN1_TYPE_OBJECT;    goto label_L1111811191;
...
JAVA_OBJECT com_codename1_processing_ResultTokenizer_getPredicate___java_lang_StringBuffer_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 7730, 7732);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L816162189:
    if (ilocals_3_>=get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L150499707;
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(threadStateData, ilocals_4_)==0) /* IFEQ CustomJump */ goto label_L1667321053;
    __CN1_DEBUG_INFO(113);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(91);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L513755348;
...
label_L1667321053:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L2073911340;
...
JAVA_OBJECT com_codename1_processing_ResultTokenizer_next___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* ch */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 7730, 1254);
    ...
    if (get_field_com_codename1_processing_ResultTokenizer_pos(__cn1ThisObject)<get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1506480352;
...
label_L1506480352:
    ...
    if (get_field_com_codename1_processing_ResultTokenizer_predicate(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1031158501;
...
label_L1031158501:
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(threadStateData, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L771404135;
    __CN1_DEBUG_INFO(143);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(91);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L820961432;
    __CN1_DEBUG_INFO(144);
    set_field_com_codename1_processing_ResultTokenizer_predicate(threadStateData, 1 /* ICONST_1 */, __cn1ThisObject);
    goto label_L824425077;

label_L820961432:
    __CN1_DEBUG_INFO(145);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L824425077;

label_L1032724390:
    __CN1_DEBUG_INFO(146);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_processing_ResultTokenizer_expression(__cn1ThisObject), (get_field_com_codename1_processing_ResultTokenizer_pos(__cn1ThisObject) + 1 /* ICONST_1 */)))==0) /* IFEQ CustomJump */ goto label_L824425077;
...
label_L779538643:
    if (ilocals_3_>=get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1166536953;
    __CN1_DEBUG_INFO(158);
    /* VarOp.assignFrom */ ilocals_4_ = /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_processing_ResultTokenizer_expression(__cn1ThisObject), ilocals_3_);
    __CN1_DEBUG_INFO(159);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(threadStateData, ilocals_4_)==0) /* IFEQ CustomJump */ goto label_L36315889;
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_processing_ResultTokenizer(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7730, 7733);
    ...
    SP--;
    switch((*SP).data.i) {
        case 91: goto label_L1674086804;
        case 93: goto label_L1674086804;
        default: goto label_L422751532;
    }
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    volatile JAVA_INT ilocals_0_ = 0; /* ch */
    __STATIC_INITIALIZER_com_codename1_processing_ResultTokenizer(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 7730, 7734);
    ilocals_0_ = __cn1Arg1;
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1255946577;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    volatile JAVA_INT ilocals_0_ = 0; /* ch */
    __STATIC_INITIALIZER_com_codename1_processing_ResultTokenizer(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7730, 7735);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(185);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(threadStateData, ilocals_0_)!=0) /* IFNE CustomJump */ goto label_L1972846458;
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, ilocals_0_)==0) /* IFEQ CustomJump */ goto label_L2034284329;
