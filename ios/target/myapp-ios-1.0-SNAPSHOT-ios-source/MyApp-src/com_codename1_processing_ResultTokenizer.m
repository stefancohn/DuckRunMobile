...
JAVA_VOID com_codename1_processing_ResultTokenizer___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1078290151;
    __CN1_DEBUG_INFO(64);
...
label_L150499707:
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(223), locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L1054374766;
    __CN1_DEBUG_INFO(78);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1111811191;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[3].data.o, 58);
    PUSH_INT(tmpResult); }
    BC_DUP(); /* DUP */
    BC_ISTORE(4);
    PUSH_INT(-1); /* ICONST_M1 */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1111811191;
    __CN1_DEBUG_INFO(79);
    BC_ALOAD(1);
    ...
    BC_ASTORE(5);
    __CN1_DEBUG_INFO(80);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1111811191;
    __CN1_DEBUG_INFO(81);
...
label_L1111811191:
    ...
    __CN1_DEBUG_INFO(77);
    /* VarOp.assignFrom */ locals[3].data.o = com_codename1_processing_ResultTokenizer_next___R_java_lang_String(threadStateData, __cn1ThisObject);locals[3].type=CN1_TYPE_OBJECT;    goto label_L150499707;
...
label_L1506480352:
    if (ilocals_3_>=get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1667321053;
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(threadStateData, ilocals_4_)==0) /* IFEQ CustomJump */ goto label_L513755348;
    __CN1_DEBUG_INFO(113);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(91);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2073911340;
...
label_L513755348:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L816162189;
...
JAVA_OBJECT com_codename1_processing_ResultTokenizer_next___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_processing_ResultTokenizer_pos(__cn1ThisObject)<get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1031158501;
...
label_L1031158501:
    ...
    if (get_field_com_codename1_processing_ResultTokenizer_predicate(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L771404135;
...
label_L771404135:
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(threadStateData, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L820961432;
    __CN1_DEBUG_INFO(143);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(91);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L824425077;
...
label_L824425077:
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L1032724390;

label_L1166536953:
    __CN1_DEBUG_INFO(146);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_processing_ResultTokenizer_expression(__cn1ThisObject), (get_field_com_codename1_processing_ResultTokenizer_pos(__cn1ThisObject) + 1 /* ICONST_1 */)))==0) /* IFEQ CustomJump */ goto label_L1032724390;
...
label_L1674086804:
    if (ilocals_3_>=get_field_com_codename1_processing_ResultTokenizer_length(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L36315889;
    __CN1_DEBUG_INFO(158);
    /* VarOp.assignFrom */ ilocals_4_ = /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_processing_ResultTokenizer_expression(__cn1ThisObject), ilocals_3_);
    __CN1_DEBUG_INFO(159);
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(threadStateData, ilocals_4_)==0) /* IFEQ CustomJump */ goto label_L779538643;
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 91: goto label_L422751532;
        case 93: goto label_L422751532;
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1387567249;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1972846458;
...
JAVA_BOOLEAN com_codename1_processing_ResultTokenizer_isDelimiter___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_CHAR __cn1Arg1) {
    ...
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSubscript___char_R_boolean(threadStateData, ilocals_0_)!=0) /* IFNE CustomJump */ goto label_L2034284329;
    if (/* CustomInvoke */com_codename1_processing_ResultTokenizer_isSeparator___char_R_boolean(threadStateData, ilocals_0_)==0) /* IFEQ CustomJump */ goto label_L1383931873;

label_L2034284329:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L620459311;
