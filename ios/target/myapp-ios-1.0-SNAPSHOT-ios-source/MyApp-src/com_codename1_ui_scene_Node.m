...
JAVA_VOID com_codename1_ui_scene_Node_addTags___java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_tags(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1002541036;
...
label_L913711668:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L518953848;
...
JAVA_VOID com_codename1_ui_scene_Node_removeTags___java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_tags(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L419394876;
...
label_L804661024:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L419394876;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_BOOLEAN com_codename1_ui_scene_Node_hasTag___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_tags(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1160338685;
    if (/* CustomInvoke */virtual_java_util_HashSet_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_scene_Node_tags(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1160338685;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_scene_Node_setScene___com_codename1_ui_scene_Scene(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L561801758;
...
label_L1068336694:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L561801758;
...
JAVA_OBJECT com_codename1_ui_scene_Node_getLocalToParentTransform___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L812448650;
...
JAVA_OBJECT com_codename1_ui_scene_Node_getLocalToSceneTransform___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_scene_Node_parent(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1067809448;
...
JAVA_OBJECT com_codename1_ui_scene_Node_getPaintingRect___R_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_scene_Node_paintingRect(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2102123480;
    if (virtual_com_codename1_properties_Property_get___R_java_lang_Object(threadStateData, get_field_com_codename1_ui_scene_Node_paintingRect(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2102123480;
...
JAVA_BOOLEAN com_codename1_ui_scene_Node_contains___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    int restoreToL2781245901;
    int tryBlockOffsetL2781245901;
    DEFINE_CATCH_BLOCK(catch_L2781245901, label_L780435057, restoreToL2781245901);
    int restoreToL78043505702;
    int tryBlockOffsetL78043505702;
    DEFINE_CATCH_BLOCK(catch_L78043505702, label_L780435057, restoreToL78043505702);
...
label_L27812459:
 tryBlockOffsetL2781245901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L2781245901);
    restoreToL2781245901 = threadStateData->threadObjectStackOffset;
...
label_L780435057:
 tryBlockOffsetL78043505702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L78043505702);
    restoreToL78043505702 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_scene_Node_getLocalToScreenTransform___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_Transform_isPerspectiveSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1129000460;
    if (virtual_com_codename1_properties_Property_get___R_java_lang_Object(threadStateData, get_field_com_codename1_ui_scene_Scene_camera(get_field_com_codename1_ui_scene_Node_scene(__cn1ThisObject)))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1129000460;
...
JAVA_VOID com_codename1_ui_scene_Node_render___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL71830522401;
    int tryBlockOffsetL71830522401;
    DEFINE_CATCH_BLOCK(catch_L71830522401, label_L1966366279, restoreToL71830522401);
    int restoreToL196636627902;
    int tryBlockOffsetL196636627902;
    DEFINE_CATCH_BLOCK(catch_L196636627902, label_L1966366279, restoreToL196636627902);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L921963890, 0);
...
label_L921963890:
    ...
    if (com_codename1_ui_Transform_isPerspectiveSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L743800558, 0);
    if (virtual_com_codename1_properties_Property_get___R_java_lang_Object(threadStateData, get_field_com_codename1_ui_scene_Scene_camera(get_field_com_codename1_ui_scene_Node_scene(__cn1ThisObject)))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L743800558, 0);
    PUSH_POINTER(get_field_com_codename1_ui_scene_Scene_camera(get_field_com_codename1_ui_scene_Node_scene(__cn1ThisObject)));
...
label_L718305224:
 tryBlockOffsetL71830522401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L71830522401);
    restoreToL71830522401 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(489);
    if (get_field_com_codename1_ui_scene_Node_renderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L727064401, 1);
    ...
    if (get_field_com_codename1_ui_scene_Node_renderAsImage(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1029638356, 1);
...
END_TRY(1);    __CN1_DEBUG_INFO(517);
    ...
    JUMP_TO(label_L989504415, 0);

label_L1966366279:
 tryBlockOffsetL196636627902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L196636627902);
    restoreToL196636627902 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_scene_Node_renderChildren___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_List_iterator___R_java_util_Iterator(threadStateData, get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject));locals[2].type=CN1_TYPE_OBJECT;
label_L1623990497:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L2071663688;
...
JAVA_VOID com_codename1_ui_scene_Node_add___com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L621845892;
...
JAVA_VOID com_codename1_ui_scene_Node_remove___com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_scene_Node_parent(locals[1].data.o)==__cn1ThisObject) /* IF_ACMPEQ CustomJump */ goto label_L1243165922;
...
label_L1243165922:
    ...
    if (get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1768140989;
...
JAVA_VOID com_codename1_ui_scene_Node_layoutChildrenInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_scene_Node_isNeedsLayout___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1755926104;
...
JAVA_BOOLEAN com_codename1_ui_scene_Node_hasChildren___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1046160944;
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1046160944;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_scene_Node_removeAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_scene_Node_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1974219375;
