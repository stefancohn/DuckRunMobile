...
JAVA_VOID com_codename1_ui_util_UITimer_cancel__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_util_UITimer_bound(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L146842175;
...
JAVA_VOID com_codename1_ui_util_UITimer_testEllapse__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR((llocals_1_ - get_field_com_codename1_ui_util_UITimer_lastEllapse(__cn1ThisObject)), ((JAVA_LONG)get_field_com_codename1_ui_util_UITimer_ms(__cn1ThisObject)))<0) /* IFLT CustomJump */ goto label_L72187428;
    __CN1_DEBUG_INFO(117);
    if (get_field_com_codename1_ui_util_UITimer_repeat(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L650687126;
