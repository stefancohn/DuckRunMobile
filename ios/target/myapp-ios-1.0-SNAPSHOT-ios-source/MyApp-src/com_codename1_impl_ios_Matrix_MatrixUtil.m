...
JAVA_FLOAT com_codename1_impl_ios_Matrix_MatrixUtil_clamp___float_R_float(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1) {
    ...
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ goto label_L1701436909;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_orthoM___float_1ARRAY_int_float_float_float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5, JAVA_FLOAT __cn1Arg6, JAVA_FLOAT __cn1Arg7, JAVA_FLOAT __cn1Arg8) {
    ...
    if (CN1_CMP_EXPR(flocals_2_, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L763236610;
...
label_L763236610:
    ...
    if (CN1_CMP_EXPR(flocals_4_, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L106113013;
...
label_L106113013:
    ...
    if (CN1_CMP_EXPR(flocals_6_, flocals_7_)!=0) /* IFNE CustomJump */ goto label_L719182854;
...
label_L1226298219:
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1791589252;
...
label_L944348744:
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1248435962;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_setRotateM___float_1ARRAY_int_float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5, JAVA_FLOAT __cn1Arg6) {
    ...
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L1225114731;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L1225114731;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L1225114731;
    ...
    goto label_L397309480;

label_L1225114731:
    __CN1_DEBUG_INFO(1167);
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L288797801;
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L288797801;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L288797801;
...
label_L288797801:
    ...
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L1702478809;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L1702478809;
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L1702478809;
...
label_L1702478809:
    ...
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_8_)==0) /* IFEQ CustomJump */ goto label_L45643137;
