...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9694, 205);
...
JAVA_FLOAT com_codename1_impl_ios_Matrix_MatrixUtil_clamp___float_R_float(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 9694, 9695);
    ...
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ goto label_L1869177530;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_orthoM___float_1ARRAY_int_float_float_float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5, JAVA_FLOAT __cn1Arg6, JAVA_FLOAT __cn1Arg7, JAVA_FLOAT __cn1Arg8) {
    ...
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(3, 17, 0, 9694, 9700);
    ...
    if (CN1_CMP_EXPR(flocals_2_, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L359806817;
    __CN1_DEBUG_INFO(843);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9701));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L359806817:
    __CN1_DEBUG_INFO(845);
    if (CN1_CMP_EXPR(flocals_4_, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L824900551;
    __CN1_DEBUG_INFO(846);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9702));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L824900551:
    __CN1_DEBUG_INFO(848);
    if (CN1_CMP_EXPR(flocals_6_, flocals_7_)!=0) /* IFNE CustomJump */ goto label_L1503614751;
    __CN1_DEBUG_INFO(849);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9703));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_perspectiveM___float_1ARRAY_int_float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5, JAVA_FLOAT __cn1Arg6) {
    ...
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 8, 0, 9694, 9708);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    flocals_2_ = __cn1Arg3;
...
JAVA_FLOAT com_codename1_impl_ios_Matrix_MatrixUtil_length___float_float_float_R_float(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(3, 3, 0, 9694, 889);
    flocals_0_ = __cn1Arg1;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_scaleM___float_1ARRAY_int_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5) {
    ...
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(5, 7, 0, 9694, 9710);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    flocals_2_ = __cn1Arg3;
...
label_L1786040872:
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L918307166;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_translateM___float_1ARRAY_int_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5) {
    ...
    volatile JAVA_FLOAT flocals_2_ = 0; /* x */
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 7, 0, 9694, 9711);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    flocals_2_ = __cn1Arg3;
...
label_L1320869181:
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L775574071;
...
JAVA_VOID com_codename1_impl_ios_Matrix_MatrixUtil_setRotateM___float_1ARRAY_int_float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_FLOAT __cn1Arg5, JAVA_FLOAT __cn1Arg6) {
    ...
    volatile JAVA_FLOAT flocals_15_ = 0; /* v15 */
    __STATIC_INITIALIZER_com_codename1_impl_ios_Matrix_MatrixUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 16, 0, 9694, 9712);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    flocals_2_ = __cn1Arg3;
    ...
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L1791589252;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L1791589252;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L1791589252;
    ...
    goto label_L1226298219;

label_L1791589252:
    __CN1_DEBUG_INFO(1167);
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_3_)!=0) /* IFNE CustomJump */ goto label_L901815188;
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L901815188;
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L901815188;
...
label_L901815188:
    ...
    if (CN1_CMP_EXPR(0 /* FCONST_0 */, flocals_4_)!=0) /* IFNE CustomJump */ goto label_L755759908;
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_5_)!=0) /* IFNE CustomJump */ goto label_L755759908;
...
label_L755759908:
    ...
    if (CN1_CMP_EXPR(1 /* FCONST_1 */, flocals_8_)==0) /* IFEQ CustomJump */ goto label_L205496410;
