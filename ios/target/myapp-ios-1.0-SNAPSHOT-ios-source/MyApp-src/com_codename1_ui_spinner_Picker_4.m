...
JAVA_VOID com_codename1_ui_spinner_Picker_4_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_spinner_Picker_4_val_sizeChanged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1246052237;
...
label_L1246052237:
    ...
    if (virtual_com_codename1_components_InteractionDialog_isShowing___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_4_val_dlg(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1621525516;
