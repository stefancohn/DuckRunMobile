...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_21_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL39018078301;
    int tryBlockOffsetL39018078301;
    DEFINE_CATCH_BLOCK(catch_L39018078301, label_L1011104118, restoreToL39018078301);
...
label_L390180783:
 tryBlockOffsetL39018078301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L39018078301);
    restoreToL39018078301 = threadStateData->threadObjectStackOffset;
...
label_L1011104118:
 tryBlockOffsetL101110411802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L101110411802);
    restoreToL101110411802 = threadStateData->threadObjectStackOffset;
