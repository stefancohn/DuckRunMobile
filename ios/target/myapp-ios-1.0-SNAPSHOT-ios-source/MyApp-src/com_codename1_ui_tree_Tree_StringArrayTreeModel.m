...
JAVA_OBJECT com_codename1_ui_tree_Tree_StringArrayTreeModel_getChildren___java_lang_Object_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L438432831;
...
label_L37878764:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L2131366717;
...
label_L1181041291:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1902094533;
    __CN1_DEBUG_INFO(217);
    if (locals[1].data.o!=CN1_ARRAY_ELEMENT_OBJECT(CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_tree_Tree_StringArrayTreeModel_arr(__cn1ThisObject), 0 /* ICONST_0 */), ilocals_5_)) /* IF_ACMPNE CustomJump */ goto label_L1682586333;
    __CN1_DEBUG_INFO(218);
    if (ilocals_2_<=(ilocals_5_ + 1 /* ICONST_1 */)) /* IF_ICMPLE CustomJump */ goto label_L1682586333;
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_tree_Tree_StringArrayTreeModel_arr(__cn1ThisObject), (ilocals_5_ + 1 /* ICONST_1 */))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1682586333;
...
label_L1266048658:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1682586333;
...
JAVA_BOOLEAN com_codename1_ui_tree_Tree_StringArrayTreeModel_isLeaf___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1248908034;
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L2144965699;
