...
JAVA_VOID com_codename1_io_tar_TarInputStream___INIT_____java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 8981, 205);
...
JAVA_BOOLEAN com_codename1_io_tar_TarInputStream_markSupported___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8981, 989);
...
JAVA_VOID com_codename1_io_tar_TarInputStream_reset__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 8981, 991);
    monitorEnterBlock(threadStateData, __cn1ThisObject);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_io_IOException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8372));     SP -= 1;
...
JAVA_INT com_codename1_io_tar_TarInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8981, 990);
    ...
    __CN1_DEBUG_INFO(80);
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1652216902;
    __CN1_DEBUG_INFO(81);
...
JAVA_INT com_codename1_io_tar_TarInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 8981, 990);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(96);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2013186564;
    __CN1_DEBUG_INFO(97);
    ...
    PUSH_LONG(tmpResult); }
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L61921754;
    __CN1_DEBUG_INFO(98);
...
label_L61921754:
    ...
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L2013186564;
...
label_L2013186564:
    ...
    if (ilocals_4_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1522752279;
    __CN1_DEBUG_INFO(107);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1856990445;
...
JAVA_OBJECT com_codename1_io_tar_TarInputStream_getNextEntry___R_com_codename1_io_tar_TarEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 8981, 8982);
...
label_L706783822:
    ...
    SP++;
    PUSH_INT(512);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1870673366;
    ...
    if (ilocals_4_>=0) /* IFGE CustomJump */ goto label_L1786466293;
    __CN1_DEBUG_INFO(135);
    goto label_L1870673366;
...
label_L1627993706:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1065186275;
    /* VarOp.assignFrom */ ilocals_8_=CN1_ARRAY_ELEMENT_BYTE(locals[5].data.o, ilocals_7_);
    __CN1_DEBUG_INFO(145);
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1363009375;
...
label_L1363009375:
    __CN1_DEBUG_INFO(144);
    BC_IINC(7, 1);
    goto label_L1627993706;

label_L1065186275:
    __CN1_DEBUG_INFO(151);
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1322554079;
...
JAVA_VOID com_codename1_io_tar_TarInputStream_closeCurrentEntry__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 8981, 8983);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(165);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L451019405;
    __CN1_DEBUG_INFO(166);
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L630907305;
...
label_L1730154498:
    ...
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L630907305;
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L218638614;
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    ...
    PUSH_POINTER(__NEW_java_io_IOException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_io_IOException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8984));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_io_tar_TarInputStream_skipPad__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 8981, 8985);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(192);
    if (CN1_CMP_EXPR(get_field_com_codename1_io_tar_TarInputStream_bytesRead(__cn1ThisObject), 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1843171329;
    ...
    if (ilocals_1_<=0) /* IFLE CustomJump */ goto label_L1843171329;
    __CN1_DEBUG_INFO(196);
    /* VarOp.assignFrom */     llocals_2_ = 0 /* LCONST_0 */; 

label_L523875258:
    __CN1_DEBUG_INFO(197);
    if (CN1_CMP_EXPR(llocals_2_, ((JAVA_LONG)(512 - ilocals_1_)))>=0) /* IFGE CustomJump */ goto label_L1843171329;
...
JAVA_LONG com_codename1_io_tar_TarInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    volatile JAVA_LONG llocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(7, 7, 0, 8981, 992);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     llocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(212);
    if (get_field_com_codename1_io_tar_TarInputStream_defaultSkip(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1404402130;
...
label_L1404402130:
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L888329126;
...
label_L816870841:
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1034355105;
    __CN1_DEBUG_INFO(226);
    BC_ALOAD(0);
    BC_ALOAD(5);
    PUSH_INT(0); /* ICONST_0 */
    if (CN1_CMP_EXPR(llocals_3_, 2048LL)>=0) /* IFGE CustomJump */ goto label_L1867633100;
    BC_LLOAD(3);
...
label_L399662621:
    ...
    if (ilocals_6_>=0) /* IFGE CustomJump */ goto label_L899666082;
    __CN1_DEBUG_INFO(228);
    goto label_L1034355105;

label_L899666082:
    __CN1_DEBUG_INFO(230);
    /* VarOp.assignFrom */ llocals_3_=(llocals_3_ - ((JAVA_LONG)ilocals_6_));
    __CN1_DEBUG_INFO(231);
    goto label_L816870841;
