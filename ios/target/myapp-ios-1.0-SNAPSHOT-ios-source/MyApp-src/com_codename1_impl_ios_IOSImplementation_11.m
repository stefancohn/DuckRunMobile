...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11___INIT_____boolean_int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 9491, 205);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 9491, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL88000965901;
    int tryBlockOffsetL88000965901;
    DEFINE_CATCH_BLOCK(catch_L88000965901, label_L1179272258, restoreToL88000965901);
    int restoreToL117927225802;
    int tryBlockOffsetL117927225802;
    DEFINE_CATCH_BLOCK(catch_L117927225802, label_L1179272258, restoreToL117927225802);
    __CN1_DEBUG_INFO(987);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L678680178, 0);
    __CN1_DEBUG_INFO(988);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_finished(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1002911155, 0);
    __CN1_DEBUG_INFO(989);
    PUSH_INT(get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1467977993, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1124317168, 0);
...
label_L880009659:
 tryBlockOffsetL88000965901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L88000965901);
    restoreToL88000965901 = threadStateData->threadObjectStackOffset;
    ...
    if (com_codename1_impl_ios_IOSImplementation_access$800___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1970612644, 1);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1970612644, 1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData)));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_TextArea);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1970612644, 1);
...
label_L1970612644:
    ...
    if (virtual_com_codename1_impl_ios_IOSNative_isAsyncEditMode___R_boolean(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_nativeInstance(threadStateData))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2006835220, 1);
...
label_L2006835220:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1547817015, 1);
...
label_L1242651724:
END_TRY(1);    JUMP_TO(label_L35864696, 0);

label_L1179272258:
 tryBlockOffsetL117927225802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L117927225802);
    restoreToL117927225802 = threadStateData->threadObjectStackOffset;
...
label_L35864696:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1590129041, 0);
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1590129041, 0);
...
label_L1178777373:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L340789130, 0);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L340789130, 0);
...
label_L678680178:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9492));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
