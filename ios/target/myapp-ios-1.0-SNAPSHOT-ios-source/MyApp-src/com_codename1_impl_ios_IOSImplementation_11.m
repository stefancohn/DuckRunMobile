...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL163029300801;
    int tryBlockOffsetL163029300801;
    DEFINE_CATCH_BLOCK(catch_L163029300801, label_L1799424291, restoreToL163029300801);
...
label_L1630293008:
 tryBlockOffsetL163029300801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L163029300801);
    restoreToL163029300801 = threadStateData->threadObjectStackOffset;
