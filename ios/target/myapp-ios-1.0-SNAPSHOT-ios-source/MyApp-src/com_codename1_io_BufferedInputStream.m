...
JAVA_VOID com_codename1_io_BufferedInputStream___INIT_____java_io_InputStream_int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (ilocals_2_>0) /* IFGT CustomJump */ goto label_L1358847474;
...
JAVA_VOID com_codename1_io_BufferedInputStream_fill__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L800041407;
    __CN1_DEBUG_INFO(232);
    set_field_com_codename1_io_BufferedInputStream_pos(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    goto label_L1409112532;

label_L800041407:
    __CN1_DEBUG_INFO(233);
    if (get_field_com_codename1_io_BufferedInputStream_pos(__cn1ThisObject)<CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L1409112532;
    __CN1_DEBUG_INFO(234);
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L71054164;
...
label_L71054164:
    if (CN1_ARRAY_LENGTH(locals[1].data.o)<get_field_com_codename1_io_BufferedInputStream_marklimit(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L638582764;
...
label_L638582764:
    ...
    if (ilocals_2_<=get_field_com_codename1_io_BufferedInputStream_marklimit(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1950308547;
...
label_L1950308547:
    ...
    if (locals[1].data.o==get_field_com_codename1_io_BufferedInputStream_buf(__cn1ThisObject)) /* IF_ACMPEQ CustomJump */ goto label_L1295359081;
...
label_L1409112532:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_actualAvailable(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L687251464;
...
label_L687251464:
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L1910491749;
    ...
    goto label_L2141744605;

label_L1910491749:
    __CN1_DEBUG_INFO(265);
    if (ilocals_3_>=0) /* IFGE CustomJump */ goto label_L2141744605;
...
JAVA_INT com_codename1_io_BufferedInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L513761429;
...
label_L513761429:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L66348462;
    ...
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L209128279;
    if (ilocals_1_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L209128279;
...
label_L66348462:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_pos(__cn1ThisObject)<get_field_com_codename1_io_BufferedInputStream_count(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L814565761;
...
label_L814565761:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1433607373;
...
JAVA_VOID com_codename1_io_BufferedInputStream_fireProgress__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_progressListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1963645656;
...
JAVA_INT com_codename1_io_BufferedInputStream_read1___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (ilocals_4_>0) /* IFGT CustomJump */ goto label_L1100176029;
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L453562991;
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L453562991;
    ...
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L1448095927;
    __CN1_DEBUG_INFO(340);
    set_field_com_codename1_io_BufferedInputStream_actualAvailable(threadStateData, -1 /* ICONST_M1 */, __cn1ThisObject);
    goto label_L1966075071;

label_L1448095927:
    __CN1_DEBUG_INFO(342);
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1966075071;
...
label_L1100176029:
    ...
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L783488821;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    goto label_L1937060646;
...
JAVA_VOID com_codename1_io_BufferedInputStream_yieldTime__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1913478032cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1913478032cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1913478032cn1_class_id_java_lang_InterruptedException1, label_L783759938, restoreToL1913478032cn1_class_id_java_lang_InterruptedException1);
    __CN1_DEBUG_INFO(364);
    /* VarOp.assignFrom */ llocals_1_ = java_lang_System_currentTimeMillis___R_long(threadStateData);
    __CN1_DEBUG_INFO(365);
    if (CN1_CMP_EXPR((llocals_1_ - get_field_com_codename1_io_BufferedInputStream_elapsedSinceLastYield(__cn1ThisObject)), 300LL)<=0) /* IFLE CustomJump */ JUMP_TO(label_L411802142, 0);

label_L1913478032:
 tryBlockOffsetL1913478032cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1913478032cn1_class_id_java_lang_InterruptedException1);
    restoreToL1913478032cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_io_BufferedInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1565967058;
...
label_L1565967058:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_yield(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1243911696;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1243911696;
...
label_L1243911696:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L247184928;
    ...
    if (ilocals_4_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L664700395;
...
label_L247184928:
    ...
    if ((((ilocals_2_ | ilocals_3_) | (ilocals_2_ + ilocals_3_)) | (CN1_ARRAY_LENGTH(locals[1].data.o) - (ilocals_2_ + ilocals_3_)))>=0) /* IFGE CustomJump */ goto label_L583997448;
...
label_L583997448:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1901525199;
...
label_L156954340:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L573872851;
...
label_L573872851:
    ...
    if (ilocals_5_>0) /* IFGT CustomJump */ goto label_L1123939422;
    __CN1_DEBUG_INFO(447);
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L405318481;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
...
label_L1123939422:
    ...
    if (ilocals_4_<ilocals_3_) /* IF_IMPLT CustomJump */ goto label_L1969754956;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(456);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L684154003;
    if (com_codename1_io_BufferedInputStream_superAvailable___R_int(threadStateData, __cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L684154003;
    __CN1_DEBUG_INFO(457);
    goto label_L1486504709;

label_L684154003:
    __CN1_DEBUG_INFO(459);
    if (get_field_com_codename1_io_BufferedInputStream_yield(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L55711712;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L55711712;
    __CN1_DEBUG_INFO(460);
    com_codename1_io_BufferedInputStream_yieldTime__(threadStateData, __cn1ThisObject); 

label_L55711712:
    __CN1_DEBUG_INFO(462);
    goto label_L156954340;

label_L1486504709:
    __CN1_DEBUG_INFO(463);
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L1008561904;
...
JAVA_LONG com_codename1_io_BufferedInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L774676004;
...
label_L774676004:
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L1037201686;
...
label_L1037201686:
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L1663141254;
    __CN1_DEBUG_INFO(496);
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L874253820;
...
label_L1663141254:
    ...
    if (CN1_CMP_EXPR(llocals_3_, llocals_1_)>=0) /* IFGE CustomJump */ goto label_L2114676965;
    BC_LLOAD(3);
...
JAVA_INT com_codename1_io_BufferedInputStream_available___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1058885327;
...
JAVA_VOID com_codename1_io_BufferedInputStream_reset__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1807402813;
...
JAVA_INT com_codename1_io_BufferedInputStream_superAvailable___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL259576171cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL259576171cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L259576171cn1_class_id_java_io_IOException1, label_L1314113263, restoreToL259576171cn1_class_id_java_io_IOException1);
    int restoreToL1633989538cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL1633989538cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L1633989538cn1_class_id_java_io_IOException2, label_L1314113263, restoreToL1633989538cn1_class_id_java_io_IOException2);

label_L259576171:
 tryBlockOffsetL259576171cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L259576171cn1_class_id_java_io_IOException1);
    restoreToL259576171cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(592);
    if (get_field_com_codename1_io_BufferedInputStream_actualAvailable(__cn1ThisObject)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1633989538, 0);
...
label_L1633989538:
 tryBlockOffsetL1633989538cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1633989538cn1_class_id_java_io_IOException2);
    restoreToL1633989538cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_io_BufferedInputStream_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_closed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L878375543;
...
label_L878375543:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_connection(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L157567214;
...
label_L157567214:
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(1);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1498452883;
    __CN1_DEBUG_INFO(624);
    if (get_field_com_codename1_io_BufferedInputStream_buf(__cn1ThisObject)!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L157567214;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(627);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L493732536;
