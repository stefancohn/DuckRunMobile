...
JAVA_VOID com_codename1_io_BufferedInputStream_yieldTime__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL688459177cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL688459177cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L688459177cn1_class_id_java_lang_InterruptedException1, label_L620195959, restoreToL688459177cn1_class_id_java_lang_InterruptedException1);
...
label_L688459177:
 tryBlockOffsetL688459177cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L688459177cn1_class_id_java_lang_InterruptedException1);
    restoreToL688459177cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_io_BufferedInputStream_superAvailable___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1530162893cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1530162893cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1530162893cn1_class_id_java_io_IOException1, label_L1807402813, restoreToL1530162893cn1_class_id_java_io_IOException1);
...
label_L1530162893:
 tryBlockOffsetL1530162893cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1530162893cn1_class_id_java_io_IOException1);
    restoreToL1530162893cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
