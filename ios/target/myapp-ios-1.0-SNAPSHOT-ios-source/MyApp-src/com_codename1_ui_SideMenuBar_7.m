...
JAVA_VOID com_codename1_ui_SideMenuBar_7___INIT_____com_codename1_ui_SideMenuBar_com_codename1_ui_Image_boolean_com_codename1_ui_Image_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 7043, 205);
...
JAVA_VOID com_codename1_ui_SideMenuBar_7_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 7043, 2370);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(913);
    if (get_field_com_codename1_ui_SideMenuBar_7_img(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L936546050;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L368040556;
...
label_L368040556:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1616257837;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L871554897;
...
label_L1616257837:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2074896491;
...
label_L936546050:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L262093096;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L262093096;
...
label_L262093096:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1078905349;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1488526679;
...
label_L1078905349:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1638472859;
