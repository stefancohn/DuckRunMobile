...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_24_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL182665157401;
    int tryBlockOffsetL182665157401;
    DEFINE_CATCH_BLOCK(catch_L182665157401, label_L1759915172, restoreToL182665157401);

label_L1826651574:
 tryBlockOffsetL182665157401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L182665157401);
    restoreToL182665157401 = threadStateData->threadObjectStackOffset;
