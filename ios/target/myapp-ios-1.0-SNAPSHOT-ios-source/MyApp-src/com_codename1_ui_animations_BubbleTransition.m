...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_initTransition__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L1634190383;
    if (ilocals_4_>0) /* IFGT CustomJump */ goto label_L750529970;
...
label_L750529970:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L770272954;
...
label_L770272954:
    ...
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1642133945;
...
label_L1642133945:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L746359178;
...
label_L1018053912:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originSrc(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1516588549;
    ...
    POP_MANY(2);
    goto label_L303934490;

label_L1516588549:
    __CN1_DEBUG_INFO(171);
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1838444270;
...
JAVA_BOOLEAN com_codename1_ui_animations_BubbleTransition_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originSrc(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L601649345;
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1404635097;
...
label_L1404635097:
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_animations_BubbleTransition_clipMotion(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L742067400;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_getBubbleShape___R_com_codename1_ui_geom_GeneralPath(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_bubbleShape(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L571267668;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(212);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L957388291;
    BC_ALOAD(3);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Form);
    if(POP_INT() != 0) /* IFNE */ goto label_L1295618213;
...
label_L417277601:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1548063124;
...
label_L1548063124:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_roundBubble(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1641587857;
    if (virtual_com_codename1_ui_Graphics_isShapeClipSupported___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1641587857;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_drawDialogCmp___com_codename1_ui_Graphics_com_codename1_ui_Dialog(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L1427067435;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1427067435;
...
label_L145823503:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L407034937;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1786758337;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[5].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1786758337;
...
label_L1786758337:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L654350286;
