...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NativeFont_getMaxStringLength___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_maxStringLength(__cn1ThisObject)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1173504361;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NativeFont_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1792381498;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(5418);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1147394515;
    __CN1_DEBUG_INFO(5419);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L70978270;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o), get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L70978270;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_weight(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_weight(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L70978270;
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_height(locals[2].data.o), get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_height(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L70978270;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1147394515:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L353891891;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_style(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_style(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L353891891;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_face(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_face(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L353891891;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_size(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_size(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L353891891;
    PUSH_INT(1); /* ICONST_1 */
