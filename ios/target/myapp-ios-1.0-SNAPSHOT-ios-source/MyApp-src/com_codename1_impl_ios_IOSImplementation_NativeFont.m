...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeFont___INIT_____com_codename1_impl_ios_IOSImplementation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 9584, 205);
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NativeFont_getMaxStringLength___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 9584, 9585);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(5398);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_maxStringLength(__cn1ThisObject)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1792381498;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NativeFont_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 9584, 439);
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1147394515;
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_NativeFont_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 9584, 880);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(5417);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(5418);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L70978270;
    __CN1_DEBUG_INFO(5419);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1402333753;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o), get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1402333753;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_weight(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_weight(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1402333753;
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_height(locals[2].data.o), get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_height(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1402333753;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L353891891;
...
label_L70978270:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_name(locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1340086275;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_style(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_style(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1340086275;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_face(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_face(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1340086275;
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_size(locals[2].data.o)!=get_field_com_codename1_impl_ios_IOSImplementation_NativeFont_size(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1340086275;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L332498651;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NativeFont_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 9584, 885);
