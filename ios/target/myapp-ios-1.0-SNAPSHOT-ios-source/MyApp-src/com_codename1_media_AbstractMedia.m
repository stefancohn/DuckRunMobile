...
JAVA_OBJECT com_codename1_media_AbstractMedia_getState___R_com_codename1_media_AsyncMedia_State(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_media_AbstractMedia_isPlaying___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L746855108;
    __CN1_DEBUG_INFO(56);
...
JAVA_OBJECT com_codename1_media_AbstractMedia_fireMediaStateChange___com_codename1_media_AsyncMedia_State_R_com_codename1_media_AsyncMedia_MediaStateChangeEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    BC_ASTORE(2);
    __CN1_DEBUG_INFO(69);
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_media_AbstractMedia_stateChangeListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L652576951;
    __CN1_DEBUG_INFO(71);
...
JAVA_OBJECT com_codename1_media_AbstractMedia_fireMediaError___com_codename1_media_AsyncMedia_MediaException_R_com_codename1_media_AsyncMedia_MediaErrorEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_media_AbstractMedia_errorListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2084599;
...
JAVA_OBJECT com_codename1_media_AbstractMedia_playAsync___com_codename1_media_AsyncMedia_PlayRequest_R_com_codename1_media_AsyncMedia_PlayRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_media_AsyncMedia_PlayRequest_isDone___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L791942962;
...
label_L791942962:
    ...
    if (get_field_com_codename1_media_AbstractMedia_pendingPauseRequest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L594176554;
...
label_L594176554:
    ...
    if (get_field_com_codename1_media_AbstractMedia_pendingPlayRequest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L692121280;
    if (get_field_com_codename1_media_AbstractMedia_pendingPlayRequest(__cn1ThisObject)==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L692121280;
...
label_L692121280:
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1473705321;
...
JAVA_OBJECT com_codename1_media_AbstractMedia_pauseAsync___com_codename1_media_AsyncMedia_PauseRequest_R_com_codename1_media_AsyncMedia_PauseRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_media_AsyncMedia_PauseRequest_isDone___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1481958694;
...
label_L1481958694:
    ...
    if (get_field_com_codename1_media_AbstractMedia_pendingPlayRequest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L681574204;
...
label_L681574204:
    ...
    if (get_field_com_codename1_media_AbstractMedia_pendingPauseRequest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L109519361;
    if (get_field_com_codename1_media_AbstractMedia_pendingPauseRequest(__cn1ThisObject)==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L109519361;
...
label_L109519361:
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1721426437;
