...
JAVA_OBJECT com_codename1_processing_AttributeEvaluator_evaluateSingle___com_codename1_processing_StructuredContent_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __CN1_DEBUG_INFO(71);
    if (/* CustomInvoke */virtual_com_codename1_processing_StructuredContent_getAttribute___java_lang_String_R_java_lang_String(threadStateData, locals[1].data.o, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L506883855;
    __CN1_DEBUG_INFO(72);
...
label_L1685798867:
    ...
    __CN1_DEBUG_INFO(91);
    if (ilocals_5_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1483438295;
    __CN1_DEBUG_INFO(92);
...
label_L1315483358:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_compareTo___java_lang_String_R_int(threadStateData, locals[4].data.o, locals[3].data.o)<=0) /* IFLE CustomJump */ goto label_L1971858114;
    __CN1_DEBUG_INFO(98);
...
JAVA_OBJECT com_codename1_processing_AttributeEvaluator_evaluateLeftGreaterRight___com_codename1_processing_StructuredContent_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1219499527;
    __CN1_DEBUG_INFO(111);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L1219499527:
    __CN1_DEBUG_INFO(113);
    if (/* CustomInvoke */virtual_com_codename1_processing_AttributeEvaluator_isNumeric___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1126522769;
    if (/* CustomInvoke */virtual_com_codename1_processing_AttributeEvaluator_isNumeric___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1126522769;
    __CN1_DEBUG_INFO(114);
    /* VarOp.assignFrom */ ilocals_5_ = /* CustomInvoke */java_lang_Integer_parseInt___java_lang_String_R_int(threadStateData, locals[4].data.o);
    __CN1_DEBUG_INFO(115);
    /* VarOp.assignFrom */ ilocals_6_ = /* CustomInvoke */java_lang_Integer_parseInt___java_lang_String_R_int(threadStateData, locals[3].data.o);
    __CN1_DEBUG_INFO(116);
    if (ilocals_5_<=ilocals_6_) /* IF_ICMPLE CustomJump */ goto label_L1082862306;
...
label_L1126522769:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_compareTo___java_lang_String_R_int(threadStateData, locals[4].data.o, locals[3].data.o)>=0) /* IFGE CustomJump */ goto label_L1960957451;
...
JAVA_OBJECT com_codename1_processing_AttributeEvaluator_evaluateLeftEqualsRight___com_codename1_processing_StructuredContent_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1009383102;
    __CN1_DEBUG_INFO(136);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L1009383102:
    __CN1_DEBUG_INFO(138);
    if (/* CustomInvoke */virtual_com_codename1_processing_AttributeEvaluator_isNumeric___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1427763069;
    if (/* CustomInvoke */virtual_com_codename1_processing_AttributeEvaluator_isNumeric___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1427763069;
    __CN1_DEBUG_INFO(139);
    /* VarOp.assignFrom */ ilocals_5_ = /* CustomInvoke */java_lang_Integer_parseInt___java_lang_String_R_int(threadStateData, locals[4].data.o);
    __CN1_DEBUG_INFO(140);
    /* VarOp.assignFrom */ ilocals_6_ = /* CustomInvoke */java_lang_Integer_parseInt___java_lang_String_R_int(threadStateData, locals[3].data.o);
    __CN1_DEBUG_INFO(141);
    if (ilocals_5_!=ilocals_6_) /* IF_ICMPNE CustomJump */ goto label_L1281098502;
...
label_L1427763069:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_compareTo___java_lang_String_R_int(threadStateData, locals[4].data.o, locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L913818888;
