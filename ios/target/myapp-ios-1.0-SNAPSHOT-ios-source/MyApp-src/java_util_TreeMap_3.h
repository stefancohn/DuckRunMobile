...
extern void __INIT_VTABLE_java_util_TreeMap_3(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_TreeMap_3(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_TreeMap_3(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_TreeMap_3(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_util_TreeMap_3(CODENAME_ONE_THREAD_STATE);
...
JAVA_VOID java_util_TreeMap_3_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_TreeMap_3_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_util_TreeMap_3_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);

JAVA_OBJECT java_util_TreeMap_3_clone___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
JAVA_OBJECT get_field_java_util_TreeMap_3_this_0(JAVA_OBJECT t);
void set_field_java_util_TreeMap_3_this_0(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T);


struct obj__java_util_TreeMap_3 {
    DEBUG_GC_VARIABLES
    ...
    void* __ownerThread;
    int __heapPosition;
    JAVA_OBJECT java_util_TreeMap_3_this_0;
};



#endif //__JAVA_UTIL_TREEMAP_3__
