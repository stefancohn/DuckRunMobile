...
JAVA_OBJECT com_codename1_io_CacheMap_getStorageCacheContent___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheContentVec(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1836115595;
    __CN1_DEBUG_INFO(57);
    BC_ALOAD(0);
...
JAVA_VOID com_codename1_io_CacheMap_put___java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_io_CacheMap_cacheSize(__cn1ThisObject)>virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_io_CacheMap_memoryCache(__cn1ThisObject))) /* IF_ICMPGT CustomJump */ goto label_L663139908;
...
label_L1875933782:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L993587250;
    ...
    if (CN1_CMP_EXPR(llocals_10_, llocals_4_)<=0) /* IFLE CustomJump */ goto label_L400048100;
    if (locals[7].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2104940330;
...
label_L663139908:
    ...
    if (get_field_com_codename1_io_CacheMap_alwaysStore(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L320192254;
...
label_L1645088054:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1164219495;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[5].data.o, 1 /* ICONST_1 */), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L241222758;
...
JAVA_OBJECT com_codename1_io_CacheMap_get___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1557310919;
...
label_L1557310919:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1039453590;
...
label_L1039453590:
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L901737914;
...
label_L1966896145:
    if (ilocals_5_>=virtual_java_util_Vector_size___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L901737914;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[6].data.o, 1 /* ICONST_1 */), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L667591046;
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1858051117;
...
JAVA_VOID com_codename1_io_CacheMap_placeInStorageCache___java_lang_Object_long_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_LONG __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L1000347057;
...
label_L1297259967:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1234453970;
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(226);
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[9].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1532556857;
...
label_L1532556857:
    __CN1_DEBUG_INFO(223);
    BC_IINC(7, 1);
    goto label_L1297259967;

label_L1234453970:
    __CN1_DEBUG_INFO(233);
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[5].data.o)>=get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1986270265;
...
label_L238381376:
    if (ilocals_10_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L29401411;
    ...
    if (CN1_CMP_EXPR(llocals_7_, llocals_12_)<=0) /* IFLE CustomJump */ goto label_L1478917025;
...
JAVA_VOID com_codename1_io_CacheMap_placeInStorageCache___int_java_lang_Object_long_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_LONG __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[8].data.o)<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L949557121;
...
JAVA_VOID com_codename1_io_CacheMap_clearStorageCache__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1892322930;
