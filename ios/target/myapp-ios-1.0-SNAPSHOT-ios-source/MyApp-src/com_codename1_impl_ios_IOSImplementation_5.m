...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_5_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL34028147901;
    int tryBlockOffsetL34028147901;
    DEFINE_CATCH_BLOCK(catch_L34028147901, label_L1520656618, restoreToL34028147901);
...
label_L340281479:
 tryBlockOffsetL34028147901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L34028147901);
    restoreToL34028147901 = threadStateData->threadObjectStackOffset;
