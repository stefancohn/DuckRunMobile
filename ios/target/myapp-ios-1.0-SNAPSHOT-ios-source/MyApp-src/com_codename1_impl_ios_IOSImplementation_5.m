...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_5___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9627, 205);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_5_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 9627, 207);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL203543054301;
    int tryBlockOffsetL203543054301;
    DEFINE_CATCH_BLOCK(catch_L203543054301, label_L1699265405, restoreToL203543054301);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L237484673, 0);
...
label_L2035430543:
 tryBlockOffsetL203543054301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L203543054301);
    restoreToL203543054301 = threadStateData->threadObjectStackOffset;
