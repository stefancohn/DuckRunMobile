...
JAVA_VOID com_codename1_ui_Display_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL98541685601;
    int tryBlockOffsetL98541685601;
    DEFINE_CATCH_BLOCK(catch_L98541685601, label_L371156515, restoreToL98541685601);
    int restoreToL176387238902;
    int tryBlockOffsetL176387238902;
    DEFINE_CATCH_BLOCK(catch_L176387238902, label_L371156515, restoreToL176387238902);
    int restoreToL37115651503;
    int tryBlockOffsetL37115651503;
    DEFINE_CATCH_BLOCK(catch_L37115651503, label_L371156515, restoreToL37115651503);
    int restoreToL2054997292cn1_class_id_java_lang_Throwable4;
    int tryBlockOffsetL2054997292cn1_class_id_java_lang_Throwable4;
    DEFINE_CATCH_BLOCK(catch_L2054997292cn1_class_id_java_lang_Throwable4, label_L1041611526, restoreToL2054997292cn1_class_id_java_lang_Throwable4);
    int restoreToL1481853275cn1_class_id_java_lang_InterruptedException5;
    int tryBlockOffsetL1481853275cn1_class_id_java_lang_InterruptedException5;
    DEFINE_CATCH_BLOCK(catch_L1481853275cn1_class_id_java_lang_InterruptedException5, label_L1735962278, restoreToL1481853275cn1_class_id_java_lang_InterruptedException5);
...
label_L985416856:
 tryBlockOffsetL98541685601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L98541685601);
    restoreToL98541685601 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L81907268, 1);
...
label_L1763872389:
 tryBlockOffsetL176387238902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L176387238902);
    restoreToL176387238902 = threadStateData->threadObjectStackOffset;
...
label_L152728727:
END_TRY(1);    JUMP_TO(label_L2054997292, 0);

label_L371156515:
 tryBlockOffsetL37115651503 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L37115651503);
    restoreToL37115651503 = threadStateData->threadObjectStackOffset;
...
label_L2054997292:
 tryBlockOffsetL2054997292cn1_class_id_java_lang_Throwable4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L2054997292cn1_class_id_java_lang_Throwable4);
    restoreToL2054997292cn1_class_id_java_lang_Throwable4 = threadStateData->threadObjectStackOffset;
...
label_L1481853275:
 tryBlockOffsetL1481853275cn1_class_id_java_lang_InterruptedException5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1481853275cn1_class_id_java_lang_InterruptedException5);
    restoreToL1481853275cn1_class_id_java_lang_InterruptedException5 = threadStateData->threadObjectStackOffset;
