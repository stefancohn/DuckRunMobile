...
JAVA_VOID com_codename1_ui_Display_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL82358526601;
    int tryBlockOffsetL82358526601;
    DEFINE_CATCH_BLOCK(catch_L82358526601, label_L353296011, restoreToL82358526601);
...
label_L823585266:
 tryBlockOffsetL82358526601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L82358526601);
    restoreToL82358526601 = threadStateData->threadObjectStackOffset;
