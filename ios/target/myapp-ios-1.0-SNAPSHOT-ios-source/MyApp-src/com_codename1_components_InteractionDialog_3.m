...
JAVA_VOID com_codename1_components_InteractionDialog_3_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */com_codename1_components_InteractionDialog_access$200___com_codename1_components_InteractionDialog_R_boolean(threadStateData, get_field_com_codename1_components_InteractionDialog_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L317254273;
...
label_L317254273:
    ...
    if (/* CustomInvoke */com_codename1_components_InteractionDialog_access$600___com_codename1_components_InteractionDialog_R_boolean(threadStateData, get_field_com_codename1_components_InteractionDialog_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1665522694;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1665522694;
    PUSH_POINTER(get_field_com_codename1_components_InteractionDialog_3_this_0(__cn1ThisObject));
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1665522694;
    PUSH_POINTER(get_field_com_codename1_components_InteractionDialog_3_this_0(__cn1ThisObject));
