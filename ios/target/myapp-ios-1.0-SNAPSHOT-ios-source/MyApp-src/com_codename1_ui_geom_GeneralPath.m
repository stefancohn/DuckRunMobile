...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_pathPool___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(84);
    if (get_static_com_codename1_ui_geom_GeneralPath_pathPool(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L556677614;
    __CN1_DEBUG_INFO(85);
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_rectPool___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(91);
    if (get_static_com_codename1_ui_geom_GeneralPath_rectPool(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1670196451;
    __CN1_DEBUG_INFO(92);
    PUSH_POINTER(__NEW_java_util_ArrayList(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ArrayList___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_floatPool___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(98);
    if (get_static_com_codename1_ui_geom_GeneralPath_floatPool(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2036431933;
    __CN1_DEBUG_INFO(99);
    PUSH_POINTER(__NEW_java_util_ArrayList(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ArrayList___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_boolPool___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_geom_GeneralPath_boolPool(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1238166297;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_iteratorPool___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_geom_GeneralPath_iteratorPool(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L427645575;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_createRectFromPool___R_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE) {
    ...
    { JAVA_INT tmpResult = virtual_java_util_ArrayList_isEmpty___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1634697653;
...
label_L1138107948:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1330981538;
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=ilocals_0_) /* IF_ICMPNE CustomJump */ goto label_L1016064173;
...
label_L2068191651:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1579775434;
    ...
    if (CN1_ARRAY_LENGTH(locals[3].data.o)!=ilocals_0_) /* IF_ICMPNE CustomJump */ goto label_L953107607;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_recycle___com_codename1_ui_geom_GeneralPath(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L474027124;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_recycle___com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_static_com_codename1_ui_geom_GeneralPath_rectPool(threadStateData))>=get_static_com_codename1_ui_geom_GeneralPath_MAX_POOL_SIZE(threadStateData)) /* IF_ICMPGE CustomJump */ goto label_L354980344;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_recycle___com_codename1_ui_geom_GeneralPath_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(get_static_com_codename1_ui_geom_GeneralPath_MAX_POOL_SIZE(threadStateData));
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2085085303;
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1102932495;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_isPolygon___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL111300384501;
    int tryBlockOffsetL111300384501;
    DEFINE_CATCH_BLOCK(catch_L111300384501, label_L451530980, restoreToL111300384501);
    int restoreToL75118060302;
    int tryBlockOffsetL75118060302;
    DEFINE_CATCH_BLOCK(catch_L75118060302, label_L451530980, restoreToL75118060302);
    int restoreToL147123019803;
    int tryBlockOffsetL147123019803;
    DEFINE_CATCH_BLOCK(catch_L147123019803, label_L451530980, restoreToL147123019803);
    int restoreToL45153098004;
    int tryBlockOffsetL45153098004;
    DEFINE_CATCH_BLOCK(catch_L45153098004, label_L451530980, restoreToL45153098004);
    __CN1_DEBUG_INFO(429);
    if (virtual_com_codename1_ui_geom_GeneralPath_isRectangle___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1791706561, 0);
...
label_L1113003845:
 tryBlockOffsetL111300384501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L111300384501);
    restoreToL111300384501 = threadStateData->threadObjectStackOffset;
...
label_L1927763846:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L692864183, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L51101315, 1);
        case 1: JUMP_TO(label_L1471230198, 0);
        case 2: JUMP_TO(label_L1743032972, 1);
        case 3: JUMP_TO(label_L1743032972, 1);
        default: JUMP_TO(label_L1471230198, 0);
    }

label_L51101315:
    __CN1_DEBUG_INFO(441);
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L751180603, 0);
...
label_L751180603:
 tryBlockOffsetL75118060302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L75118060302);
    restoreToL75118060302 = threadStateData->threadObjectStackOffset;
...
label_L1471230198:
 tryBlockOffsetL147123019803 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L147123019803);
    restoreToL147123019803 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(453);
    virtual_com_codename1_ui_geom_GeneralPath_Iterator_next__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1927763846, 1);

label_L692864183:
    __CN1_DEBUG_INFO(456);
    if (ilocals_5_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L739241900, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[2].data.o, 0 /* ICONST_0 */), CN1_ARRAY_ELEMENT_FLOAT(locals[3].data.o, 0 /* ICONST_0 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1874622547, 1);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[2].data.o, 1 /* ICONST_1 */), CN1_ARRAY_ELEMENT_FLOAT(locals[3].data.o, 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1874622547, 1);

label_L739241900:
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1933551964, 1);
...
label_L451530980:
 tryBlockOffsetL45153098004 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L45153098004);
    restoreToL45153098004 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath___INIT_____com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L992775130;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL79624030501;
    int tryBlockOffsetL79624030501;
    DEFINE_CATCH_BLOCK(catch_L79624030501, label_L1686106686, restoreToL79624030501);
    int restoreToL168610668602;
    int tryBlockOffsetL168610668602;
    DEFINE_CATCH_BLOCK(catch_L168610668602, label_L1686106686, restoreToL168610668602);
...
label_L796240305:
 tryBlockOffsetL79624030501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L79624030501);
    restoreToL79624030501 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(521);
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1778700964, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L900327013, 1);
        case 1: JUMP_TO(label_L908845261, 1);
        case 2: JUMP_TO(label_L769526324, 1);
        case 3: JUMP_TO(label_L1636003033, 1);
        case 4: JUMP_TO(label_L459482178, 1);
        default: JUMP_TO(label_L1915196011, 1);
    }
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_setWindingRule___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1470726905;
    if (ilocals_1_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1470726905;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_equals___com_codename1_ui_geom_Shape_com_codename1_ui_Transform_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL195586951201;
    int tryBlockOffsetL195586951201;
    DEFINE_CATCH_BLOCK(catch_L195586951201, label_L433321645, restoreToL195586951201);
    int restoreToL43332164502;
    int tryBlockOffsetL43332164502;
    DEFINE_CATCH_BLOCK(catch_L43332164502, label_L433321645, restoreToL43332164502);
    int restoreToL88023294603;
    int tryBlockOffsetL88023294603;
    DEFINE_CATCH_BLOCK(catch_L88023294603, label_L459930631, restoreToL88023294603);
    int restoreToL45993063104;
    int tryBlockOffsetL45993063104;
    DEFINE_CATCH_BLOCK(catch_L45993063104, label_L459930631, restoreToL45993063104);
    int restoreToL46478299705;
    int tryBlockOffsetL46478299705;
    DEFINE_CATCH_BLOCK(catch_L46478299705, label_L434635189, restoreToL46478299705);
    int restoreToL43463518906;
    int tryBlockOffsetL43463518906;
    DEFINE_CATCH_BLOCK(catch_L43463518906, label_L434635189, restoreToL43463518906);
    __CN1_DEBUG_INFO(568);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L38659643, 0);
    if (virtual_com_codename1_ui_Transform_isIdentity___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L38659643, 0);
...
label_L1955869512:
 tryBlockOffsetL195586951201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L195586951201);
    restoreToL195586951201 = threadStateData->threadObjectStackOffset;
...
label_L433321645:
 tryBlockOffsetL43332164502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L43332164502);
    restoreToL43332164502 = threadStateData->threadObjectStackOffset;
...
label_L38659643:
    ...
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L70061633, 0);
    releaseForReturnInException(threadStateData, cn1LocalsBeginInThread, methodBlockOffset); return 1 /* ICONST_1 */;
...
label_L880232946:
 tryBlockOffsetL88023294603 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L88023294603);
    restoreToL88023294603 = threadStateData->threadObjectStackOffset;
...
label_L459930631:
 tryBlockOffsetL45993063104 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L45993063104);
    restoreToL45993063104 = threadStateData->threadObjectStackOffset;
...
label_L1357927175:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L164365573, 0);
    __CN1_DEBUG_INFO(588);
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;    locals[3].data.o = locals[1].data.o;
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(589);
    if (/* CustomInvoke */java_util_Arrays_equals___float_1ARRAY_float_1ARRAY_R_boolean(threadStateData, get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject), get_field_com_codename1_ui_geom_GeneralPath_points(locals[3].data.o))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1683834425, 0);
    if (/* CustomInvoke */java_util_Arrays_equals___byte_1ARRAY_byte_1ARRAY_R_boolean(threadStateData, get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject), get_field_com_codename1_ui_geom_GeneralPath_types(locals[3].data.o))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1683834425, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L149816309, 0);
...
label_L464782997:
 tryBlockOffsetL46478299705 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L46478299705);
    restoreToL46478299705 = threadStateData->threadObjectStackOffset;
...
label_L434635189:
 tryBlockOffsetL43463518906 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L43463518906);
    restoreToL43463518906 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_checkBuf___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1523843460;
    if (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1523843460;
...
label_L1523843460:
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)!=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L861520886;
...
label_L861520886:
    ...
    if ((get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject) + ilocals_1_)<=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject))) /* IF_ICMPLE CustomJump */ goto label_L1027286826;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_moveTo___float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1169324755;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject), (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject) - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ goto label_L1169324755;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_arcTo___float_float_float_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_BOOLEAN __cn1Arg5) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L1110157751;
...
label_L1110157751:
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L651023535;
...
label_L651023535:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1887389255;
    ...
    goto label_L1267338499;

label_L1887389255:
    __CN1_DEBUG_INFO(1229);
    if (ilocals_5_!=0) /* IFNE CustomJump */ goto label_L1267338499;
    if (CN1_CMP_EXPR(dlocals_23_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1267338499;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_closePath__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1425241044;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject), (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject) - 1 /* ICONST_1 */))==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L475249993;
...
label_L1622945931:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1908321704;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L401872697;
        case 1: goto label_L725291300;
        case 2: goto label_L1411932985;
        case 3: goto label_L1350518777;
        case 4: goto label_L1736826640;
        default: goto label_L340017397;
    }

label_L401872697:
    __CN1_DEBUG_INFO(1327);
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L65194223;
    if (get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L688392165;
...
label_L688392165:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject), (get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject) - 2 /* ICONST_2 */)), CN1_ARRAY_ELEMENT_FLOAT(locals[4].data.o, 0 /* ICONST_0 */))!=0) /* IFNE CustomJump */ goto label_L725291300;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject), (get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject) - 1 /* ICONST_1 */)), CN1_ARRAY_ELEMENT_FLOAT(locals[4].data.o, 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ goto label_L725291300;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_getBounds2D___float_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1053273441;
...
label_L1341158560:
    ...
    if (ilocals_6_<=0) /* IFLE CustomJump */ goto label_L674480275;
    ...
    if (CN1_CMP_EXPR(flocals_8_, flocals_2_)>=0) /* IFGE CustomJump */ goto label_L1972950645;
...
label_L1972950645:
    ...
    if (CN1_CMP_EXPR(flocals_8_, flocals_4_)<=0) /* IFLE CustomJump */ goto label_L1229342812;
    __CN1_DEBUG_INFO(1434);
    /* VarOp.assignFrom */     flocals_4_ = flocals_8_;

label_L1229342812:
    __CN1_DEBUG_INFO(1436);
    if (CN1_CMP_EXPR(flocals_7_, flocals_3_)>=0) /* IFGE CustomJump */ goto label_L1256806576;
...
label_L1256806576:
    ...
    if (CN1_CMP_EXPR(flocals_7_, flocals_5_)<=0) /* IFLE CustomJump */ goto label_L2087202342;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_isRectangle___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL50432686701;
    int tryBlockOffsetL50432686701;
    DEFINE_CATCH_BLOCK(catch_L50432686701, label_L660144865, restoreToL50432686701);
    int restoreToL116973459102;
    int tryBlockOffsetL116973459102;
    DEFINE_CATCH_BLOCK(catch_L116973459102, label_L660144865, restoreToL116973459102);
    int restoreToL50229626903;
    int tryBlockOffsetL50229626903;
    DEFINE_CATCH_BLOCK(catch_L50229626903, label_L660144865, restoreToL50229626903);
    int restoreToL146921773704;
    int tryBlockOffsetL146921773704;
    DEFINE_CATCH_BLOCK(catch_L146921773704, label_L660144865, restoreToL146921773704);
    int restoreToL66014486505;
    int tryBlockOffsetL66014486505;
    DEFINE_CATCH_BLOCK(catch_L66014486505, label_L660144865, restoreToL66014486505);
    ...
    /* VarOp.assignFrom */ locals[4].data.o = com_codename1_ui_geom_GeneralPath_createRectFromPool___R_com_codename1_ui_geom_Rectangle(threadStateData);locals[4].type=CN1_TYPE_OBJECT;
label_L504326867:
 tryBlockOffsetL50432686701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L50432686701);
    restoreToL50432686701 = threadStateData->threadObjectStackOffset;
    ...
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L477662472, 1);
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1530);
    if (CN1_ARRAY_LENGTH(locals[2].data.o)==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L719068804, 1);
...
label_L1819665340:
    ...
    if (virtual_com_codename1_ui_geom_GeneralPath_Iterator_isDone___R_boolean(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L714734087, 1);
    ...
    if (ilocals_9_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1169734591, 0);
    if (ilocals_9_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1169734591, 0);
    if (ilocals_9_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1169734591, 0);
...
label_L1169734591:
 tryBlockOffsetL116973459102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L116973459102);
    restoreToL116973459102 = threadStateData->threadObjectStackOffset;
    ...
    if (ilocals_9_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L502296269, 0);
    if (ilocals_10_==ilocals_7_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L502296269, 0);
    if (ilocals_11_==ilocals_8_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L502296269, 0);
...
label_L502296269:
 tryBlockOffsetL50229626903 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L50229626903);
    restoreToL50229626903 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1555);
    if (ilocals_10_==virtual_com_codename1_ui_geom_Rectangle_getX___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1469217737, 0);
    if (ilocals_11_==virtual_com_codename1_ui_geom_Rectangle_getY___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1469217737, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1469217737, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
...
label_L1469217737:
 tryBlockOffsetL146921773704 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L146921773704);
    restoreToL146921773704 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1560);
    /* VarOp.assignFrom */     ilocals_12_ = 0 /* ICONST_0 */; 

label_L698133256:
    if (ilocals_12_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L842988286, 1);
    __CN1_DEBUG_INFO(1561);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[6].data.o, ilocals_12_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L853264965, 1);
    __CN1_DEBUG_INFO(1562);
    JUMP_TO(label_L750996693, 1);
...
label_L853264965:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L1749755575, 1);
        case 1: JUMP_TO(label_L770164810, 1);
        case 2: JUMP_TO(label_L1099081297, 1);
        case 3: JUMP_TO(label_L2006056784, 1);
        default: JUMP_TO(label_L750996693, 1);
    }
...
label_L1749755575:
    ...
    (*SP).data.i = ilocals_12_; 
    SP++;
    if (ilocals_10_!=virtual_com_codename1_ui_geom_Rectangle_getX___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1188958603, 1);
...
label_L770164810:
    ...
    if (ilocals_11_!=virtual_com_codename1_ui_geom_Rectangle_getY___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L17608784, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L2006056784:
    ...
    (*SP).data.i = ilocals_12_; 
    SP++;
    if (ilocals_10_!=virtual_com_codename1_ui_geom_Rectangle_getX___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1061774578, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_11_; 
    SP++;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_geom_Rectangle_getY___R_int(threadStateData, locals[4].data.o);
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1061774578, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L714734087:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(locals[6].data.o, 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L409957428, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[6].data.o, 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L409957428, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[6].data.o, 2 /* ICONST_2 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L409957428, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[6].data.o, 3 /* ICONST_3 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L409957428, 1);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L594822442, 1);
...
label_L660144865:
 tryBlockOffsetL66014486505 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L66014486505);
    restoreToL66014486505 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_setPath___com_codename1_ui_geom_GeneralPath_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1878814375;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_geom_GeneralPath_points(__cn1ThisObject))>=get_field_com_codename1_ui_geom_GeneralPath_pointSize(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L743901415;
...
label_L743901415:
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1341785997;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_geom_GeneralPath_types(__cn1ThisObject))>=get_field_com_codename1_ui_geom_GeneralPath_typeSize(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1311135309;
...
label_L1311135309:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1109622904;
    if (virtual_com_codename1_ui_Transform_isIdentity___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1445443819;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_setRect___com_codename1_ui_geom_Rectangle_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL48531081101;
    int tryBlockOffsetL48531081101;
    DEFINE_CATCH_BLOCK(catch_L48531081101, label_L890681473, restoreToL48531081101);
    int restoreToL89068147302;
    int tryBlockOffsetL89068147302;
    DEFINE_CATCH_BLOCK(catch_L89068147302, label_L890681473, restoreToL89068147302);
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1810419227, 0);
...
label_L485310811:
 tryBlockOffsetL48531081101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L48531081101);
    restoreToL48531081101 = threadStateData->threadObjectStackOffset;
...
label_L890681473:
 tryBlockOffsetL89068147302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L89068147302);
    restoreToL89068147302 = threadStateData->threadObjectStackOffset;
...
label_L964301023:
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L337509625;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_intersect___com_codename1_ui_geom_Rectangle_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL95693039601;
    int tryBlockOffsetL95693039601;
    DEFINE_CATCH_BLOCK(catch_L95693039601, label_L175881660, restoreToL95693039601);
    int restoreToL167658515602;
    int tryBlockOffsetL167658515602;
    DEFINE_CATCH_BLOCK(catch_L167658515602, label_L175881660, restoreToL167658515602);
    int restoreToL17588166003;
    int tryBlockOffsetL17588166003;
    DEFINE_CATCH_BLOCK(catch_L17588166003, label_L175881660, restoreToL17588166003);
...
label_L956930396:
 tryBlockOffsetL95693039601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L95693039601);
    restoreToL95693039601 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1676585156, 0);
...
label_L175881660:
 tryBlockOffsetL17588166003 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L17588166003);
    restoreToL17588166003 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_intersect___int_int_int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    int restoreToL114391720701;
    int tryBlockOffsetL114391720701;
    DEFINE_CATCH_BLOCK(catch_L114391720701, label_L429018901, restoreToL114391720701);
    int restoreToL42901890102;
    int tryBlockOffsetL42901890102;
    DEFINE_CATCH_BLOCK(catch_L42901890102, label_L429018901, restoreToL42901890102);
...
label_L1143917207:
 tryBlockOffsetL114391720701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L114391720701);
    restoreToL114391720701 = threadStateData->threadObjectStackOffset;
...
label_L429018901:
 tryBlockOffsetL42901890102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L42901890102);
    restoreToL42901890102 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_geom_GeneralPath_transform___com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1645449962;
    if (virtual_com_codename1_ui_Transform_isIdentity___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1645449962;
...
JAVA_OBJECT com_codename1_ui_geom_GeneralPath_intersection___com_codename1_ui_geom_Rectangle_R_com_codename1_ui_geom_Shape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L602694575;
...
JAVA_BOOLEAN com_codename1_ui_geom_GeneralPath_isInside___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_geom_GeneralPath_rule(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L671967776;
...
label_L788075428:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L500580931;
...
label_L500580931:
    ...
    if (/* CustomInvoke */com_codename1_ui_geom_GeneralPath_detectPolygonType___com_codename1_ui_geom_GeneralPath_Pt_1ARRAY_int_R_int(threadStateData, locals[3].data.o, ilocals_2_)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1376533963;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_geom_GeneralPath_detectPolygonType___com_codename1_ui_geom_GeneralPath_Pt_1ARRAY_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_static_com_codename1_ui_geom_GeneralPath_tmpV1(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L993293369;
    PUSH_POINTER(__NEW_com_codename1_ui_geom_GeneralPath_Pt(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_geom_GeneralPath_Pt___INIT_____com_codename1_ui_geom_GeneralPath_1(threadStateData, SP[-1].data.o, JAVA_NULL /* ACONST_NULL */);     SP -= 1;
    BC_DUP(); /* DUP */
...
label_L1563833544:
    ...
    if (get_static_com_codename1_ui_geom_GeneralPath_tmpV2(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1852287168;
    PUSH_POINTER(__NEW_com_codename1_ui_geom_GeneralPath_Pt(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_geom_GeneralPath_Pt___INIT_____com_codename1_ui_geom_GeneralPath_1(threadStateData, SP[-1].data.o, JAVA_NULL /* ACONST_NULL */);     SP -= 1;
    BC_DUP(); /* DUP */
...
label_L93720343:
    ...
    if (ilocals_1_>=3 /* ICONST_3 */) /* IF_ICMPGE CustomJump */ goto label_L488322592;
...
label_L390994841:
    if (ilocals_8_>=(ilocals_1_ - 1 /* ICONST_1 */)) /* IF_ICMPGE CustomJump */ goto label_L1911013695;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(3274);
    ...
    if (CN1_CMP_EXPR((dlocals_6_ * dlocals_4_), 0 /* DCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1403032934;
