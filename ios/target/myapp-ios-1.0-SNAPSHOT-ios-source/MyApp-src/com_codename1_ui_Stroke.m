...
JAVA_BOOLEAN com_codename1_ui_Stroke_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1107984450;
    __CN1_DEBUG_INFO(217);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(218);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Stroke_miterLimit(locals[2].data.o), get_field_com_codename1_ui_Stroke_miterLimit(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L848484634;
    if (get_field_com_codename1_ui_Stroke_capStyle(locals[2].data.o)!=get_field_com_codename1_ui_Stroke_capStyle(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L848484634;
    if (get_field_com_codename1_ui_Stroke_joinStyle(locals[2].data.o)!=get_field_com_codename1_ui_Stroke_joinStyle(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L848484634;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Stroke_lineWidth(locals[2].data.o), get_field_com_codename1_ui_Stroke_lineWidth(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L848484634;
    PUSH_INT(1); /* ICONST_1 */
