...
JAVA_VOID com_codename1_ui_Toolbar_ToolbarSideMenu_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$1300___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_ToolbarSideMenu_this_0(get_field_com_codename1_ui_Toolbar_ToolbarSideMenu_1_this_1(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L834842620;
