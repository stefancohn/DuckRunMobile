...
JAVA_VOID com_example_entity_EnemyManager___INIT_____com_example_levels_LevelManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 10280, 205);
...
label_L388802347:
    if (ilocals_1_>=CN1_ARRAY_LENGTH(get_field_com_example_entity_EnemyManager_spawnPoints(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1403716230;
    __CN1_DEBUG_INFO(39);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 

label_L479734028:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(CN1_ARRAY_ELEMENT_OBJECT(get_field_com_example_entity_EnemyManager_spawnPoints(__cn1ThisObject), ilocals_1_))) /* IF_ICMPGE CustomJump */ goto label_L1673916398;
    __CN1_DEBUG_INFO(40);
    ...
    __CN1_DEBUG_INFO(41);
    if (ilocals_3_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L756080817;
    __CN1_DEBUG_INFO(42);
...
JAVA_VOID com_example_entity_EnemyManager_spawnGooseRandom__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 7, 0, 10280, 10282);
...
label_L1624817884:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1541046463;
    __CN1_DEBUG_INFO(51);
    BC_ALOAD(1);
    ...
    BC_ISTORE(5);
    __CN1_DEBUG_INFO(54);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1910896157;
    if (ilocals_3_!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L753426788;

label_L1910896157:
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1586470445;
    if (ilocals_4_!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L753426788;

label_L1586470445:
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1373577787;
    if (ilocals_5_!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L753426788;
...
label_L1373577787:
    ...
    SP[-1].data.i = ((JAVA_ARRAY_INT*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(4); /* ICONST_4 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L753426788;
    BC_ALOAD(1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    ...
    PUSH_INT(30);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L265577219;
    __CN1_DEBUG_INFO(59);
    if (ilocals_6_>(6 + ((JAVA_INT)get_static_com_example_statemanager_PlayingScene_gameScore(threadStateData)))) /* IF_ICMPGT CustomJump */ goto label_L753426788;
    __CN1_DEBUG_INFO(60);
    PUSH_POINTER(get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject));
    PUSH_POINTER(__NEW_com_example_entity_Goose(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
label_L265577219:
    ...
    SP++;
    PUSH_INT(36);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L753426788;
    __CN1_DEBUG_INFO(64);
    PUSH_POINTER(get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject));
    PUSH_POINTER(__NEW_com_example_entity_Goose(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
JAVA_VOID com_example_entity_EnemyManager_callXOffsetGoose___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 10280, 10283);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(72);
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_ArrayList_iterator___R_java_util_Iterator(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject));locals[2].type=CN1_TYPE_OBJECT;
label_L1784834205:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1107579932;
    /* VarOp.assignFrom */ locals[3].data.o = virtual_java_util_Iterator_next___R_java_lang_Object(threadStateData, locals[2].data.o);locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(73);
    /* CustomInvoke */virtual_com_example_entity_Goose_xOffsetForConstantMove___int(threadStateData, locals[3].data.o, ilocals_1_); 
    __CN1_DEBUG_INFO(74);
...
JAVA_VOID com_example_entity_EnemyManager_removeGoose__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10280, 10284);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(78);
    /* VarOp.assignFrom */     ilocals_1_ = 0 /* ICONST_0 */; 

label_L4073506:
    if (ilocals_1_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1174586025;
    __CN1_DEBUG_INFO(79);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1627010197;
    __CN1_DEBUG_INFO(80);
...
JAVA_VOID com_example_entity_EnemyManager_duckyAndGooseCollision__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 10280, 10285);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(86);
    /* VarOp.assignFrom */     ilocals_1_ = 0 /* ICONST_0 */; 

label_L407493402:
    if (ilocals_1_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L2044825144;
    __CN1_DEBUG_INFO(88);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L698747943;
...
JAVA_VOID com_example_entity_EnemyManager_gooseAndProjectileCollision__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 10280, 10286);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(94);
    /* VarOp.assignFrom */     ilocals_1_ = 0 /* ICONST_0 */; 

label_L114414807:
    if (ilocals_1_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1774690057;
    __CN1_DEBUG_INFO(95);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 

label_L1396385390:
    if (ilocals_2_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L480402503;
    __CN1_DEBUG_INFO(96);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject), ilocals_1_);
    PUSH_OBJ(tmpResult); }
    PUSH_POINTER(get_field_com_example_entity_Goose_hitbox(POP_OBJ()));
    ...
    { JAVA_INT tmpResult = virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L100445376;
    __CN1_DEBUG_INFO(97);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject), ilocals_2_);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */PUSH_OBJ(java_lang_Boolean_valueOf___boolean_R_java_lang_Boolean(threadStateData, 1 /* ICONST_1 */));
    ...
    /* CustomInvoke */virtual_com_example_audio_AudioPlayer_playAudio___java_lang_String(threadStateData, get_static_com_example_myapp_Game_audioPlayer(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10287)); 
...
JAVA_VOID com_example_entity_EnemyManager_createProjectiles__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(9, 1, 0, 10280, 10288);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(108);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, get_field_com_example_entity_Ducky_isAttacking(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L144699438;
    if (get_field_com_example_entity_Ducky_spriteLoop(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject))!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L144699438;
    PUSH_INT(get_field_com_example_entity_Ducky_aniTick(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)));
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L144699438;
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, get_field_com_example_entity_Ducky_isAttackingLeft(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)))!=0) /* IFNE CustomJump */ goto label_L144699438;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; /* POP */
    goto label_L1751500625;

label_L144699438:
    __CN1_DEBUG_INFO(110);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, get_field_com_example_entity_Ducky_isAttacking(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L1751500625;
    if (get_field_com_example_entity_Ducky_spriteLoop(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject))!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L1751500625;
    PUSH_INT(get_field_com_example_entity_Ducky_aniTick(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)));
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1751500625;
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, get_field_com_example_entity_Ducky_isAttackingLeft(get_field_com_example_entity_EnemyManager_duck(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L1751500625;
...
JAVA_VOID com_example_entity_EnemyManager_removeProjectiles__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10280, 10289);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(115);
    /* VarOp.assignFrom */     ilocals_1_ = 0 /* ICONST_0 */; 

label_L493944943:
    if (ilocals_1_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1650955365;
    ...
    { JAVA_INT tmpResult = virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1788380050;
...
JAVA_VOID com_example_entity_EnemyManager_update__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10280, 2530);
    ...
    /* VarOp.assignFrom */ locals[1].data.o = virtual_java_util_ArrayList_iterator___R_java_util_Iterator(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject));locals[1].type=CN1_TYPE_OBJECT;
label_L99770475:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1533547487;
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_Iterator_next___R_java_lang_Object(threadStateData, locals[1].data.o);locals[2].type=CN1_TYPE_OBJECT;    virtual_com_example_entity_Goose_update__(threadStateData, locals[2].data.o); 
...
label_L1052768296:
    if (ilocals_1_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L727250772;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject), ilocals_1_);
    PUSH_OBJ(tmpResult); }
...
JAVA_VOID com_example_entity_EnemyManager_draw___com_codename1_ui_Graphics_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 10280, 5503);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(134);
    /* VarOp.assignFrom */ locals[3].data.o = virtual_java_util_ArrayList_iterator___R_java_util_Iterator(threadStateData, get_field_com_example_entity_EnemyManager_enemies(__cn1ThisObject));locals[3].type=CN1_TYPE_OBJECT;
label_L859123506:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L626193099;
    /* VarOp.assignFrom */ locals[4].data.o = virtual_java_util_Iterator_next___R_java_lang_Object(threadStateData, locals[3].data.o);locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(135);
    /* CustomInvoke */virtual_com_example_entity_Goose_draw___com_codename1_ui_Graphics_int(threadStateData, locals[4].data.o, locals[1].data.o, ilocals_2_); 
...
label_L503595296:
    if (ilocals_3_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_example_entity_EnemyManager_projectiles(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1597742167;
