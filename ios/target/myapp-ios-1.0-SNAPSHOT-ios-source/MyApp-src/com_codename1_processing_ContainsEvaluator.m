...
JAVA_OBJECT com_codename1_processing_ContainsEvaluator_evaluateLeftContainsRight___com_codename1_processing_StructuredContent_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1078290151;
    __CN1_DEBUG_INFO(78);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L1078290151:
    __CN1_DEBUG_INFO(82);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6448))!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1054374766;
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1054374766;
    __CN1_DEBUG_INFO(83);
...
label_L816162189:
    if (ilocals_10_>=ilocals_9_) /* IF_ICMPGE CustomJump */ goto label_L1111811191;
...
label_L513755348:
    if (ilocals_6_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L150499707;
    __CN1_DEBUG_INFO(92);
...
locals[12].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(93);
    if (/* CustomInvoke */virtual_java_lang_String_equalsIgnoreCase___java_lang_String_R_boolean(threadStateData, locals[12].data.o, locals[11].data.o)==0) /* IFEQ CustomJump */ goto label_L1667321053;
    __CN1_DEBUG_INFO(94);
...
label_L150499707:
    __CN1_DEBUG_INFO(97);
    if (ilocals_6_!=ilocals_7_) /* IF_ICMPNE CustomJump */ goto label_L2073911340;
    __CN1_DEBUG_INFO(98);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;
