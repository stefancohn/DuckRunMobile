...
JAVA_VOID com_codename1_util_Base64___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8149, 205);
...
JAVA_OBJECT com_codename1_util_Base64_decode___byte_1ARRAY_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 8149, 1978);
...
JAVA_OBJECT com_codename1_util_Base64_decode___byte_1ARRAY_int_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(5, 11, 0, 8149, 1978);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    __CN1_DEBUG_INFO(44);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1009725708;
    __CN1_DEBUG_INFO(45);
    PUSH_INT(0); /* ICONST_0 */
...
label_L837308176:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1962487060;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1074206864;
    __CN1_DEBUG_INFO(59);
...
label_L1074206864:
    ...
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1955243996;
    __CN1_DEBUG_INFO(62);
    BC_IINC(4, 1);
...
label_L522491865:
    if (ilocals_10_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L205804980;
    __CN1_DEBUG_INFO(76);
    ...
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1954484020;
    __CN1_DEBUG_INFO(78);
    goto label_L205804980;
...
label_L1954484020:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1433068064;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L646559570;
    __CN1_DEBUG_INFO(83);
...
label_L646559570:
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L139374530;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(90);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L139374530;
    __CN1_DEBUG_INFO(89);
    /* VarOp.assignFrom */ ilocals_8_=(ilocals_5_ - 65);
    goto label_L71567184;
...
label_L139374530:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L104701466;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L104701466;
    __CN1_DEBUG_INFO(94);
...
label_L104701466:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1835371176;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1835371176;
    __CN1_DEBUG_INFO(99);
...
label_L1835371176:
    ...
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L271059065;
...
label_L271059065:
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L879948715;
...
label_L71567184:
    ...
    if ((ilocals_7_ % 4/* ICONST_4 */)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L1582659185;
...
label_L205804980:
    ...
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L1327443844;
    ...
    if (ilocals_4_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1327443844;
...
JAVA_OBJECT com_codename1_util_Base64_encodeNoNewline___byte_1ARRAY_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(7, 6, 0, 8149, 8150);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
label_L1684834090:
    if (ilocals_4_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1445093476;
...
label_L1445093476:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L496751830;
        case 2: goto label_L1922613977;
        default: goto label_L930921902;
    }
...
JAVA_VOID com_codename1_util_Base64___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 8149, 275);
