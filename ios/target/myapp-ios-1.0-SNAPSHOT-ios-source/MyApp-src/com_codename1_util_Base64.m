...
JAVA_OBJECT com_codename1_util_Base64_decode___byte_1ARRAY_int_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __CN1_DEBUG_INFO(44);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1432962253;
    __CN1_DEBUG_INFO(45);
    PUSH_INT(0); /* ICONST_0 */
...
label_L2117522696:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L923439967;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2114027335;
    __CN1_DEBUG_INFO(59);
    goto label_L923439967;
...
label_L2114027335:
    ...
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1634118341;
    __CN1_DEBUG_INFO(62);
    BC_IINC(4, 1);
...
label_L139374530:
    if (ilocals_10_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L491074042;
    __CN1_DEBUG_INFO(76);
...
label_L1758170706:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1009725708;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1962487060;
    __CN1_DEBUG_INFO(83);
    goto label_L1009725708;
...
label_L1074206864:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L837308176;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L837308176;
    __CN1_DEBUG_INFO(94);
...
label_L837308176:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L205804980;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L205804980;
    __CN1_DEBUG_INFO(99);
...
label_L1954484020:
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1433068064;
...
label_L1955243996:
    ...
    if ((ilocals_7_ % 4/* ICONST_4 */)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L646559570;
...
label_L1009725708:
    __CN1_DEBUG_INFO(75);
    BC_IINC(10, 1);
    goto label_L139374530;

label_L491074042:
    __CN1_DEBUG_INFO(117);
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L71567184;
    ...
    if (ilocals_4_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L71567184;
...
label_L1817408103:
    if (ilocals_4_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1327443844;
...
label_L1327443844:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L432039778;
        case 2: goto label_L585212380;
        default: goto label_L347396363;
    }
