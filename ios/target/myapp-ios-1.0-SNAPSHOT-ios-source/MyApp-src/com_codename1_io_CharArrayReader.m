...
JAVA_VOID com_codename1_io_CharArrayReader_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL138603274501;
    int tryBlockOffsetL138603274501;
    DEFINE_CATCH_BLOCK(catch_L138603274501, label_L2031003023, restoreToL138603274501);
...
JAVA_VOID com_codename1_io_CharArrayReader_mark___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L93424257701, label_L1732238376, restoreToL93424257701);
...
JAVA_INT com_codename1_io_CharArrayReader_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL106577520001;
    int tryBlockOffsetL106577520001;
    DEFINE_CATCH_BLOCK(catch_L106577520001, label_L1111947524, restoreToL106577520001);
...
label_L1065775200:
 tryBlockOffsetL106577520001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L106577520001);
    restoreToL106577520001 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_io_CharArrayReader_read___char_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    int restoreToL37437720601;
    int tryBlockOffsetL37437720601;
    DEFINE_CATCH_BLOCK(catch_L37437720601, label_L1777328089, restoreToL37437720601);
...
JAVA_VOID com_codename1_io_CharArrayReader_reset__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL8794823201;
    int tryBlockOffsetL8794823201;
    DEFINE_CATCH_BLOCK(catch_L8794823201, label_L639313883, restoreToL8794823201);
...
label_L87948232:
 tryBlockOffsetL8794823201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L8794823201);
    restoreToL8794823201 = threadStateData->threadObjectStackOffset;
...
JAVA_LONG com_codename1_io_CharArrayReader_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    int restoreToL55146105701;
    int tryBlockOffsetL55146105701;
    DEFINE_CATCH_BLOCK(catch_L55146105701, label_L854246299, restoreToL55146105701);
...
label_L551461057:
 tryBlockOffsetL55146105701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L55146105701);
    restoreToL55146105701 = threadStateData->threadObjectStackOffset;
