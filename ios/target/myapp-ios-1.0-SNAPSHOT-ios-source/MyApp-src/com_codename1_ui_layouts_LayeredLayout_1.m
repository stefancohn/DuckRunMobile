...
JAVA_INT com_codename1_ui_layouts_LayeredLayout_1_compare___com_codename1_ui_Component_com_codename1_ui_Component_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_Component_getY___R_int(threadStateData, locals[1].data.o)>=virtual_com_codename1_ui_Component_getY___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1881996254;
    __CN1_DEBUG_INFO(3383);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;

label_L1881996254:
    __CN1_DEBUG_INFO(3384);
    if (virtual_com_codename1_ui_Component_getY___R_int(threadStateData, locals[1].data.o)<=virtual_com_codename1_ui_Component_getY___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPLE CustomJump */ goto label_L131316947;
    __CN1_DEBUG_INFO(3385);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L131316947:
    __CN1_DEBUG_INFO(3387);
    if (virtual_com_codename1_ui_Component_getX___R_int(threadStateData, locals[1].data.o)>=virtual_com_codename1_ui_Component_getX___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1573805059;
    __CN1_DEBUG_INFO(3388);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;

label_L1573805059:
    __CN1_DEBUG_INFO(3389);
    if (virtual_com_codename1_ui_Component_getX___R_int(threadStateData, locals[1].data.o)<=virtual_com_codename1_ui_Component_getX___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPLE CustomJump */ goto label_L192329688;
