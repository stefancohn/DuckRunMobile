...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(144);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(31);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1660570248;
...
label_L780427036:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1265189536;
    __CN1_DEBUG_INFO(170);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[0].data.o, ilocals_5_)!=0) /* IFNE CustomJump */ goto label_L1684281752;
    __CN1_DEBUG_INFO(171);
    goto label_L1265189536;
