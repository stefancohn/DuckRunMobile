...
JAVA_INT com_codename1_impl_ios_NSFileInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(77);
    if (ilocals_4_<get_field_com_codename1_impl_ios_NSFileInputStream_length(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L474933596;
    __CN1_DEBUG_INFO(78);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;

label_L474933596:
    __CN1_DEBUG_INFO(80);
    if ((ilocals_4_ + ilocals_3_)<=get_field_com_codename1_impl_ios_NSFileInputStream_length(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L2042917213;
    __CN1_DEBUG_INFO(81);
...
JAVA_INT com_codename1_impl_ios_NSFileInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    __CN1_DEBUG_INFO(91);
    if (ilocals_1_<get_field_com_codename1_impl_ios_NSFileInputStream_length(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1520656618;
    __CN1_DEBUG_INFO(92);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;
...
JAVA_LONG com_codename1_impl_ios_NSFileInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (CN1_CMP_EXPR((((JAVA_LONG)ilocals_3_) + llocals_1_), ((JAVA_LONG)get_field_com_codename1_impl_ios_NSFileInputStream_length(__cn1ThisObject)))<0) /* IFLT CustomJump */ goto label_L1699265405;
...
JAVA_VOID com_codename1_impl_ios_NSFileInputStream_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_NSFileInputStream_nsFileHandle(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1412656257;
