...
JAVA_VOID com_codename1_xml_Element___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 205);
...
JAVA_VOID com_codename1_xml_Element___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7749, 205);
...
JAVA_VOID com_codename1_xml_Element___INIT_____java_lang_String_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7749, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_xml_Element_isTextElement___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 7750);
...
JAVA_OBJECT com_codename1_xml_Element_getTagName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7749, 7751);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(119);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1227792007;
    __CN1_DEBUG_INFO(120);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7752));     SP -= 1;
...
JAVA_VOID com_codename1_xml_Element_setAttribute___java_lang_Object_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7749, 7753);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(142);
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1931608383;
...
JAVA_VOID com_codename1_xml_Element_addChild___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7749, 7754);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_xml_Element_setParent___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7749, 2481);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_xml_Element_getParent___R_com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 364);
...
JAVA_INT com_codename1_xml_Element_getNumChildren___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 7755);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(185);
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L980700722;
...
JAVA_OBJECT com_codename1_xml_Element_getChildAt___int_R_com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7749, 7759);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(248);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1593443833;
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1593443833;
    if (ilocals_1_<virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L85284187;
...
JAVA_BOOLEAN com_codename1_xml_Element_cmpTagName___java_lang_String_com_codename1_xml_Element_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_xml_Element(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 7749, 7760);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(262);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1663), locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1491251091;
...
JAVA_VOID com_codename1_xml_Element_getDescendantsByTagNameInternal___java_util_Vector_java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 7749, 7764);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1885256525;
    __CN1_DEBUG_INFO(323);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 

label_L1301992318:
    __CN1_DEBUG_INFO(324);
    if (ilocals_4_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1885256525;
    ...
    if (ilocals_3_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L849515361;
...
label_L849515361:
    ...
    if (get_field_com_codename1_xml_Element_textElement(locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L2104281815;
    if (/* CustomInvoke */com_codename1_xml_Element_cmpTagName___java_lang_String_com_codename1_xml_Element_R_boolean(threadStateData, locals[2].data.o, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L2104281815;
...
JAVA_OBJECT com_codename1_xml_Element_getDescendantsByTagName___java_lang_String_int_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 7749, 7768);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(388);
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L1807861968;
    __CN1_DEBUG_INFO(389);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7767));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L1807861968:
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2140404961;
...
JAVA_OBJECT com_codename1_xml_Element_getDescendantsByTagName___java_lang_String_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7749, 7768);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_xml_Element_getChildrenByTagName___java_lang_String_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7749, 7769);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_xml_Element_setAttribute___java_lang_String_java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L751467836;
    __CN1_DEBUG_INFO(530);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7773));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT com_codename1_xml_Element_getAttribute___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7749, 7618);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(592);
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1369468885;
    __CN1_DEBUG_INFO(593);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L1369468885:
    __CN1_DEBUG_INFO(595);
    if (get_field_com_codename1_xml_Element_caseSensitive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L653130292;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L653130292;
...
JAVA_VOID com_codename1_xml_Element_setChildParent___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7749, 7776);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(605);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2003533730;
    __CN1_DEBUG_INFO(606);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7777));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L2003533730:
    __CN1_DEBUG_INFO(609);
    if (virtual_com_codename1_xml_Element_getParent___R_com_codename1_xml_Element(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1065002232;
    __CN1_DEBUG_INFO(610);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7778));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1065002232:
    __CN1_DEBUG_INFO(612);
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1836493317;
...
JAVA_OBJECT com_codename1_xml_Element_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7749, 4122);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(690);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1399313519;
    __CN1_DEBUG_INFO(691);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7784));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_xml_Element_setText___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7749, 3059);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(703);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1817103570;
    __CN1_DEBUG_INFO(704);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7785));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT com_codename1_xml_Element_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7749, 263);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(716);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_xml_Element_toString___java_lang_String_R_java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(289));
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
...
JAVA_OBJECT com_codename1_xml_Element_toString___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 7749, 263);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(728);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(729);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1447992331;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5405));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1283267007;
...
label_L567572723:
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1283267007;
...
label_L1283267007:
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1004931143;
    __CN1_DEBUG_INFO(740);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L434791924:
    if (ilocals_3_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1004931143;
...
JAVA_BOOLEAN com_codename1_xml_Element_isEmpty___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 274);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(772);
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L851514585;
    if (virtual_java_util_ArrayList_isEmpty___R_boolean(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1945567153;

label_L851514585:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1158016054;
...
JAVA_OBJECT com_codename1_xml_Element_iterator___R_java_util_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7749, 608);
