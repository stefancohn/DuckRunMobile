...
JAVA_OBJECT com_codename1_ui_spinner_TimeSpinner3D_2_format___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1579957888cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1579957888cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1579957888cn1_class_id_java_lang_Throwable1, label_L405273678, restoreToL1579957888cn1_class_id_java_lang_Throwable1);
    __CN1_DEBUG_INFO(101);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1279369591, 0);
    __CN1_DEBUG_INFO(102);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;
label_L1579957888:
 tryBlockOffsetL1579957888cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1579957888cn1_class_id_java_lang_Throwable1);
    restoreToL1579957888cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
label_L800026186:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1279369591, 0);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_java_lang_Integer);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1279369591, 0);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L1135281753, 0);
