...
JAVA_VOID com_codename1_ui_SideMenuBar_3___INIT_____com_codename1_ui_SideMenuBar_boolean_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7038, 205);
...
JAVA_VOID com_codename1_ui_SideMenuBar_3_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 7038, 3061);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(272);
    if (get_field_com_codename1_ui_SideMenuBar_sideSwipePotential(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1360393616;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1360393616;
...
label_L1261545224:
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L300111306;
...
label_L1360393616:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$300___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1893088773;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L236055802;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1893088773;
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1893088773;
...
label_L236055802:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L1214125015;
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, (ilocals_3_ - get_field_com_codename1_ui_SideMenuBar_initialDragY(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))))<=(get_field_com_codename1_ui_SideMenuBar_initialDragX(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject)) - ilocals_2_)) /* IF_ICMPLE CustomJump */ goto label_L1134051859;
...
label_L1134051859:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1893088773;
    ...
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L50297459;
...
label_L1893088773:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$400___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L997219303;
    __CN1_DEBUG_INFO(312);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_events_ActionEvent_getX___R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(313);
    /* VarOp.assignFrom */ ilocals_3_ = virtual_com_codename1_ui_events_ActionEvent_getY___R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(314);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, (ilocals_3_ - get_field_com_codename1_ui_SideMenuBar_initialDragY(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))))>=(ilocals_2_ - get_field_com_codename1_ui_SideMenuBar_initialDragX(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject)))) /* IF_ICMPGE CustomJump */ goto label_L981012032;
...
label_L981012032:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L997219303;
