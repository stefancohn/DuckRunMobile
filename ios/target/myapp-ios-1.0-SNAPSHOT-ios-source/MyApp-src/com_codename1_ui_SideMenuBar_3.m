...
JAVA_VOID com_codename1_ui_SideMenuBar_3_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_SideMenuBar_sideSwipePotential(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L50297459;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ goto label_L50297459;
...
label_L50297459:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$300___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L981012032;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1135400862;
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_ui_SideMenuBar_3_val_hasSideMenus(__cn1ThisObject), 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ goto label_L981012032;
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L981012032;
...
label_L1135400862:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L31567969;
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, (ilocals_3_ - get_field_com_codename1_ui_SideMenuBar_initialDragY(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))))<=(get_field_com_codename1_ui_SideMenuBar_initialDragX(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject)) - ilocals_2_)) /* IF_ICMPLE CustomJump */ goto label_L955743449;
...
label_L955743449:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L981012032;
    ...
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1250848393;
...
label_L981012032:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$400___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1674938191;
    __CN1_DEBUG_INFO(312);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_events_ActionEvent_getX___R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(313);
    /* VarOp.assignFrom */ ilocals_3_ = virtual_com_codename1_ui_events_ActionEvent_getY___R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(314);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, (ilocals_3_ - get_field_com_codename1_ui_SideMenuBar_initialDragY(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject))))>=(ilocals_2_ - get_field_com_codename1_ui_SideMenuBar_initialDragX(get_field_com_codename1_ui_SideMenuBar_3_this_0(__cn1ThisObject)))) /* IF_ICMPGE CustomJump */ goto label_L1623670360;
...
label_L1623670360:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1674938191;
