...
JAVA_OBJECT com_codename1_ui_animations_CommonTransitions_createFastSlide___int_boolean_int_R_com_codename1_ui_animations_CommonTransitions(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L321041730;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_initTransition__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L111768855;
...
label_L111768855:
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L676022399;
    if (ilocals_4_>0) /* IFGT CustomJump */ goto label_L1694636980;
...
label_L1694636980:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1661745907;
...
label_L1661745907:
    ...
    PUSH_INT(6);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1555711823;
...
label_L1555711823:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L726226084;
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L49477935;

label_L726226084:
    __CN1_DEBUG_INFO(436);
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L217859585;
...
label_L217859585:
    ...
    if (virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject))!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L604148185;
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject))==ilocals_4_) /* IF_ICMPEQ CustomJump */ goto label_L49477935;
...
label_L49477935:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1158614409;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1352773510;
...
label_L247461277:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getComponentForm___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L862048902;
...
label_L1158614409:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1241213245;
...
label_L1241213245:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1975880178;
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)==3 /* ICONST_3 */) /* IF_ICMPEQ CustomJump */ goto label_L1975880178;
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject));
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1975880178;
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject));
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L115016870;
...
label_L1975880178:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L150172894;
    if (get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L150172894;
    __CN1_DEBUG_INFO(511);
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L1114182596;
    PUSH_INT(1); /* ICONST_1 */
...
label_L150172894:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1159348615;
...
label_L1159348615:
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L909878836;
...
label_L1627289079:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_drawDialogMenu(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L320318508;
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L320318508;
    ...
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1311163144;
...
label_L909878836:
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ goto label_L2089779261;
...
label_L2089779261:
    ...
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L320318508;
    ...
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L320318508;
...
label_L393118622:
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L2087366743;
...
label_L2095335823:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L527783934;
...
JAVA_OBJECT com_codename1_ui_animations_CommonTransitions_createMotion___int_int_int_R_com_codename1_ui_animations_Motion(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_motionSetManually(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2077742876;
    __CN1_DEBUG_INFO(632);
    if (get_field_com_codename1_ui_animations_CommonTransitions_lazyMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1385576505;
...
label_L2077742876:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_linearMotion(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L216054741;
...
JAVA_BOOLEAN com_codename1_ui_animations_CommonTransitions_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_timeline(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L966776592;
...
label_L966776592:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_motion(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2083887112;
...
label_L2083887112:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_firstFinished(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L520171591;
...
label_L520171591:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L372645473;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L24333082;
        case 1: goto label_L401002619;
        default: goto label_L1364618464;
    }
...
label_L1364618464:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_firstFinished(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L372645473;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1922046989cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1922046989cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1922046989cn1_class_id_java_lang_Throwable1, label_L830804464, restoreToL1922046989cn1_class_id_java_lang_Throwable1);
    int restoreToL322033405cn1_class_id_java_lang_Throwable2;
    int tryBlockOffsetL322033405cn1_class_id_java_lang_Throwable2;
    DEFINE_CATCH_BLOCK(catch_L322033405cn1_class_id_java_lang_Throwable2, label_L830804464, restoreToL322033405cn1_class_id_java_lang_Throwable2);
    int restoreToL1850252216cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL1850252216cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L1850252216cn1_class_id_java_lang_Throwable3, label_L830804464, restoreToL1850252216cn1_class_id_java_lang_Throwable3);
    int restoreToL1214701735cn1_class_id_java_lang_Throwable4;
    int tryBlockOffsetL1214701735cn1_class_id_java_lang_Throwable4;
    DEFINE_CATCH_BLOCK(catch_L1214701735cn1_class_id_java_lang_Throwable4, label_L830804464, restoreToL1214701735cn1_class_id_java_lang_Throwable4);
    int restoreToL1772262616cn1_class_id_java_lang_Throwable5;
    int tryBlockOffsetL1772262616cn1_class_id_java_lang_Throwable5;
    DEFINE_CATCH_BLOCK(catch_L1772262616cn1_class_id_java_lang_Throwable5, label_L830804464, restoreToL1772262616cn1_class_id_java_lang_Throwable5);
    int restoreToL1890648717cn1_class_id_java_lang_Throwable6;
    int tryBlockOffsetL1890648717cn1_class_id_java_lang_Throwable6;
    DEFINE_CATCH_BLOCK(catch_L1890648717cn1_class_id_java_lang_Throwable6, label_L830804464, restoreToL1890648717cn1_class_id_java_lang_Throwable6);
    int restoreToL1578732608cn1_class_id_java_lang_Throwable7;
    int tryBlockOffsetL1578732608cn1_class_id_java_lang_Throwable7;
    DEFINE_CATCH_BLOCK(catch_L1578732608cn1_class_id_java_lang_Throwable7, label_L830804464, restoreToL1578732608cn1_class_id_java_lang_Throwable7);
    int restoreToL960630105cn1_class_id_java_lang_Throwable8;
    int tryBlockOffsetL960630105cn1_class_id_java_lang_Throwable8;
    DEFINE_CATCH_BLOCK(catch_L960630105cn1_class_id_java_lang_Throwable8, label_L830804464, restoreToL960630105cn1_class_id_java_lang_Throwable8);
    int restoreToL299115261cn1_class_id_java_lang_Throwable9;
    int tryBlockOffsetL299115261cn1_class_id_java_lang_Throwable9;
    DEFINE_CATCH_BLOCK(catch_L299115261cn1_class_id_java_lang_Throwable9, label_L830804464, restoreToL299115261cn1_class_id_java_lang_Throwable9);

label_L1922046989:
 tryBlockOffsetL1922046989cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1922046989cn1_class_id_java_lang_Throwable1);
    restoreToL1922046989cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(690);
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject));
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1398164044, 1);
        case 2: JUMP_TO(label_L1214701735, 0);
        case 3: JUMP_TO(label_L1398164044, 1);
        case 4: JUMP_TO(label_L1772262616, 0);
        case 5: JUMP_TO(label_L1890648717, 0);
        case 6: JUMP_TO(label_L299115261, 0);
        case 7: JUMP_TO(label_L1850252216, 0);
        case 8: JUMP_TO(label_L322033405, 0);
        default: JUMP_TO(label_L1802242940, 0);
    }
...
label_L322033405:
 tryBlockOffsetL322033405cn1_class_id_java_lang_Throwable2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L322033405cn1_class_id_java_lang_Throwable2);
    restoreToL322033405cn1_class_id_java_lang_Throwable2 = threadStateData->threadObjectStackOffset;
...
label_L1850252216:
 tryBlockOffsetL1850252216cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1850252216cn1_class_id_java_lang_Throwable3);
    restoreToL1850252216cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(715);
    virtual_com_codename1_ui_animations_CommonTransitions_hideInterformContainers__(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(716);
    if (get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1153624232, 1);
...
label_L1214701735:
 tryBlockOffsetL1214701735cn1_class_id_java_lang_Throwable4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1214701735cn1_class_id_java_lang_Throwable4);
    restoreToL1214701735cn1_class_id_java_lang_Throwable4 = threadStateData->threadObjectStackOffset;
...
label_L1772262616:
 tryBlockOffsetL1772262616cn1_class_id_java_lang_Throwable5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1772262616cn1_class_id_java_lang_Throwable5);
    restoreToL1772262616cn1_class_id_java_lang_Throwable5 = threadStateData->threadObjectStackOffset;
...
label_L1890648717:
 tryBlockOffsetL1890648717cn1_class_id_java_lang_Throwable6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1890648717cn1_class_id_java_lang_Throwable6);
    restoreToL1890648717cn1_class_id_java_lang_Throwable6 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L70140977, 1);
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_isHidden___boolean_R_boolean(threadStateData, locals[6].data.o, 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L70140977, 1);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L70140977, 1);
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_isHidden___boolean_R_boolean(threadStateData, locals[7].data.o, 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1578732608, 0);
...
label_L1578732608:
 tryBlockOffsetL1578732608cn1_class_id_java_lang_Throwable7 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1578732608cn1_class_id_java_lang_Throwable7);
    restoreToL1578732608cn1_class_id_java_lang_Throwable7 = threadStateData->threadObjectStackOffset;
    ...
    if (ilocals_12_<=0) /* IFLE CustomJump */ JUMP_TO(label_L231585923, 1);
    if (ilocals_13_>0) /* IFGT CustomJump */ JUMP_TO(label_L960630105, 0);
...
label_L960630105:
 tryBlockOffsetL960630105cn1_class_id_java_lang_Throwable8 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L960630105cn1_class_id_java_lang_Throwable8);
    restoreToL960630105cn1_class_id_java_lang_Throwable8 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1337710988, 1);
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_isRTL___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1337710988, 1);
    __CN1_DEBUG_INFO(764);
    if (ilocals_16_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1574053815, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L1337710988:
    ...
    if (ilocals_16_==0) /* IFEQ CustomJump */ JUMP_TO(label_L347766549, 1);
...
label_L299115261:
 tryBlockOffsetL299115261cn1_class_id_java_lang_Throwable9 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L299115261cn1_class_id_java_lang_Throwable9);
    restoreToL299115261cn1_class_id_java_lang_Throwable9 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_motion2(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1233113908, 1);
...
label_L1233113908:
    ...
    if (virtual_com_codename1_ui_Graphics_isAffineSupported___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L671890880, 1);
...
label_L1759413538:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L947519212;
...
label_L1909597726:
    ...
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L531076772;
...
JAVA_OBJECT com_codename1_ui_animations_CommonTransitions_getComponentShiftMotion___com_codename1_ui_Component_boolean_R_com_codename1_ui_animations_Motion(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L148679921;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1357984916;
...
label_L1942002328:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1865152087;
...
label_L1865152087:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_isRTL___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L41772135;
    __CN1_DEBUG_INFO(866);
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1542567208;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_paintAlpha___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1572937899;
...
label_L1572937899:
    ...
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L1237586315;
    __CN1_DEBUG_INFO(896);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 

label_L1237586315:
    __CN1_DEBUG_INFO(900);
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2130179092;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(904);
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L405654827;
    BC_ALOAD(6);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Form);
    if(POP_INT() == 0) /* IFEQ */ goto label_L405654827;
...
label_L2130179092:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_rgbBuffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1279095549;
...
label_L1279095549:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_secondaryBuffer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1678404939;
...
label_L901087828:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L305700980;
...
label_L318869248:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1941633008;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_cleanup__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L180295702;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_paintSlideAtPosition___com_codename1_ui_Graphics_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L129831064;
...
label_L1784029781:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L927704210;
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L927704210;
    __CN1_DEBUG_INFO(1000);
    if (ilocals_8_!=0) /* IFNE CustomJump */ goto label_L1478318899;
    PUSH_INT(1); /* ICONST_1 */
...
label_L774689836:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L831543502;
...
label_L484103705:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L996963339;
    __CN1_DEBUG_INFO(1024);
    /* CustomInvoke */virtual_com_codename1_ui_Graphics_drawImage___com_codename1_ui_Image_int_int(threadStateData, locals[1].data.o, get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject), 0 /* ICONST_0 */, 0 /* ICONST_0 */); 
    goto label_L134815104;
...
label_L1909198389:
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2029310301;
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1767429584;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_paintCoverAtPosition___com_codename1_ui_Graphics_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1902761576;
...
label_L1902761576:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L793349921;
...
label_L9451853:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1355475787;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, locals[5].data.o);
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getLookAndFeel___R_com_codename1_ui_plaf_LookAndFeel(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    if (ilocals_8_!=0) /* IFNE CustomJump */ goto label_L1873788332;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1355475787:
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L220667244;
    __CN1_DEBUG_INFO(1067);
    /* VarOp.assignFrom */ ilocals_6_=(-(ilocals_6_));
    __CN1_DEBUG_INFO(1068);
    /* VarOp.assignFrom */ ilocals_7_=(-(ilocals_7_));
    goto label_L170929968;
...
label_L170929968:
    ...
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L408989959;
    __CN1_DEBUG_INFO(1077);
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1951337995;
...
label_L408989959:
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1459693562;
    __CN1_DEBUG_INFO(1088);
    /* CustomInvoke */virtual_com_codename1_ui_Graphics_drawImage___com_codename1_ui_Image_int_int(threadStateData, locals[1].data.o, get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject), 0 /* ICONST_0 */, 0 /* ICONST_0 */); 
    goto label_L1530020935;
...
label_L1257525034:
    ...
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject));
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L805100699;
    __CN1_DEBUG_INFO(1097);
    /* CustomInvoke */com_codename1_ui_animations_CommonTransitions_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int(threadStateData, __cn1ThisObject, locals[1].data.o, locals[5].data.o, 0 /* ICONST_0 */, 0 /* ICONST_0 */); 
    __CN1_DEBUG_INFO(1098);
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1201228625;
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L435788463;
...
label_L805100699:
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L435286832;
    if (get_field_com_codename1_ui_animations_CommonTransitions_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L339730588;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_drawDialogCmp___com_codename1_ui_Graphics_com_codename1_ui_Dialog(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_drawDialogMenu(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L370971752;
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L370971752;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L370971752;
...
JAVA_VOID com_codename1_ui_animations_CommonTransitions_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_BOOLEAN __cn1Arg5) {
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_transitionType(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1798485624;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
...
label_L1798485624:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1772874516;
...
locals[12].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1159);
    ...
    if (get_field_com_codename1_ui_animations_CommonTransitions_drawDialogMenu(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2108864020;
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[12].data.o)<=0) /* IFLE CustomJump */ goto label_L2108864020;
    ...
    if (locals[13].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2108864020;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1223);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L739939746;
        case 1: goto label_L450836606;
        case 2: goto label_L1924480807;
        case 3: goto label_L467970019;
        case 4: goto label_L1663801016;
        case 5: goto label_L5525099;
        case 6: goto label_L1531118913;
        case 7: goto label_L1705405045;
        case 8: goto label_L1510452783;
        default: goto label_L2021823506;
    }
...
label_L1705405045:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1725187457;
    __CN1_DEBUG_INFO(1244);
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject));
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L452592778;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1510452783:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1894487255;
    __CN1_DEBUG_INFO(1254);
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject));
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L886517510;
    PUSH_INT(1); /* ICONST_1 */
...
label_L5525099:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L568168963;
    __CN1_DEBUG_INFO(1263);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L230488003;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1984109;
...
label_L467970019:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1663319183;
    __CN1_DEBUG_INFO(1273);
    PUSH_INT(get_field_com_codename1_ui_animations_CommonTransitions_slideType(__cn1ThisObject));
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L782559074;
    PUSH_INT(1); /* ICONST_1 */
