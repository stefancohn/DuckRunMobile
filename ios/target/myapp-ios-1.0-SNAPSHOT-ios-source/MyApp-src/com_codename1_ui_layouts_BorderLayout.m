...
JAVA_VOID com_codename1_ui_layouts_BorderLayout___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5968, 205);
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 5968, 205);
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_addLayoutComponent___java_lang_Object_com_codename1_ui_Component_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 5968, 3408);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1004826012;
    __CN1_DEBUG_INFO(193);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5971));     SP -= 1;
...
label_L1004826012:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1104705467;
    __CN1_DEBUG_INFO(198);
    { JAVA_INT tmpResult = virtual_java_lang_Integer_intValue___R_int(threadStateData, locals[1].data.o);
    PUSH_INT(tmpResult); }
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L969253125;
        case 1: goto label_L1227859754;
        case 2: goto label_L1363127070;
        case 3: goto label_L1406696237;
        case 4: goto label_L1191261658;
        default: goto label_L1931730151;
    }
...
label_L1931730151:
    ...
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5972));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(223);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(141), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1600712390;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(225);
    ...
    goto label_L1341781781;

label_L1600712390:
    __CN1_DEBUG_INFO(226);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(66), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L18392277;
...
label_L18392277:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(67), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1823577333;
...
label_L1823577333:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(69), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1958168955;
...
label_L1958168955:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(68), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1962297767;
...
label_L1962297767:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(142), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L814507488;
...
label_L814507488:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5973));
...
label_L1341781781:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1358584120;
    if (locals[4].data.o==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1358584120;
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_removeLayoutComponent___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5968, 3410);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(253);
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitCenter(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L508047053;
    ...
    goto label_L1488320466;

label_L508047053:
    __CN1_DEBUG_INFO(255);
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitNorth(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L197470785;
...
label_L197470785:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitSouth(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L167018904;
...
label_L167018904:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitEast(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1444280365;
...
label_L1444280365:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitWest(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L560565850;
...
label_L560565850:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_overlay(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1488320466;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getComponentConstraint___com_codename1_ui_Component_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5968, 3411);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(275);
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitCenter(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L64761620;
...
label_L64761620:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitNorth(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L780764854;
...
label_L780764854:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitSouth(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1462028250;
...
label_L1462028250:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitEast(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L986875962;
...
label_L986875962:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_overlay(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1477752059;
...
label_L1477752059:
    ...
    if (locals[1].data.o!=get_field_com_codename1_ui_layouts_BorderLayout_portraitWest(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L986326393;
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 27, 0, 5968, 3360);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L1268858861;
...
label_L1268858861:
    ...
    if (locals[13].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1696394747;
...
label_L1696394747:
    ...
    if (locals[12].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L416427727;
...
locals[16].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(331);
    if (ilocals_9_==0) /* IFEQ CustomJump */ goto label_L1943548225;
...
label_L1943548225:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L826553984;
...
label_L826553984:
    ...
    if (locals[16].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L859137638;
...
label_L859137638:
    ...
    if (locals[14].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L983073433;
...
locals[17].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(350);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L142147250;
        case 2: goto label_L404240651;
        case 3: goto label_L424504;
        default: goto label_L2129964267;
    }
...
label_L52544167:
    ...
    if (ilocals_23_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L834031849;
    __CN1_DEBUG_INFO(359);
    if (virtual_com_codename1_ui_geom_Dimension_getWidth___R_int(threadStateData, locals[22].data.o)>=ilocals_18_) /* IF_ICMPGE CustomJump */ goto label_L1749018549;
    ...
    if (ilocals_24_<=ilocals_20_) /* IF_ICMPLE CustomJump */ goto label_L1532725040;
...
label_L1749018549:
    ...
    if (ilocals_23_!=0) /* IFNE CustomJump */ goto label_L9698116;
...
label_L834031849:
    ...
    if (locals[13].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L347377465;
...
label_L347377465:
    ...
    if (locals[12].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L332527768;
...
label_L332527768:
    ...
    if (virtual_com_codename1_ui_geom_Dimension_getHeight___R_int(threadStateData, locals[22].data.o)>=ilocals_19_) /* IF_ICMPGE CustomJump */ goto label_L2129964267;
    ...
    if (ilocals_26_<=ilocals_21_) /* IF_ICMPLE CustomJump */ goto label_L210204797;
...
label_L448382773:
    ...
    if (ilocals_23_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L29271984;
    __CN1_DEBUG_INFO(398);
    if (virtual_com_codename1_ui_geom_Dimension_getWidth___R_int(threadStateData, locals[22].data.o)>=ilocals_18_) /* IF_ICMPGE CustomJump */ goto label_L826490361;
...
label_L826490361:
    ...
    if (ilocals_23_!=0) /* IFNE CustomJump */ goto label_L759826033;
...
label_L983073433:
    ...
    if (get_field_com_codename1_ui_layouts_BorderLayout_overlay(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1850630389;
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_positionLeftRight___com_codename1_ui_Component_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    DEFINE_INSTANCE_METHOD_STACK(4, 8, 0, 5968, 5974);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_layouts_BorderLayout_scaleEdges(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1179268144;
...
label_L1179268144:
    ...
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1872376613;
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_positionTopBottom___com_codename1_ui_Component_com_codename1_ui_Component_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    volatile JAVA_INT ilocals_8_ = 0; /* v8 */
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 5968, 5975);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_layouts_BorderLayout_scaleEdges(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1926148075;
...
label_L1926148075:
    ...
    if (ilocals_8_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L686366573;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getPreferredSize___com_codename1_ui_Container_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5968, 2441);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L382992974;
...
label_L382992974:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L300041864;
...
label_L300041864:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1674824156;
...
label_L1674824156:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L60924092;
...
label_L60924092:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L902894836;
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_isLandscape___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5968, 5976);
    ...
    if (virtual_com_codename1_ui_Display_isPortrait___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L914674368;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1273258213;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getComponentAtIgnoreLandscape___java_lang_String_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5968, 5977);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(530);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1162780005;
    __CN1_DEBUG_INFO(531);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(66))==0) /* IFEQ CustomJump */ goto label_L2013611916;
...
label_L2013611916:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(67))==0) /* IFEQ CustomJump */ goto label_L1745328286;
...
label_L1745328286:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(69))==0) /* IFEQ CustomJump */ goto label_L798259;
...
label_L798259:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(68))==0) /* IFEQ CustomJump */ goto label_L823672546;
...
label_L823672546:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(141))==0) /* IFEQ CustomJump */ goto label_L1162780005;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getComponentImpl___com_codename1_ui_Component_java_lang_String_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 5968, 5978);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(551);
    if (get_field_com_codename1_ui_layouts_BorderLayout_landscapeSwap(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1676883562;
    if (com_codename1_ui_layouts_BorderLayout_isLandscape___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1676883562;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1676883562;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getSouth___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5968, 5979);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getCenter___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5968, 5980);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getNorth___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5968, 5981);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getEast___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5968, 5982);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getWest___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5968, 5983);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getOverlay___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5968, 5984);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5968, 899);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(617);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return STRING_FROM_CONSTANT_POOL_OFFSET(5985);
}
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5968, 880);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(654);
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L644323208;
    if (get_field_com_codename1_ui_layouts_BorderLayout_centerBehavior(__cn1ThisObject)!=get_field_com_codename1_ui_layouts_BorderLayout_centerBehavior(locals[1].data.o)) /* IF_ICMPNE CustomJump */ goto label_L644323208;
    __CN1_DEBUG_INFO(655);
    if (get_field_com_codename1_ui_layouts_BorderLayout_landscapeSwap(__cn1ThisObject)!=get_field_com_codename1_ui_layouts_BorderLayout_landscapeSwap(locals[1].data.o)) /* IF_ACMPNE CustomJump */ goto label_L1558029640;
    __CN1_DEBUG_INFO(656);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1558029640:
    __CN1_DEBUG_INFO(658);
    if (get_field_com_codename1_ui_layouts_BorderLayout_landscapeSwap(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L644323208;
...
JAVA_INT com_codename1_ui_layouts_BorderLayout_getCenterBehavior___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5968, 5990);
...
JAVA_VOID com_codename1_ui_layouts_BorderLayout_setCenterBehavior___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5968, 5991);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_isOverlapSupported___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 5968, 3413);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(712);
    if (get_field_com_codename1_ui_layouts_BorderLayout_centerBehavior(__cn1ThisObject)==3 /* ICONST_3 */) /* IF_ICMPEQ CustomJump */ goto label_L357532288;
    if (get_field_com_codename1_ui_layouts_BorderLayout_overlay(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L620301055;
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_isConstraintTracking___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5968, 3414);
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_obscuresPotential___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5968, 3415);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(742);
    if (virtual_com_codename1_ui_layouts_BorderLayout_getCenter___R_com_codename1_ui_Component(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L636094094;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1289280305;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_center___com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_BorderLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 5968, 131);
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_centerEastWest___com_codename1_ui_Component_com_codename1_ui_Component_com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_BorderLayout(threadStateData);
    DEFINE_METHOD_STACK(4, 4, 0, 5968, 5994);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L538611367;
    __CN1_DEBUG_INFO(765);
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */com_codename1_ui_layouts_BorderLayout_center___com_codename1_ui_Component_R_com_codename1_ui_Container(threadStateData, locals[0].data.o);locals[3].type=CN1_TYPE_OBJECT;    goto label_L248447628;
...
label_L248447628:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2070199213;
...
label_L2070199213:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1911551651;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_north___com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_BorderLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 5968, 6001);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_south___com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_layouts_BorderLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 5968, 6002);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_layouts_BorderLayout_overridesTabIndices___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5968, 3416);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_layouts_BorderLayout_getChildrenInTraversalOrder___com_codename1_ui_Container_R_com_codename1_ui_Component_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 5968, 3417);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
