...
JAVA_VOID com_codename1_io_Log_4_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_Log_4_val_consumeError(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L882371818;
...
label_L882371818:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L508067159;
...
label_L1261105387:
    ...
    if (com_codename1_io_Log_getUniqueDeviceKey___R_java_lang_String(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1724067349;
