...
JAVA_VOID com_codename1_ui_layouts_BoxLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L77780590;
...
label_L1283050069:
    if (ilocals_10_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L81788921;
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L688176214;
        case 3: goto label_L2075283526;
        case 4: goto label_L688176214;
        default: goto label_L1773267192;
    }
...
label_L688176214:
    ...
    SP++;
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L308998656;
...
label_L308998656:
    ...
    (*SP).data.i = ilocals_13_; 
    SP++;
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L503319063;
...
label_L2075283526:
    ...
    if (ilocals_5_<ilocals_15_) /* IF_IMPLT CustomJump */ goto label_L298424794;
    if (virtual_com_codename1_ui_Container_isScrollableX___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L298424794;
    __CN1_DEBUG_INFO(247);
    /* VarOp.assignFrom */     ilocals_16_ = 0 /* ICONST_0 */; 
    goto label_L1425445649;
...
label_L298424794:
    ...
    SP++;
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1425445649;
...
label_L1425445649:
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1253600042;
...
label_L1773267192:
    ...
    if (ilocals_5_<ilocals_15_) /* IF_IMPLT CustomJump */ goto label_L717874492;
    if (virtual_com_codename1_ui_Container_isScrollableX___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L717874492;
    __CN1_DEBUG_INFO(271);
    /* VarOp.assignFrom */     ilocals_16_ = 0 /* ICONST_0 */; 
    goto label_L1254589807;
...
label_L717874492:
    ...
    (*SP).data.i = ilocals_15_; 
    SP++;
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1254589807;
...
label_L1254589807:
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1127171622;
...
label_L81788921:
    ...
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L979620424;
    if (ilocals_7_<=0) /* IFLE CustomJump */ goto label_L979620424;
...
label_L63221076:
    ...
    (*SP).data.i = ilocals_4_; 
    SP++;
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L979620424;
...
label_L979620424:
    ...
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1260527949;
    __CN1_DEBUG_INFO(301);
    if (ilocals_7_<=0) /* IFLE CustomJump */ goto label_L1233871134;
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1843272693;
        case 4: goto label_L1263973655;
        default: goto label_L287628665;
    }
...
label_L287628665:
    ...
    if (ilocals_13_<=0) /* IFLE CustomJump */ goto label_L53857746;
    __CN1_DEBUG_INFO(317);
    /* VarOp.assignFrom */     ilocals_14_ = 0 /* ICONST_0 */; 

label_L514420722:
    if (ilocals_14_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L53857746;
...
label_L1260527949:
    ...
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1233871134;
    __CN1_DEBUG_INFO(325);
    if (ilocals_7_<=0) /* IFLE CustomJump */ goto label_L1233871134;
    __CN1_DEBUG_INFO(326);
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1621729085;
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L1464949060;
        case 4: goto label_L2049393953;
        default: goto label_L799306600;
    }
...
label_L799306600:
    ...
    if (ilocals_13_<=0) /* IFLE CustomJump */ goto label_L56115670;
    __CN1_DEBUG_INFO(342);
    /* VarOp.assignFrom */     ilocals_14_ = 0 /* ICONST_0 */; 

label_L1587454848:
    if (ilocals_14_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L56115670;
...
label_L1621729085:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L508619583;
        case 4: goto label_L316929198;
        default: goto label_L1400132053;
    }
...
label_L1400132053:
    ...
    if (ilocals_13_<=0) /* IFLE CustomJump */ goto label_L1233871134;
    __CN1_DEBUG_INFO(363);
    /* VarOp.assignFrom */     ilocals_14_ = 0 /* ICONST_0 */; 

label_L2019388056:
    if (ilocals_14_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1233871134;
...
label_L78461289:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1632468927;
    ...
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L1812378044;
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L495828752;
...
JAVA_OBJECT com_codename1_ui_layouts_BoxLayout_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1568666385;
...
JAVA_BOOLEAN com_codename1_ui_layouts_BoxLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L763011729;
    if (get_field_com_codename1_ui_layouts_BoxLayout_axis(__cn1ThisObject)!=get_field_com_codename1_ui_layouts_BoxLayout_axis(locals[1].data.o)) /* IF_ICMPNE CustomJump */ goto label_L763011729;
    PUSH_INT(1); /* ICONST_1 */
