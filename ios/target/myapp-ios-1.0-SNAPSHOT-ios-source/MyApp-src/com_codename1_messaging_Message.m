...
JAVA_OBJECT com_codename1_messaging_Message_getAttachments___R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_messaging_Message_attachments(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L391269430;
...
label_L391269430:
    ...
    if (get_field_com_codename1_messaging_Message_fileUri(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L797553742;
    if (get_field_com_codename1_messaging_Message_attachmentMimeType(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L797553742;
    if (virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_messaging_Message_fileUri(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L797553742;
    if (virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_messaging_Message_attachmentMimeType(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L797553742;
    if (/* CustomInvoke */virtual_java_util_HashMap_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_messaging_Message_attachments(__cn1ThisObject), get_field_com_codename1_messaging_Message_fileUri(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L797553742;
