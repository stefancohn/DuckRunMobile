...
JAVA_VOID com_example_levels_Level___INIT_____int_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10318, 205);
...
JAVA_INT com_example_levels_Level_getSpriteIndex___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10318, 10319);
...
JAVA_OBJECT com_example_levels_Level_getLevelData___R_int_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10318, 10320);
...
JAVA_VOID com_example_levels_Level_shiftLevelRight___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 10318, 10321);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(21);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 

label_L1360541835:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_example_levels_Level_levelData(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L677217562;
    __CN1_DEBUG_INFO(22);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L1716164115:
    if (ilocals_3_>=(CN1_ARRAY_LENGTH(CN1_ARRAY_ELEMENT_OBJECT(get_field_com_example_levels_Level_levelData(__cn1ThisObject), ilocals_2_)) - ilocals_1_)) /* IF_ICMPGE CustomJump */ goto label_L827035437;
    __CN1_DEBUG_INFO(23);
