...
JAVA_VOID java_util_Timer_T_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1341257842cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1341257842cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1341257842cn1_class_id_java_lang_InterruptedException1, label_L236840983, restoreToL1341257842cn1_class_id_java_lang_InterruptedException1);
...
label_L1341257842:
 tryBlockOffsetL1341257842cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1341257842cn1_class_id_java_lang_InterruptedException1);
    restoreToL1341257842cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
