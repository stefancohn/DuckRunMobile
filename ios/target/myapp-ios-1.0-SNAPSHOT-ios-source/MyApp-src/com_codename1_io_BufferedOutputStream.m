...
JAVA_VOID com_codename1_io_BufferedOutputStream_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL543110131cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL543110131cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L543110131cn1_class_id_java_lang_Exception1, label_L1510527745, restoreToL543110131cn1_class_id_java_lang_Exception1);
    int restoreToL54311013102;
    int tryBlockOffsetL54311013102;
    DEFINE_CATCH_BLOCK(catch_L54311013102, label_L1675886984, restoreToL54311013102);
...
label_L543110131:
 tryBlockOffsetL54311013102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L54311013102);
    restoreToL54311013102 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL543110131cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L543110131cn1_class_id_java_lang_Exception1);
    restoreToL543110131cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
