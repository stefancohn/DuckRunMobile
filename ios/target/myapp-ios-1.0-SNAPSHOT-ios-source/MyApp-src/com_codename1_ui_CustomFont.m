...
JAVA_OBJECT com_codename1_ui_CustomFont_getImageArray___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3585, 3586);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(70);
    if (get_field_com_codename1_ui_CustomFont_imageArrayRef(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2012528704;
    __CN1_DEBUG_INFO(71);
...
JAVA_VOID com_codename1_ui_CustomFont___INIT_____com_codename1_ui_Image_int_1ARRAY_int_1ARRAY_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 8, 0, 3585, 205);
...
label_L111238003:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1617566660;
...
JAVA_INT com_codename1_ui_CustomFont_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 3585, 877);
    ...
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L1155300221;
...
JAVA_INT com_codename1_ui_CustomFont_getHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3585, 879);
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3585, 3587);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_get___java_lang_Object_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject), locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L368788838;
...
label_L368788838:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L637524006;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(143);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L696870185;
    __CN1_DEBUG_INFO(144);
    set_field_com_codename1_ui_CustomFont_cache(threadStateData, locals[5].data.o, __cn1ThisObject);
    __CN1_DEBUG_INFO(145);
    if (virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L237630710;
...
label_L637524006:
    ...
    if (virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L1102463008;
...
JAVA_VOID com_codename1_ui_CustomFont_initColor___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3585, 3588);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (ilocals_2_==get_field_com_codename1_ui_CustomFont_color(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L441683672;
    if (/* CustomInvoke */com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_2_)!=0) /* IFNE CustomJump */ goto label_L441683672;
...
label_L970900790:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2022768790;
...
JAVA_VOID com_codename1_ui_CustomFont_addContrast___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 3585, 3109);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
label_L1935994577:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1287215032;
    __CN1_DEBUG_INFO(209);
    /* VarOp.assignFrom */ ilocals_5_=(BC_ISHR_EXPR(CN1_ARRAY_ELEMENT_INT(locals[2].data.o, ilocals_4_), 24) & 255);
    __CN1_DEBUG_INFO(210);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1021082377;
...
JAVA_VOID com_codename1_ui_CustomFont_drawString___com_codename1_ui_Graphics_java_lang_String_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 13, 0, 3585, 836);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1749978269;
...
label_L831993944:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1749978269;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1858863803;
...
label_L1749978269:
    ...
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1699826397;
    if ((ilocals_6_ + ilocals_8_)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1699826397;
...
label_L277155095:
    if (ilocals_11_>=ilocals_10_) /* IF_ICMPGE CustomJump */ goto label_L1699826397;
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L2045188238;
    __CN1_DEBUG_INFO(249);
    goto label_L1999639763;
...
label_L2045188238:
    ...
    if (virtual_com_codename1_ui_Graphics_getClipWidth___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L2146285461;
    if (virtual_com_codename1_ui_Graphics_getClipHeight___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L2146285461;
...
JAVA_INT com_codename1_ui_CustomFont_charsWidth___char_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3585, 868);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L1190857779:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1549005458;
...
JAVA_INT com_codename1_ui_CustomFont_substringWidth___java_lang_String_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3585, 3111);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_INT com_codename1_ui_CustomFont_stringWidth___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3585, 873);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_CustomFont_getFace___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3585, 978);
...
JAVA_INT com_codename1_ui_CustomFont_getSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3585, 995);
...
JAVA_INT com_codename1_ui_CustomFont_getStyle___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3585, 996);
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 3585, 244);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(371);
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L1106510750;
    __CN1_DEBUG_INFO(372);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1106510750:
    __CN1_DEBUG_INFO(374);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1609565447;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1609565447;
    __CN1_DEBUG_INFO(375);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(376);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_CustomFont_charsets(__cn1ThisObject), get_field_com_codename1_ui_CustomFont_charsets(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L1609565447;
...
label_L116606935:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1614588868;
    __CN1_DEBUG_INFO(379);
    if (CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(__cn1ThisObject), ilocals_4_)==CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(locals[2].data.o), ilocals_4_)) /* IF_ICMPEQ CustomJump */ goto label_L1744457797;
