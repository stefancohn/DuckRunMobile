...
JAVA_OBJECT com_codename1_ui_CustomFont_getImageArray___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_CustomFont_imageArrayRef(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1459669467;
    __CN1_DEBUG_INFO(71);
...
label_L1806434229:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1729954747;
...
JAVA_INT com_codename1_ui_CustomFont_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L561227586;
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_get___java_lang_Object_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject), locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1886186662;
...
label_L1886186662:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2137205195;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(143);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1266759621;
...
label_L2137205195:
    ...
    if (virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L1617566660;
...
JAVA_VOID com_codename1_ui_CustomFont_initColor___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_2_==get_field_com_codename1_ui_CustomFont_color(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L111238003;
    if (/* CustomInvoke */com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_2_)!=0) /* IFNE CustomJump */ goto label_L111238003;
...
label_L368788838:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1155300221;
...
label_L1102463008:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L696870185;
    __CN1_DEBUG_INFO(209);
    /* VarOp.assignFrom */ ilocals_5_=(BC_ISHR_EXPR(CN1_ARRAY_ELEMENT_INT(locals[2].data.o, ilocals_4_), 24) & 255);
    __CN1_DEBUG_INFO(210);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L237630710;
...
label_L970900790:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L441683672;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2022768790;
...
label_L441683672:
    ...
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1243227501;
    if ((ilocals_6_ + ilocals_8_)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1243227501;
...
label_L1749978269:
    if (ilocals_11_>=ilocals_10_) /* IF_ICMPGE CustomJump */ goto label_L1243227501;
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L1287215032;
...
label_L1287215032:
    ...
    if (virtual_com_codename1_ui_Graphics_getClipWidth___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L1935994577;
    if (virtual_com_codename1_ui_Graphics_getClipHeight___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L1935994577;
...
label_L876945112:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L646337666;
...
JAVA_INT com_codename1_ui_CustomFont_stringWidth___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L202395890;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1740328397;
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L1938634748;
...
label_L1938634748:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1872905355;
    __CN1_DEBUG_INFO(375);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(376);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_CustomFont_charsets(__cn1ThisObject), get_field_com_codename1_ui_CustomFont_charsets(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L1872905355;
...
label_L1190857779:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1639652941;
    __CN1_DEBUG_INFO(379);
    if (CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(__cn1ThisObject), ilocals_4_)==CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(locals[2].data.o), ilocals_4_)) /* IF_ICMPEQ CustomJump */ goto label_L1549005458;
