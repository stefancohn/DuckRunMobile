...
JAVA_VOID com_codename1_io_MultipartRequest_addData___java_lang_String_byte_1ARRAY_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_filenames(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L2068113806;
...
JAVA_VOID com_codename1_io_MultipartRequest_addArgument___java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_filenames(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1300216352;
...
JAVA_LONG com_codename1_io_MultipartRequest_calculateContentLength___R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1149268243cn1_class_id_java_io_UnsupportedEncodingException1;
    int tryBlockOffsetL1149268243cn1_class_id_java_io_UnsupportedEncodingException1;
    DEFINE_CATCH_BLOCK(catch_L1149268243cn1_class_id_java_io_UnsupportedEncodingException1, label_L288043672, restoreToL1149268243cn1_class_id_java_io_UnsupportedEncodingException1);
    int restoreToL56882594cn1_class_id_java_io_UnsupportedEncodingException2;
    int tryBlockOffsetL56882594cn1_class_id_java_io_UnsupportedEncodingException2;
    DEFINE_CATCH_BLOCK(catch_L56882594cn1_class_id_java_io_UnsupportedEncodingException2, label_L1372771126, restoreToL56882594cn1_class_id_java_io_UnsupportedEncodingException2);
    int restoreToL640533259cn1_class_id_java_io_UnsupportedEncodingException3;
    int tryBlockOffsetL640533259cn1_class_id_java_io_UnsupportedEncodingException3;
    DEFINE_CATCH_BLOCK(catch_L640533259cn1_class_id_java_io_UnsupportedEncodingException3, label_L151781803, restoreToL640533259cn1_class_id_java_io_UnsupportedEncodingException3);
...
label_L1231345665:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L965874704, 0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1910857288, 0);
    ...
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[16].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L912877601, 0);

label_L1149268243:
 tryBlockOffsetL1149268243cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L1149268243cn1_class_id_java_io_UnsupportedEncodingException1);
    restoreToL1149268243cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->threadObjectStackOffset;
...
label_L912877601:
    ...
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1989843834, 0);
...
label_L1910857288:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L760646911, 0);
...
label_L1936362218:
    if (ilocals_20_>=ilocals_19_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1342423316, 0);
...
locals[21].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(271);
    ...
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[16].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L115653836, 0);

label_L56882594:
 tryBlockOffsetL56882594cn1_class_id_java_io_UnsupportedEncodingException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L56882594cn1_class_id_java_io_UnsupportedEncodingException2);
    restoreToL56882594cn1_class_id_java_io_UnsupportedEncodingException2 = threadStateData->threadObjectStackOffset;
...
label_L115653836:
    ...
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1026553658, 0);
...
label_L640533259:
 tryBlockOffsetL640533259cn1_class_id_java_io_UnsupportedEncodingException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L640533259cn1_class_id_java_io_UnsupportedEncodingException3);
    restoreToL640533259cn1_class_id_java_io_UnsupportedEncodingException3 = threadStateData->threadObjectStackOffset;
...
label_L388551431:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L187723824;
    __CN1_DEBUG_INFO(312);
    if (virtual_com_codename1_io_MultipartRequest_shouldStop___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L749377126;
    __CN1_DEBUG_INFO(313);
    goto label_L187723824;
...
label_L749377126:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L641691286;
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1232346752;
    __CN1_DEBUG_INFO(330);
    virtual_java_io_Writer_flush__(threadStateData, locals[2].data.o); 

label_L1232346752:
    __CN1_DEBUG_INFO(332);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1095583342;
...
label_L1095583342:
    ...
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1681552378;
...
label_L967635335:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L231989731;
    __CN1_DEBUG_INFO(343);
    virtual_java_io_Writer_flush__(threadStateData, locals[2].data.o); 
    goto label_L231989731;

label_L641691286:
    __CN1_DEBUG_INFO(346);
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_array_1_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L646359041;
...
label_L1368067090:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L2021148063;
...
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(349);
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1332370633;
...
label_L646359041:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1525789217;
...
locals[6].type=CN1_TYPE_OBJECT;    goto label_L2102001207;
...
label_L467903124:
    ...
    if (ilocals_8_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1957398032;
    __CN1_DEBUG_INFO(401);
    if (virtual_com_codename1_io_MultipartRequest_shouldStop___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L589058590;
...
label_L589058590:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L694766024;
...
label_L1957398032:
    ...
    if (get_static_com_codename1_io_MultipartRequest_leaveInputStreamsOpen(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1922896936;
    __CN1_DEBUG_INFO(412);
    /* CustomInvoke */com_codename1_io_Util_cleanup___java_lang_Object(threadStateData, locals[6].data.o); 
    goto label_L1922896936;
...
label_L231989731:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L291054778;
