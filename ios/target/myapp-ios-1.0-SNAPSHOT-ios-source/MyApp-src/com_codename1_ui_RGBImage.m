...
label_L896945135:
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1805845895;
    __CN1_DEBUG_INFO(84);
...
JAVA_OBJECT com_codename1_ui_RGBImage_scaled___int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L1446238973;
    if (ilocals_4_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1446238973;
...
JAVA_VOID com_codename1_ui_RGBImage_scale___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L1565614310;
    if (ilocals_4_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1565614310;
...
label_L1638864144:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L783141366;
    __CN1_DEBUG_INFO(148);
    if ((CN1_ARRAY_ELEMENT_INT(locals[2].data.o, ilocals_5_) & -16777216)==0) /* IFEQ CustomJump */ goto label_L688113407;
...
label_L1502616653:
    if (ilocals_8_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L934223763;
...
label_L1083086553:
    if (ilocals_10_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L2005762793;
...
JAVA_VOID com_codename1_ui_RGBImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (get_field_com_codename1_ui_RGBImage_opaque(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L378327915;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L227381657;
