...
JAVA_OBJECT com_codename1_l10n_DateFormat_format___java_lang_Object_java_lang_StringBuilder_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL162476481cn1_class_id_com_codename1_l10n_ParseException1;
    int tryBlockOffsetL162476481cn1_class_id_com_codename1_l10n_ParseException1;
    DEFINE_CATCH_BLOCK(catch_L162476481cn1_class_id_com_codename1_l10n_ParseException1, label_L1931506956, restoreToL162476481cn1_class_id_com_codename1_l10n_ParseException1);
...
locals[3].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1449647504, 0);
...
label_L162476481:
 tryBlockOffsetL162476481cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_l10n_ParseException, catch_L162476481cn1_class_id_com_codename1_l10n_ParseException1);
    restoreToL162476481cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->threadObjectStackOffset;
...
label_L1449647504:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L639588933, 0);
    __CN1_DEBUG_INFO(114);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L124154861, 0);
    /* LDC: 'null'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(903));
    JUMP_TO(label_L1832984588, 0);
...
JAVA_BOOLEAN com_codename1_l10n_DateFormat_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (__cn1ThisObject!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L86178665;
    __CN1_DEBUG_INFO(273);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L86178665:
    __CN1_DEBUG_INFO(274);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1496536314;
...
label_L1496536314:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1845411114;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(279);
    if (get_field_com_codename1_l10n_DateFormat_dateStyle(__cn1ThisObject)==get_field_com_codename1_l10n_DateFormat_dateStyle(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L165392857;
    __CN1_DEBUG_INFO(280);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L165392857:
    __CN1_DEBUG_INFO(281);
    if (get_field_com_codename1_l10n_DateFormat_timeStyle(__cn1ThisObject)==get_field_com_codename1_l10n_DateFormat_timeStyle(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L464583224;
