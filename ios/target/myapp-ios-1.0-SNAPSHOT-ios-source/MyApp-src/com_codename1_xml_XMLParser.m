...
JAVA_INT com_codename1_xml_XMLParser_read___java_io_Reader_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(97);
    if (get_static_com_codename1_xml_XMLParser_buffer(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L726998651;
    __CN1_DEBUG_INFO(98);
    PUSH_INT(8192);
...
label_L726998651:
    ...
    if (get_static_com_codename1_xml_XMLParser_buffSize(threadStateData)<0) /* IFLT CustomJump */ goto label_L921262971;
    if (get_static_com_codename1_xml_XMLParser_buffOffset(threadStateData)<get_static_com_codename1_xml_XMLParser_buffSize(threadStateData)) /* IF_IMPLT CustomJump */ goto label_L509157868;
...
label_L921262971:
    ...
    if (get_static_com_codename1_xml_XMLParser_buffSize(threadStateData)>=0) /* IFGE CustomJump */ goto label_L815490920;
...
JAVA_OBJECT com_codename1_xml_XMLParser_convertCharEntity___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL19670515cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL19670515cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L19670515cn1_class_id_java_lang_IllegalArgumentException1, label_L1293905436, restoreToL19670515cn1_class_id_java_lang_IllegalArgumentException1);

label_L19670515:
 tryBlockOffsetL19670515cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L19670515cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL19670515cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_xml_XMLParser_parse___java_io_Reader_R_com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1545816470cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1545816470cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1545816470cn1_class_id_java_io_IOException1, label_L875678495, restoreToL1545816470cn1_class_id_java_io_IOException1);
...
label_L1545816470:
 tryBlockOffsetL1545816470cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1545816470cn1_class_id_java_io_IOException1);
    restoreToL1545816470cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
label_L1120531149:
    ...
    if (virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L127387260, 0);
...
label_L127387260:
    ...
    if (virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, locals[2].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L835594012, 0);
...
label_L2145651615:
    if (ilocals_4_>=virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L186481417, 0);
    ...
    if (virtual_com_codename1_xml_Element_isTextElement___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L105885501, 0);
...
label_L186481417:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(536))==0) /* IFEQ CustomJump */ JUMP_TO(label_L524415577, 0);
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(302);
    if (virtual_com_codename1_xml_Element_isTextElement___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1686929611, 0);
...
JAVA_BOOLEAN com_codename1_xml_XMLParser_isLegalCharEntityCharacter___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L360328326;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L96061258;
...
label_L360328326:
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L95655406;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(90);
...
label_L620415815:
    ...
    SP++;
    PUSH_INT(35);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1612762434;

label_L96061258:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L728286619;
...
label_L1037612046:
    ...
    if (ilocals_5_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L846019069;
    __CN1_DEBUG_INFO(421);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(60);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1077898244;
    __CN1_DEBUG_INFO(422);
    if (get_field_com_codename1_xml_XMLParser_includeWhitespacesBetweenTags(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L647226268;
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L647226268;
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L647226268;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L647226268;
    if (virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L647226268;
...
label_L647226268:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1270529736;
    __CN1_DEBUG_INFO(430);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L272876691;
...
label_L272876691:
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L724030931;
...
label_L724030931:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L303127592;
...
label_L1270529736:
    ...
    if (locals[8].data.o!=get_static_com_codename1_xml_XMLParser_END_TAG(threadStateData)) /* IF_ACMPNE CustomJump */ goto label_L44746251;
    ...
    if (ilocals_10_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L389415616;
...
locals[8].type=CN1_TYPE_OBJECT;    goto label_L266267666;
...
label_L485281961:
    ...
    SP++;
    PUSH_INT(62);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L266267666;
    ...
    if (ilocals_10_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L485281961;
    __CN1_DEBUG_INFO(465);
    /* VarOp.assignFrom */ locals[8].type=CN1_TYPE_INVALID;locals[8].data.o = get_static_com_codename1_xml_XMLParser_END_TAG(threadStateData);
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(466);
    goto label_L266267666;
...
label_L266267666:
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1210242977;
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[11].data.o)!=0) /* IFNE CustomJump */ goto label_L1210242977;
...
label_L1210242977:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1873149031;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L400761853;
...
label_L400761853:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[11].data.o)==0) /* IFEQ CustomJump */ goto label_L1844498480;
    goto label_L1873149031;
...
label_L1873149031:
    ...
    goto label_L858889712;

label_L44746251:
    __CN1_DEBUG_INFO(491);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L858889712;
    if (get_field_com_codename1_xml_Element_isComment(locals[8].data.o)!=0) /* IFNE CustomJump */ goto label_L858889712;
...
label_L1077898244:
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2101686389;
    __CN1_DEBUG_INFO(496);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L383717053;
    ...
    /* VarOp.assignFrom */ locals[7].type=CN1_TYPE_INVALID;    locals[7].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[7].type=CN1_TYPE_OBJECT;    goto label_L1941379381;

label_L700370827:
    __CN1_DEBUG_INFO(500);
    if (/* CustomInvoke */com_codename1_xml_XMLParser_isLegalCharEntityCharacter___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_6_)==0) /* IFEQ CustomJump */ goto label_L1653282104;
...
label_L383717053:
    ...
    SP++;
    PUSH_INT(38);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L916019076;
...
label_L2101686389:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_6_)!=0) /* IFNE CustomJump */ goto label_L1490885900;
    __CN1_DEBUG_INFO(512);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(38);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L121656075;
...
JAVA_BOOLEAN com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1090642246;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(10);
...
label_L1228855526:
    ...
    if (ilocals_7_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L1806382908;
    if (ilocals_5_!=/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(180), ilocals_7_)) /* IF_ICMPNE CustomJump */ goto label_L1806382908;
...
label_L1806382908:
    ...
    if (ilocals_7_!=ilocals_8_) /* IF_ICMPNE CustomJump */ goto label_L2072605782;
...
label_L1109132666:
    ...
    SP++;
    PUSH_INT(63);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1305218621;
...
label_L1305218621:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L2146222703;
...
label_L2146222703:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)!=0) /* IFNE CustomJump */ goto label_L1076550812;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(62);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1076550812;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(47);
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1882274571;
    __CN1_DEBUG_INFO(593);
    if (get_field_com_codename1_xml_XMLParser_caseSensitive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1882274571;
...
label_L1882274571:
    ...
    if (ilocals_6_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1570860758;
...
label_L1076550812:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L1145512119;
...
label_L1145512119:
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1386207903;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(632);
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L730815140;
...
label_L730815140:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L2098087645;
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isSupported___com_codename1_xml_Element_R_boolean(threadStateData, __cn1ThisObject, locals[8].data.o)!=0) /* IFNE CustomJump */ goto label_L3244883;
...
label_L2098087645:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L752286440;
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_shouldEvaluate___com_codename1_xml_Element_R_boolean(threadStateData, __cn1ThisObject, locals[8].data.o)!=0) /* IFNE CustomJump */ goto label_L3244883;
...
label_L2127390817:
    ...
    SP++;
    PUSH_INT(62);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2103304108;
    ...
    if (ilocals_10_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1927960180;
...
label_L2103304108:
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1700257002;
...
label_L1210315984:
    ...
    if (ilocals_11_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L1700257002;
    ...
    if (ilocals_13_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1994710867;
...
label_L1994710867:
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1453157901;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(90);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1453157901;
    __CN1_DEBUG_INFO(666);
    /* VarOp.assignFrom */ ilocals_5_=(((ilocals_5_ - 65) + 97) & 0xffff);

label_L1453157901:
    __CN1_DEBUG_INFO(668);
    if (ilocals_5_!=/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[10].data.o, ilocals_11_)) /* IF_ICMPNE CustomJump */ goto label_L1124506335;
...
label_L3244883:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L47491804;
...
label_L1978865375:
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1296074566;
...
label_L705531384:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)!=0) /* IFNE CustomJump */ goto label_L1793414776;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1793414776;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(62);
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1271355282;
    __CN1_DEBUG_INFO(703);
    if (get_field_com_codename1_xml_XMLParser_caseSensitive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1271355282;
...
label_L1793414776:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L589863377;
...
label_L1673413960:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L1377968609;
...
label_L1377968609:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L92510173;
...
label_L560752677:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L1644322989;
...
label_L1644322989:
    ...
    SP++;
    PUSH_INT(34);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L91147932;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(39);
...
label_L906244819:
    ...
    if (ilocals_11_!=0) /* IFNE CustomJump */ goto label_L794026109;
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L1547358501;
...
label_L1547358501:
    ...
    if (ilocals_5_!=ilocals_9_) /* IF_ICMPNE CustomJump */ goto label_L341631013;
    __CN1_DEBUG_INFO(761);
    /* VarOp.assignFrom */     ilocals_11_ = 1 /* ICONST_1 */; 
    __CN1_DEBUG_INFO(762);
    /* VarOp.assignFrom */ ilocals_12_ = /* CustomInvoke */com_codename1_xml_XMLParser_read___java_io_Reader_R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(763);
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L502047593;
...
label_L657827804:
    ...
    if (locals[10].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1721207829;
...
label_L747909318:
    ...
    /* VarOp.assignFrom */ locals[10].type=CN1_TYPE_INVALID;    locals[10].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[10].type=CN1_TYPE_OBJECT;    goto label_L755820705;

label_L1639379591:
    __CN1_DEBUG_INFO(779);
    if (/* CustomInvoke */com_codename1_xml_XMLParser_isLegalCharEntityCharacter___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L1823075447;
...
label_L794026109:
    ...
    if (locals[10].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1814723699;
...
label_L1814723699:
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L987666875;
...
label_L987666875:
    ...
    if (ilocals_12_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L246561692;
...
label_L246561692:
    ...
    if (ilocals_12_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L423039171;
...
label_L423039171:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isWhiteSpace___char_R_boolean(threadStateData, __cn1ThisObject, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L826542045;
    __CN1_DEBUG_INFO(811);
    /* VarOp.assignFrom */ ilocals_12_ = /* CustomInvoke */com_codename1_xml_XMLParser_read___java_io_Reader_R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(812);
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L2132361999;
...
label_L826542045:
    ...
    if (/* CustomInvoke */virtual_com_codename1_xml_XMLParser_isEmptyTag___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L1106791345;
...
label_L1586095399:
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1343473340;
    __CN1_DEBUG_INFO(824);
    /* VarOp.assignFrom */ ilocals_12_ = /* CustomInvoke */com_codename1_xml_XMLParser_read___java_io_Reader_R_int(threadStateData, locals[1].data.o);
    __CN1_DEBUG_INFO(825);
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L1697117834;
...
label_L1697117834:
    ...
    if (get_field_com_codename1_xml_XMLParser_eventParser(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2008088356;
...
label_L756603373:
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L962126152;
    ...
    if (ilocals_7_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1670501199;
...
label_L1670501199:
    ...
    if (ilocals_8_!=CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, ilocals_4_)) /* IF_ICMPNE CustomJump */ goto label_L603574478;
    __CN1_DEBUG_INFO(868);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(869);
    if (ilocals_4_!=CN1_ARRAY_LENGTH(locals[3].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1405108810;
...
label_L603574478:
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L762100699;
    __CN1_DEBUG_INFO(877);
    if (ilocals_8_!=CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, 0 /* ICONST_0 */)) /* IF_ICMPNE CustomJump */ goto label_L1082789522;
    if (ilocals_4_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1082789522;
...
locals[7].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(890);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7809))==0) /* IFEQ CustomJump */ goto label_L2090535958;
...
locals[7].type=CN1_TYPE_OBJECT;    goto label_L887210557;

label_L2090535958:
    __CN1_DEBUG_INFO(892);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5920))==0) /* IFEQ CustomJump */ goto label_L605004973;
...
JAVA_VOID com_codename1_xml_XMLParser_notifyError___int_java_lang_String_java_lang_String_java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    ...
    if (get_field_com_codename1_xml_XMLParser_parserCallback(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1369857878;
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1369857878;
