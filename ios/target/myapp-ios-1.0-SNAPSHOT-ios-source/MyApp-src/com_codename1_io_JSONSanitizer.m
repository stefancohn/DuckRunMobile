...
JAVA_OBJECT com_codename1_io_JSONSanitizer_sanitize___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_io_JSONSanitizer(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 7545, 7546);
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_sanitize___java_lang_String_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_io_JSONSanitizer(threadStateData);
    DEFINE_METHOD_STACK(4, 3, 0, 7545, 7546);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_io_JSONSanitizer___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7545, 205);
...
JAVA_VOID com_codename1_io_JSONSanitizer___INIT_____java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7545, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(0);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2052572633;
    BC_ALOAD(1);
    goto label_L1948950538;

label_L2052572633:
    /* LDC: 'null'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(268));
...
JAVA_VOID com_codename1_io_JSONSanitizer_sanitize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 12, 0, 7545, 7546);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    int tryBlockOffsetL933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    DEFINE_CATCH_BLOCK(catch_L933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1, label_L736233691, restoreToL933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    int restoreToL411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    int tryBlockOffsetL411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    DEFINE_CATCH_BLOCK(catch_L411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2, label_L736233691, restoreToL411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
...
label_L907409625:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1590977463, 0);

label_L933240659:
 tryBlockOffsetL933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    restoreToL933240659cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L451480761, 1);
        case 10: JUMP_TO(label_L451480761, 1);
        case 13: JUMP_TO(label_L451480761, 1);
        case 32: JUMP_TO(label_L451480761, 1);
        case 34: JUMP_TO(label_L996328734, 1);
        case 39: JUMP_TO(label_L996328734, 1);
        case 40: JUMP_TO(label_L8238713, 1);
        case 41: JUMP_TO(label_L8238713, 1);
        case 44: JUMP_TO(label_L2110370842, 1);
        case 47: JUMP_TO(label_L798483422, 1);
        case 58: JUMP_TO(label_L49322247, 1);
        case 91: JUMP_TO(label_L1867721054, 1);
        case 93: JUMP_TO(label_L1602890186, 1);
        case 123: JUMP_TO(label_L1867721054, 1);
        case 125: JUMP_TO(label_L1602890186, 1);
        default: JUMP_TO(label_L1335077110, 1);
    }

label_L451480761:
    __CN1_DEBUG_INFO(232);
    JUMP_TO(label_L1227700386, 1);
...
label_L1867721054:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1069736192, 1);
...
label_L1069736192:
    ...
    SP++;
    PUSH_INT(123);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L831019851, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L1670283668:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1137069423, 1);
    PUSH_POINTER(get_static_com_codename1_io_JSONSanitizer_State_START_MAP(threadStateData));
    JUMP_TO(label_L1797553910, 1);
...
label_L1602890186:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L411382490, 0);
...
END_TRY(1);    __CN1_DEBUG_INFO(264);
    JUMP_TO(label_L1590977463, 0);

label_L411382490:
 tryBlockOffsetL411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
    restoreToL411382490cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L252744319, 1);
        case 2: JUMP_TO(label_L2118912967, 1);
        case 3: JUMP_TO(label_L2118912967, 1);
        case 4: JUMP_TO(label_L911673654, 1);
        case 5: JUMP_TO(label_L125173444, 1);
        case 6: JUMP_TO(label_L125173444, 1);
        case 7: JUMP_TO(label_L125173444, 1);
        case 8: JUMP_TO(label_L125173444, 1);
        default: JUMP_TO(label_L125173444, 1);
    }

label_L252744319:
    __CN1_DEBUG_INFO(271);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_insert___int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_3_, STRING_FROM_CONSTANT_POOL_OFFSET(268)); 
    __CN1_DEBUG_INFO(272);
    JUMP_TO(label_L125173444, 1);
...
label_L911673654:
    ...
    /* CustomInvoke */com_codename1_io_JSONSanitizer_insert___int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_3_, STRING_FROM_CONSTANT_POOL_OFFSET(7548)); 
...
label_L125173444:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L209524543, 1);
    PUSH_INT(125);
    JUMP_TO(label_L317794116, 1);
...
label_L317794116:
    ...
    if (ilocals_4_==ilocals_7_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L476152469, 1);
...
label_L476152469:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L877317123, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject) - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1357570394, 1);
...
label_L2110370842:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1532977612, 1);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7549));     SP -= 1;
...
label_L1532977612:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L957846640, 1);
        case 2: JUMP_TO(label_L1055932985, 1);
        case 3: JUMP_TO(label_L610844900, 1);
        case 4: JUMP_TO(label_L610844900, 1);
        case 5: JUMP_TO(label_L610844900, 1);
        case 6: JUMP_TO(label_L1055932985, 1);
        case 7: JUMP_TO(label_L77173924, 1);
        case 8: JUMP_TO(label_L27796563, 1);
        default: JUMP_TO(label_L1039486933, 1);
    }
...
label_L49322247:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1610143599, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1227700386, 1);
...
label_L798483422:
    ...
    if ((ilocals_3_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L395068544, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 42: JUMP_TO(label_L1464230046, 1);
        case 47: JUMP_TO(label_L1088034372, 1);
        default: JUMP_TO(label_L395068544, 1);
    }
...
label_L1476625795:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1501618847, 1);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L752686443, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(8233);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1216070398, 1);

label_L752686443:
    __CN1_DEBUG_INFO(345);
    /* VarOp.assignFrom */ ilocals_8_=(ilocals_9_ + 1 /* ICONST_1 */);
    __CN1_DEBUG_INFO(346);
    JUMP_TO(label_L1501618847, 1);

label_L1216070398:
    __CN1_DEBUG_INFO(341);
    BC_IINC(9, 1);
    JUMP_TO(label_L1476625795, 1);

label_L1501618847:
    __CN1_DEBUG_INFO(349);
    JUMP_TO(label_L395068544, 1);

label_L1464230046:
    __CN1_DEBUG_INFO(351);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_2_;
    __CN1_DEBUG_INFO(352);
    if ((ilocals_3_ + 3 /* ICONST_3 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L395068544, 1);
...
label_L105451526:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(9);
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L395068544, 1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(42);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L105451526, 1);
...
label_L443006437:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1123757033, 1);
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1417768314, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L275432948, 1);
...
label_L1417768314:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1592602335, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(57);
...
label_L1592602335:
    ...
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L275432948, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(45);
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1163059848, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(90);
...
label_L1123757033:
    ...
    if (ilocals_9_!=ilocals_3_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1550093880, 1);
...
label_L1550093880:
    ...
    (*SP).data.i = ilocals_4_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1808324797, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L962339310, 1);
...
label_L1808324797:
    ...
    SP++;
    PUSH_INT(46);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L962339310, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(43);
...
label_L1721660173:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1262371411, 1);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(threadStateData, __cn1ThisObject, ilocals_3_, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1262371411, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L330652043:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L337405659, 1);
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L337405659, 1);

label_L22737007:
    __CN1_DEBUG_INFO(406);
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L26179918, 1);
    __CN1_DEBUG_INFO(407);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L949657590, 1);
...
label_L949657590:
    __CN1_DEBUG_INFO(406);
    BC_IINC(9, 1);
    JUMP_TO(label_L22737007, 1);

label_L26179918:
    __CN1_DEBUG_INFO(411);
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L337405659, 1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(34);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L337405659, 1);
    __CN1_DEBUG_INFO(412);
    BC_IINC(9, 1);

label_L337405659:
    __CN1_DEBUG_INFO(416);
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1988584481, 1);
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L205010614, 1);
...
label_L1988584481:
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L910041097, 1);
...
label_L910041097:
    ...
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1613856232, 1);
...
label_L1590977463:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_START_ARRAY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1562381774, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1562381774, 0);
    __CN1_DEBUG_INFO(457);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_insert___int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_2_, STRING_FROM_CONSTANT_POOL_OFFSET(268)); 
...
label_L1562381774:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L442060811, 0);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1312556583, 0);

label_L442060811:
    if (get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1312556583, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1475804169, 0);

label_L1312556583:
    __CN1_DEBUG_INFO(469);
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L182834500, 0);
...
label_L182834500:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1525421339, 0);
        case 2: JUMP_TO(label_L1959734623, 0);
        case 3: JUMP_TO(label_L1959734623, 0);
        case 4: JUMP_TO(label_L347701627, 0);
        default: JUMP_TO(label_L810695005, 0);
    }
...
label_L1959734623:
    ...
    JUMP_TO(label_L810695005, 0);

label_L347701627:
    __CN1_DEBUG_INFO(480);
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(7548)); 
    __CN1_DEBUG_INFO(481);
    JUMP_TO(label_L810695005, 0);

label_L1525421339:
    __CN1_DEBUG_INFO(483);
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(268)); 
...
label_L810695005:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L170698369, 0);
    PUSH_INT(125);
    JUMP_TO(label_L126142286, 0);
...
JAVA_VOID com_codename1_io_JSONSanitizer_sanitizeString___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_8_ = 0; /* v8 */
    volatile JAVA_INT ilocals_9_ = 0; /* v9 */
    DEFINE_INSTANCE_METHOD_STACK(5, 10, 0, 7545, 7550);
...
label_L1394111263:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1609448604;
    ...
    SP--;
    switch((*SP).data.i) {
        case 10: goto label_L2119663341;
        case 13: goto label_L295749384;
        case 34: goto label_L817880261;
        case 39: goto label_L817880261;
        case 47: goto label_L513477778;
        case 92: goto label_L1543420346;
        case 93: goto label_L1290911050;
        case 8232: goto label_L40245733;
        case 8233: goto label_L1147103911;
        default: goto label_L1782724863;
    }

label_L2119663341:
    __CN1_DEBUG_INFO(517);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7485)); 
    goto label_L731431696;

label_L295749384:
    __CN1_DEBUG_INFO(518);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7487)); 
    goto label_L731431696;

label_L40245733:
    __CN1_DEBUG_INFO(520);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7551)); 
    goto label_L731431696;

label_L1147103911:
    __CN1_DEBUG_INFO(521);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7552)); 
    goto label_L731431696;

label_L817880261:
    __CN1_DEBUG_INFO(525);
    if (ilocals_4_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L428035767;
    __CN1_DEBUG_INFO(526);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L731431696;
...
label_L428035767:
    ...
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L641078642;
    ...
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1573405835;
...
label_L1573405835:
    ...
    if (ilocals_6_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L807771233;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L869304868;
...
label_L641078642:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L626754729;
...
label_L513477778:
    ...
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L731431696;
    if ((ilocals_4_ + 2 /* ICONST_2 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L731431696;
    PUSH_INT(60);
...
label_L1290911050:
    ...
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7553)); 
    goto label_L731431696;

label_L1543420346:
    __CN1_DEBUG_INFO(564);
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L975724693;
...
label_L975724693:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L645018917;
        case 47: goto label_L645018917;
        case 48: goto label_L298060389;
        case 49: goto label_L298060389;
        case 50: goto label_L298060389;
        case 51: goto label_L298060389;
        case 52: goto label_L298060389;
        case 53: goto label_L298060389;
        case 54: goto label_L298060389;
        case 55: goto label_L298060389;
        case 92: goto label_L645018917;
        case 98: goto label_L645018917;
        case 102: goto label_L645018917;
        case 110: goto label_L645018917;
        case 114: goto label_L645018917;
        case 116: goto label_L645018917;
        case 117: goto label_L1757653560;
        case 118: goto label_L295064445;
        case 120: goto label_L645564279;
        default: goto label_L391915263;
    }
...
label_L295064445:
    ...
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 2 /* ICONST_2 */), STRING_FROM_CONSTANT_POOL_OFFSET(7554)); 
...
label_L645564279:
    ...
    if ((ilocals_4_ + 4/* ICONST_4 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1648090182;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 2 /* ICONST_2 */))==0) /* IFEQ CustomJump */ goto label_L1648090182;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 3 /* ICONST_3 */))==0) /* IFEQ CustomJump */ goto label_L1648090182;
    __CN1_DEBUG_INFO(580);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 2 /* ICONST_2 */), STRING_FROM_CONSTANT_POOL_OFFSET(7555)); 
...
label_L1757653560:
    ...
    if ((ilocals_4_ + 6)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1091925703;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 2 /* ICONST_2 */))==0) /* IFEQ CustomJump */ goto label_L1091925703;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 3 /* ICONST_3 */))==0) /* IFEQ CustomJump */ goto label_L1091925703;
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1091925703;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 5 /* ICONST_5 */))==0) /* IFEQ CustomJump */ goto label_L1091925703;
...
label_L298060389:
    ...
    if ((ilocals_7_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L858132653;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_7_ + 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ goto label_L858132653;
    ...
    SP++;
    PUSH_INT(51);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1169929192;
    if ((ilocals_7_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1169929192;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_7_ + 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ goto label_L1169929192;
...
label_L328690775:
    if (ilocals_9_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L2036240117;
    ...
    __CN1_DEBUG_INFO(603);
    BC_IINC(9, 1);
    goto label_L328690775;

label_L2036240117:
    __CN1_DEBUG_INFO(606);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, (ilocals_4_ + 1 /* ICONST_1 */), ilocals_7_, STRING_FROM_CONSTANT_POOL_OFFSET(7556)); 
...
label_L1782724863:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L280475120;
    __CN1_DEBUG_INFO(625);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L731431696;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(10);
    ...
    SP++;
    PUSH_INT(13);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L134967549;
    goto label_L731431696;

label_L280475120:
    __CN1_DEBUG_INFO(626);
    if (ilocals_5_>=55296) /* IF_ICMPGE CustomJump */ goto label_L95387183;
    __CN1_DEBUG_INFO(627);
    goto label_L731431696;

label_L95387183:
    __CN1_DEBUG_INFO(628);
    if (ilocals_5_>=57344) /* IF_ICMPGE CustomJump */ goto label_L770854681;
    __CN1_DEBUG_INFO(629);
    if (/* CustomInvoke */java_lang_Character_isHighSurrogate___char_R_boolean(threadStateData, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L134967549;
    if ((ilocals_4_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L134967549;
    PUSH_POINTER(get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject));
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L134967549;
...
label_L770854681:
    ...
    if (ilocals_5_>65533) /* IF_ICMPGT CustomJump */ goto label_L134967549;
    __CN1_DEBUG_INFO(635);
    goto label_L731431696;

label_L134967549:
    __CN1_DEBUG_INFO(637);
    /* CustomInvoke */com_codename1_io_JSONSanitizer_replace___int_int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_4_, (ilocals_4_ + 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(7489)); 
    __CN1_DEBUG_INFO(638);
    /* VarOp.assignFrom */     ilocals_7_ = 4/* ICONST_4 */; 

label_L13068130:
    BC_IINC(7, -1);
    if (ilocals_7_<0) /* IFLT CustomJump */ goto label_L731431696;
    ...
    goto label_L13068130;

label_L731431696:
    __CN1_DEBUG_INFO(513);
    BC_IINC(4, 1);
    goto label_L1394111263;

label_L1609448604:
    __CN1_DEBUG_INFO(644);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L767041877;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_requireValueState___int_com_codename1_io_JSONSanitizer_State_boolean_R_com_codename1_io_JSONSanitizer_State(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7545, 7557);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L311245180;
        case 2: goto label_L692760632;
        case 3: goto label_L962248325;
        case 4: goto label_L1434751602;
        case 5: goto label_L962248325;
        case 6: goto label_L692760632;
        case 7: goto label_L783882087;
        case 8: goto label_L1376696824;
        default: goto label_L1053596586;
    }

label_L962248325:
    __CN1_DEBUG_INFO(651);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1328191747;
...
label_L1328191747:
    ...
    /* CustomInvoke */com_codename1_io_JSONSanitizer_insert___int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_1_, STRING_FROM_CONSTANT_POOL_OFFSET(7558)); 
...
label_L1376696824:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L693026222;
...
label_L693026222:
    ...
    /* CustomInvoke */com_codename1_io_JSONSanitizer_insert___int_java_lang_String(threadStateData, __cn1ThisObject, ilocals_1_, STRING_FROM_CONSTANT_POOL_OFFSET(7559)); 
...
label_L783882087:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L237502470;
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7549));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_io_JSONSanitizer_insert___int_char(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_CHAR __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_1_ = 0; /* pos */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 7545, 378);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_io_JSONSanitizer_elide___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* start */
    volatile JAVA_INT ilocals_2_ = 0; /* end */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 7545, 7560);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(689);
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1424214946;
...
JAVA_VOID com_codename1_io_JSONSanitizer_replace___int_int_char(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_CHAR __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* end */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7545, 257);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_INT com_codename1_io_JSONSanitizer_endOfQuotedString___java_lang_String_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    __STATIC_INITIALIZER_com_codename1_io_JSONSanitizer(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 7545, 7561);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
...
label_L224591535:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(3);
    if(POP_INT() < 0) /* IFLT */ goto label_L1327145660;
    __CN1_DEBUG_INFO(716);
    /* VarOp.assignFrom */     ilocals_4_ = ilocals_3_;

label_L1560534902:
    __CN1_DEBUG_INFO(717);
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L333825340;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(92);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L333825340;
...
label_L333825340:
    ...
    if (((ilocals_3_ - ilocals_4_) & 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L402104751;
...
JAVA_VOID com_codename1_io_JSONSanitizer_elideTrailingComma___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 7545, 7562);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
label_L1803439542:
    BC_IINC(2, -1);
    if (ilocals_2_<get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L814945818;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: goto label_L1940424465;
        case 10: goto label_L1940424465;
        case 13: goto label_L1940424465;
        case 32: goto label_L1940424465;
        case 44: goto label_L1501084178;
        default: goto label_L1140174868;
    }

label_L1940424465:
    __CN1_DEBUG_INFO(736);
    goto label_L1803439542;
...
label_L814945818:
    ...
    if (get_static_com_codename1_io_JSONSanitizer__assertionsDisabled(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1549393863;
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1549393863;
...
label_L264092188:
    BC_IINC(2, -1);
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L1089291892;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: goto label_L787889005;
        case 10: goto label_L787889005;
        case 13: goto label_L787889005;
        case 32: goto label_L787889005;
        case 44: goto label_L930922744;
        default: goto label_L633964087;
    }
...
label_L1089291892:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7563));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7564));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_VOID com_codename1_io_JSONSanitizer_normalizeNumber___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 10, 0, 7545, 7565);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(772);
    /* VarOp.assignFrom */     ilocals_3_ = ilocals_1_;
    __CN1_DEBUG_INFO(774);
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L277861845;
    ...
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L1092992060;
        case 45: goto label_L682914321;
        default: goto label_L277861845;
    }
...
label_L277861845:
    ...
    if (ilocals_3_!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L1253785665;
...
label_L1253785665:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L611587518;
    __CN1_DEBUG_INFO(793);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(794);
    /* VarOp.assignFrom */     llocals_6_ = 0 /* LCONST_0 */; 
    __CN1_DEBUG_INFO(795);
    if ((ilocals_4_ - ilocals_3_)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1222416720;
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1222416720;
    PUSH_INT(120);
    PUSH_POINTER(get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject));
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
...
label_L2076021838:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1131634336;
    ...
    (*SP).data.i = ilocals_8_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1398450119;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_8_; 
    SP++;
    PUSH_INT(57);
...
label_L1398450119:
    ...
    (*SP).data.i = ilocals_8_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1131634336;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_8_; 
    SP++;
    PUSH_INT(102);
...
label_L1222416720:
    ...
    if ((ilocals_4_ - ilocals_3_)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L585257927;
    __CN1_DEBUG_INFO(814);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_3_;

label_L1491860427:
    if (ilocals_8_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L612412611;
    ...
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L1340283293;
...
label_L585257927:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L611587518;
    ...
    if (CN1_CMP_EXPR(llocals_6_, 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1755838330;
    ...
    if (ilocals_8_<0) /* IFLT CustomJump */ goto label_L1755838330;
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1231075353;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1755838330;
...
label_L611587518:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L513310553;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    PUSH_INT(46);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L513310553;
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L422243042;
...
label_L513310553:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1323418266;
    PUSH_INT(101);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1323418266;
    __CN1_DEBUG_INFO(865);
    BC_IINC(3, 1);
    __CN1_DEBUG_INFO(866);
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L42801967;
    __CN1_DEBUG_INFO(867);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L1597169296;
        case 45: goto label_L1597169296;
...
label_L42801967:
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L293687918;
...
label_L1323418266:
    ...
    if (ilocals_3_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L1362405334;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_canonicalizeNumber___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 7545, 7566);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_canonicalizeNumber___java_lang_StringBuilder_int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_io_JSONSanitizer(threadStateData);
    DEFINE_METHOD_STACK(6, 19, 0, 7545, 7566);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    ilocals_2_ = __cn1Arg3;
    int restoreToL80867688cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL80867688cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L80867688cn1_class_id_java_lang_NumberFormatException1, label_L998935228, restoreToL80867688cn1_class_id_java_lang_NumberFormatException1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1921324291, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1762409247, 0);
...
label_L674608081:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L494021631, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L494021631, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1925356935, 0);
    JUMP_TO(label_L494021631, 0);

label_L1925356935:
    __CN1_DEBUG_INFO(925);
    BC_IINC(4, 1);
    JUMP_TO(label_L674608081, 0);

label_L494021631:
    __CN1_DEBUG_INFO(929);
    if (ilocals_4_==ilocals_2_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L552186123, 0);
    PUSH_INT(46);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L742939450, 0);
...
label_L572706092:
    if (ilocals_6_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1241568657, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1241568657, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1336822843, 0);
    JUMP_TO(label_L1241568657, 0);

label_L1336822843:
    __CN1_DEBUG_INFO(933);
    BC_IINC(6, 1);
    JUMP_TO(label_L572706092, 0);

label_L1241568657:
    __CN1_DEBUG_INFO(938);
    if (ilocals_6_!=ilocals_2_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1289602009, 0);
...
label_L1289602009:
    ...
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1037000742, 0);
...
label_L1037000742:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L154177822, 0);
    BC_IINC(7, 1);
...
label_L4008846:
    ...
    if (ilocals_3_>ilocals_4_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L735140074, 0);
    if (ilocals_4_>ilocals_5_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L735140074, 0);
    if (ilocals_5_>ilocals_6_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L735140074, 0);
    if (ilocals_6_>ilocals_7_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L735140074, 0);
    if (ilocals_7_<=ilocals_8_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1121544005, 0);

label_L735140074:
    __CN1_DEBUG_INFO(955);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7568));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1121544005:
    __CN1_DEBUG_INFO(959);
    if (ilocals_8_!=ilocals_7_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L80867688, 0);
    __CN1_DEBUG_INFO(960);
    /* VarOp.assignFrom */     ilocals_9_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L165951629, 0);

label_L80867688:
 tryBlockOffsetL80867688cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L80867688cn1_class_id_java_lang_NumberFormatException1);
    restoreToL80867688cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L2001804956:
    if (ilocals_14_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L676538195, 0);
    ...
    SP++;
    PUSH_INT(46);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L557424211, 0);
    __CN1_DEBUG_INFO(997);
    /* VarOp.assignFrom */     ilocals_11_ = 1 /* ICONST_1 */; 
    __CN1_DEBUG_INFO(998);
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L711487917, 0);
    /* VarOp.assignFrom */     ilocals_15_ = 0 /* ICONST_0 */; 
...
label_L557424211:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L39846973, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_17_; 
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L859361949, 0);

label_L39846973:
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L859361949, 0);
    BC_IINC(10, 1);
...
label_L859361949:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1579030959, 0);
...
label_L1579030959:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L932380376, 0);
    __CN1_DEBUG_INFO(1013);
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L902907387, 0);
...
label_L1911571121:
    ...
    if (ilocals_15_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1082705382, 0);
    if (ilocals_17_==0) /* IFEQ CustomJump */ JUMP_TO(label_L711487917, 0);

label_L1082705382:
    __CN1_DEBUG_INFO(1021);
    if (ilocals_15_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1853194041, 0);
...
label_L676538195:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L840444920, 0);
...
label_L840444920:
    ...
    if (ilocals_14_>ilocals_10_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L1974397962, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1974397962, 0);
    __CN1_DEBUG_INFO(1053);
    /* VarOp.assignFrom */     ilocals_15_ = ilocals_14_;

label_L2044888689:
    if (ilocals_15_>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L112774596, 0);
    __CN1_DEBUG_INFO(1054);
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___char_R_java_lang_StringBuilder(threadStateData, locals[0].data.o, 48); 
    __CN1_DEBUG_INFO(1053);
    BC_IINC(15, 1);
    JUMP_TO(label_L2044888689, 0);

label_L112774596:
    JUMP_TO(label_L181806430, 0);

label_L1974397962:
    __CN1_DEBUG_INFO(1061);
    if (0 /* ICONST_0 */>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L135943858, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L135943858, 0);
...
label_L135943858:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L1217162392, 0);
    if (ilocals_10_>0) /* IFGT CustomJump */ JUMP_TO(label_L1217162392, 0);
    __CN1_DEBUG_INFO(1069);
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_String_substring___int_int_R_java_lang_String(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(7569), 0 /* ICONST_0 */, (2 /* ICONST_2 */ - ilocals_10_));
    PUSH_OBJ(tmpResult); }
...
label_L1217162392:
    ...
    if (ilocals_14_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L623950582, 0);
...
label_L511154139:
    ...
    PUSH_OBJ(tmpResult); }
    if (ilocals_15_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1141042529, 0);
    PUSH_INT(45);
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_regionMatches___java_lang_String_int_java_lang_String_int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    __STATIC_INITIALIZER_com_codename1_io_JSONSanitizer(threadStateData);
    DEFINE_METHOD_STACK(4, 6, 0, 7545, 254);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
...
label_L1045909404:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1334198737;
    __CN1_DEBUG_INFO(1100);
    if (/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[0].data.o, (ilocals_1_ + ilocals_5_))==/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[2].data.o, (ilocals_3_ + ilocals_5_))) /* IF_ICMPEQ CustomJump */ goto label_L1835916981;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* end */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 7545, 7570);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1108);
    /* VarOp.assignFrom */ ilocals_3_=(ilocals_2_ - ilocals_1_);
    __CN1_DEBUG_INFO(1109);
    if (ilocals_3_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1559928458;
    __CN1_DEBUG_INFO(1110);

{
    JAVA_INT ___returnValue=/* CustomInvoke */com_codename1_io_JSONSanitizer_regionMatches___java_lang_String_int_java_lang_String_int_int_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(267), 0 /* ICONST_0 */, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_1_, ilocals_3_);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return ___returnValue;
}

label_L1559928458:
    __CN1_DEBUG_INFO(1111);
    if (ilocals_3_!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L563069965;
    __CN1_DEBUG_INFO(1112);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_regionMatches___java_lang_String_int_java_lang_String_int_int_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(268), 0 /* ICONST_0 */, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_1_, ilocals_3_)!=0) /* IFNE CustomJump */ goto label_L580136703;
    /* LDC: 'true'*/
    ...
    SP-=4;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L649838238;

label_L580136703:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L784165389;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7545, 7571);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    (*SP).data.i = ilocals_2_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1900903547;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(55);
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* ch */
    volatile JAVA_INT ilocals_1_ = 0; /* i */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7545, 7572);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    (*SP).data.i = ilocals_2_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L161040638;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(57);
...
label_L161040638:
    ...
    (*SP).data.i = ilocals_2_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1278326466;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(102);
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* ch */
    volatile JAVA_INT ilocals_1_ = 0; /* i */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7545, 7573);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1317746351;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;
...
label_L1317746351:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L219564344;
        case 44: goto label_L219564344;
        case 58: goto label_L219564344;
        case 91: goto label_L219564344;
        case 93: goto label_L219564344;
        case 123: goto label_L219564344;
        case 125: goto label_L219564344;
        default: goto label_L1288731134;
    }
...
JAVA_VOID com_codename1_io_JSONSanitizer_appendHex___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 7545, 2293);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1343952313:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L931280002;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L539710099;
    PUSH_INT(48);
...
JAVA_INT com_codename1_io_JSONSanitizer_endOfDigitRun___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 7545, 7574);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1198122764:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1989877020;
    ...
    (*SP).data.i = ilocals_4_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L207517334;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1331139970;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7545, 263);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1170);
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1765040384;
...
JAVA_VOID com_codename1_io_JSONSanitizer___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 7545, 275);
    __CN1_DEBUG_INFO(93);
    if (virtual_java_lang_Class_desiredAssertionStatus___R_boolean(threadStateData, (JAVA_OBJECT)&class__com_codename1_io_JSONSanitizer)!=0) /* IFNE CustomJump */ goto label_L1697201317;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1836115595;
