...
JAVA_VOID com_codename1_io_JSONSanitizer___INIT_____java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    BC_ALOAD(0);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1774347256;
    BC_ALOAD(1);
...
JAVA_VOID com_codename1_io_JSONSanitizer_sanitize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    int tryBlockOffsetL1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    DEFINE_CATCH_BLOCK(catch_L1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1, label_L428475414, restoreToL1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    int restoreToL1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    int tryBlockOffsetL1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    DEFINE_CATCH_BLOCK(catch_L1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2, label_L428475414, restoreToL1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
...
label_L26179918:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L522219842, 0);

label_L1738954797:
 tryBlockOffsetL1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    restoreToL1738954797cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1703353597, 1);
        case 10: JUMP_TO(label_L1703353597, 1);
        case 13: JUMP_TO(label_L1703353597, 1);
        case 32: JUMP_TO(label_L1703353597, 1);
        case 34: JUMP_TO(label_L1916766608, 1);
        case 39: JUMP_TO(label_L1916766608, 1);
        case 40: JUMP_TO(label_L1004308853, 1);
        case 41: JUMP_TO(label_L1004308853, 1);
        case 44: JUMP_TO(label_L669668653, 1);
        case 47: JUMP_TO(label_L2052572633, 1);
        case 58: JUMP_TO(label_L1948950538, 1);
        case 91: JUMP_TO(label_L736233691, 1);
        case 93: JUMP_TO(label_L1590977463, 1);
        case 123: JUMP_TO(label_L736233691, 1);
        case 125: JUMP_TO(label_L1590977463, 1);
        default: JUMP_TO(label_L451480761, 1);
    }

label_L1703353597:
    __CN1_DEBUG_INFO(232);
    JUMP_TO(label_L996328734, 1);
...
label_L736233691:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L8238713, 1);
...
label_L8238713:
    ...
    SP++;
    PUSH_INT(123);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L2110370842, 1);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L798483422, 1);
...
label_L1590977463:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1602890186, 0);
...
END_TRY(1);    __CN1_DEBUG_INFO(264);
    JUMP_TO(label_L522219842, 0);

label_L1602890186:
 tryBlockOffsetL1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
    restoreToL1602890186cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1335077110, 1);
        case 2: JUMP_TO(label_L1227700386, 1);
        case 3: JUMP_TO(label_L1227700386, 1);
        case 4: JUMP_TO(label_L1069736192, 1);
        case 5: JUMP_TO(label_L831019851, 1);
        case 6: JUMP_TO(label_L831019851, 1);
        case 7: JUMP_TO(label_L831019851, 1);
        case 8: JUMP_TO(label_L831019851, 1);
        default: JUMP_TO(label_L831019851, 1);
    }
...
label_L831019851:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1670283668, 1);
    PUSH_INT(125);
    JUMP_TO(label_L1137069423, 1);
...
label_L1137069423:
    ...
    if (ilocals_4_==ilocals_7_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1797553910, 1);
...
label_L1797553910:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L411382490, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject) - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L252744319, 1);

label_L411382490:
    PUSH_POINTER(get_static_com_codename1_io_JSONSanitizer_State_AFTER_ELEMENT(threadStateData));
    JUMP_TO(label_L2118912967, 1);
...
label_L669668653:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L911673654, 1);
...
label_L911673654:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L125173444, 1);
        case 2: JUMP_TO(label_L209524543, 1);
        case 3: JUMP_TO(label_L317794116, 1);
        case 4: JUMP_TO(label_L317794116, 1);
        case 5: JUMP_TO(label_L317794116, 1);
        case 6: JUMP_TO(label_L209524543, 1);
        case 7: JUMP_TO(label_L476152469, 1);
        case 8: JUMP_TO(label_L877317123, 1);
        default: JUMP_TO(label_L1357570394, 1);
    }
...
label_L1948950538:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1270490884, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L996328734, 1);
...
label_L2052572633:
    ...
    if ((ilocals_3_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1532977612, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 42: JUMP_TO(label_L957846640, 1);
        case 47: JUMP_TO(label_L1055932985, 1);
        default: JUMP_TO(label_L1532977612, 1);
    }
...
label_L1039486933:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L610844900, 1);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L77173924, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(8233);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L27796563, 1);

label_L77173924:
    __CN1_DEBUG_INFO(345);
    /* VarOp.assignFrom */ ilocals_8_=(ilocals_9_ + 1 /* ICONST_1 */);
    __CN1_DEBUG_INFO(346);
    JUMP_TO(label_L610844900, 1);
...
label_L610844900:
    ...
    JUMP_TO(label_L1532977612, 1);

label_L957846640:
    __CN1_DEBUG_INFO(351);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_2_;
    __CN1_DEBUG_INFO(352);
    if ((ilocals_3_ + 3 /* ICONST_3 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1532977612, 1);
...
label_L1610143599:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(9);
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L1532977612, 1);
...
label_L1216070398:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L395068544, 1);
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1464230046, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1088034372, 1);
...
label_L1501618847:
    ...
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1088034372, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(45);
...
label_L1088034372:
    __CN1_DEBUG_INFO(382);
    BC_IINC(9, 1);
    JUMP_TO(label_L1216070398, 1);

label_L395068544:
    __CN1_DEBUG_INFO(392);
    if (ilocals_9_!=ilocals_3_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1476625795, 1);
...
label_L1476625795:
    ...
    (*SP).data.i = ilocals_4_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L105451526, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1123757033, 1);
...
label_L105451526:
    ...
    SP++;
    PUSH_INT(46);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1123757033, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(43);
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1417768314, 1);
...
label_L275432948:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1592602335, 1);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(threadStateData, __cn1ThisObject, ilocals_3_, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1592602335, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L1163059848:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L443006437, 1);
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L443006437, 1);

label_L962339310:
    __CN1_DEBUG_INFO(406);
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1550093880, 1);
    __CN1_DEBUG_INFO(407);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1808324797, 1);
    __CN1_DEBUG_INFO(408);
    JUMP_TO(label_L1550093880, 1);

label_L1808324797:
    __CN1_DEBUG_INFO(406);
    BC_IINC(9, 1);
    JUMP_TO(label_L962339310, 1);
...
label_L1550093880:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(34);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L443006437, 1);
    __CN1_DEBUG_INFO(412);
    BC_IINC(9, 1);

label_L443006437:
    __CN1_DEBUG_INFO(416);
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L510868405, 1);
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1721660173, 1);
...
label_L510868405:
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L330652043, 1);
...
label_L330652043:
    ...
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1262371411, 1);
...
label_L522219842:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_START_ARRAY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L949657590, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L949657590, 0);
...
label_L949657590:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L22737007, 0);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1988584481, 0);

label_L22737007:
    if (get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1988584481, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L205010614, 0);

label_L1988584481:
    __CN1_DEBUG_INFO(469);
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1613856232, 0);
...
label_L1613856232:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L910041097, 0);
        case 2: JUMP_TO(label_L2069232771, 0);
        case 3: JUMP_TO(label_L2069232771, 0);
        case 4: JUMP_TO(label_L907409625, 0);
        default: JUMP_TO(label_L1562381774, 0);
    }
...
label_L1562381774:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L442060811, 0);
    PUSH_INT(125);
    JUMP_TO(label_L1312556583, 0);
...
label_L1169929192:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1475804169;
    ...
    switch((*SP).data.i) {
        ...
        case 13: goto label_L1525421339;
        case 34: goto label_L1959734623;
        case 39: goto label_L1959734623;
        case 47: goto label_L347701627;
        case 92: goto label_L810695005;
        case 93: goto label_L170698369;
        case 8232: goto label_L126142286;
        case 8233: goto label_L1609448604;
...
label_L1959734623:
    ...
    if (ilocals_4_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L817880261;
    __CN1_DEBUG_INFO(526);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L295749384;
...
label_L817880261:
    ...
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L513477778;
    ...
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1543420346;
...
label_L1543420346:
    ...
    if (ilocals_6_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L1290911050;
    PUSH_INT(1); /* ICONST_1 */
...
label_L513477778:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1147103911;
...
label_L347701627:
    ...
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L295749384;
    if ((ilocals_4_ + 2 /* ICONST_2 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L295749384;
    PUSH_INT(60);
...
label_L810695005:
    ...
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1782724863;
...
label_L1782724863:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L731431696;
        case 47: goto label_L731431696;
        case 48: goto label_L428035767;
        case 49: goto label_L428035767;
        case 50: goto label_L428035767;
        case 51: goto label_L428035767;
        case 52: goto label_L428035767;
        case 53: goto label_L428035767;
        case 54: goto label_L428035767;
        case 55: goto label_L428035767;
        case 92: goto label_L731431696;
        case 98: goto label_L731431696;
        case 102: goto label_L731431696;
        case 110: goto label_L731431696;
        case 114: goto label_L731431696;
        case 116: goto label_L731431696;
        case 117: goto label_L641078642;
        case 118: goto label_L1573405835;
        case 120: goto label_L807771233;
        default: goto label_L869304868;
    }
...
label_L807771233:
    ...
    if ((ilocals_4_ + 4/* ICONST_4 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L626754729;
...
label_L641078642:
    ...
    if ((ilocals_4_ + 6)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L975724693;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L975724693;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 5 /* ICONST_5 */))==0) /* IFEQ CustomJump */ goto label_L975724693;
...
label_L428035767:
    ...
    SP++;
    PUSH_INT(51);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L298060389;
...
label_L295064445:
    if (ilocals_9_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1757653560;
...
label_L2119663341:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L645564279;
    __CN1_DEBUG_INFO(625);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L295749384;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(10);
    ...
    SP++;
    PUSH_INT(13);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L391915263;
    goto label_L295749384;

label_L645564279:
    __CN1_DEBUG_INFO(626);
    if (ilocals_5_>=55296) /* IF_ICMPGE CustomJump */ goto label_L1648090182;
    __CN1_DEBUG_INFO(627);
    goto label_L295749384;

label_L1648090182:
    __CN1_DEBUG_INFO(628);
    if (ilocals_5_>=57344) /* IF_ICMPGE CustomJump */ goto label_L1091925703;
    __CN1_DEBUG_INFO(629);
    if (/* CustomInvoke */java_lang_Character_isHighSurrogate___char_R_boolean(threadStateData, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L391915263;
    if ((ilocals_4_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L391915263;
    PUSH_POINTER(get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject));
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L391915263;
...
label_L1091925703:
    ...
    if (ilocals_5_>65533) /* IF_ICMPGT CustomJump */ goto label_L391915263;
...
label_L858132653:
    BC_IINC(7, -1);
    if (ilocals_7_<0) /* IFLT CustomJump */ goto label_L295749384;
...
label_L1475804169:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L2036240117;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_requireValueState___int_com_codename1_io_JSONSanitizer_State_boolean_R_com_codename1_io_JSONSanitizer_State(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L328690775;
        case 2: goto label_L280475120;
        case 3: goto label_L134967549;
        case 4: goto label_L95387183;
        case 5: goto label_L134967549;
        case 6: goto label_L280475120;
        case 7: goto label_L770854681;
        case 8: goto label_L13068130;
        default: goto label_L1394111263;
    }
...
label_L770854681:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L692760632;
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7539));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_io_JSONSanitizer_elide___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L962248325;
...
label_L1328191747:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(3);
    if(POP_INT() < 0) /* IFLT */ goto label_L1434751602;
    __CN1_DEBUG_INFO(716);
    /* VarOp.assignFrom */     ilocals_4_ = ilocals_3_;

label_L1376696824:
    __CN1_DEBUG_INFO(717);
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L783882087;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(92);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L783882087;
    __CN1_DEBUG_INFO(718);
    BC_IINC(4, -1);
    goto label_L1376696824;

label_L783882087:
    __CN1_DEBUG_INFO(720);
    if (((ilocals_3_ - ilocals_4_) & 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1053596586;
...
label_L333825340:
    BC_IINC(2, -1);
    if (ilocals_2_<get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L693026222;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: goto label_L237502470;
        case 10: goto label_L237502470;
        case 13: goto label_L237502470;
        case 32: goto label_L237502470;
        case 44: goto label_L1424214946;
        default: goto label_L1327145660;
    }

label_L237502470:
    __CN1_DEBUG_INFO(736);
    goto label_L333825340;
...
label_L693026222:
    ...
    if (get_static_com_codename1_io_JSONSanitizer__assertionsDisabled(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1560534902;
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1560534902;
...
label_L1501084178:
    BC_IINC(2, -1);
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L402104751;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: goto label_L224591535;
        case 10: goto label_L224591535;
        case 13: goto label_L224591535;
        case 32: goto label_L224591535;
        case 44: goto label_L814945818;
        default: goto label_L1940424465;
    }
...
JAVA_VOID com_codename1_io_JSONSanitizer_normalizeNumber___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1140174868;
    ...
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L1803439542;
        case 45: goto label_L1549393863;
...
label_L1140174868:
    ...
    if (ilocals_3_!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L1089291892;
...
label_L1089291892:
    ...
    if ((ilocals_4_ - ilocals_3_)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L930922744;
...
label_L930922744:
    ...
    if ((ilocals_4_ - ilocals_3_)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L682914321;
    __CN1_DEBUG_INFO(814);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_3_;

label_L1222416720:
    if (ilocals_8_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1253785665;
    ...
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L611587518;
...
label_L682914321:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L787889005;
    ...
    if (CN1_CMP_EXPR(llocals_6_, 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1131634336;
    ...
    if (ilocals_8_<0) /* IFLT CustomJump */ goto label_L1131634336;
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1398450119;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1131634336;
...
label_L787889005:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1468498423;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    PUSH_INT(46);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1468498423;
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L2076021838;
...
label_L1468498423:
    ...
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L585257927;
    ...
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L1340283293;
        case 45: goto label_L1340283293;
        default: goto label_L612412611;
    }
...
label_L612412611:
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L1491860427;
...
label_L585257927:
    ...
    if (ilocals_3_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L1755838330;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_canonicalizeNumber___java_lang_StringBuilder_int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    int restoreToL1336822843cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL1336822843cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L1336822843cn1_class_id_java_lang_NumberFormatException1, label_L1231075353, restoreToL1336822843cn1_class_id_java_lang_NumberFormatException1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L513310553, 0);
    PUSH_INT(1); /* ICONST_1 */
...
label_L1597169296:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1323418266, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1323418266, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L42801967, 0);
    JUMP_TO(label_L1323418266, 0);

label_L42801967:
    __CN1_DEBUG_INFO(925);
    BC_IINC(4, 1);
    JUMP_TO(label_L1597169296, 0);

label_L1323418266:
    __CN1_DEBUG_INFO(929);
    if (ilocals_4_==ilocals_2_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L293687918, 0);
    PUSH_INT(46);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1362405334, 0);
...
label_L1762409247:
    if (ilocals_6_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L998935228, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L998935228, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1921324291, 0);
    JUMP_TO(label_L998935228, 0);
...
label_L998935228:
    ...
    if (ilocals_6_!=ilocals_2_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L494021631, 0);
...
label_L494021631:
    ...
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L674608081, 0);
...
label_L674608081:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L552186123, 0);
    BC_IINC(7, 1);
...
label_L1925356935:
    ...
    if (ilocals_3_>ilocals_4_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L742939450, 0);
    if (ilocals_4_>ilocals_5_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L742939450, 0);
    if (ilocals_5_>ilocals_6_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L742939450, 0);
    if (ilocals_6_>ilocals_7_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L742939450, 0);
    if (ilocals_7_<=ilocals_8_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1241568657, 0);
...
label_L1241568657:
    ...
    if (ilocals_8_!=ilocals_7_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1336822843, 0);
    __CN1_DEBUG_INFO(960);
    /* VarOp.assignFrom */     ilocals_9_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L572706092, 0);

label_L1336822843:
 tryBlockOffsetL1336822843cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1336822843cn1_class_id_java_lang_NumberFormatException1);
    restoreToL1336822843cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L859361949:
    if (ilocals_14_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1289602009, 0);
    ...
    SP++;
    PUSH_INT(46);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L4008846, 0);
...
label_L4008846:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L735140074, 0);

label_L154177822:
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L735140074, 0);
    BC_IINC(10, 1);
...
label_L735140074:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1121544005, 0);
...
label_L1121544005:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L80867688, 0);
    __CN1_DEBUG_INFO(1013);
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L165951629, 0);
...
label_L39846973:
    ...
    if (ilocals_17_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1037000742, 0);
...
label_L1289602009:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1579030959, 0);
...
label_L1579030959:
    ...
    if (ilocals_14_>ilocals_10_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L932380376, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L932380376, 0);
    __CN1_DEBUG_INFO(1053);
    /* VarOp.assignFrom */     ilocals_15_ = ilocals_14_;

label_L1082705382:
    if (ilocals_15_>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L902907387, 0);
...
label_L932380376:
    ...
    if (0 /* ICONST_0 */>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1311844369, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1311844369, 0);
...
label_L1311844369:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L1911571121, 0);
    if (ilocals_10_>0) /* IFGT CustomJump */ JUMP_TO(label_L1911571121, 0);
...
label_L1911571121:
    ...
    if (ilocals_14_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2001804956, 0);
    JUMP_TO(label_L840444920, 0);
...
label_L840444920:
    ...
    PUSH_OBJ(tmpResult); }
    if (ilocals_15_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1974397962, 0);
    PUSH_INT(45);
    JUMP_TO(label_L112774596, 0);
...
label_L135943858:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2044888689;
    __CN1_DEBUG_INFO(1100);
    if (/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[0].data.o, (ilocals_1_ + ilocals_5_))==/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[2].data.o, (ilocals_3_ + ilocals_5_))) /* IF_ICMPEQ CustomJump */ goto label_L181806430;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1217162392;
...
label_L1217162392:
    ...
    SP-=4;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1141042529;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    (*SP).data.i = ilocals_2_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1334198737;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(55);
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L580136703;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;
...
label_L580136703:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L649838238;
        case 44: goto label_L649838238;
        case 58: goto label_L649838238;
        case 91: goto label_L649838238;
        case 93: goto label_L649838238;
        case 123: goto label_L649838238;
        case 125: goto label_L649838238;
        default: goto label_L784165389;
    }
...
label_L1278326466:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1923962747;
    PUSH_INT(48);
...
label_L1288731134:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1443210651;
    ...
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L219564344;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L931280002;
...
JAVA_VOID com_codename1_io_JSONSanitizer___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(93);
    if (virtual_java_lang_Class_desiredAssertionStatus___R_boolean(threadStateData, (JAVA_OBJECT)&class__com_codename1_io_JSONSanitizer)!=0) /* IFNE CustomJump */ goto label_L525041703;
    PUSH_INT(1); /* ICONST_1 */
