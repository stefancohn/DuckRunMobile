...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_ScalarUnit___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1864), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L583744857;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(401), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L870627780;
...
label_L870627780:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2449))==0) /* IFEQ CustomJump */ goto label_L282166934;
...
label_L282166934:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2450))==0) /* IFEQ CustomJump */ goto label_L1804292128;
...
label_L1804292128:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5758))==0) /* IFEQ CustomJump */ goto label_L2100817420;
...
label_L2100817420:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1661))==0) /* IFEQ CustomJump */ goto label_L1518022811;
...
label_L1518022811:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5759))==0) /* IFEQ CustomJump */ goto label_L1174599796;
...
label_L1174599796:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5760))==0) /* IFEQ CustomJump */ goto label_L2000267972;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L893152673;
    __CN1_DEBUG_INFO(444);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(445);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_value(locals[2].data.o), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L918584437;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_value(__cn1ThisObject), 0 /* FCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1733354369;

label_L918584437:
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_value(locals[2].data.o), get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_value(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1568999973;
    if (get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_type(locals[2].data.o)!=get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_type(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1568999973;

label_L1733354369:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L184690001;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_validate___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1864), locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L1041552272;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(401), locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1589146424;
...
label_L1589146424:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2450))==0) /* IFEQ CustomJump */ goto label_L731487976;
...
label_L731487976:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5758))!=0) /* IFNE CustomJump */ goto label_L833298023;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2449))!=0) /* IFNE CustomJump */ goto label_L833298023;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5759))!=0) /* IFNE CustomJump */ goto label_L833298023;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5760))==0) /* IFEQ CustomJump */ goto label_L700171153;
...
label_L833298023:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L700171153;
    __CN1_DEBUG_INFO(462);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L700171153:
    __CN1_DEBUG_INFO(464);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1661))==0) /* IFEQ CustomJump */ goto label_L881280045;
    ...
    { JAVA_INT tmpResult = com_codename1_ui_plaf_CSSBorder_ScalarUnit_isFloat___java_lang_String_R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L881280045;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_isInt___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL1726397326cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1726397326cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1726397326cn1_class_id_java_lang_Throwable1, label_L1393484427, restoreToL1726397326cn1_class_id_java_lang_Throwable1);

label_L1726397326:
 tryBlockOffsetL1726397326cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1726397326cn1_class_id_java_lang_Throwable1);
    restoreToL1726397326cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_isFloat___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL1113504138cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1113504138cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1113504138cn1_class_id_java_lang_Throwable1, label_L977245867, restoreToL1113504138cn1_class_id_java_lang_Throwable1);

label_L1113504138:
 tryBlockOffsetL1113504138cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1113504138cn1_class_id_java_lang_Throwable1);
    restoreToL1113504138cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_CSSBorder_ScalarUnit_value(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1307540790;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_plaf_CSSBorder_ScalarUnit_px___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1744389827;
        case 2: goto label_L565517913;
        default: goto label_L394645908;
    }
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_ScalarUnit_floatPx___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1800031808;
        case 2: goto label_L1185465012;
        default: goto label_L1332104174;
    }
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_ScalarUnit_floatPx___com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D_boolean_R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1985362663;
        case 1: goto label_L1339507235;
        case 2: goto label_L1340769295;
        case 3: goto label_L850300711;
        case 4: goto label_L1978141335;
...
label_L1339507235:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L5998675;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_ScalarUnit_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    BC_DCMPL();
    if(POP_INT() != 0) /* IFNE */ goto label_L878169229;
...
label_L2053555034:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L2039783633;
        case 1: goto label_L121521031;
        case 2: goto label_L227005513;
        case 3: goto label_L1094167216;
        case 4: goto label_L502863983;
        default: goto label_L1094167216;
    }
