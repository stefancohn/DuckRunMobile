...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_isInt___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL922062853cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL922062853cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L922062853cn1_class_id_java_lang_Throwable1, label_L700171153, restoreToL922062853cn1_class_id_java_lang_Throwable1);

label_L922062853:
 tryBlockOffsetL922062853cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L922062853cn1_class_id_java_lang_Throwable1);
    restoreToL922062853cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_ScalarUnit_isFloat___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L66707894cn1_class_id_java_lang_Throwable1, label_L881280045, restoreToL66707894cn1_class_id_java_lang_Throwable1);
