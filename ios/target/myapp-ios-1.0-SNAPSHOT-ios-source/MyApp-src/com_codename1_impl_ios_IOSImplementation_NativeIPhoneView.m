...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView___INIT_____com_codename1_impl_ios_IOSImplementation_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 9673, 205);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_finalize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 9673, 270);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(6866);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L818859466;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L818859466;
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_isFocusable___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9673, 2571);
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(6, 2, 0, 9673, 1871);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(6880);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1859928417;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1418102907;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_onPositionSizeChange__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 1, 0, 9673, 3824);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(6889);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1378280450;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1378280450;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 1, 0, 9673, 1863);
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L339788561;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L339788561;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 9673, 1341);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(6902);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L412835761;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L412835761;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_setLightweightMode___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 9673, 2739);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(6910);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2017380745;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L2017380745;
    __CN1_DEBUG_INFO(6911);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L2017380745;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L501036152;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L261567641;
...
label_L261567641:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2017380745;
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_generatePeerImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 9673, 3818);
    ...
    if (CN1_CMP_EXPR(llocals_2_, 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1295225869;
...
label_L1295225869:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_impl_ios_IOSImplementation_NativeImage___INIT_____com_codename1_impl_ios_IOSImplementation_java_lang_String(threadStateData, SP[-1].data.o, get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_this_0(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(9674));     SP -= 1;
    BC_ASTORE(4);
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_shouldRenderPeerImage___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9673, 3820);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(6937);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1137667747;
    if (virtual_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_isInitialized___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L935722070;
