...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation___INIT_____com_codename1_ui_animations_ComponentAnimation_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 2804, 205);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation___INIT_____com_codename1_ui_animations_ComponentAnimation_1ARRAY_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 2804, 205);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 2804, 2795);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(190);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1324113830;
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1324113830;
    __CN1_DEBUG_INFO(191);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L559389493;
    __CN1_DEBUG_INFO(192);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L559389493:
    __CN1_DEBUG_INFO(194);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))<=get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L632831438;
    __CN1_DEBUG_INFO(195);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L1959627861;
...
label_L567367986:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1483799557;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(203);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1172527629;
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 2804, 2796);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(212);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L963036793;
...
label_L960858222:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1722389892;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 2804, 934);
...
label_L497813380:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L309747389;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
JAVA_INT com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_getMaxSteps___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 2804, 2794);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(230);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L922985472;
...
label_L36924735:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L571497590;
...
label_L1431782037:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L2136918746;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_setStep___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 2804, 2792);
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1963218853;
...
label_L1707510247:
    ...
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1816626863;
    if (virtual_com_codename1_ui_animations_ComponentAnimation_getMaxSteps___R_int(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), ilocals_2_))>ilocals_1_) /* IF_ICMPGT CustomJump */ goto label_L1816626863;
...
label_L1816626863:
    ...
    if (ilocals_2_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L174730272;
