...
label_L99042020:
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1792473683;
...
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(32);
    if (/* CustomInvoke */java_util_Arrays_equals___int_1ARRAY_int_1ARRAY_R_boolean(threadStateData, locals[10].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1441410416;
    __CN1_DEBUG_INFO(33);
    /* VarOp.assignFrom */     ilocals_5_ = 1 /* ICONST_1 */; 
    __CN1_DEBUG_INFO(34);
    goto label_L1792473683;

label_L1441410416:
    __CN1_DEBUG_INFO(30);
    BC_IINC(8, 1);
    goto label_L99042020;

label_L1792473683:
    __CN1_DEBUG_INFO(37);
    if (ilocals_5_!=0) /* IFNE CustomJump */ goto label_L391827378;
    __CN1_DEBUG_INFO(38);
...
label_L391827378:
    ...
    __CN1_DEBUG_INFO(42);
    if (CN1_ARRAY_ELEMENT_INT(locals[3].data.o, 0 /* ICONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1241758568;
    if (CN1_ARRAY_ELEMENT_INT(locals[3].data.o, 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L1241758568;
    if (virtual_com_codename1_capture_VideoCaptureConstraints_getPreferredQuality___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1241758568;
    __CN1_DEBUG_INFO(44);
    BC_ALOAD(3);
    PUSH_INT(0); /* ICONST_0 */
    ...
    PUSH_INT(320);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1317441269;
    BC_ALOAD(3);
    PUSH_INT(1); /* ICONST_1 */
    CHECK_ARRAY_ACCESS(2, SP[-1].data.i); /* IALOAD */
    SP--; SP[-1].type = CN1_TYPE_INT; 
...
label_L1908999587:
    ...
    SP[-1].data.i = ((JAVA_ARRAY_INT*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(800);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L816804727;
    BC_ALOAD(3);
    PUSH_INT(1); /* ICONST_1 */
    CHECK_ARRAY_ACCESS(2, SP[-1].data.i); /* IALOAD */
    SP--; SP[-1].type = CN1_TYPE_INT; 
