...
JAVA_OBJECT com_codename1_ui_Transform_IDENTITY___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_Transform__IDENTITY(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1178090104;
...
JAVA_OBJECT com_codename1_ui_Transform_impl___R_com_codename1_impl_CodenameOneImplementation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_impl(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L918716909;
...
JAVA_VOID com_codename1_ui_Transform_initNativeTransform__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_nativeTransform(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L38027658;
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1264191370;
...
label_L1264191370:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1278615395;
...
label_L38027658:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1859724001;
        case 1: goto label_L1320248993;
        case 2: goto label_L1431064234;
        default: goto label_L1278615395;
    }
...
JAVA_BOOLEAN com_codename1_ui_Transform_isIdentity___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L704482919;
...
JAVA_OBJECT com_codename1_ui_Transform_makeScale___float_float_float_R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if (CN1_CMP_EXPR(flocals_0_, 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1933808172;
...
JAVA_VOID com_codename1_ui_Transform_setScale___float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if (CN1_CMP_EXPR(flocals_1_, 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1382756158;
    if (CN1_CMP_EXPR(flocals_2_, 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1382756158;
    if (CN1_CMP_EXPR(flocals_3_, 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L1382756158;
...
label_L1865289764:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1399691256;
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateX(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1011920203;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateY(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1011920203;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateZ(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1011920203;
...
JAVA_VOID com_codename1_ui_Transform_setTranslation___float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L687472349;
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateX(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L395607661;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateY(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L395607661;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_translateZ(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L395607661;
...
JAVA_VOID com_codename1_ui_Transform_scale___float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L773301025;
...
label_L773301025:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1377546660;
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_scaleZ(__cn1ThisObject), 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L905159212;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_scaleY(__cn1ThisObject), 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L905159212;
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_Transform_scaleZ(__cn1ThisObject), 1 /* FCONST_1 */)!=0) /* IFNE CustomJump */ goto label_L905159212;
...
JAVA_OBJECT com_codename1_ui_Transform_makeInverse___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L306016343;
...
label_L306016343:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L488928549;
...
label_L488928549:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L904808047;
...
JAVA_VOID com_codename1_ui_Transform_getInverse___com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Transform_inverse(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L853955254;
    ...
    goto label_L1268786037;

label_L853955254:
    __CN1_DEBUG_INFO(703);
    if (get_field_com_codename1_ui_Transform_inverseDirty(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1268786037;
...
JAVA_VOID com_codename1_ui_Transform_invert__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1972628089;
    goto label_L847841178;

label_L1972628089:
    __CN1_DEBUG_INFO(714);
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L855277727;
...
label_L855277727:
    ...
    if (get_field_com_codename1_ui_Transform_type(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L2022417982;
...
JAVA_VOID com_codename1_ui_Transform_setTransform___com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L312560500;
        case 1: goto label_L312560500;
        case 2: goto label_L312560500;
        default: goto label_L1760443245;
    }
...
JAVA_VOID com_codename1_ui_Transform_transformPoints___int_float_1ARRAY_int_float_1ARRAY_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L736714033;
        case 1: goto label_L864766419;
        case 2: goto label_L715602332;
        default: goto label_L300865111;
    }
...
JAVA_VOID com_codename1_ui_Transform_transformPoint___float_1ARRAY_float_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    switch((*SP).data.i) {
        ...
        case 1: goto label_L173783788;
        case 2: goto label_L1835043230;
        default: goto label_L1709930189;
    }
...
label_L173783788:
    ...
    if (ilocals_3_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1679160862;
...
label_L1835043230:
    ...
    if (ilocals_3_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1510731556;
    if (ilocals_4_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1510731556;
...
label_L430119837:
    ...
    if (ilocals_3_>2 /* ICONST_2 */) /* IF_ICMPGT CustomJump */ goto label_L860798122;
    if (ilocals_4_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L860798122;
...
JAVA_OBJECT com_codename1_ui_Transform_getNativeTransform___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Transform_dirty(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1684580278;
...
JAVA_BOOLEAN com_codename1_ui_Transform_equals___com_codename1_ui_Transform_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Transform_type(locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L797313059;
