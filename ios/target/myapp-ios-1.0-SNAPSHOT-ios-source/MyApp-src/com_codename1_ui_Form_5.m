...
JAVA_INT com_codename1_ui_Form_5_compare___com_codename1_ui_Component_com_codename1_ui_Component_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_Component_getTabIndex___R_int(threadStateData, locals[1].data.o)>=virtual_com_codename1_ui_Component_getTabIndex___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L67570169;
...
label_L67570169:
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1670627211;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1796938191;
