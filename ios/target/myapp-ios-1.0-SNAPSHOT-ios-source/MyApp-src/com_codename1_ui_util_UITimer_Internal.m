...
JAVA_VOID com_codename1_ui_util_UITimer_Internal_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_ui_util_UITimer_access$000___com_codename1_ui_util_UITimer_R_java_lang_Runnable(threadStateData, get_field_com_codename1_ui_util_UITimer_Internal_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1756333997;
