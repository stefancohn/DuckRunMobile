...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_Color_cache___R_java_util_Map(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_plaf_CSSBorder_Color_cache(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L184996973;
...
label_L106350019:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L39476366;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_Color_parse___java_lang_String_R_com_codename1_ui_plaf_CSSBorder_Color(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L2031209493;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(100);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1141492454;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_validate___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4593))!=0) /* IFNE CustomJump */ goto label_L350703813;
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5713))!=0) /* IFNE CustomJump */ goto label_L350703813;
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5714))!=0) /* IFNE CustomJump */ goto label_L350703813;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5715), locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L607123271;

label_L350703813:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1395259059;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1501382858;
    __CN1_DEBUG_INFO(895);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(896);
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(locals[2].data.o)!=get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1999784536;
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_color(locals[2].data.o)!=get_field_com_codename1_ui_plaf_CSSBorder_Color_color(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1999784536;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_Color___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4593))==0) /* IFEQ CustomJump */ goto label_L813496676;
    __CN1_DEBUG_INFO(906);
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o);
    PUSH_INT(tmpResult); }
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L57986233;
...
label_L57986233:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L716216643;
...
label_L716216643:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L2102457000;
...
label_L2102457000:
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1483008191;
...
label_L813496676:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5713))==0) /* IFEQ CustomJump */ goto label_L936000680;
...
label_L936000680:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5715), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L421446035;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_isTransparent___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1663149482;
    PUSH_INT(1); /* ICONST_1 */
