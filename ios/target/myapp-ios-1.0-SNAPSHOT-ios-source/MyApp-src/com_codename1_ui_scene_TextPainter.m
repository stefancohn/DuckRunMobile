...
JAVA_VOID com_codename1_ui_scene_TextPainter_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle_com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2122810288;
    __CN1_DEBUG_INFO(59);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L2122810288:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2022543673;
    __CN1_DEBUG_INFO(63);
...
label_L2022543673:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L1406333164;
        case 4: goto label_L1443621056;
        default: goto label_L349399986;
    }
...
label_L349399986:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L4400200;
        case 4: goto label_L1146282300;
        default: goto label_L1301695646;
    }
