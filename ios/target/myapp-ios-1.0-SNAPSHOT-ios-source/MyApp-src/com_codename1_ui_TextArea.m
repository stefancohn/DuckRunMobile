...
JAVA_VOID com_codename1_ui_TextArea_setText___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL64518772701;
    int tryBlockOffsetL64518772701;
    DEFINE_CATCH_BLOCK(catch_L64518772701, label_L593573025, restoreToL64518772701);
...
label_L645187727:
 tryBlockOffsetL64518772701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L64518772701);
    restoreToL64518772701 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_TextArea_editString__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL900133744cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL900133744cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L900133744cn1_class_id_java_lang_IllegalArgumentException1, label_L1955502880, restoreToL900133744cn1_class_id_java_lang_IllegalArgumentException1);
...
label_L900133744:
 tryBlockOffsetL900133744cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L900133744cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL900133744cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_TextArea_registerAsInputDevice__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL397826166cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL397826166cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L397826166cn1_class_id_java_lang_Exception1, label_L1794068152, restoreToL397826166cn1_class_id_java_lang_Exception1);
...
label_L397826166:
 tryBlockOffsetL397826166cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L397826166cn1_class_id_java_lang_Exception1);
    restoreToL397826166cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
