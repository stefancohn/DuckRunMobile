...
JAVA_VOID com_codename1_ui_TextSelection_3_call___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1587818510;
    if (/* CustomInvoke */virtual_com_codename1_ui_TextSelection_TextSelectionSupport_isTextSelectionEnabled___com_codename1_ui_TextSelection_R_boolean(threadStateData, locals[2].data.o, get_field_com_codename1_ui_TextSelection_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1587818510;
