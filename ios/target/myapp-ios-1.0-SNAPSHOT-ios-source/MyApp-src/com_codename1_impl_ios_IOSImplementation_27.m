...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_27_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_impl_ios_IOSImplementation_getLocalNotificationCallback___R_com_codename1_notifications_LocalNotificationCallback(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L181326224;
