...
label_L456653804:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L479769835;
    ...
    if (locals[13].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1166021410;
...
label_L1969958288:
    ...
    if (ilocals_14_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L891327883;
...
label_L873249151:
    ...
    if (virtual_java_io_DataInputStream_readBoolean___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1779787990;
...
label_L1779787990:
    ...
    if (virtual_java_io_DataInputStream_readBoolean___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L298355914;
...
JAVA_VOID com_codename1_ui_util_Resources_openFileImpl___java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L1243705012;
...
label_L95476731:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L196340990;
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1590202270;
...
label_L990994954:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L2047145776;
...
label_L1590202270:
    ...
    SP--;
    switch((*SP).data.i) {
        case -18: goto label_L802270602;
        case -17: goto label_L897541009;
        case -16: goto label_L897541009;
        case -15: goto label_L897541009;
        case -14: goto label_L1755295609;
        case -13: goto label_L1479446866;
        case -12: goto label_L2050083360;
        case -11: goto label_L897541009;
        case -10: goto label_L882658588;
        case -9: goto label_L569235601;
        case -8: goto label_L897541009;
        case -7: goto label_L233142783;
        case -6: goto label_L2037498537;
        case -5: goto label_L802395190;
        case -4: goto label_L1622534157;
        case -3: goto label_L1178160997;
        case -2: goto label_L833272193;
        case -1: goto label_L40626598;
        default: goto label_L897541009;
    }
...
label_L569235601:
    ...
    SP++;
    PUSH_INT(-14);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2028372993;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L957683143;
...
JAVA_VOID com_codename1_ui_util_Resources_checkKey___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_static_com_codename1_ui_util_Resources_key(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L366023886;
...
label_L366023886:
    ...
    SP++;
    PUSH_INT(119);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L190490203;
...
JAVA_INT com_codename1_ui_util_Resources_decode___int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_util_Resources_keyOffset(__cn1ThisObject)!=CN1_ARRAY_LENGTH(get_static_com_codename1_ui_util_Resources_key(threadStateData))) /* IF_ICMPNE CustomJump */ goto label_L1993191331;
...
label_L1337347604:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1797763792;
...
JAVA_VOID com_codename1_ui_util_Resources_setResource___java_lang_String_byte_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BYTE __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1548535364;
...
label_L1886350630:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1186127045;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_util_Resources_isTheme___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L604976394;
...
label_L1488130490:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L676060909;
...
JAVA_BOOLEAN com_codename1_ui_util_Resources_isTheme___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(-9);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L52477555;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(-14);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1130250604;

label_L52477555:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1794314439;
...
label_L1727379710:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L79283217;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L69115782;
...
JAVA_OBJECT com_codename1_ui_util_Resources_open___java_lang_String_int_R_com_codename1_ui_util_Resources(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    int restoreToL961463164cn1_class_id_java_lang_RuntimeException1;
    int tryBlockOffsetL961463164cn1_class_id_java_lang_RuntimeException1;
    DEFINE_CATCH_BLOCK(catch_L961463164cn1_class_id_java_lang_RuntimeException1, label_L591352568, restoreToL961463164cn1_class_id_java_lang_RuntimeException1);
    int restoreToL1777112002cn1_class_id_java_lang_RuntimeException2;
    int tryBlockOffsetL1777112002cn1_class_id_java_lang_RuntimeException2;
    DEFINE_CATCH_BLOCK(catch_L1777112002cn1_class_id_java_lang_RuntimeException2, label_L591352568, restoreToL1777112002cn1_class_id_java_lang_RuntimeException2);
    int restoreToL436126678cn1_class_id_java_lang_RuntimeException3;
    int tryBlockOffsetL436126678cn1_class_id_java_lang_RuntimeException3;
    DEFINE_CATCH_BLOCK(catch_L436126678cn1_class_id_java_lang_RuntimeException3, label_L591352568, restoreToL436126678cn1_class_id_java_lang_RuntimeException3);
    int restoreToL192318053cn1_class_id_java_lang_RuntimeException4;
    int tryBlockOffsetL192318053cn1_class_id_java_lang_RuntimeException4;
    DEFINE_CATCH_BLOCK(catch_L192318053cn1_class_id_java_lang_RuntimeException4, label_L591352568, restoreToL192318053cn1_class_id_java_lang_RuntimeException4);

label_L961463164:
 tryBlockOffsetL961463164cn1_class_id_java_lang_RuntimeException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L961463164cn1_class_id_java_lang_RuntimeException1);
    restoreToL961463164cn1_class_id_java_lang_RuntimeException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(745);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(106))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1777112002, 0);
    if (get_static_com_codename1_ui_util_Resources_systemResource(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1777112002, 0);
...
label_L1777112002:
 tryBlockOffsetL1777112002cn1_class_id_java_lang_RuntimeException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L1777112002cn1_class_id_java_lang_RuntimeException2);
    restoreToL1777112002cn1_class_id_java_lang_RuntimeException2 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(748);
    if (get_static_com_codename1_ui_util_Resources_lastLoadedName(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L436126678, 0);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_static_com_codename1_ui_util_Resources_lastLoadedName(threadStateData), locals[0].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L436126678, 0);
    if (get_static_com_codename1_ui_util_Resources_lastLoadedDPI(threadStateData)!=ilocals_1_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L436126678, 0);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L436126678, 0);
...
label_L436126678:
 tryBlockOffsetL436126678cn1_class_id_java_lang_RuntimeException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L436126678cn1_class_id_java_lang_RuntimeException3);
    restoreToL436126678cn1_class_id_java_lang_RuntimeException3 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1384626783, 1);
...
label_L1384626783:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(106))==0) /* IFEQ CustomJump */ JUMP_TO(label_L192318053, 0);
...
label_L192318053:
 tryBlockOffsetL192318053cn1_class_id_java_lang_RuntimeException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L192318053cn1_class_id_java_lang_RuntimeException4);
    restoreToL192318053cn1_class_id_java_lang_RuntimeException4 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_util_Resources_getTheme___java_lang_String_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L113042195;
    if (/* CustomInvoke */virtual_java_util_Hashtable_containsKey___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5554))==0) /* IFEQ CustomJump */ goto label_L113042195;
...
label_L2090142523:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L958817283;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(115))!=0) /* IFNE CustomJump */ goto label_L1957691975;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4031))==0) /* IFEQ CustomJump */ goto label_L715213542;
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5555))!=0) /* IFNE CustomJump */ goto label_L715213542;
...
label_L1957691975:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1273270490;
...
label_L1273270490:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L715213542;
    __CN1_DEBUG_INFO(894);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4031))==0) /* IFEQ CustomJump */ goto label_L1097397209;
    __CN1_DEBUG_INFO(895);
    /* VarOp.assignFrom */ locals[6].data.o = /* CustomInvoke */virtual_com_codename1_ui_util_Resources_getImage___java_lang_String_R_com_codename1_ui_Image(threadStateData, __cn1ThisObject, locals[5].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L893281161;
...
label_L715213542:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5559))==0) /* IFEQ CustomJump */ goto label_L2053491093;
...
label_L988876043:
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L1745241742;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(925);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1014698874;
...
JAVA_OBJECT com_codename1_ui_util_Resources_createImageBorder___java_lang_String_1ARRAY_R_com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, 0 /* ICONST_0 */), STRING_FROM_CONSTANT_POOL_OFFSET(5561))==0) /* IFEQ CustomJump */ goto label_L1751325469;
...
label_L1751325469:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, 0 /* ICONST_0 */), STRING_FROM_CONSTANT_POOL_OFFSET(1919))==0) /* IFEQ CustomJump */ goto label_L1514723919;
...
label_L1514723919:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, 0 /* ICONST_0 */), STRING_FROM_CONSTANT_POOL_OFFSET(5562))==0) /* IFEQ CustomJump */ goto label_L10536382;
...
label_L241316255:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L149526537;
...
label_L149526537:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1295338046;
        case 3: goto label_L614516107;
        case 8: goto label_L1615669446;
        default: goto label_L2134639513;
    }
...
JAVA_OBJECT com_codename1_ui_util_Resources_createImage___java_io_DataInputStream_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_util_Resources_majorVersion(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L406831866;
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L406831866;
...
label_L406831866:
    ...
    SP--;
    switch((*SP).data.i) {
        case 239: goto label_L974242027;
        case 240: goto label_L856937591;
        case 241: goto label_L741095751;
        case 242: goto label_L741095751;
        case 243: goto label_L1247938090;
        case 244: goto label_L856937591;
        case 245: goto label_L2126545173;
        case 246: goto label_L1407009494;
        case 247: goto label_L511094763;
        default: goto label_L856937591;
    }
...
label_L741095751:
    ...
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L1149217113;
...
label_L2126545173:
    ...
    if (com_codename1_ui_Image_isSVGSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1045250282;
    ...
    if (CN1_ARRAY_LENGTH(locals[8].data.o)<=0) /* IFLE CustomJump */ goto label_L121597447;
...
label_L353489239:
    ...
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L748523772;
...
label_L511094763:
    ...
    if (com_codename1_ui_Image_isSVGSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1099925775;
    ...
    if (virtual_com_codename1_ui_Image_getSVGDocument___R_java_lang_Object(threadStateData, locals[9].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1027377263;
...
label_L1717967062:
    ...
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L2103895364;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1092);
    if (get_field_com_codename1_ui_util_Resources_dpi(__cn1ThisObject)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1528574692;
...
label_L516570791:
    if (ilocals_10_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L45790744;
    ...
    if (ilocals_6_==get_field_com_codename1_ui_util_Resources_dpi(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L1220292558;
    if (get_field_com_codename1_ui_util_Resources_dpi(__cn1ThisObject)<ilocals_11_) /* IF_IMPLT CustomJump */ goto label_L1220292558;
    if (ilocals_11_<ilocals_6_) /* IF_IMPLT CustomJump */ goto label_L1220292558;
...
label_L45790744:
    ...
    if (ilocals_9_!=0) /* IFNE CustomJump */ goto label_L620471432;
...
label_L1515016092:
    if (ilocals_10_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L620471432;
    __CN1_DEBUG_INFO(1117);
    if (CN1_ARRAY_ELEMENT_INT(locals[8].data.o, ilocals_10_)>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1940311161;
...
label_L620471432:
    ...
    if (get_static_com_codename1_ui_util_Resources_runtimeMultiImages(threadStateData)==0) /* IFEQ CustomJump */ goto label_L356347252;
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L356347252;
...
label_L698062929:
    if (ilocals_11_>=CN1_ARRAY_LENGTH(locals[7].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1822115007;
...
label_L605472344:
    if (ilocals_10_>=CN1_ARRAY_LENGTH(locals[7].data.o)) /* IF_ICMPGE CustomJump */ goto label_L421135185;
    __CN1_DEBUG_INFO(1134);
    /* VarOp.assignFrom */ ilocals_11_=CN1_ARRAY_ELEMENT_INT(locals[7].data.o, ilocals_10_);
    __CN1_DEBUG_INFO(1135);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1731365835;
    if (ilocals_5_!=ilocals_10_) /* IF_ICMPNE CustomJump */ goto label_L1731365835;
    ...
    goto label_L1371182382;

label_L1731365835:
    __CN1_DEBUG_INFO(1140);
    if (ilocals_11_<=0) /* IFLE CustomJump */ goto label_L1371182382;
...
JAVA_OBJECT com_codename1_ui_util_Resources_loadFont___java_io_DataInputStream_java_lang_String_boolean_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_util_Resources_majorVersion(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1834961152;
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1834961152;
    __CN1_DEBUG_INFO(1164);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L507575219;
    __CN1_DEBUG_INFO(1165);
    /* VarOp.assignFrom */ locals[4].data.o = com_codename1_ui_util_Resources_createPackedImage8___R_com_codename1_ui_Image(threadStateData, __cn1ThisObject);locals[4].type=CN1_TYPE_OBJECT;    goto label_L458624688;
...
label_L509632753:
    if (ilocals_8_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L165687172;
...
label_L165687172:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L132423149;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1200);
    ...
    if (ilocals_7_==0) /* IFEQ CustomJump */ goto label_L745287727;
    ...
    if (locals[6].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L745287727;
    if (com_codename1_ui_Font_isCreationByStringSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L745287727;
...
label_L745287727:
    ...
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L611890729;
...
label_L611890729:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L956448191;
...
label_L518349613:
    if (ilocals_8_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L908218259;
    __CN1_DEBUG_INFO(1232);
    CN1_SET_ARRAY_ELEMENT_INT(locals[7].data.o, ilocals_8_, virtual_java_io_DataInputStream_readByte___R_byte(threadStateData, locals[1].data.o));
    __CN1_DEBUG_INFO(1231);
    BC_IINC(8, 1);
    goto label_L518349613;
...
label_L908218259:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1386713738;
    __CN1_DEBUG_INFO(1237);
    if (com_codename1_ui_Font_isBitmapFontEnabled___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1386713738;
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1446825265;
...
JAVA_OBJECT com_codename1_ui_util_Resources_createTrueTypeFont___com_codename1_ui_Font_java_lang_String_java_lang_String_float_int_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_FLOAT __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    int restoreToL1203394043cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1203394043cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1203394043cn1_class_id_java_lang_Exception1, label_L1917214386, restoreToL1203394043cn1_class_id_java_lang_Exception1);
    int restoreToL1227612217cn1_class_id_java_lang_Exception2;
    int tryBlockOffsetL1227612217cn1_class_id_java_lang_Exception2;
    DEFINE_CATCH_BLOCK(catch_L1227612217cn1_class_id_java_lang_Exception2, label_L1917214386, restoreToL1227612217cn1_class_id_java_lang_Exception2);
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L1200601052, 0);
        case 1: JUMP_TO(label_L701652581, 0);
        case 2: JUMP_TO(label_L431446827, 0);
        case 3: JUMP_TO(label_L1506030945, 0);
        case 4: JUMP_TO(label_L1666144466, 0);
        case 5: JUMP_TO(label_L1481970600, 0);
        case 6: JUMP_TO(label_L2065196426, 0);
        case 7: JUMP_TO(label_L51325109, 0);
        case 8: JUMP_TO(label_L438270414, 0);
        case 9: JUMP_TO(label_L1789387126, 0);
        default: JUMP_TO(label_L1386999197, 0);
    }
...
label_L1386999197:
    ...
    if (get_static_com_codename1_ui_util_Resources_failOnMissingTruetype(threadStateData)!=0) /* IFNE CustomJump */ JUMP_TO(label_L672869885, 0);

label_L1203394043:
 tryBlockOffsetL1203394043cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1203394043cn1_class_id_java_lang_Exception1);
    restoreToL1203394043cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1227612217, 0);
...
label_L1227612217:
 tryBlockOffsetL1227612217cn1_class_id_java_lang_Exception2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1227612217cn1_class_id_java_lang_Exception2);
    restoreToL1227612217cn1_class_id_java_lang_Exception2 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_util_Resources_loadTheme___java_lang_String_boolean_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    int restoreToL1193487410cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1193487410cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1193487410cn1_class_id_java_lang_Exception1, label_L483529787, restoreToL1193487410cn1_class_id_java_lang_Exception1);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5572), locals[5].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L286840121, 0);
...
label_L1612539426:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2061424899, 0);
    /* LDC: 'tablet'*/
...
label_L2073484941:
    if (ilocals_18_>=ilocals_13_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L767060604, 0);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5220))==0) /* IFEQ CustomJump */ JUMP_TO(label_L639579551, 0);
    ...
    if (get_static_com_codename1_ui_util_Resources_enableMediaQueries(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1526901124, 0);
    __CN1_DEBUG_INFO(1334);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5580))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1526901124, 0);
    __CN1_DEBUG_INFO(1335);
    if (locals[15].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1461216550, 0);
...
label_L1526901124:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5581))==0) /* IFEQ CustomJump */ JUMP_TO(label_L958209587, 0);
    if (ilocals_17_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L958209587, 0);
    ...
    if (ilocals_20_<=0) /* IFLE CustomJump */ JUMP_TO(label_L958209587, 0);
    ...
    if (com_codename1_ui_CN_isDesktop___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1727096642, 0);
    PUSH_FLOAT(96.0); /* LDC */
    JUMP_TO(label_L678538385, 0);
...
label_L958209587:
    ...
    if (com_codename1_ui_CN_isTablet___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1012194796, 0);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5582))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1012194796, 0);
    if (ilocals_17_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1012194796, 0);
    ...
    if (ilocals_20_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1012194796, 0);
...
label_L1012194796:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5583))==0) /* IFEQ CustomJump */ JUMP_TO(label_L629092599, 0);
    if (ilocals_17_>=3 /* ICONST_3 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L629092599, 0);
...
label_L1071522313:
    ...
    JUMP_TO(label_L629092599, 0);

label_L639579551:
    __CN1_DEBUG_INFO(1367);
    if (get_static_com_codename1_ui_util_Resources_enableMediaQueries(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L990413155, 0);
...
locals[20].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1369);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5579))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1971855969, 0);
    __CN1_DEBUG_INFO(1373);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, locals[9].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1629292387, 0);
...
label_L1971855969:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5576))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1633615132, 0);
    __CN1_DEBUG_INFO(1383);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L505572301, 0);
...
label_L1633615132:
    ...
    if (ilocals_21_==0) /* IFEQ CustomJump */ JUMP_TO(label_L713939266, 0);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5578))==0) /* IFEQ CustomJump */ JUMP_TO(label_L713939266, 0);
    __CN1_DEBUG_INFO(1392);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[20].data.o, locals[8].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L589489519, 0);
...
label_L713939266:
    ...
    if (ilocals_21_==0) /* IFEQ CustomJump */ JUMP_TO(label_L990413155, 0);
    __CN1_DEBUG_INFO(1402);
    if (locals[16].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L889346570, 0);
...
label_L889346570:
    ...
    if (locals[24].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L947069796, 0);
    __CN1_DEBUG_INFO(1408);
    /* VarOp.assignFrom */     ilocals_25_ = 1 /* ICONST_1 */; 

label_L947069796:
    __CN1_DEBUG_INFO(1410);
    if (ilocals_25_!=0) /* IFNE CustomJump */ JUMP_TO(label_L2087758561, 0);
    if (get_field_com_codename1_ui_util_Resources_1MediaRule_matchCount(locals[24].data.o)>ilocals_22_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L2087758561, 0);
    __CN1_DEBUG_INFO(1411);
    /* VarOp.assignFrom */     ilocals_25_ = 1 /* ICONST_1 */; 

label_L2087758561:
    __CN1_DEBUG_INFO(1413);
    if (ilocals_25_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1221407133, 0);
    if (get_field_com_codename1_ui_util_Resources_1MediaRule_bestMatchScore(locals[24].data.o)>ilocals_23_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L1221407133, 0);
    __CN1_DEBUG_INFO(1414);
    /* VarOp.assignFrom */     ilocals_25_ = 1 /* ICONST_1 */; 

label_L1221407133:
    __CN1_DEBUG_INFO(1416);
    if (ilocals_25_==0) /* IFEQ CustomJump */ JUMP_TO(label_L990413155, 0);
    __CN1_DEBUG_INFO(1417);
    if (locals[24].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1866002564, 0);
...
label_L990413155:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5584))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1324451332, 0);
...
label_L1324451332:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(126))!=0) /* IFNE CustomJump */ JUMP_TO(label_L925829785, 0);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(127))==0) /* IFEQ CustomJump */ JUMP_TO(label_L382698552, 0);
...
label_L382698552:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5585))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1046211253, 0);
...
label_L1046211253:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(110))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2086177500, 0);
...
label_L2086177500:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(117))==0) /* IFEQ CustomJump */ JUMP_TO(label_L871115788, 0);
...
label_L871115788:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(118))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1500020749, 0);
...
label_L1500020749:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(119))==0) /* IFEQ CustomJump */ JUMP_TO(label_L948422615, 0);
...
label_L948422615:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(120))==0) /* IFEQ CustomJump */ JUMP_TO(label_L11646065, 0);
...
label_L11646065:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(121))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1383031847, 0);
...
label_L1383031847:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5586))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1327169167, 0);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5587))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1227170244, 0);

label_L1327169167:
    __CN1_DEBUG_INFO(1479);
    PUSH_INT(get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject));
    PUSH_INT(7);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1144653485, 0);
...
label_L1227170244:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5588))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1843207249, 0);
...
label_L1843207249:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5559))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1965779427, 0);
...
label_L1965779427:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5589))==0) /* IFEQ CustomJump */ JUMP_TO(label_L358636931, 0);
    __CN1_DEBUG_INFO(1518);
    if (virtual_java_io_DataInputStream_readBoolean___R_boolean(threadStateData, get_field_com_codename1_ui_util_Resources_input(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L33238764, 0);
    ...
    if (locals[20].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L79791382, 0);
...
label_L33238764:
    ...
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)<=4/* ICONST_4 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L705400860, 0);
    ...
    if (ilocals_21_==0) /* IFEQ CustomJump */ JUMP_TO(label_L705400860, 0);
    ...
    if (com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L705400860, 0);
...
label_L358636931:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5590))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1024478363, 0);
    ...
    if (ilocals_21_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1698990491, 0);
    __CN1_DEBUG_INFO(1552);
    /* VarOp.assignFrom */ locals[19].data.o = /* CustomInvoke */virtual_java_lang_String_substring___int_int_R_java_lang_String(threadStateData, locals[19].data.o, 0 /* ICONST_0 */, ilocals_21_);locals[19].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1839548688, 0);
...
label_L1839548688:
    ...
    SP--;
    switch((*SP).data.i) {
        case -12: JUMP_TO(label_L467185608, 0);
        case 241: JUMP_TO(label_L467185608, 0);
        case 242: JUMP_TO(label_L605244604, 0);
        case 243: JUMP_TO(label_L605244604, 0);
        case 245: JUMP_TO(label_L605244604, 0);
        case 246: JUMP_TO(label_L1708786164, 0);
        case 247: JUMP_TO(label_L1708786164, 0);
        case 248: JUMP_TO(label_L586164630, 0);
        default: JUMP_TO(label_L2089317615, 0);
    }
...
label_L586164630:
    ...
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1119920494, 0);
...
label_L1024478363:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3104))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2007031139, 0);
...
label_L2007031139:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(111))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1413473944, 0);
    ...
    if (locals[21].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1798299644, 0);
...
label_L1413473944:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5555))==0) /* IFEQ CustomJump */ JUMP_TO(label_L748935206, 0);
    __CN1_DEBUG_INFO(1629);
    if (virtual_java_io_DataInputStream_readBoolean___R_boolean(threadStateData, get_field_com_codename1_ui_util_Resources_input(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1561936660, 0);
...
label_L748935206:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(112))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1983472905, 0);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(113))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1669104653, 0);
...
label_L1669104653:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[19].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(114))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1370231468, 0);
    __CN1_DEBUG_INFO(1643);
    if (get_field_com_codename1_ui_util_Resources_minorVersion(__cn1ThisObject)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1178270318, 0);
...
label_L629092599:
    __CN1_DEBUG_INFO(1329);
    BC_IINC(18, 1);
    JUMP_TO(label_L2073484941, 0);

label_L767060604:
    __CN1_DEBUG_INFO(1665);
    if (get_static_com_codename1_ui_util_Resources_enableMediaQueries(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2093834526, 0);
    __CN1_DEBUG_INFO(1666);
    if (locals[16].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1304765785, 0);
    if (virtual_java_util_Map_isEmpty___R_boolean(threadStateData, locals[16].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1304765785, 0);
...
label_L1547521797:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[18].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1304765785, 0);
...
label_L1304765785:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2093834526, 0);
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, locals[14].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L2093834526, 0);
...
label_L1657521272:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L294817977, 0);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5579))==0) /* IFEQ CustomJump */ JUMP_TO(label_L104912388, 0);
    __CN1_DEBUG_INFO(1679);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, locals[9].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1657521272, 0);
...
label_L104912388:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5576))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1413020227, 0);
    __CN1_DEBUG_INFO(1686);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1657521272, 0);
...
label_L1413020227:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5578))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1361755941, 0);
    __CN1_DEBUG_INFO(1695);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[22].data.o, locals[8].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1657521272, 0);
...
label_L1361755941:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5592), locals[22].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1364898802, 0);
...
label_L294817977:
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L2093834526, 0);
...
label_L2121744549:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[19].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2093834526, 0);
    ...
    if (locals[21].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1829651877, 0);
    if (virtual_com_codename1_ui_Font_isTTFNativeFont___R_boolean(threadStateData, locals[21].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1829651877, 0);

label_L1193487410:
 tryBlockOffsetL1193487410cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1193487410cn1_class_id_java_lang_Exception1);
    restoreToL1193487410cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_ui_util_Resources_createBorder___java_io_DataInputStream_int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    int restoreToL2014454780cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL2014454780cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L2014454780cn1_class_id_java_lang_Throwable1, label_L2057313241, restoreToL2014454780cn1_class_id_java_lang_Throwable1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 65281: JUMP_TO(label_L2120344156, 0);
        case 65282: JUMP_TO(label_L1633530712, 0);
        case 65283: JUMP_TO(label_L627815870, 0);
        case 65284: JUMP_TO(label_L1609501721, 0);
        case 65285: JUMP_TO(label_L778925754, 0);
        case 65286: JUMP_TO(label_L581359452, 0);
        case 65287: JUMP_TO(label_L1519927539, 0);
        case 65288: JUMP_TO(label_L2100297853, 0);
        case 65289: JUMP_TO(label_L942502343, 0);
        case 65290: JUMP_TO(label_L749030825, 0);
        case 65291: JUMP_TO(label_L749030825, 0);
        case 65292: JUMP_TO(label_L749030825, 0);
        case 65293: JUMP_TO(label_L749030825, 0);
        case 65294: JUMP_TO(label_L749030825, 0);
        case 65295: JUMP_TO(label_L749030825, 0);
        case 65296: JUMP_TO(label_L883035926, 0);
        case 65297: JUMP_TO(label_L1231864343, 0);
        case 65298: JUMP_TO(label_L438051252, 0);
        case 65299: JUMP_TO(label_L483589979, 0);
        case 65300: JUMP_TO(label_L950831464, 0);
        case 65301: JUMP_TO(label_L402622480, 0);
        case 65302: JUMP_TO(label_L1821711066, 0);
        default: JUMP_TO(label_L749030825, 0);
    }
...
label_L2014454780:
 tryBlockOffsetL2014454780cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L2014454780cn1_class_id_java_lang_Throwable1);
    restoreToL2014454780cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
label_L1289903687:
    if (ilocals_4_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L914175168;
...
label_L890085657:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1669392873;
...
label_L885465900:
    if (ilocals_5_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1778993228;
...
label_L629790599:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1357663228;
...
label_L677007331:
    if (ilocals_8_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L145833361;
...
JAVA_OBJECT com_codename1_ui_util_Resources_createPackedImage8___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L394840929;
...
label_L1812681178:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L383005108;
...
JAVA_OBJECT com_codename1_ui_util_Resources_getSystemResource___R_com_codename1_ui_util_Resources(CODENAME_ONE_THREAD_STATE) {
    ...
    int restoreToL1471512574cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1471512574cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1471512574cn1_class_id_java_io_IOException1, label_L123045427, restoreToL1471512574cn1_class_id_java_io_IOException1);

label_L1471512574:
 tryBlockOffsetL1471512574cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1471512574cn1_class_id_java_io_IOException1);
    restoreToL1471512574cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
