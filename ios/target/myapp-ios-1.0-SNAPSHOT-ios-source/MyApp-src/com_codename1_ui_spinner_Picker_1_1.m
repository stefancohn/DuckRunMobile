...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(644);
    ...
    if (get_field_com_codename1_ui_spinner_Picker_1_1_keyListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1910085426;
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_1_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L589884531;
...
label_L589884531:
    ...
    if (get_field_com_codename1_ui_spinner_Picker_1_1_keyListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1117803827;
