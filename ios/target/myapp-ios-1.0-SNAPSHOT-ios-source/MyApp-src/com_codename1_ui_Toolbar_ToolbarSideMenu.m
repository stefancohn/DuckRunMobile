...
JAVA_VOID com_codename1_ui_Toolbar_ToolbarSideMenu_removeCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_ui_Toolbar_access$1000___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1102181662;
    if (com_codename1_ui_Toolbar_access$1100___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L978599729;
...
label_L1102181662:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L978599729;
...
JAVA_VOID com_codename1_ui_Toolbar_ToolbarSideMenu_initMenuBar___com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1203142603;
...
label_L1203142603:
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$800___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_ToolbarSideMenu_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L731870416;
...
JAVA_VOID com_codename1_ui_Toolbar_ToolbarSideMenu_installRightCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1297462845cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1297462845cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1297462845cn1_class_id_java_lang_Throwable1, label_L2130606983, restoreToL1297462845cn1_class_id_java_lang_Throwable1);
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$1500___com_codename1_ui_Toolbar_R_java_util_Vector(threadStateData, get_field_com_codename1_ui_Toolbar_ToolbarSideMenu_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L180489140, 0);
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L180489140, 0);
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7199), JAVA_NULL /* ACONST_NULL */)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1512822728, 0);
    __CN1_DEBUG_INFO(2616);
    /* VarOp.assignFrom */     flocals_3_ = 4.5;

label_L1297462845:
 tryBlockOffsetL1297462845cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1297462845cn1_class_id_java_lang_Throwable1);
    restoreToL1297462845cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
...
label_L1512822728:
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1904720585, 0);
...
label_L1904720585:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L180489140, 0);
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2639);
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1803714790, 0);
    ...
    JUMP_TO(label_L180489140, 0);

label_L1803714790:
    __CN1_DEBUG_INFO(2643);
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1863557065, 0);
...
label_L1715602761:
    if (ilocals_7_>=virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, locals[6].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1428527783, 0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L423109432, 0);
    __CN1_DEBUG_INFO(2649);
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[8].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7200))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L423109432, 0);
...
label_L1863557065:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7200))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L366752671, 0);
...
label_L1118998513:
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1825923873;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Command_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4609))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L883735648;
    __CN1_DEBUG_INFO(2700);
    /* VarOp.assignFrom */     ilocals_1_ = 1 /* ICONST_1 */; 
    __CN1_DEBUG_INFO(2701);
    goto label_L1825923873;

label_L883735648:
    __CN1_DEBUG_INFO(2697);
    BC_IINC(3, -1);
    goto label_L1118998513;
...
label_L1825923873:
    ...
    if (virtual_com_codename1_ui_Toolbar_ToolbarSideMenu_getBackCommand___R_com_codename1_ui_Command(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L906370291;
    __CN1_DEBUG_INFO(2711);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1905114489;
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1905114489;
...
label_L1905114489:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L538132628;
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L906370291;
...
label_L538132628:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_layouts_BorderLayout);
    if(POP_INT() == 0) /* IFEQ */ goto label_L906370291;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2721);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1988664928;
...
label_L1988664928:
    ...
    BC_ALOAD(7);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1886381510;
...
label_L1886381510:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1813375175;
