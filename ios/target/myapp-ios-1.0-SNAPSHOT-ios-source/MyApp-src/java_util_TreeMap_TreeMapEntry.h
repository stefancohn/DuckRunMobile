...
extern void __INIT_VTABLE_java_util_TreeMap_TreeMapEntry(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_java_util_TreeMap_TreeMapEntry(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_java_util_TreeMap_TreeMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_java_util_TreeMap_TreeMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_java_util_TreeMap_TreeMapEntry(CODENAME_ONE_THREAD_STATE);
...
JAVA_VOID java_util_TreeMap_TreeMapEntry_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID java_util_TreeMap_TreeMapEntry_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID java_util_TreeMap_TreeMapEntry_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
struct obj__java_util_TreeMap_TreeMapEntry {
    ...
    JAVA_OBJECT java_util_TreeMap_TreeMapEntry_node;
    JAVA_INT java_util_TreeMap_TreeMapEntry_index;
};



#endif //__JAVA_UTIL_TREEMAP_TREEMAPENTRY__
