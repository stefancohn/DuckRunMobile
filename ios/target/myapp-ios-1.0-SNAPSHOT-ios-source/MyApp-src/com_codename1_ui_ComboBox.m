...
JAVA_VOID com_codename1_ui_ComboBox___INIT_____com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L752772379;
...
label_L752772379:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1397643446;
...
label_L28612052:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1579015748;
...
label_L1579015748:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4449), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2134357721;
...
JAVA_INT com_codename1_ui_ComboBox_getBaseline___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_ComboBox_getRenderingPrototype___R_java_lang_Object(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L119420356;
...
label_L119420356:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L580979398;
...
JAVA_OBJECT com_codename1_ui_ComboBox_showPopupDialog___com_codename1_ui_Dialog_com_codename1_ui_List_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_ComboBox_getLabelForComponent___R_com_codename1_ui_Label(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1346237136;
...
label_L1346237136:
    ...
    if (get_field_com_codename1_ui_ComboBox_includeSelectCancel(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L654003462;
...
label_L654003462:
    ...
    if (get_field_com_codename1_ui_ComboBox_actAsSpinnerDialog(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1373051324;
...
label_L1373051324:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L758705661;
...
label_L758705661:
    ...
    if (virtual_com_codename1_ui_Form_getSoftButtonCount___R_int(threadStateData, locals[7].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L352830403;
...
label_L352830403:
    ...
    if (ilocals_11_>=ilocals_13_) /* IF_ICMPGE CustomJump */ goto label_L1700397528;
    __CN1_DEBUG_INFO(415);
    if (ilocals_3_<=(ilocals_13_ / 2 /* ICONST_2 */)) /* IF_ICMPLE CustomJump */ goto label_L204078646;
...
label_L1712635211:
    ...
    if (ilocals_6_>=0) /* IFGE CustomJump */ goto label_L1294361489;
...
JAVA_VOID com_codename1_ui_ComboBox_fireClicked__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L2017980204;
    if (virtual_com_codename1_ui_Dialog_wasDisposedDueToOutOfBoundsTouch___R_boolean(threadStateData, locals[4].data.o)!=0) /* IFNE CustomJump */ goto label_L2017980204;
    BC_ALOAD(4);
...
JAVA_OBJECT com_codename1_ui_ComboBox_createPopupList___R_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2028042905;
...
JAVA_VOID com_codename1_ui_ComboBox_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L103130367;
...
JAVA_VOID com_codename1_ui_ComboBox_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_ComboBox_isEnabled___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1104938392;
    if (virtual_com_codename1_impl_CodenameOneImplementation_isScrollWheeling___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))!=0) /* IFNE CustomJump */ goto label_L1104938392;
