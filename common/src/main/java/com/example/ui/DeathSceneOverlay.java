...
public class DeathSceneOverlay {
    ...
    int buttonPlacementX = (int) ((MyApp.DEVICE_WIDTH/1.4) - (buttonWidth/2));
    int playAgainY = (int) (MyApp.DEVICE_HEIGHT * .45);
    ...
    public void draw(Graphics g) {
        ...
        for (int i = 0; i < SaveScores.highscores.size(); i++) {
            g.drawString((i + 1) + ") " + SaveScores.highscores.get(i).toString(), hsX, 380 + i * hsY);
        }
    }
