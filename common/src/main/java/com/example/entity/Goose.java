...
public class Goose extends Entity {
    ...
    public void draw(Graphics g, int xOffset) {
        g.drawImage(gooseImages[spriteRow][0], (int) (hitbox.x * MyApp.WIDTH_SCALE) - xOffset, (int) (hitbox.y * MyApp.HEIGHT_SCALE), (int) (width * MyApp.WIDTH_SCALE), (int) (height * MyApp.HEIGHT_SCALE));
        //drawHitbox(g);
    }
}