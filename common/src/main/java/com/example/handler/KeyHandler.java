...
public class KeyHandler {
    ...
    public void touchMovement(int x, int y) {
        if (Bounds.checkBounds(x, y, arrowButtons.upArrowX, arrowButtons.upArrowY, arrowButtons.arrowWidth, arrowButtons.arrowHeight)) {
            upPressed = true;
            direction = "up";
            arrowButtons.upArrowSprite = 1;
            upTouched = true;
        } 
        if (Bounds.checkBounds(x, y, arrowButtons.xPos, arrowButtons.yPos, arrowButtons.arrowWidth, arrowButtons.arrowHeight)) { 
            leftPressed = true;
            arrowButtons.arrowSprite = 1;
         } 
        if (Bounds.checkBounds(x, y, arrowButtons.rightArrowX, arrowButtons.yPos, arrowButtons.arrowWidth, arrowButtons.arrowHeight)) {
            rightPressed = true;
