...
public class LevelManager {
    ...
    private Image background = LoadSave.getSpriteAtlas("/background.jpg");

    Level mainLevel;
    Level[] obstacleSequences = new Level[Constants.AMOUNT_OF_PATTERNS];

    public static int widthOfBlocks = (int) (1 * Constants.TILES_SIZE_DEF * MyApp.WIDTH_SCALE);
    public static int heightOfBlocks = (int) (1 * Constants.TILES_SIZE_DEF * MyApp.HEIGHT_SCALE);
